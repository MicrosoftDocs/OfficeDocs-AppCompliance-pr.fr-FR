---
title: Informations sur l’application pour le concepteur
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/23/2021
...
description: Toutes les informations de sécurité et de conformité disponibles pour le Concepteur, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
ms.locfileid: "65225298"
---
# <a name="application-information-for-designer-by-officeatwork"></a>Informations sur l’application pour le concepteur par officeatwork

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Dernière mise à jour par le développeur : 23 juin 2021</p>

* [Afficher dans AppSource](https://appsource.microsoft.com/product/web-apps/officeatwork-ag.designer)
...
>| Sites.Read.All | Délégué | Aucune donnée n’est stockée. | SharePoint Online : pour activer la lecture des données à partir de SharePoint Online. | 0c67871c-ffbc-4b37-bd61-afce12b299f9 |
...
>| offline_access | Délégué | Aucune donnée n’est stockée. | Sing-In : pour activer la connexion automatique via des jetons d’actualisation, comme sans, les utilisateurs doivent se connecter manuellement chaque fois qu’ils lancent l’application officeatwork. Cette étendue est uniquement requise pour les applications hôtes non compatibles avec l’authentification unique. | 0c67871c-ffbc-4b37-bd61-afce12b299f9 |
>| openid | Délégué | Aucune donnée n’est stockée. | Sing-In : pour permettre aux utilisateurs de se connecter à l’application Officeatwork avec leur organisation et/ou leur compte Microsoft | 0c67871c-ffbc-4b37-bd61-afce12b299f9 |
>| profil | Délégué | Aucune donnée n’est stockée. | Sing-In : pour afficher l’utilisateur connecté dans l’application Officeatwork. Cela permet d’assurer/de confirmer à l’utilisateur quel compte a été utilisé pour se connecter à l’application officeatwork. | 0c67871c-ffbc-4b37-bd61-afce12b299f9 |
...
<iframe height='1020' title='informations de Microsoft Cloud App Security' src='https://appmcasinfoprod.azurewebsites.net/#/dashboard/35749' frameborder='0'></iframe>

[Afficher sous un onglet](https://appmcasinfoprod.azurewebsites.net/#/dashboard/35749){:target="_blank"}
