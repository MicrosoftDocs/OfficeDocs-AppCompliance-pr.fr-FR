---
title: Informations sur l’application pour le choisisseur de contenu
ms.author: elmalova
author: elenamalova
ms.date: 06/23/2021
ms.topic: article
...
description: Toutes les informations de sécurité et de conformité disponibles pour content Chooser, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
ms.locfileid: "65225005"
---
# <a name="application-information-for-content-chooser-by-officeatwork"></a>Informations d’application pour le chooser de contenu par officeatwork
...
|:----------------|:-------------|
| Nom de l'application | Choisisseur de contenu |
...
>|:----------------|:--------------------|:---------------------------------------------------|:--------------------------|:--------------------------|
>| Files.ReadWrite.All | Délégué | Aucune donnée n’est stockée. | Favoris : pour pouvoir lire et écrire des données sur les utilisateurs OneDrive. | edb24f8f-38af-4b3e-9475-0da243678d5a |
...
>| GroupMember.Read.All | Délégué | Aucune donnée n’est stockée. | SharePoint Online - Prise en charge des groupes de sécurité : pour permettre à l’application de répertorier les groupes, de lire les propriétés de groupe de base et de lire les appartenances de tous les groupes auxquels l’utilisateur connecté a accès | edb24f8f-38af-4b3e-9475-0da243678d5a |
>| Sites.Read.All | Délégué | Aucune donnée n’est stockée. | SharePoint Online : pour activer la lecture des données à partir de SharePoint Online. | edb24f8f-38af-4b3e-9475-0da243678d5a |
...
>| offline_access | Délégué | Aucune donnée n’est stockée. | Sing-In : pour activer la connexion automatique via des jetons d’actualisation, comme sans, les utilisateurs doivent se connecter manuellement chaque fois qu’ils lancent l’application officeatwork. Cette étendue est uniquement requise pour les applications hôtes non compatibles avec l’authentification unique. | edb24f8f-38af-4b3e-9475-0da243678d5a |
>| openid | Délégué | Aucune donnée n’est stockée. | Sing-In : pour permettre aux utilisateurs de se connecter à l’application Officeatwork avec leur organisation et/ou leur compte Microsoft. | edb24f8f-38af-4b3e-9475-0da243678d5a |
>| profil | Délégué | Aucune donnée n’est stockée. | Sing-In : pour afficher l’utilisateur connecté dans l’application Officeatwork. Cela permet d’assurer/de confirmer à l’utilisateur quel compte a été utilisé pour se connecter à l’application officeatwork. | edb24f8f-38af-4b3e-9475-0da243678d5a |
...
<iframe height='1020' title='informations de Microsoft Cloud App Security' src='https://appmcasinfoprod.azurewebsites.net/#/dashboard/35751' frameborder='no'></iframe>
