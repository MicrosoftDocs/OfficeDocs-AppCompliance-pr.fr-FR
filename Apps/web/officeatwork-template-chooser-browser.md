---
title: Informations sur l’application pour le navigateur du choisisseur de modèle
ms.author: elmalova
author: elenamalova
ms.date: 06/22/2021
ms.topic: article
...
description: Toutes les informations de sécurité et de conformité disponibles pour Template Chooser Browser, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
---
# <a name="application-information-for-template-chooser-browser-by-officeatwork"></a>Informations d’application pour template chooser Browser by officeatwork

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Dernière mise à jour par le développeur : 22 juin 2021</p>

* <a href="https://appsource.microsoft.com/product/web-apps/officeatwork-ag.template-chooser-browser" target="_blank">Afficher dans AppSource</a>
...
|:----------------|:-------------|
| Nom de l'application | Navigateur du choisisseur de modèle |
...
>|:----------------|:--------------------|:---------------------------------------------------|:--------------------------|:--------------------------|
>| Files.ReadWrite.All | Délégué | Aucune donnée n’est stockée. | Favoris : pour pouvoir lire et écrire des données aux utilisateurs OneDrive ; OneDrive : pour pouvoir lire et écrire des données aux utilisateurs OneDrive. | dae2eacf-3eb5-4440-baff-984fbd5cae68 |
>| Group.ReadWrite.All | Délégué | Aucune donnée n’est stockée. | Teams : pour pouvoir lire et écrire des données dans un groupe. | dae2eacf-3eb5-4440-baff-984fbd5cae68 |
>| GroupMember.Read.All | Délégué | Aucune donnée n’est stockée. | SharePoint Online : autorisation de l’utilisateur pour activer la lecture des données à partir de SharePoint Online. | dae2eacf-3eb5-4440-baff-984fbd5cae68 |
>| Sites.Read.All | Délégué | Aucune donnée n’est stockée. | SharePoint Online : pour activer la lecture des données à partir de SharePoint Online. | dae2eacf-3eb5-4440-baff-984fbd5cae68 |
...
>| offline_access | Délégué | Aucune donnée n’est stockée. | Sing-In : pour activer la connexion automatique via des jetons d’actualisation, comme sans, les utilisateurs doivent se connecter manuellement chaque fois qu’ils lancent l’application officeatwork. Cette étendue est uniquement requise pour les applications hôtes non compatibles avec l’authentification unique. | dae2eacf-3eb5-4440-baff-984fbd5cae68 |
>| openid | Délégué | Aucune donnée n’est stockée. | Sing-In : pour permettre aux utilisateurs de se connecter à l’application Officeatwork avec leur organisation et/ou leur compte Microsoft | dae2eacf-3eb5-4440-baff-984fbd5cae68 |
>| profil | Délégué | Aucune donnée n’est stockée. | Sing-In : pour afficher l’utilisateur connecté dans l’application Officeatwork. Cela permet d’assurer/de confirmer à l’utilisateur quel compte a été utilisé pour se connecter à l’application officeatwork. | dae2eacf-3eb5-4440-baff-984fbd5cae68 |
...
<iframe height='1020' title='informations de Microsoft Cloud App Security' src='https://appmcasinfoprod.azurewebsites.net/#/dashboard/35385' frameborder='no'></iframe>
