---
title: Informations sur l’application pour le chargeur
ms.author: elmalova
author: elenamalova
ms.date: 06/23/2021
ms.topic: article
...
description: Toutes les informations de sécurité et de conformité disponibles pour Uploader, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
---
# <a name="application-information-for-uploader-by-officeatwork"></a>Informations sur l’application pour uploader par officeatwork

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Dernière mise à jour par le développeur : 23 juin 2021</p>

* <a href="https://appsource.microsoft.com/product/web-apps/officeatwork-ag.uploader" target="_blank">Afficher dans AppSource</a>
...
|:----------------|:-------------|
| Nom de l'application | Téléchargeur |
...
>|:----------------|:--------------------|:---------------------------------------------------|:--------------------------|:--------------------------|
>| Files.ReadWrite.All | Délégué | Aucune donnée n’est stockée. | OneDrive : pour pouvoir lire et écrire des données dans le OneDrive de l’utilisateur. | f5c9f179-b9a5-4364-8f99-18d203b902ad |
...
>| GroupMember.Read.All | Délégué | Aucune donnée n’est stockée. | SharePoint Online - Prise en charge des groupes de sécurité : pour autoriser l’application à répertorier les groupes, lire les propriétés de groupe de base et lire les appartenances de tous les groupes auxquels l’utilisateur connecté a accès. | f5c9f179-b9a5-4364-8f99-18d203b902ad |
>| Sites.Read.All | Délégué | Aucune donnée n’est stockée. | SharePoint Online : pour activer la lecture des données dans SharePoint Online, l’utilisateur connecté a accès. Pour activer le chargement de données dans SharePoint Online | f5c9f179-b9a5-4364-8f99-18d203b902ad |
...
>| offline_access | Délégué | Aucune donnée n’est stockée. | Sing-In : pour activer la connexion automatique via des jetons d’actualisation, comme sans, les utilisateurs doivent se connecter manuellement chaque fois qu’ils lancent l’application officeatwork. Cette étendue est uniquement requise pour les applications hôtes non compatibles avec l’authentification unique. | f5c9f179-b9a5-4364-8f99-18d203b902ad |
>| openid | Délégué | Aucune donnée n’est stockée. | Sing-In : pour permettre aux utilisateurs de se connecter à l’application Officeatwork avec leur organisation et/ou leur compte Microsoft. | f5c9f179-b9a5-4364-8f99-18d203b902ad |
>| profil | Délégué | Aucune donnée n’est stockée. | Sing-In : pour afficher l’utilisateur connecté dans l’application Officeatwork. Cela permet d’assurer/de confirmer à l’utilisateur quel compte a été utilisé pour se connecter à l’application officeatwork. | f5c9f179-b9a5-4364-8f99-18d203b902ad |
...
<iframe height='1020' title='informations de Microsoft Cloud App Security' src='https://appmcasinfoprod.azurewebsites.net/#/dashboard/35750' frameborder='no'></iframe>
