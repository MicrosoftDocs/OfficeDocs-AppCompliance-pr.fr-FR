---
title: Certification Microsoft 365 - Exemple de guide de preuve
author: OrionOmalley
ms.author: oromalle
manager: tonybal
description: Vue d’ensemble de l’exemple de guide de soumission de preuves de certification Microsoft 365
...
![Capture d’écran de la stratégie antivirus et des programmes malveillants](../media/UserGuidePhotos/Control-No-1.png)
...
![Capture d’écran de Azure Security Center ; elle montre qu’une extension Antimalware a été déployée sur la machine virtuelle](../media/UserGuidePhotos/Control-No-2.png)
...
![capture d’écran montrant La mise à jour de Microsoft Defender au moins quotidienne en montrant « Event 2000, Windows Defender »](../media/UserGuidePhotos/Control-No-3.png)
...
![capture d’écran répertorie les applications approuvées avec justification métier.](../media/UserGuidePhotos/Control-No-7.png)
...
![capture d’écran répertorie le mécanisme de contrôle utilisé pour implémenter le contrôle d’application.](../media/UserGuidePhotos/Control-No-8.png)
...
![Capture d’écran montrant un objet stratégie de groupe avec les stratégies de restriction logicielle activées.](../media/UserGuidePhotos/Control-No-9.png)

Cette capture d’écran suivante montre la configuration en ligne avec le contrôle ci-dessus.

![Capture d’écran montrant la configuration en ligne avec le contrôle ci-dessus.](../media/UserGuidePhotos/Control-No-9-1.png)
...
![Capture d’écran montrant l’environnement M365 et les ordinateurs inclus dans l’étendue appliquée à cet objet GPO « Domain Computer Paramètres ».](../media/UserGuidePhotos/Control-No-9-2.png)
...
![Capture d’écran montrant le serveur dans l’étendue « DBServer1 » se trouvant dans l’unité d’organisation dans la capture d’écran ci-dessus.](../media/UserGuidePhotos/Control-No-9-3.png)
...
![Capture d’écran montrant un extrait de code d’une stratégie de classement des risques.](../media/UserGuidePhotos/Control-No-10.png)
...
![capture d’écran montrant qu’un groupe de diffusion est utilisé pour être averti des vulnérabilités de sécurité.](../media/UserGuidePhotos/Control-No-11.png)
...
![Il faudrait fournir des preuves de redimensionnement des évaluations des risques comme preuves à l’appui](../media/UserGuidePhotos/Control-No-12.png)

### <a name="patch-management--patching"></a>Gestion des correctifs : mise à jour corrective
...
![Capture d’écran d’une copie de toutes les stratégies et procédures détaillant le processus de gestion des correctifs. ](../media/UserGuidePhotos/Control-No-13.png)
...
![Capture d’écran montrant que le composant système d’étendue « CLARANET-SBU-WM » effectue Windows mises à jour conformément à la stratégie de mise à jour corrective.](../media/UserGuidePhotos/Control-No-14.png)
...
![la preuve montre que le composant système dans l’étendue THOR exécute des logiciels pris en charge par le fournisseur, car Nessus n’a signalé aucun problème.](../media/UserGuidePhotos/Control-No-15.png)
...
![Capture d’écran montrant que le composant système dans l’étendue « CLARANET-SBU-WM » s’exécute sur une version Windows prise en charge.](../media/UserGuidePhotos/Control-No-15-1.png)
...
![capture d’écran de la sortie Trivy, que le rapport complet ne répertorie pas d’applications non prises en charge.](../media/UserGuidePhotos/Control-No-15-2.png)
...
![Capture d’écran montrant une analyse Nessus de l’environnement dans l’étendue (un seul ordinateur dans cet exemple nommé « THOR ») montrant des vulnérabilités le 2 août 2021.](../media/UserGuidePhotos/Control-No-17.png)
...
![Capture d’écran montrant que les problèmes ont été résolus, 2 jours plus tard, dans la fenêtre de mise à jour corrective définie dans la stratégie de mise à jour corrective.](../media/UserGuidePhotos/Control-No-17-1.png)
...
![exemple du type de document de stratégie de pare-feu dont nous avons besoin](../media/UserGuidePhotos/Control-No-18.png)

![exemple du type de document de stratégie de pare-feu dont nous avons besoin 2](../media/UserGuidePhotos/Control-No-18-1.png)
...
![capture d’écran de la base de règles de pare-feu WatchGuard](../media/UserGuidePhotos/Control-No-23.png)
...
![Capture d’écran montrant la sortie de SSLScan par rapport à l’interface d’administration web du pare-feu WatchGuard sur le port TCP 8080.](../media/UserGuidePhotos/Control-No-24.png)
...
![Capture d’écran montrant la preuve d’une révision du pare-feu en janvier 2021.](../media/UserGuidePhotos/Control-No-25.png)

La capture d’écran suivante montre la preuve d’une révision du pare-feu en juillet 2021.

![Capture d’écran montrant la preuve d’une révision du pare-feu en juillet 2021.](../media/UserGuidePhotos/Control-No-25-1.png)

### <a name="firewalls--wafs"></a>Pare-feu – PARE-FEU
...
![captures d’écran montrant que la stratégie WAF contoso Production Azure Application Gateway est activée et qu’elle est configurée pour le mode « Prévention »](../media/UserGuidePhotos/Control-No-26.png)

La capture d’écran ci-dessous montre la configuration ip front-end

![capture d’écran montrant la configuration IP front-end](../media/UserGuidePhotos/Control-No-26-1.png)
...
![capture d’écran montrant les connexions web entrantes à l’aide de ce pare-feu d’applications web](../media/UserGuidePhotos/Control-No-26-2.png)
...
![Capture d’écran montrant que la stratégie WAF contoso Production Azure Application Gateway est configurée pour l’analyse sur l’ensemble de règles OWASP Core Version 3.2.](../media/UserGuidePhotos/Control-No-28.png)

### <a name="change-control"></a>Modifier le contrôle
...
![le début d’un exemple de stratégie de gestion des modifications.](../media/UserGuidePhotos/Control-No-29.png)
...
![Capture d’écran montrant un abonnement Azure pour l’environnement TEST de Contoso&#39;.](../media/UserGuidePhotos/Control-No-30.png)
...
![Capture d’écran montrant les 3 premiers enregistrements de la base de données de production.](../media/UserGuidePhotos/Control-No-31.png)
...
![Capture d’écran montrant la même requête de la base de données de développement, montrant différents enregistrements.](../media/UserGuidePhotos/Control-No-31-1.png)
...
![une nouvelle vulnérabilité de script intersite (XSS) affectée et documente la demande de modification.](../media/UserGuidePhotos/Control-No-32.png)

Les tickets ci-dessous montrent les informations qui ont été définies ou ajoutées au ticket lors de sa résolution.

![Capture d’écran montrant les tickets montrant les informations qui ont été définies ou ajoutées au ticket lors de sa résolution.](../media/UserGuidePhotos/Control-No-32-1.png) ![Capture d’écran montrant les tickets montrant les informations qui ont été définies ou ajoutées au ticket lors de sa résolution.](../media/UserGuidePhotos/Control-No-32-2.png)
...
![Exemple d’une personne effectuant le workExample](../media/UserGuidePhotos/Control-No-32-3.png)
![ d’une autre personne approuvant le travail](../media/UserGuidePhotos/Control-No-32-4.png)
...
![Capture d’écran montrant un exemple de ticket Jira montrant que la modification doit être autorisée avant d’être implémentée et approuvée par une autre personne que le développeur/demandeur.](../media/UserGuidePhotos/Control-No-33.png)
...
![Capture d’écran du ticket terminé](../media/UserGuidePhotos/Control-No-33-1.png)

![Capture d’écran du ticket 2 terminé](../media/UserGuidePhotos/Control-No-33-2.png)

### <a name="secure-software-developmentdeployment"></a>Développement/déploiement de logiciels sécurisés
...
![Capture d’écran d’un extrait de la procédure de développement logiciel sécurisé de Contoso&#39;](../media/UserGuidePhotos/Control-No-34.png)

![Capture d’écran d’un extrait de la procédure de développement logiciel sécurisée 2 de Contoso&#39;](../media/UserGuidePhotos/Control-No-34-1.png)

![Capture d’écran d’un extrait de la procédure de développement logiciel sécurisée 3 de Contoso&#39;](../media/UserGuidePhotos/Control-No-34-2.png)

![Capture d’écran d’un extrait de la procédure de développement logiciel sécurisée 4 de Contoso&#39;](../media/UserGuidePhotos/Control-No-34-3.png)
...
![la révision du code a été attribuée à quelqu’un d’autre que le développeur d’origine](../media/UserGuidePhotos/Control-No-35-1.png)

![Le ticket doit maintenant obtenir l’approbation d’un responsable avant que les modifications puissent être apportées aux systèmes de production en direct.](../media/UserGuidePhotos/Control-No-35-2.png) L’image ci-dessus montre que le code examiné a été approuvé pour être implémenté sur les systèmes de production en direct.

![Exemple d’approbation finale](../media/UserGuidePhotos/Control-No-35-3.png) Une fois que les modifications de code ont été effectuées, le travail final obtient la signature comme indiqué dans l’image ci-dessus.
...
![e-mail demandant au personnel de l’équipe DevOps d’être inscrit à la formation annuelle OWASP Top Ten](../media/UserGuidePhotos/Control-No-36.png)
...
![a été demandée avec justification et approbation commerciales.](../media/UserGuidePhotos/Control-No-36-1.png)
...
![capture d’écran montrant les membres du projet « Customers » dans GitLab, qui est le « Portail client » de Contoso](../media/UserGuidePhotos/Control-No-38.png)
...
![Capture d’écran montrant un exemple de stratégie de gestion des comptes pour Contoso.](../media/UserGuidePhotos/Control-No-39.png)

![Capture d’écran montrant d’autres détialisations d’une stratégie de gestion des comptes pour Contoso.](../media/UserGuidePhotos/Control-No-39-1.png)
...
![La capture d’écran suivante montre les comptes d’utilisateur configurés pour le composant système in-scope « CLARANET-SBU-WM ». ](../media/UserGuidePhotos/Control-No-40.png)
...
![Capture d’écran montrant que le compte Administrateur est désactivé sur le composant système in-scope « CLARANET-SBU-WM ».](../media/UserGuidePhotos/Control-No-40-1.png)
...
![Capture d’écran montrant que le compte invité est désactivé sur le composant système in-scope « CLARANET-SBU-WM ».](../media/UserGuidePhotos/Control-No-40-2.png)
...
![Exemple de création de compte](../media/UserGuidePhotos/Control-No-41.png)

![Processus de connexion dans le ticket](../media/UserGuidePhotos/Control-No-41-1.png)
...
![Exemple de désactivation de l’utilisateur](../media/UserGuidePhotos/Control-No-42-1.png)
...
![la stratégie de mot de passe configurée dans la « stratégie de sécurité locale » du composant système in-scope « CLARANET-SBU-WM ».](../media/UserGuidePhotos/Control-No-43.png)

![Autre exemple de stratégie de mot de passe configurée dans la « Stratégie de sécurité locale » du composant système in-scope « CLARANET-SBU-WM ».](../media/UserGuidePhotos/Control-No-43-1.png)

La capture d’écran ci-dessous montre les paramètres de verrouillage de compte pour un pare-feu WatchGuard.

![Paramètres de verrouillage de compte pour un pare-feu WatchGuard](../media/UserGuidePhotos/Control-No-43-2.png)
...
![Capture d’écran montrant les comptes d’utilisateur configurés pour le composant système in-scope « CLARANET-SBU-WM ».](../media/UserGuidePhotos/Control-No-44.png)

Cette capture d’écran suivante montre que le compte Administrateur est désactivé sur le composant &quot;système in-scope CLARANET-SBU-WM&quot;.

![Capture d’écran montrant que le compte Administrateur est désactivé sur le composant système in-scope « CLARANET-SBU-WM ».](../media/UserGuidePhotos/Control-No-44-1.png)

Cette capture d’écran suivante montre que le compte invité est désactivé sur le composant &quot;système in-scope CLARANET-SBU-WM&quot;.

![Capture d’écran montrant que le compte invité est désactivé sur le composant système in-scope « CLARANET-SBU-WM ».](../media/UserGuidePhotos/Control-No-44-2.png)
...
![Capture d’écran montrant que l’environnement est configuré avec des groupes affectés en fonction de la fonction de travail.](../media/UserGuidePhotos/Control-No-45.png)
...
![ Capture d’écran montrant que l’option « Le compte est sensible et que la connexion est déléguée » est sélectionnée sur le compte de service « _Prod SQL compte de service ».](../media/UserGuidePhotos/Control-No-46.png)
...
![Capture d’écran montrant que le compte de service « _Prod SQL compte de service » est verrouillé sur le SQL Server et ne peut se connecter qu’à ce serveur.](../media/UserGuidePhotos/Control-No-46-1.png)
...
![Captures d’écran montrant les domaines d’authentification configurés sur Pulse Secure, qui est utilisé pour l’accès à distance dans l’environnement.](../media/UserGuidePhotos/Control-No-47.png)
...
![Capture d’écran montrant qu’un serveur d’authentification supplémentaire est activé, pointant vers « Duo-LDAP » pour le domaine d’authentification « Duo - Itinéraire par défaut ».](../media/UserGuidePhotos/Control-No-47-1.png)
...
![Capture d’écran montrant la configuration du serveur d’authentification Duo-LDAP qui montre qu’il pointe vers le service SaaS Duo pour l’authentification multifacteur.](../media/UserGuidePhotos/Control-No-47-2.png)
...
![montrer que l’authentification multifacteur est activée pour tous les utilisateurs Azure.](../media/UserGuidePhotos/Control-No-47-3.png)
...
![Les preuves ci-dessous montrent que le niveau de chiffrement RDP sur « Webserver01 » est configuré avec un paramètre « High Level ».](../media/UserGuidePhotos/Control-No-48.png)
...
![Capture d’écran montrant le contoso.com DNS est géré dans Microsoft Azure pour Contoso Corporation.](../media/UserGuidePhotos/Control-No-49.png)
...
![Les captures d’écran montrent que l’authentification multifacteur est activée pour tous les utilisateurs Azure.](../media/UserGuidePhotos/Control-No-49-1.png)
...
![Capture d’écran montrant que la fonctionnalité IDPS est activée sur le pare-feu WatchGuard.](../media/UserGuidePhotos/Control-No-50.png)
...
![Capture d’écran montrant que la dernière version d’IDPS est installée](../media/UserGuidePhotos/Control-No-51.png)
...
![capture d’écran montrant les règles HTTPS sur le pare-feu](../media/UserGuidePhotos/Control-No-52.png)

Cette capture d’écran suivante montre que le protocole IDPS est activé sur ces règles.

![capture d’écran montrant que le protocole IDPS est activé sur ces règles.](../media/UserGuidePhotos/Control-No-52-1.png)
...
![Capture d’écran montrant qu’une « action proxy » est appliquée à la règle « Inbound_Bot_Traffic », qui est utilisée pour activer l’inspection du contenu.](../media/UserGuidePhotos/Control-No-52-2.png)
...
![Capture d’écran montrant que IDPS est configuré sur toutes les règles (stratégies) du pare-feu WatchGuard.](../media/UserGuidePhotos/Control-No-54.png)
...
![La capture de paquets Netwatcher a été utilisée pour capturer des paquets et utilisée avec Suricata, qui est un outil IDS Open-Source.](../media/UserGuidePhotos/Control-No-54-1.png)
...
![image montrant l’interface Suricata.](../media/UserGuidePhotos/Control-No-54-2.png)
...
![l’image montre un instantané de certaines signatures.](../media/UserGuidePhotos/Control-No-54-3.png)
...
![Image montrant comment surveiller votre configuration IDPS de logiciels tiers Netwatcher et Suricata à l’aide de Sentinel SIEM/SOAR.](../media/UserGuidePhotos/Control-No-54-4.png)

![L’image montre plus de détails sur la façon dont vous surveilleriez votre configuration IDPS de logiciels tiers Netwatcher et Suricata à l’aide de Sentinel SIEM/SOAR.](../media/UserGuidePhotos/Control-No-54-5.png)
...
![image montrant comment ajouter une signature d’intrusion de remplacement ou une règle de contournement pour la détection d’intrusion à l’aide de l’interface CLI](../media/UserGuidePhotos/Control-No-54-6.png)
...
![Image montrant comment répertorier toutes les configurations de détection d’intrusion à l’aide de l’interface CLI](../media/UserGuidePhotos/Control-No-54-7.png)
...
![Capture d’écran du mode IDPS activé](../media/UserGuidePhotos/Control-No-54-8.png)

![Capture d’écran des alertes IDPS activées](../media/UserGuidePhotos/Control-No-54-9.png)

![Capture d’écran de l’inspection TLS activée](../media/UserGuidePhotos/Control-No-54-10.png)

![Capture d’écran de l’intelligence contre les menaces activée](../media/UserGuidePhotos/Control-No-54-11.png)

![Capture d’écran de DLS activé](../media/UserGuidePhotos/Control-No-54-12.png)

![Capture d’écran des réseaux virtuels sécurisés](../media/UserGuidePhotos/Control-No-54-13.png)
...
![extraire de la stratégie/procédure de journalisation.](../media/UserGuidePhotos/Control-No-55.png)
...
![La capture d’écran suivante montre les paramètres de configuration de l’un des appareils échantillonnées appelés « VICTIM1-WINDOWS ».](../media/UserGuidePhotos/Control-No-56.png)
...
![Capture d’écran montrant un événement où un utilisateur a effacé un journal des événements de l’un des appareils échantillonnés appelés « VICTIM1-WINDOWS ».
...
![Capture d’écran montrant que le message de journalisation s’affiche dans la solution de journalisation centralisée.](../media/UserGuidePhotos/Control-No-56-2.png)
...
![La capture d’écran suivante montre les informations des événements de sécurité dans Windows observateur d'événements du composant système dans l’étendue « SEGSVR02 ».](../media/UserGuidePhotos/Control-No-57.png)
...
![Diagramme montrant la topologie de synchronisation de l’heure utilisée.](../media/UserGuidePhotos/Control-No-58.png)
...
![Capture d’écran montrant WatchGuard configuré en tant que serveur NTP et pointant vers time.windows.com comme source d’heure.](../media/UserGuidePhotos/Control-No-58-1.png)
...
![affiche le service « nxlog » s’exécutant sur la jumpbox DMZ « DESKTOP-7S65PN » utilisée pour gérer tous les serveurs DMZ.](../media/UserGuidePhotos/Control-No-59.png)
...
![capture d’écran montrant un extrait du fichier nxlog.conf](../media/UserGuidePhotos/Control-No-59-1.png)
...
![captures d’écran montrant que des journaux d’activité d’une valeur de 30 jours sont disponibles dans AlienVault.](../media/UserGuidePhotos/Control-No-61.png)
...
![Capture d’écran montrant que les journaux d’activité sont disponibles en affichant un extrait de journal remontant à 5 mois.](../media/UserGuidePhotos/Control-No-61-1.png)
...
![Capture d’écran montrant que les événements de journal sont conservés pendant 30 jours disponibles en direct et 90 jours dans le stockage froid dans Azure.](../media/UserGuidePhotos/Control-No-61-2.png)
...
![extrait de la stratégie/procédure de révision de journal.](../media/UserGuidePhotos/Control-No-62.png)
...
![Capture d’écran identifiant l’emplacement où un utilisateur a été ajouté au groupe « Administrateurs de domaine ».](../media/UserGuidePhotos/Control-No-63.png)
...
![Capture d’écran identifiant l’endroit où plusieurs tentatives d’ouverture de session ayant échoué sont ensuite suivies d’une connexion réussie qui peut mettre en évidence une attaque par force brute réussie.](../media/UserGuidePhotos/Control-No-63-1.png)
...
![Capture d’écran identifiant l’endroit où une modification de stratégie de mot de passe s’est produite lors de la définition de la stratégie, afin que les mots de passe de compte n’expirent pas.](../media/UserGuidePhotos/Control-No-63-2.png)
...
![Capture d’écran montrant une alerte de sécurité suivie dans ServiceNow par le SOC Claranet Cyber Security MDR (Managed Detection and Response).](../media/UserGuidePhotos/Control-No-64.png)
...
![Capture d’écran montrant la confirmation que cela a été résolu par David Ashton @ Contoso via une mise à jour dans le portail client ServiceNow.](../media/UserGuidePhotos/Control-No-64-1.png)
...
![extrait de la stratégie/procédure d’alerte d’événement de sécurité.](../media/UserGuidePhotos/Control-No-65.png)
![ extrait développé de la stratégie/procédure d’alerte d’événement de sécurité.](../media/UserGuidePhotos/Control-No-65-1.png)
...
![Capture d’écran montrant une rota sur appel pour décembre 2020 pour Contoso.](../media/UserGuidePhotos/Control-No-67.png)

### <a name="information-security-risk-management"></a>Gestion des risques liés à la sécurité des informations
...
![La preuve suivante est une capture d’écran d’une partie du processus d’évaluation des risques de Contoso.](../media/UserGuidePhotos/Control-No-68.png)

![La preuve suivante est une capture d’écran de la partie étendue du processus d’évaluation des risques de Contoso.](../media/UserGuidePhotos/Control-No-68-1.png)
...
![Capture d’écran montrant une réunion d’évaluation des risques planifiée tous les six mois.](../media/UserGuidePhotos/Control-No-69.png)

Ces deux captures d’écran montrent les minutes de réunion de deux réunions d’évaluation des risques.

![capture d’écran montrant les minutes de la réunion à partir de deux réunions d’évaluation des risques.](../media/UserGuidePhotos/Control-No-69-1.png)
...
![Capture d’écran montrant le registre des risques qui illustre les menaces et les vulnérabilités incluses.](../media/UserGuidePhotos/Control-No-70.png)
...
![registre des risques pour Contoso.](../media/UserGuidePhotos/Control-No-72.png)

**Note:** La documentation complète de l’évaluation des risques doit être fournie au lieu d’une capture d’écran.

La capture d’écran suivante illustre un plan de traitement des risques.

![capture d’écran montrant un plan de traitement des risques.](../media/UserGuidePhotos/Control-No-72-1.png)
...
![Capture d’écran montrant le début du plan de réponse aux incidents de Contoso.](../media/UserGuidePhotos/Control-No-73.png)
...
![capture d’écran montrant un extrait du rapport de réponse aux incidents généré par Claranet pour Contoso1](../media/UserGuidePhotos/Control-No-75.png)

![Capture d’écran montrant un extrait du rapport de réponse aux incidents généré par Claranet pour Contoso2](../media/UserGuidePhotos/Control-No-75-1.png)

![Capture d’écran montrant un extrait du rapport de réponse aux incidents généré par Claranet pour Contoso3](../media/UserGuidePhotos/Control-No-75-2.png)
...
![captures d’écran de l’IRP fourni en fonction des leçons apprises et/ou des modifications apportées à l’organisation1](../media/UserGuidePhotos/Control-No-76.png)

![captures d’écran de l’IRP fourni en fonction des leçons apprises et/ou des modifications apportées à l’organisation2](../media/UserGuidePhotos/Control-No-76-1.png)
...
![captures d’écran de l’IRP fourni en fonction des leçons apprises et/ou des modifications apportées à l’organisation3](../media/UserGuidePhotos/Control-No-76-2.png)

## <a name="security-domain-data-handling-security-and-privacy"></a>Domaine de sécurité : gestion des données sécurité et confidentialité
...
![capture d’écran montrant les résultats de l’écouteur web theclaranet1](../media/UserGuidePhotos/Security-Domain-Control-No-1.png)

![capture d’écran montrant les résultats de l’écouteur web theclaranet2](../media/UserGuidePhotos/Security-Domain-Control-No-1-1.png)
...
![capture d’écran montrant que TLS 1.2 est configuré sur le stockage1](../media/UserGuidePhotos/Security-Domain-Control-No-1-2.png)
...
![captures d’écran montrant que TLS V1.3 est uniquement activé sur le serveur](../media/UserGuidePhotos/Security-Domain-Control-No-1-3.png)
...
![Capture d’écran montrant une autre façon de montrer si TLS est activé ou désactivé1](../media/UserGuidePhotos/Security-Domain-Control-No-1-4.png)

![Capture d’écran montrant une autre façon de montrer si TLS est activé ou désactivé2](../media/UserGuidePhotos/Security-Domain-Control-No-1-5.png)
...
![Capture d’écran montrant des preuves via l’outil Qualys SSL Labs ou d’autres outils et compléments de navigateur web](../media/UserGuidePhotos/Security-Domain-Control-No-3.png)
...
![capture d’écran montrant que TDE (Transparent Data Encryption) est activé sur la base de données Contoso](../media/UserGuidePhotos/Security-Domain-Control-No-4.png)

![Capture d’écran montrant que le chiffrement AES 256 est utilisé pour Azure TDE](../media/UserGuidePhotos/Security-Domain-Control-No-4-1.png)
...
![Capture d’écran montrant stockage Azure configuré avec le chiffrement pour les objets blob et les fichiers ](../media/UserGuidePhotos/Security-Domain-Control-No-4-2.png)
...
![capture d’écran montrant un exemple de ce qu’un document montrant les types de données peut ressembler](../media/UserGuidePhotos/Security-Domain-Control-No-6.png)
...
![Capture d’écran ci-dessous montrant la stratégie de conservation des données de Contoso1](../media/UserGuidePhotos/Security-Domain-Control-No-7.png)

![Capture d’écran ci-dessous montrant la stratégie de rétention des données de Contoso2](../media/UserGuidePhotos/Security-Domain-Control-No-7-1.png)
...
![Capture d’écran montrant une requête SQL montrant le contenu de la table de base de données classée dans l’ordre croissant](../media/UserGuidePhotos/Security-Domain-Control-No-8.png)
...
![Capture d’écran du script qui peut être utilisé pour supprimer tous les enregistrements de données conservés en fonction de la date](../media/UserGuidePhotos/Security-Domain-Control-No-9.png)
...
![Capture d’écran du plan de rétention des données Contoso à partir de Control 7](../media/UserGuidePhotos/Security-Domain-Control-No-9-1.png)
...
![Capture d’écran du runbook de rétention des données](../media/UserGuidePhotos/Security-Domain-Control-No-9-2.png)
...
![Capture d’écran montrant que le Runbook a été modifié pour rechercher des enregistrements et que des commandes de suppression ne sont pas affichées comme le script1](../media/UserGuidePhotos/Security-Domain-Control-No-9-3.png)

![Capture d’écran montrant que le Runbook a été modifié pour rechercher des enregistrements et que des commandes de suppression ne sont pas affichées comme le script1](../media/UserGuidePhotos/Security-Domain-Control-No-9-4.png)
...
![Capture d’écran montrant qu’une demande a été créée dans Jira pour obtenir l’approbation Sam Daily pour les clés de chiffrement sur l’environnement principal des systèmes1](../media/UserGuidePhotos/Security-Domain-Control-No-11.png)

![Capture d’écran montrant qu’une demande a été créée dans Jira pour obtenir l’approbation Sam Daily pour les clés de chiffrement sur les systèmes backend environmen2](../media/UserGuidePhotos/Security-Domain-Control-No-11-1.png)
...
![Capture d’écran montrant que la demande d’accès à Sam Daily a été approuvée par Jon Smith, une personne de la direction](../media/UserGuidePhotos/Security-Domain-Control-No-11-2.png)
...
![Capture d’écran montrant un flux de travail dans Jira](../media/UserGuidePhotos/Security-Domain-Control-No-11-3.png)
...
![Capture d’écran montrant que l’approbation a été donnée pour Sam Daily](../media/UserGuidePhotos/Security-Domain-Control-No-11-4.png)
...
![Processus d’approbation1](../media/UserGuidePhotos/Security-Domain-Control-No-11-5.png)

![Processus d’approbation2](../media/UserGuidePhotos/Security-Domain-Control-No-11-6.png)

![Processus d’approbation3](../media/UserGuidePhotos/Security-Domain-Control-No-11-7.png)
...
![Exemple d’e-mail1](../media/UserGuidePhotos/Security-Domain-Control-No-13.png)

![Exemple d’e-mail2](../media/UserGuidePhotos/Security-Domain-Control-No-13-1.png)
...
![capture d’écran montrant un exemple simple de contrat de partage de données1](../media/UserGuidePhotos/Security-Domain-Control-No-14.png)

![capture d’écran montrant un exemple simple de contrat de partage de données2](../media/UserGuidePhotos/Security-Domain-Control-No-14-1.png)
...
![Capture d’écran montrant un processus documenté pour la gestion des signatures d’accès partagés](../media/UserGuidePhotos/Security-Domain-Control-No-16.png)
...
![capture d’écran est un extrait de la procédure sar ci-dessus qui montre comment les données seront trouvées.](../media/UserGuidePhotos/Security-Domain-Control-No-17.png)
...
![Capture d’écran montrant comment les emplacements de données ISV où interrogé1](../media/UserGuidePhotos/Security-Domain-Control-No-17-1.png)

![Capture d’écran montrant comment les emplacements de données ISV où interrogé2](../media/UserGuidePhotos/Security-Domain-Control-No-17-2.png)
...
![Capture d’écran montrant comment les emplacements de données ISV où interrogé3](../media/UserGuidePhotos/Security-Domain-Control-No-17-4.png)

![Capture d’écran montrant comment les emplacements de données ISV où interrogé4](../media/UserGuidePhotos/Security-Domain-Control-No-17-5.png)
...
![Capture d’écran de contoso Privacy Notice 1](../media/UserGuidePhotos/Security-Domain-Control-No-18.png)

![Capture d’écran de contoso Privacy Notice 2](../media/UserGuidePhotos/Security-Domain-Control-No-18-1.png)
...
![Capture d’écran de contoso Privacy Notice 3](../media/UserGuidePhotos/Security-Domain-Control-No-18-2.png)
...
![Capture d’écran de la stratégie de protection des données qui peut être utilisée conjointement avec l’avis de confidentialité indiqué précédemment1](../media/UserGuidePhotos/Security-Domain-Control-No-18-3.png)

![Capture d’écran de la stratégie de protection des données qui peut être utilisée conjointement avec l’avis de confidentialité indiqué précédemment2](../media/UserGuidePhotos/Security-Domain-Control-No-18-4.png)

![Capture d’écran de la stratégie de protection des données qui peut être utilisée conjointement avec l’avis de confidentialité indiqué précédemment3](../media/UserGuidePhotos/Security-Domain-Control-No-18-5.png)
