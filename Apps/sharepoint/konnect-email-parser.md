---
title: Informations sur l’application pour Konnect eMail Parser par Konnect eMail
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/01/2022
...
<p>Dernière mise à jour par le développeur : 1er février 2022</p>

* <a href="https://appsource.microsoft.com/product/office/WA200001893" target="_blank">Afficher dans AppSource</a>
...
| Site web de la société | [https://www.konnectemail.com](https://www.konnectemail.com) |
| Conditions d’utilisation de l’application | [https://www.konnectemail.com/eula](https://www.konnectemail.com/eula) |
| Fonctionnalités principales de l’application | Capturez automatiquement les attributs de messagerie en tant que métadonnées. |
| Emplacement du siège social de la société | Australie |
| Page d’informations sur l’application | [https://www.konnectemail.com/sharepoint-email-management](https://www.konnectemail.com/sharepoint-email-management) |
...
Ces informations ont été fournies par Konnect eMail sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont traitées par votre application ? | Données de messagerie utilisateur |
