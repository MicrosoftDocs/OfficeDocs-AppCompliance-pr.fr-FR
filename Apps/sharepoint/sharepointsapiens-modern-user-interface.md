---
title: Informations d’application SharePoint|'interface utilisateur moderne de SharePointSapiens
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/31/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour l’interface utilisateur moderne SharePoint|sapiens, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le Registre CSA STAR.
...
ms.locfileid: "64602605"
---
# <a name="sharepointsapiens-modern-user-interface"></a>SharePoint|'interface utilisateur moderne de SharePoint|sapiens

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Last updated by the developer on: March 30, 2022</p>

* <a href="https://appsource.microsoft.com/product/office/WA200003529" target="_blank">Afficher dans AppSource</a>
...
|:----------------|:-------------|
| Nom de l'application | SharePoint’interface utilisateur moderne à base de logiciels |
| ID | WA200003529 |
...
| Fonctionnalités principales de l’application | Cette application doit être utilisée conjointement avec nos SharePoint|application de gestion des événements (WA104380834) ou SharePoint|application gestion de formation des employés (WA104380833).  Cette application fournit une interface utilisateur intuitive qui vous permet de créer et de gérer des événements, des rubriques, des cours et des programmes en SharePoint, d’inscrire des utilisateurs ou de les autoriser à s’inscrire eux-mêmes et à suivre tous les participants, devoirs et succès. |
