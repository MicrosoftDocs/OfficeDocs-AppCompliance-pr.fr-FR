---
title: Informations sur l’application pour Adobe Acrobat Sign pour SharePoint par Adobe Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/23/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour Adobe Acrobat Sign pour SharePoint, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le Registre CSA STAR.
...
|:----------------|:-------------|
| Nom de l'application | Adobe Acrobat Sign for SharePoint |
| ID | WA104381012 |
...
| Fonctionnalités principales de l’application | Maintenez les flux de travail de signature de documents en mouvement rapide lorsque vous ajoutez Adobe Sign à Teams. À présent, dans Teams, vous pouvez signer des documents, les envoyer pour approbations et signatures électroniques juridiquement contraignantes &#8212; avec la solution de signature électronique préférée de Microsoft. |
| Emplacement du siège social de l’entreprise | États-Unis d’Amérique |
| Page d’informations sur l’application | [https://helpx.adobe.com/sign/using/microsoft-sharepoint-use...](https://helpx.adobe.com/sign/using/microsoft-sharepoint-user-guide.html) |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.Read.All | délégué | Pour obtenir le rôle d’utilisateur et valider si l’utilisateur dispose d’une autorisation spécifique pour la fonctionnalité d’application. | [99a3ad8d-8682-4f2a-9c2c-b4b27e99585c](../azure/99a3ad8d-8682-4f2a-9c2c-b4b27e99585c.md) |
