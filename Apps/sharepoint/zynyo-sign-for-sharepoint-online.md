---
title: Informations sur l’application pour le sign for SharePoint Online par Magasinsnyo
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/24/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour sign for SharePoint Online, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le Registre CSA STAR.
...
ms.locfileid: "63553253"
---
# <a name="zynyo-sign-for-sharepoint-online"></a>Sign for SharePoint Online

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Last updated by the developer on: November 11, 2021</p>

* <a href="https://appsource.microsoft.com/product/office/WA200003673" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies parNyo à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | Sign for SharePoint Online |
| ID | WA200003673 |
| Office 365 clients pris en charge | SharePoint 2016 ou ultérieure |
| Nom de la société partenaire | Nyo |
| Site web de l’entreprise | [https://zynyo.com](https://zynyo.com) |
| Conditions d’utilisation de l’application | [https://zynyo.com/Algemene%20Voorwaarden%20Zynyo%20BV.pdf](https://zynyo.com/Algemene%20Voorwaarden%20Zynyo%20BV.pdf) |
| Fonctionnalités principales de l’application | Alle documenten eenvoudig en rechtsgeldig digitaal laten ondertekenen. |
| Emplacement du siège social de l’entreprise | Pays-Bas (les) |
| Page d’informations sur l’application | [https://zynyo.com/signing-service-diensten/sharepoint/](https://zynyo.com/signing-service-diensten/sharepoint/) |
...
Ces informations ont été fournies parNyo sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont stockées dans vos bases de données ? | Lorsque l’utilisateur envoie une demande de signature, le document sélectionné et les données entrées sont stockés, cela peut inclure des données client telles que le nom, le courrier électronique et le numéro de téléphone. Ces données sont supprimées à l’expiration de la demande de signature, par défaut 30 jours. |
...
| URL de la politique de confidentialité | https://zynyo.com/Zynyo-Privacyverklaring.pdf |
