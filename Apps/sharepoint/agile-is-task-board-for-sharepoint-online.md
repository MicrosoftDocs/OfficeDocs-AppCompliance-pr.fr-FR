---
title: Informations sur l’application pour agile Task Board pour SharePoint Online par Agile-IS
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/08/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour agile Task Board pour SharePoint Online, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
---
# <a name="agile-task-board-for-sharepoint-online"></a>Tableau des tâches agiles pour SharePoint Online
...
|:----------------|:-------------|
| Nom de l'application | Tableau des tâches agiles pour SharePoint Online |
| ID | WA200002087 |
