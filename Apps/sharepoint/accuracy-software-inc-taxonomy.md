...
| Site web de l’entreprise | [https://accuracysoftware.ca](https://accuracysoftware.ca) |
...
Ces informations ont été fournies par Accuracy Software Inc. sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
