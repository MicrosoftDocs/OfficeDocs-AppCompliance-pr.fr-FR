...
ms.locfileid: "64870952"
---
# <a name="taxonomy"></a>Taxonomie

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Dernière mise à jour par le développeur : 18 février 2022</p>

* <a href="https://appsource.microsoft.com/product/office/WA200003006" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Accuracy Software Inc. à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | Taxonomie |
| ID | WA200003006 |
| Office 365 clients pris en charge | SharePoint 2016 ou version ultérieure |
| Nom de la société partenaire | Accuracy Software Inc. |
| Site web de la société | [https://accuracysoftware.ca](https://accuracysoftware.ca) |
...
| Fonctionnalités principales de l’application | La taxonomie vous offre un moyen efficace de gérer votre plan de classification des fichiers, en permettant aux professionnels de la messagerie instantanée de collaborer avec les différentes parties prenantes pour créer, examiner et publier le plan de fichiers pour l’ensemble de l’organisation. En outre, la taxonomie vous permet de générer l’exportation d’étiquettes de rétention M365 que vous pouvez importer dans le Centre de conformité Microsoft et d’exporter votre plan de fichiers dans un format d’ensemble de termes que vous pouvez importer dans le magasin de termes SharePoint. |
...
Accuracy Software Inc. a fourni ces informations sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont stockées dans vos bases de données ? | Données de classification du plan de fichiers |
