---
title: Informations sur les applications pour le système de gestion des offres par au-delà des technologies
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/03/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour le système de gestion des offres, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le Registre CSA STAR.
...
---
# <a name="bid-management-system"></a>Système de gestion des offres

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Last updated by the developer on: November 16, 2021</p>

* <a href="https://appsource.microsoft.com/product/office/WA200001787" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Beyond Technologies à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | Système de gestion des offres |
| ID | WA200001787 |
| Office 365 clients pris en charge | SharePoint 2013 ou ultérieure |
| Nom de la société partenaire | Au-delà des technologies |
| Site web de l’entreprise | [https://www.beyondintranet.com](https://www.beyondintranet.com) |
| Conditions d’utilisation de l’application | [https://www.beyondintranet.com/eula](https://www.beyondintranet.com/eula) |
| Fonctionnalités principales de l’application | A SharePoint powered Proposal Management/Bid Management Software to digitize bid activities. |
| Emplacement du siège social de l’entreprise | États-Unis d’Amérique |
| Page d’informations sur l’application | [https://www.beyondintranet.com/bid-management-software](https://www.beyondintranet.com/bid-management-software) |
...
Ces informations ont été fournies par Beyond Technologies sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont stockées dans vos bases de données ? | Url du site de messagerie SharePoint utilisateur |
...
| URL de la politique de confidentialité | https://www.beyondintranet.com/privacypolicy |
