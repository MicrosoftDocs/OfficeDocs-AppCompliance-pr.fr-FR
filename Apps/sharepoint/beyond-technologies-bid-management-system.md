...
description: Toutes les informations de sécurité et de conformité disponibles pour le système de gestion des soumissions, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le Registre CSA STAR.
...
| Fonctionnalités principales de l’application | Un logiciel SharePoint gestion des propositions/gestion des soumissions optimisé pour numériser les activités de soumission. |
