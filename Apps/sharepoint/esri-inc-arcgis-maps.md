---
title: Vue d’ensemble d’ArcGIS Cartes
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/21/2021
...
ms.locfileid: "65225148"
---
# <a name="arcgis-maps-overview"></a>Vue d’ensemble d’ArcGIS Cartes
...
| URL du site web du partenaire | [https://www.esri.com](https://www.esri.com) |
...
>Les administrateurs clients peuvent contrôler l’accès de leurs utilisateurs aux données au niveau de l’organisation ou du projet. Les demandes sont vérifiées par rapport aux listes de contrôle d’accès avant de lire ou d’écrire des données. Les données en transit vers et depuis les utilisateurs finaux et les services externes sont chiffrées avec HTTPS (TLS 1.2 uniquement).
...
<iframe height='1020' title='informations de Microsoft Cloud App Security' src='https://appmcasinfoprod.azurewebsites.net/#/dashboard/27233' frameborder='no'></iframe>
