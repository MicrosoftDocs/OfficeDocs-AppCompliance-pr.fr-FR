...
Informations fournies à Microsoft par des solutions métiers plus intelligentes
...
| Site web de l’entreprise | [https://smarterbusiness.at](https://smarterbusiness.at) |
...
| Fonctionnalités principales de l’application | La réservation d’événements plus intelligente permet aux utilisateurs de Microsoft365 de s’inscrire aux événements précédemment créés. |
...
Ces informations ont été fournies par smarter Business Solutions Andh sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
