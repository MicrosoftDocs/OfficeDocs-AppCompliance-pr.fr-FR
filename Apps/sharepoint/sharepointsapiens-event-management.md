---
title: Informations d’application SharePoint| gestion des événements par SharePointSapiens
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/23/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour la gestion des événements SharePoint|sapiens, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le Registre CSA STAR.
...
ms.locfileid: "63778414"
---
# <a name="sharepointsapiens-event-management"></a>SharePoint|sapiens, gestion des événements

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Last updated by the developer on: March 22, 2022</p>

* <a href="https://appsource.microsoft.com/product/office/WA104380834" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par SharePointSapiens à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | SharePoint’événements « SharePoint-contrôles |
| ID | WA104380834 |
| Office 365 clients pris en charge | SharePoint 2016 ou ultérieure |
| Nom de la société partenaire | SharePointSapiens |
| Site web de l’entreprise | [https://www.sharepointsapiens.com](https://www.sharepointsapiens.com) |
...
| Fonctionnalités principales de l’application | Le module de gestion des événements vous permet d’organiser différents types d’événements. Les événements peuvent être programmés en peu de temps en quelques étapes simples. Les participants peuvent s’inscrire en ligne en un seul clic. En tant qu’organisateur, vous pouvez également inscrire des utilisateurs internes ou externes pour le compte ou envoyer des invitations par courrier électronique. Les participants reçoivent des demandes de réunion et des mises à jour par courrier électronique pour s’assurer qu’ils ont toujours les dernières informations dans Outlook calendrier. Le add-in assure le suivi de tous les participants au même endroit. |
| Emplacement du siège social de l’entreprise | Autriche |
| Page d’informations sur l’application | [https://www.sharepointsapiens.com/event-management-office36...](https://www.sharepointsapiens.com/event-management-office365/) |
...
Ces informations ont été fournies par SharePointSapiens sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Avez-vous un processus de gestion des changements établi utilisé pour examiner et approuver les demandes de modification avant qu’elles ne soient déployées en production ? | Non |
