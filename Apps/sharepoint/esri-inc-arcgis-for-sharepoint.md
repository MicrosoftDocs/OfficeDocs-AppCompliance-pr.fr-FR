---
title: Informations d’application pour ArcGIS pour SharePoint par Esri, Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/04/2021
...
description: Toutes les informations de sécurité et de conformité disponibles pour ArcGIS pour SharePoint, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
ms.locfileid: "64876541"
---
# <a name="arcgis-for-sharepoint"></a>ArcGIS pour SharePoint

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Dernière mise à jour par le développeur : 21 juillet 2021</p>

* <a href="https://appsource.microsoft.com/product/office/WA200003118" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Esri, Inc. à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | ArcGIS pour SharePoint |
| ID | WA200003118 |
| Office 365 clients pris en charge | SharePoint 2016 ou version ultérieure |
| Nom de la société partenaire | Esri, Inc. |
| Site web de la société | [https://www.esri.com](https://www.esri.com) |
| Conditions d’utilisation de l’application | [https://www.esri.com/en-us/legal/terms/master-agreement-pro...](https://www.esri.com/en-us/legal/terms/master-agreement-product) |
| Fonctionnalités principales de l’application | ArcGIS Online comprend une suite d’applications, de cartes et de données faisant autorité sur des milliers de rubriques, des outils de mappage modernes dont vous avez besoin pour visualiser vos données, des analyses pour découvrir et communiquer des modèles significatifs dans vos données et les outils d’administration pour gérer facilement les personnes et le contenu et permettre à tout le monde de créer et de partager des cartes. ArcGIS offre à tous les membres de votre organisation la possibilité de découvrir, d’utiliser, de créer et de partager des cartes à partir de n’importe quel appareil, n’importe où, à tout moment. |
| Emplacement du siège social de la société | États-Unis d’Amérique |
| Page d’informations sur l’application | [https://www.esri.com/en-us/about/esri-partner-network/our-p...](https://www.esri.com/en-us/about/esri-partner-network/our-partners/global-alliances/microsoft-esri/overview) |
...
Ces informations ont été fournies par Esri, Inc. sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Répertorier les types de stratégies prises en charge | ArcGIS Online s’appuie sur le modèle RBAC (Role Based Access Control). Tous les utilisateurs de la solution doivent avoir un rôle auquel ils ont accès. |
