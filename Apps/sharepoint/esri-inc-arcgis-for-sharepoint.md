---
title: Informations d’application pour ArcGIS SharePoint par Esri, Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/04/2021
...
| Site web de l’entreprise | [https://www.esri.com](https://www.esri.com) |
...
| Fonctionnalités principales de l’application | ArcGIS Online inclut une suite d’applications, des cartes et des données faisant autorité sur des milliers de rubriques, des outils de mappage modernes dont vous avez besoin pour visualiser vos données, des analyses pour découvrir et communiquer des modèles significatifs dans vos données et les outils d’administration pour gérer facilement les personnes et le contenu et permettre à tout le monde de créer et de partager des cartes. ArcGIS permet à tous les membres de votre organisation de découvrir, d’utiliser, de créer et de partager des cartes à partir de n’importe quel appareil, n’importe où et à tout moment. |
