---
title: Informations d’application pour 4Mata - Concepteur de mise en forme de liste par CLOUDIGNITE LLC
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/31/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour 4Mata - Concepteur de mise en forme de liste, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
ms.locfileid: "66113002"
---
# <a name="4mata---list-formatting-designer"></a>4Mata - Concepteur de mise en forme de liste

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Dernière mise à jour par le développeur : 31 mai 2022</p>

* <a href="https://appsource.microsoft.com/product/office/WA200002892" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par CLOUDIGNITE LLC à Microsoft :

| **Information** | **Réponse** |
|:----------------|:-------------|
| Nom de l'application | 4Mata - Concepteur de mise en forme de liste |
| ID | WA200002892 |
| Office 365 clients pris en charge | SharePoint 2016 ou version ultérieure |
| Nom de la société partenaire | CLOUDIGNITE LLC |
| Site web de la société | [https://4mata.com](https://4mata.com) |
| Conditions d’utilisation de l’application | [https://docs.4mata.com/legal/terms-of-service](https://docs.4mata.com/legal/terms-of-service) |
| Fonctionnalités principales de l’application | 4Mata by CloudIgnite est un ensemble d’outils qui permettent aux entreprises de visualiser les données en concevant et en mettant en forme SharePoint listes et formulaires.  Avec cette application, les utilisateurs peuvent configurer intuitivement des formulaires et des listes SharePoint complexes hautement personnalisés pour les rapports, les factures, la publication des détails du produit et la collecte des informations de contact pour les intégrer facilement aux exigences de votre processus métier.  |
| Emplacement du siège social de la société | Estados Unidos d’Amérique |
| Page d’informations sur l’application | [https://4mata.com](https://4mata.com) |
...
Ces informations ont été fournies par CLOUDIGNITE LLC sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
