---
title: Informations sur les applications pour SharePoint| de formation des employés par SharePointSapiens
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/23/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour la gestion de la formation des employés SharePoint|sapiens, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le Registre CSA STAR.
...
ms.locfileid: "63778410"
---
# <a name="sharepointsapiens-employee-training-management"></a>SharePoint|sapiens Employee Training Management

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Last updated by the developer on: March 22, 2022</p>

* <a href="https://appsource.microsoft.com/product/office/WA104380833" target="_blank">Afficher dans AppSource</a>
...
|:----------------|:-------------|
| Nom de l'application | SharePoint formation des employés |
| ID | WA104380833 |
...
| Fonctionnalités principales de l’application | Le module de gestion de formation des employés facilite l’organisation et l’administration du développement professionnel continu des employés pour tout le monde. De la configuration et de la planification des événements de formation, de la gestion des enseignants et de leurs affectations et inscriptions, au suivi des succès et des commentaires, tout est abordé. Le add-in vous aide à respecter vos réglementations de conformité et vos stratégies de sécurité. Il vous permet d’affecter la formation requise, de suivre les succès, de gérer les expirations et bien plus encore. |
| Emplacement du siège social de l’entreprise | Autriche |
| Page d’informations sur l’application | [https://www.sharepointsapiens.com/employee-training-managem...](https://www.sharepointsapiens.com/employee-training-management-office365/) |
