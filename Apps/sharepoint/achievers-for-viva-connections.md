---
title: Informations d’application pour achievers for Viva Connections by Achievers
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/06/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour Achievers for Viva Connections, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
ms.locfileid: "66655991"
---
# <a name="achievers-for-viva-connections"></a>Résultats pour Viva Connections

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Dernière mise à jour par le développeur : 10 juin 2022</p>

* <a href="https://appsource.microsoft.com/product/office/WA200004313" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Achievers à Microsoft :

| **Information** | **Réponse** |
|:----------------|:-------------|
| Nom de l'application | Résultats pour Viva Connections |
| ID | WA200004313 |
| Office 365 clients pris en charge | SharePoint 2016 ou version ultérieure |
| Nom de la société partenaire | Performants |
| Site web de la société | [https://www.achievers.com](https://www.achievers.com) |
| Conditions d’utilisation de l’application | [https://developer.achievers.com/docs/achievers-terms-of-use](https://developer.achievers.com/docs/achievers-terms-of-use) |
| Fonctionnalités principales de l’application | Cartes d’action rapides pour les membres qui utilisent la plateforme Achievers pour signer une carte de célébration, afficher les auto-reconnaissances et les reconnaissances de tendance |
...
Ces informations ont été fournies par Achievers sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont stockées dans vos bases de données ? | ID de locataire, ID d’utilisateur |
...
| URL de la politique de confidentialité | https://over.achievers.com/ilr_privacy_policy |
