---
title: Informations d’application pour HelloSign pour SharePoint par Dropbox Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 12/10/2021
...
ms.locfileid: "64876551"
---
# <a name="hellosign-for-sharepoint"></a>HelloSign pour SharePoint
...
|:----------------|:-------------|
| Nom de l'application | HelloSign pour SharePoint |
| ID | WA200003245 |
| Office 365 clients pris en charge | SharePoint 2013 ou version ultérieure |
| Nom de la société partenaire | Dropbox Inc. |
| Site web de la société | [https://hellosign.com](https://hellosign.com) |
| Conditions d’utilisation de l’application | [https://hellosign.com/terms](https://hellosign.com/terms) |
| Fonctionnalités principales de l’application | La plateforme de flux de travail numérique HelloSign&#8217;&#8211; qui inclut des solutions eSignature, de flux de travail numérique et de télécopie électronique &#8212; aide plus de 80 000 clients et des millions de personnes à faire des affaires plus rapidement. Nous aidons nos clients à conclure des transactions plus rapidement, à intégrer facilement de nouvelles recrues, à compléter des documents sans erreur, et bien plus encore. |
...
| Quelles données sont traitées par votre application ? | ID de locataire, ID de site, e-mail, ID de lecteur, ID d’élément de lecteur |
| L’application prend-elle en charge TLS 1.1 ou version ultérieure ? | Oui |
| L’application ou l’infrastructure sous-jacente stocke-t-elle des données client Microsoft ? | Oui |
| Quelles données sont stockées dans vos bases de données ? | ID de locataire, ID de site, e-mail, ID de lecteur, ID d’élément de lecteur |
...
| URL de la politique de confidentialité | https://www.hellosign.com/privacy |
...
| Si votre application n’utilise pas l’une des bibliothèques ci-dessus, quelle bibliothèque ou bibliothèque d’authentification utilise-t-elle ? | Le flux de code d’autorisation Plateforme d'identités Microsoft et OAuth 2.0 est utilisé,https://docs.microsoft.com/en-us/azure/active-directory/develop/v2-oauth2-auth-code-flow |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Files.ReadWrite.All | application | Pour charger des fichiers signés électroniquement vers SharePoint | [6fcff87e-0f86-49c3-81eb-bc028d1ccfe6](../azure/6fcff87e-0f86-49c3-81eb-bc028d1ccfe6.md) |
>| Sites.ReadWrite.All | application | Pour charger des fichiers signés électroniquement vers SharePoint | [6fcff87e-0f86-49c3-81eb-bc028d1ccfe6](../azure/6fcff87e-0f86-49c3-81eb-bc028d1ccfe6.md) |
>| User.Read | Délégué | Pour obtenir l’e-mail de l’utilisateur | [6fcff87e-0f86-49c3-81eb-bc028d1ccfe6](../azure/6fcff87e-0f86-49c3-81eb-bc028d1ccfe6.md) |
