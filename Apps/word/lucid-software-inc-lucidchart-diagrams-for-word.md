---
title: Informations d’application pour Lucidchart Diagrams for Word par Lucid Software Inc
ms.author: elmalova
author: elenamalova
ms.date: 12/16/2019
ms.topic: article
...
description: Toutes les informations disponibles sur la sécurité et la conformité pour Lucidchart Diagrams for Word, ses politiques de traitement des données, ses informations sur le catalogue d’applications Microsoft Cloud App Security et les informations de sécurité et de conformité dans le registre STAR de l’ASC.
...
---
# <a name="lucidchart-diagrams-for-word"></a>Diagrammes de Lucidchart pour mot
...
* <a href="https://appsource.microsoft.com/product/office/WA104380118" target="_blank">Voir dans AppSource</a>
...
| **Information** | **Réponse** |
|:----------------|:-------------|
| Nom de l'application | Diagrammes de Lucidchart pour mot |
| ID | WA104380118 |
| Office 365 clients soutenus | Word 2016 ou plus tard sur Mac, Word 2013 ou plus tard Windows, Word sur le web |
