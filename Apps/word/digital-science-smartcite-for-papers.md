---
title: Informations d’application pour SmartCite for Papers by Digital Science
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/03/2021
...
<p>Dernière mise à jour par le développeur : 29 mai 2021</p>
...
Informations fournies par la science numérique à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | SmartCite for Papers |
| ID | WA104380917 |
| Office 365 clients pris en charge | Word 2016 ou version ultérieure sur Mac, Word 2016 ou version ultérieure sur Windows, Word sur le web |
| Nom de la société partenaire | Science numérique |
| Site web de la société | [https://papersapp.com](https://papersapp.com) |
| Conditions d’utilisation de l’application | [https://www.papersapp.com/terms](https://www.papersapp.com/terms) |
| Fonctionnalités principales de l’application | Citez des références et générez automatiquement des bibliographies à partir de votre bibliothèque ReadCube Papers ! |
...
Ces informations ont été fournies par Digital Science sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
