---
title: Informations d’application pour RetMig &amp; Kommaforslag par GrammarSoft ApS
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
| Site web de la société | [https://retmig.dk](https://retmig.dk) |
| Conditions d’utilisation de l’application | [https://retmig.dk/terms](https://retmig.dk/terms) |
| Fonctionnalités principales de l’application | RetMig er en avanceret stave- og grammatikkontrol for dansk, mens Kommaforslag retter kommafejl. |
| Emplacement du siège social de la société | Danemark |
| Page d’informations sur l’application | [https://retmig.dk](https://retmig.dk) |
...
Ces informations ont été fournies par GrammarSoft ApS sur la façon dont cette application collecte et stocke les données d’organisation et le contrôle que votre organisation aura sur les données collectées par l’application.
