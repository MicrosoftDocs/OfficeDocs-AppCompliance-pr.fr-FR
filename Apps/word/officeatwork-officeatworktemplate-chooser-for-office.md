---
title: Informations sur l’application pour template chooser for Office by officeatwork
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/25/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour officeatwork | Choisisseur de modèles pour Office, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
ms.locfileid: "65227968"
---
# <a name="application-information-for-officeatwork--template-chooser-for-office"></a>Informations d’application pour officeatwork | Choisisseur de modèle pour Office
...
|:----------------|:-------------|
| Nom de l'application | officeatwork - Choisisseur de modèles pour Office |
| ID | WA104380050 |
| Office 365 clients pris en charge | Excel sur iPad, Excel 2016 ou ultérieur sur Mac, Excel 2013 ou version ultérieure sur Windows, Excel sur le Web, Word sur iPad, Word 2016 ou version ultérieure sur Mac, Word sur le web, Word 2013 ou version ultérieure Windows, PowerPoint sur iPad, PowerPoint 2016 ou version ultérieure sur Mac, PowerPoint sur le web, PowerPoint 2013 ou une version ultérieure Windows, Project 2016 ou ultérieure Windows |
