---
title: Informations sur l’application pour RocketDocs LaunchPad par RocketDocs
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/24/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour RocketDocs LaunchPad, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
ms.locfileid: "64877031"
---
# <a name="rocketdocs-launchpad"></a>RocketDocs LaunchPad

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Dernière mise à jour par le développeur : 27 octobre 2021</p>

* <a href="https://appsource.microsoft.com/product/office/WA200003648" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par RocketDocs à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | RocketDocs LaunchPad |
| ID | WA200003648 |
| Office 365 clients pris en charge | Excel 2016 ou version ultérieure sur Mac, Excel 2016 ou ultérieur sur Windows, Excel sur le Web, Word 2016 ou ultérieur sur Mac, Word sur le web, Word 2016 ou une version ultérieure sur Windows |
| Nom de la société partenaire | RocketDocs |
| Site web de la société | [https://rocketdocs.com](https://rocketdocs.com) |
| Conditions d’utilisation de l’application | [https://rocketdocs.com/end-user-license-agreement/](https://rocketdocs.com/end-user-license-agreement/) |
| Fonctionnalités principales de l’application | Permet aux utilisateurs de localiser du contenu dans la plateforme RocketDocs et de l’insérer dans un document. |
| Emplacement du siège social de la société | États-Unis d’Amérique |
| Page d’informations sur l’application | [https://rocketdocs.com/platform/](https://rocketdocs.com/platform/) |
...
Ces informations ont été fournies par RocketDocs sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
