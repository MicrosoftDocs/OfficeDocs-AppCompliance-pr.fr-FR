---
title: Informations sur l’application pour le LaunchPadDocsDocs parDocsDocs
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/24/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour Le LaunchPadDocs, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le Registre CSA STAR.
...
ms.locfileid: "64463818"
---
# <a name="rocketdocs-launchpad"></a>LaunchPadDocsDocs
...
Informations fournies parDocsdocs à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | LaunchPadDocsDocs |
| ID | WA200003648 |
| Office 365 clients pris en charge | Excel 2016 ou une ultérieure sur Mac, Excel 2016 ou ultérieur sur Windows, Excel sur le Web, Word 2016 ou ultérieur sur Mac, Word sur le web, Word 2016 ou une Windows |
| Nom de la société partenaire | DocsDocs |
| Site web de l’entreprise | [https://rocketdocs.com](https://rocketdocs.com) |
...
| Fonctionnalités principales de l’application | Permet aux utilisateurs de localiser du contenu dans la plateformeDocs et de l’insérer dans un document. |
...
Ces informations ont été fournies parDocsDocs sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
