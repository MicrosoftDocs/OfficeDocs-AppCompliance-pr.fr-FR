---
title: Informations sur l’application pour Loio Contract Review Software par Loio Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: Toutes les informations de sécurité et de conformité disponibles pour Loio Contract Review Software, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
ms.locfileid: "64875241"
---
# <a name="loio-contract-review-software"></a>Loio Contract Review Software
...
|:----------------|:-------------|
| Nom de l'application | Loio Contract Review Software |
| ID | WA200002273 |
...
| Site web de la société | [https://loio.com](https://loio.com) |
| Conditions d’utilisation de l’application | [https://loio.com/terms-of-use/](https://loio.com/terms-of-use/) |
| Fonctionnalités principales de l’application | Passez en revue &amp; les contrats d’analyse plus rapidement et plus précisément avec l’Assistant Contrat Loio. |
| Emplacement du siège social de la société | États-Unis d’Amérique |
| Page d’informations sur l’application | [https://loio.com](https://loio.com) |
...
Loio Inc. a fourni ces informations sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
