...
ms.locfileid: "64881196"
---
# <a name="crosscheck"></a>Recoupement
...
|:----------------|:-------------|
| Nom de l'application | Recoupement |
| ID | WA200003198 |
...
| Site web de la société | [https://kreveal.com](https://kreveal.com) |
| Conditions d’utilisation de l’application | [https://crosscheck.krevealaddins.com/docs/license.htm](https://crosscheck.krevealaddins.com/docs/license.htm) |
| Fonctionnalités principales de l’application | CrossCheck simplifie l’examen des documents et identifie les erreurs courantes de rédaction. |
| Emplacement du siège social de la société | États-Unis d’Amérique |
| Page d’informations sur l’application | [https://admin.krevealaddins.com/help](https://admin.krevealaddins.com/help) |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| openid | application | Aucune donnée n’est collectée ou utilisée. | [5edad654-f2d5-41d8-bfc0-92c2735252e1](../azure/5edad654-f2d5-41d8-bfc0-92c2735252e1.md) |
