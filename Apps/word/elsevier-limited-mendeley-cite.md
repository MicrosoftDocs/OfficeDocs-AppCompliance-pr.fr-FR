---
title: Informations d’application pour Mendeley Cite par ELSEVIER LIMITED
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/27/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour Mendeley Cite, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
* <a href="https://appsource.microsoft.com/product/office/WA104382081" target="_blank">Afficher dans AppSource</a>
...
| **Information** | **Réponse** |
|:----------------|:-------------|
| Nom de l'application | Mendeley Cite |
| ID | WA104382081 |
| Office 365 clients pris en charge | Word sur iPad, Word 2016 ou version ultérieure sur Windows, Word 2016 ou version ultérieure sur Mac, Word sur le web |
| Nom de la société partenaire | ELSEVIER LIMITED |
| Site web de la société | [https://www.mendeley.com/search/](https://www.mendeley.com/search/) |
| Conditions d’utilisation de l’application | [https://www.mendeley.com/terms/](https://www.mendeley.com/terms/) |
| Fonctionnalités principales de l’application | Citez au fur et à mesure que vous écrivez. Générez des citations et des bibliographies et modifiez votre style de citation. |
| Emplacement du siège social de la société | Royaume-Uni de Grande-Bretagne et d’Irlande du Nord (le) |
| Page d’informations sur l’application | [https://www.mendeley.com/guides/mendeley-cite/](https://www.mendeley.com/guides/mendeley-cite/) |
...
Ces informations ont été fournies par ELSEVIER LIMITED sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| URL de la politique de confidentialité | https://privacy.elsevier.com |
