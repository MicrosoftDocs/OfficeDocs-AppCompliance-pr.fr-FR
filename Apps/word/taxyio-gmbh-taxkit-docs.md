---
title: Informations d’application pour TaxKit Docs par Taxy.io GmbH
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: Toutes les informations de sécurité et de conformité disponibles pour TaxKit Docs, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
* <a href="https://appsource.microsoft.com/product/office/WA200002849" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Taxy.io GmbH à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | TaxKit Docs |
| ID | WA200002849 |
...
| Nom de la société partenaire | Taxy.io GmbH |
| Site web de la société | [https://www.taxy.io](https://www.taxy.io) |
| Conditions d’utilisation de l’application | [https://go.microsoft.com](https://go.microsoft.com) |
| Fonctionnalités principales de l’application | TaxKit Docs aide les conseillers fiscaux à trouver des documents juridiques pertinents pour le document et les cas sur lesquels ils travaillent. Cela les aide à conseiller leurs clients plus efficacement. |
...
Ces informations ont été fournies par Taxy.io GmbH sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
