---
title: Informations d’application pour Jus2vec par N2VEC TECNOLOGIA
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/18/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour Jus2vec, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
ms.locfileid: "64906414"
---
# <a name="jus2vec"></a>Jus2vec

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Dernière mise à jour par le développeur : 18 avril 2022</p>

* <a href="https://appsource.microsoft.com/product/office/WA200002506" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par N2VEC TECNOLOGIA à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | Jus2vec |
| ID | WA200002506 |
...
| Nom de la société partenaire | N2VEC TECNOLOGIA |
| Site web de la société | [https://info.jus2vec.com](https://info.jus2vec.com) |
| Conditions d’utilisation de l’application | [https://info.jus2vec.com/termos-de-uso.html](https://info.jus2vec.com/termos-de-uso.html) |
| Fonctionnalités principales de l’application | Busca por Jurisprud&#234;ncias usando Intelig&#234;ncia Artificial |
| Emplacement du siège social de la société | Brésil |
...
Ces informations ont été fournies par N2VEC TECNOLOGIA sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
