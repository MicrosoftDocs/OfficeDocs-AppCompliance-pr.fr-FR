---
title: Informations sur l’application pour BriefCatch par BriefCatch LLC
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/04/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour BriefCatch, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
* <a href="https://appsource.microsoft.com/product/office/WA200003725" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par BriefCatch LLC à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | BriefCatch |
| ID | WA200003725 |
...
| Nom de la société partenaire | BriefCatch LLC |
| Site web de la société | [https://briefcatch.com](https://briefcatch.com) |
| Conditions d’utilisation de l’application | [https://briefcatch.com/briefcatch-end-user-license-agreemen...](https://briefcatch.com/briefcatch-end-user-license-agreement/) |
| Fonctionnalités principales de l’application | Une modification juridique experte à vos côtés. |
| Emplacement du siège social de la société | États-Unis d’Amérique |
| Page d’informations sur l’application | [https://briefcatch.com/version-3/](https://briefcatch.com/version-3/) |
...
Ces informations ont été fournies par BriefCatch LLC sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
