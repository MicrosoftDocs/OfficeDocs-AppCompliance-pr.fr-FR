---
title: Informations d’application pour le choisisseur de contenu pour Office par officeatwork
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/25/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour officeatwork | Choisisseur de contenu pour Office, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
ms.locfileid: "65228532"
---
# <a name="application-information-for-officeatwork"></a>Informations d’application pour officeatwork
...
|:----------------|:-------------|
| Nom de l'application | officeatwork - Choisisseur de contenu pour Office |
| ID | WA104380602 |
