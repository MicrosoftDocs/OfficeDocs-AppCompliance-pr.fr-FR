---
title: Informations sur l’application pour le brouillon de document par Green Meadow ApS
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/06/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour le rédacteur de documents, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
ms.locfileid: "65269939"
---
# <a name="document-drafter"></a>Brouillon de document

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Dernière mise à jour par le développeur : 10 décembre 2021</p>

* <a href="https://appsource.microsoft.com/product/office/WA200003634" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Green Meadow ApS à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | Brouillon de document |
| ID | WA200003634 |
| Office 365 clients pris en charge | Word 2016 ou version ultérieure sur Mac, Word sur le web, Word 2013 ou version ultérieure sur Windows |
| Nom de la société partenaire | Green Meadow ApS |
| Site web de la société | [https://gmeadow.com](https://gmeadow.com) |
| Conditions d’utilisation de l’application | [https://tinyurl.com/2p9dw3tm](https://tinyurl.com/2p9dw3tm) |
| Fonctionnalités principales de l’application | Ce complément vous permet d’accéder à vos modèles De brouillon de document directement dans MS Word. |
| Emplacement du siège social de la société | Danemark |
| Page d’informations sur l’application | [https://gmeadow.com/addin-support/](https://gmeadow.com/addin-support/) |
...
Ces informations ont été fournies par Green Meadow ApS sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont traitées par votre application ? | ID de messagerie, nom et groupe de sécurité. |
| L’application prend-elle en charge TLS 1.1 ou version ultérieure ? | Oui |
| L’application ou l’infrastructure sous-jacente stocke-t-elle des données client Microsoft ? | Oui |
| Quelles données sont stockées dans vos bases de données ? | ID de messagerie, nom et groupe de sécurité. |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.Read.All | les deux | Pour lire les bibliothèques peoples dans les canaux, ce qui est nécessaire pour permettre aux utilisateurs de parcourir les dossiers lors du stockage des documents générés dans notre application. | [1c529524-183e-40db-b1d7-1acf275354b4](../azure/1c529524-183e-40db-b1d7-1acf275354b4.md) |
>| Files.ReadWrite.All | Délégué | Permet aux utilisateurs de parcourir ou de créer des dossiers stockant les documents générés dans notre application. | [1c529524-183e-40db-b1d7-1acf275354b4](../azure/1c529524-183e-40db-b1d7-1acf275354b4.md) |
>| Group.ReadWrite.All | Délégué | Pour identifier Teams membres à des fins de gestion des accès. | [1c529524-183e-40db-b1d7-1acf275354b4](../azure/1c529524-183e-40db-b1d7-1acf275354b4.md) |
>| TeamsActivity.Send | Délégué | Pour l’envoi de messages sur les questionnaires/la mise à jour des questionnaires, etc. | [1c529524-183e-40db-b1d7-1acf275354b4](../azure/1c529524-183e-40db-b1d7-1acf275354b4.md) |
>| User.Read.All | Délégué | Pour lire le profil complet afin de connaître l’utilisateur d’appartenance au groupe utilisé pour envoyer des messages à Teams flux d’activité. | [1c529524-183e-40db-b1d7-1acf275354b4](../azure/1c529524-183e-40db-b1d7-1acf275354b4.md) |
>| email | Délégué | Nous utilisons l’ID de messagerie pour identifier les utilisateurs dans notre système principal. | [1c529524-183e-40db-b1d7-1acf275354b4](../azure/1c529524-183e-40db-b1d7-1acf275354b4.md) |
>| openid | Délégué | Authentification de l’utilisateur. | [1c529524-183e-40db-b1d7-1acf275354b4](../azure/1c529524-183e-40db-b1d7-1acf275354b4.md) |
>| profil | Délégué | Pour améliorer l’expérience utilisateur en obtenant l’avatar/les photos des utilisateurs, le cas échéant. | [1c529524-183e-40db-b1d7-1acf275354b4](../azure/1c529524-183e-40db-b1d7-1acf275354b4.md) |
