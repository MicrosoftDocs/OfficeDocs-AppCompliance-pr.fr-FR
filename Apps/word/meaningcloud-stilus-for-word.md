---
title: Informations d’application pour Stilus pour Word par MeaningCloud
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 11/01/2021
...
description: Toutes les informations de sécurité et de conformité disponibles pour Stilus pour Word, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le Registre CSA STAR.
...
ms.locfileid: "63549902"
---
# <a name="stilus-for-word"></a>Stilus pour Word

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Last updated by the developer on: October 28, 2021</p>

* <a href="https://appsource.microsoft.com/product/office/WA200003400" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par MeaningCloud à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | Stilus pour Word |
| ID | WA200003400 |
...
| Site web de l’entreprise | [https://www.mystilus.com/en](https://www.mystilus.com/en) |
| Conditions d’utilisation de l’application | [https://www.mystilus.com/en/about-stilus/license-agreements](https://www.mystilus.com/en/about-stilus/license-agreements) |
| Fonctionnalités principales de l’application | Vérificateur d’orthographe, de grammaire et de style pour l’espagnol |
| Emplacement du siège social de l’entreprise | Espagne |
| Page d’informations sur l’application | [https://www.mystilus.com/en/plugins/stilus-for-word-365](https://www.mystilus.com/en/plugins/stilus-for-word-365) |
...
Ces informations ont été fournies par MeaningCloud sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| URL de la politique de confidentialité | https://www.mystilus.com/en/data-protection |
