---
title: Informations d’application pour ValidSign by ValidSign
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/15/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour ValidSign, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
* <a href="https://appsource.microsoft.com/product/office/WA200001890" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par ValidSign à Microsoft :

| **Information** | **Réponse** |
|:----------------|:-------------|
| Nom de l'application | ValidSign |
| ID | WA200001890 |
...
| Nom de la société partenaire | ValidSign |
| Site web de la société | [https://www.validsign.eu](https://www.validsign.eu) |
| Conditions d’utilisation de l’application | [https://www.validsign.eu/word-license-terms/](https://www.validsign.eu/word-license-terms/) |
| Fonctionnalités principales de l’application | Travailler plus intelligemment et plus efficacement avec le complément ValidSign Word |
| Emplacement du siège social de la société | Pays-Bas (le) |
| Page d’informations sur l’application | [https://www.validsign.eu/connectors/word/](https://www.validsign.eu/connectors/word/) |
...
ValidSign a fourni ces informations sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| URL de la politique de confidentialité | https://www.validsign.eu/validsign-privacy-statement/ |
