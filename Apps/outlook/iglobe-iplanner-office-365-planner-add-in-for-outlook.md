---
title: Informations sur l’application pour iPlanner Office 365 Planner Add-in for Outlook by iGlobe
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/28/2021
...
description: Toutes les informations de sécurité et de conformité disponibles pour le complément iPlanner Office 365 Planner pour Outlook, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
ms.locfileid: "64881481"
---
# <a name="iplanner-office-365-planner-add-in-for-outlook"></a>Complément iPlanner Office 365 Planner pour Outlook
...
|:----------------|:-------------|
| Nom de l'application | Complément iPlanner Office 365 Planner pour Outlook |
| ID | WA104380147 |
...
| Fonctionnalités principales de l’application | Obtenez les tâches du Planificateur à partir de Office 365 Planner &amp; Teams à l’extrémité de votre main dans Outlook sur n’importe quel appareil. La gestion et la création de tâches n’ont jamais été aussi faciles. Obtenez les tâches du Planificateur de Office 365 &amp; Teams à l’extrémité de votre main, dans Outlook pour Windows, MAC, IOS ou courrier web. |
| Emplacement du siège social de la société | Danemark |
| Page d’informations sur l’application | [https://planner.iglobe.dk](https://planner.iglobe.dk) |
