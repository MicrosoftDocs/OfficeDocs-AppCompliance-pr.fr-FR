---
title: Informations d’application pour achievers for Outlook by Achievers
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/27/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour Achievers for Outlook, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
ms.locfileid: "67048384"
---
# <a name="achievers-for-outlook"></a>Résultats pour Outlook

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Dernière mise à jour par le développeur : 28 octobre 2021</p>

* <a href="https://appsource.microsoft.com/product/office/WA104381896" target="_blank">Afficher dans AppSource</a>
...
| **Information** | **Réponse** |
|:----------------|:-------------|
| Nom de l'application | Résultats pour Outlook |
| ID | WA104381896 |
| Office 365 clients pris en charge | Outlook 2016 ou version ultérieure sur Windows, Outlook 2016 ou version ultérieure sur Mac, Outlook sur le web |
...
| Fonctionnalités principales de l’application | Créez la reconnaissance pour vos collègues dans la plateforme Achievers avec moins de frictions dans l’écosystème Microsoft. |
...
| Quelles données sont stockées dans vos bases de données ? | ID de locataire, ID d’utilisateur, e-mail utilisateur |
