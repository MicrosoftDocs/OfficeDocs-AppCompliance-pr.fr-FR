---
title: Informations d’application pour Quantum Workplace by Quantum Workplace
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/25/2021
...
| Site web de la société | [https://www.quantumworkplace.com](https://www.quantumworkplace.com) |
...
| Fonctionnalités principales de l’application | Aidez les employés à réussir avec les alertes et les notifications Quantum Workplace. |
...
| Date de certification SOC2 la plus récente | 2021-06-30 |
...
>| User.Read.All | application | User.Id (stocké) : utilisé pour mettre en corrélation les utilisateurs envoyés à notre point de terminaison de bot ; User.UserPrincipalName (non stocké) - Actuellement inutilisé ; User.Mail (non stocké) : utilisé pour faire correspondre les utilisateurs de notre système avec leur ID AzureAD que nous stockons. | [be93046b-63ab-4216-9bcc-78faa55eeaa7](../azure/be93046b-63ab-4216-9bcc-78faa55eeaa7.md) |
