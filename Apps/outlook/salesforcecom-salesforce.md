...
| Site web de l’entreprise | [https://www.salesforce.com](https://www.salesforce.com) |
...
| Fonctionnalités principales de l’application | Permet de faire l’expérience de Salesforce directement dans Outlook. L’intégration est 100 % cloud et ne repose sur aucun logiciel à pousser, installer ou gérer. Affichez tous les contacts, prospects, comptes, opportunités et cas associés aux e-mails et rendez-vous sans basculer entre Salesforce et Outlook ; vos données Salesforce apparaissent directement dans Outlook. Créez de nouveaux enregistrements Salesforce, y compris des enregistrements d’objets personnalisés, directement Outlook. Ajouter des e-mails et des rendez-vous aux enregistrements Salesforce en un clic, même lors de la composition |
