---
title: Choisisseur de contenu pour les informations d’application Outlook
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/25/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour officeatwork | Choisisseur de contenu pour Outlook, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
ms.locfileid: "64784013"
---
# <a name="content-chooser-for-outlook-application-information"></a>Choisisseur de contenu pour les informations d’application Outlook
...
|:----------------|:-------------|
| Nom de l'application | officeatwork - Choisisseur de contenu pour Outlook |
| ID | WA104380690 |
