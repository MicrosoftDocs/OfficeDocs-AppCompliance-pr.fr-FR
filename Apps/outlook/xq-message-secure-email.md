---
title: Informations sur l’application pour le message XQ Secure Email by XQ
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/10/2021
...
description: Toutes les informations de sécurité et de conformité disponibles pour XQ Secure Email, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
ms.locfileid: "64876601"
---
# <a name="xq-secure-email"></a>E-mail sécurisé XQ

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Dernière mise à jour par le développeur : 4 juillet 2021</p>
...
Informations fournies par XQ Message à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | E-mail sécurisé XQ |
| ID | WA200000090 |
...
| Site web de la société | [https://xqmsg.co](https://xqmsg.co) |
| Conditions d’utilisation de l’application | [https://xqmsg.com/terms.html](https://xqmsg.com/terms.html) |
| Fonctionnalités principales de l’application | Protégez toutes vos communications &#8212; des e-mails aux fichiers. |
| Emplacement du siège social de la société | États-Unis d’Amérique |
| Page d’informations sur l’application | [https://xqmsg.co/about](https://xqmsg.co/about) |
