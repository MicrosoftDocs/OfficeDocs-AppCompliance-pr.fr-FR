---
title: Informations sur l’application pour Dynamo by Dynamo Software
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/09/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour Dynamo, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
* <a href="https://appsource.microsoft.com/product/office/WA200004007" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Dynamo Software à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | Dynamo |
| ID | WA200004007 |
...
| Nom de la société partenaire | Dynamo Software |
| Site web de la société | [https://www.dynamosoftware.com](https://www.dynamosoftware.com) |
| Conditions d’utilisation de l’application | [https://www.dynamosoftware.com/End-User-Terms](https://www.dynamosoftware.com/End-User-Terms) |
| Fonctionnalités principales de l’application | Le complément Office dynamo&#8217;pour Outlook est un programme de prise en charge qui permet aux utilisateurs dynamo existants de travailler avec Dynamo via des applications de bureau Outlook pour Windows et Outlook sur le Web (Office 365 et Outlook.com). Vous pouvez envoyer des brouillons de fusion et publipostage, ajouter des rendez-vous et des activités ainsi que leurs pièces jointes à Dynamo, et créer de nouveaux éléments de type Contact, Société, Transaction et Fonds sans ouvrir Dynamo.  |
| Emplacement du siège social de la société | États-Unis d’Amérique |
| Page d’informations sur l’application | [https://help.dynamosoftware.com/about-dynamo-web-add-in-for...](https://help.dynamosoftware.com/about-dynamo-web-add-in-for-outlook/) |
