---
title: Informations d’application pour l’engagement commercial de sensibilisation pour Outlook par la sensibilisation
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: Toutes les informations de sécurité et de conformité disponibles pour Outreach Sales Engagement pour Outlook, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
Informations fournies par Outreach to Microsoft :
...
| Site web de la société | [https://www.outreach.io](https://www.outreach.io) |
| Conditions d’utilisation de l’application | [https://www.outreach.io/terms](https://www.outreach.io/terms) |
| Fonctionnalités principales de l’application | La sensibilisation est la plateforme d’engagement des ventes la plus importante et la plus rapide qui permet aux entreprises d’accroître considérablement leur productivité et de favoriser un engagement plus intelligent et plus perspicace avec leurs clients. De l’automatisation des ventes à l’intelligence des conversations, à l’analyse des sentiments des acheteurs, aux rapports sur les performances de l’équipe&#8212; et bien plus&#8212; Outreach est une plateforme intégrée d’engagement des ventes qui permet aux commerciaux et aux dirigeants d’augmenter la productivité, de générer plus d’opportunités de vente et de dépasser vos objectifs de vente. |
| Emplacement du siège social de la société | États-Unis d’Amérique |
| Page d’informations sur l’application | [https://www.outreach.io/product](https://www.outreach.io/product) |
| Quel est l’environnement d’hébergement ou le modèle de service utilisé pour exécuter votre application ? |  |
| Quels fournisseurs de cloud d’hébergement l’application utilise-t-elle ? | Azure, GCP, AWS |
...
Ces informations ont été fournies par Outreach sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
