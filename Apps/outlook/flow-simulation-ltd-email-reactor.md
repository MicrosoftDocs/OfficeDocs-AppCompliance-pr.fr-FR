---
title: Informations sur l’application pour le réacteur de messagerie par Flow Simulation Ltd.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/04/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour Email Reactor, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
ms.locfileid: "65229391"
---
# <a name="email-reactor"></a>Réacteur d’e-mail

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Dernière mise à jour par le développeur : 4 mai 2022</p>

* <a href="https://appsource.microsoft.com/product/office/WA104379506" target="_blank">Afficher dans AppSource</a>
...
|:----------------|:-------------|
| Nom de l'application | Réacteur d’e-mail |
| ID | WA104379506 |
...
| Conditions d’utilisation de l’application | [https://www.flosim.com/reactor/EULA.html](https://www.flosim.com/reactor/EULA.html) |
| Fonctionnalités principales de l’application | Outil de rédaction des réponses par e-mail pour gagner du temps |
| Emplacement du siège social de la société | Royaume-Uni de Grande-Bretagne et d’Irlande du Nord (le) |
| Page d’informations sur l’application | [https://www.flosim.com/reactor/Email_Reactor.html](https://www.flosim.com/reactor/Email_Reactor.html) |
