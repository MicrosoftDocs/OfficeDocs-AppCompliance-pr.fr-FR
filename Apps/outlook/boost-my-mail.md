---
title: Informations sur l’application pour Boost My Mail by Boost My Mail
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/13/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour Boost My Mail, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
---
# <a name="boost-my-mail"></a>Boost My Mail

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Dernière mise à jour par le développeur : 5 mai 2022</p>

* <a href="https://appsource.microsoft.com/product/office/WA200004085" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Boost My Mail to Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | Boost My Mail |
| ID | WA200004085 |
...
| Nom de la société partenaire | Boost My Mail |
| Site web de la société | [https://www.boostmymail.com/fr](https://www.boostmymail.com/fr) |
| Conditions d’utilisation de l’application | [https://www.boostmymail.com/fr/conditions-dutilisations/](https://www.boostmymail.com/fr/conditions-dutilisations/) |
| Fonctionnalités principales de l’application | Gérer de manière centralisée une belle signature e-mail d’entreprise sur Outlook |
...
Ces informations ont été fournies par Boost My Mail sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
