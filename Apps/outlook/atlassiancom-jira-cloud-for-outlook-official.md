...
ms.locfileid: "64881501"
---
# <a name="jira-cloud-for-outlook-official"></a>Jira Cloud for Outlook (officiel)
...
|:----------------|:-------------|
| Nom de l'application | Jira Cloud for Outlook (officiel) |
| ID | WA200000056 |
...
| Quelles données sont traitées par votre application ? | Les données de messagerie utilisateur sont traitées dans le cadre de la fonction d’application d’affichage des liens Jira. |
