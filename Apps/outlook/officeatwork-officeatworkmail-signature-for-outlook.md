...
description: Toutes les informations de sécurité et de conformité disponibles pour officeatwork | Signature électronique pour Outlook, ses stratégies de gestion des données, ses Microsoft Cloud App Security catalogue d’applications et informations de sécurité/conformité dans le Registre CSA STAR.
...
|:----------------|:-------------|
| Nom de l'application | officeatwork - Signature électronique pour Outlook |
| ID | WA200003062 |
