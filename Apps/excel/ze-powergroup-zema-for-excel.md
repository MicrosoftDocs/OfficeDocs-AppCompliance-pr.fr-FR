---
title: Informations d’application pour ZEMA pour Excel par ZE PowerGroup
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/17/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour ZEMA pour Excel, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le Registre CSA STAR.
...
ms.locfileid: "63543492"
---
# <a name="zema-for-excel"></a>ZEMA pour Excel

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Last updated by the developer on: February 17, 2022</p>

* <a href="https://appsource.microsoft.com/product/office/WA200002229" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par ZE PowerGroup à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | ZEMA pour Excel |
| ID | WA200002229 |
| Office 365 clients pris en charge | Excel 2016 ou une ultérieure sur Mac, Excel 2016 ou une Windows, Excel sur le Web |
| Nom de la société partenaire | ZE PowerGroup |
| Site web de l’entreprise | [https://www.ze.com](https://www.ze.com) |
| Conditions d’utilisation de l’application | [https://www.ze.com/terms-of-use/](https://www.ze.com/terms-of-use/) |
| Fonctionnalités principales de l’application | Importez rapidement et facilement des données et des analyses ZEMA dans votre Excel de travail. |
...
Ces informations ont été fournies par ZE PowerGroup sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
