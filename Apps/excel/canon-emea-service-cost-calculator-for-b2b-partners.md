...
description: Toutes les informations de sécurité et de conformité disponibles pour Canon EMEA Service Cost Calculator for B2B Partners, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
ms.locfileid: "64879881"
---
# <a name="canon-emea-service-cost-calculator-for-b2b-partners"></a>Calculatrice de coûts du service EMEA Canon pour les partenaires B2B

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Dernière mise à jour par le développeur : 3 août 2021</p>

* <a href="https://appsource.microsoft.com/product/office/WA200003098" target="_blank">Afficher dans AppSource</a>
...
|:----------------|:-------------|
| Nom de l'application | Calculatrice de coûts du service EMEA Canon pour les partenaires B2B |
| ID | WA200003098 |
| Office 365 clients pris en charge | Excel 2016 ou version ultérieure sur Mac, Excel 2013 ou version ultérieure sur Windows, Excel sur le Web |
| Nom de la société partenaire | Canon EMEA |
| Site web de la société | [https://www.canon-europe.com](https://www.canon-europe.com) |
| Conditions d’utilisation de l’application | [https://partners.canon-europe.com/partners/s/Terms%20and%20...](https://partners.canon-europe.com/partners/s/Terms%20and%20Conditions%20-%20English%20(Partner%20Portal)) |
| Fonctionnalités principales de l’application | Calcul précis, transparent et productif des coûts de service pour les imprimantes Canon (B2B) |
...
Ces informations ont été fournies par Canon EMEA sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
