---
title: Informations sur l’application SHEETGO
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 11/08/2021
...
<p>Dernière mise à jour par le développeur : 1er novembre 2021</p>

* <a href="https://appsource.microsoft.com/product/office/WA200002128" target="_blank">Afficher dans AppSource</a>
...
| Site web de la société | [https://www.sheetgo.com](https://www.sheetgo.com) |
| Conditions d’utilisation de l’application | [https://www.sheetgo.com/legal/terms/](https://www.sheetgo.com/legal/terms/) |
| Fonctionnalités principales de l’application | Sheetgo est une plateforme d’automatisation des flux de travail qui permet aux utilisateurs de connecter des feuilles de calcul en ligne et de créer des systèmes automatisés de gestion des données. L’application web Sheetgo fournit une plateforme pour la création et la gestion de flux de travail, ainsi qu’une gamme de modèles. Le complément Sheetgo pour Excel et le module complémentaire pour Google Sheets permettent aux utilisateurs de se connecter et d’automatiser directement à partir d’une feuille de calcul, et l’application Teams permet aux créateurs de flux de travail de partager leurs fichiers connectés avec des collègues dans des canaux et des conversations de groupe. |
| Emplacement du siège social de la société | Espagne |
| Page d’informations sur l’application | [https://www.sheetgo.com](https://www.sheetgo.com) |
...
| Quelles données sont stockées dans vos bases de données ? | Métadonnées de feuille de calcul telles que la taille de fichier, le propriétaire de la feuille de calcul, les utilisateurs de feuille de calcul, la date de dernière modification, le nom de fichier, etc. NOUS NE STOCKONS PAS LES DONNÉES DE FEUILLE DE CALCUL |
...
| URL de la politique de confidentialité | https://www.sheetgo.com/legal/privacy |
