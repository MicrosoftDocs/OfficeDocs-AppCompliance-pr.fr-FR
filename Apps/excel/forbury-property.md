---
title: Informations sur l’application for For info par For sous, propriété
ms.author: elmalova
author: elenamalova
ms.date: 11/19/2021
ms.topic: article
...
description: Toutes les informations de sécurité et de conformité disponibles pour For catalog, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le Registre CSA STAR.
...
ms.locfileid: "61146779"
---
# <a name="forbury"></a>Forz

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Last updated by the developer on: November 19, 2021</p>

* <a href="https://appsource.microsoft.com/product/office/WA200002916" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par la propriété For sous à Microsoft :

| **Information** | **Réponse** |
|:----------------|:-------------|
| Nom de l'application | Forz |
| ID | WA200002916 |
| Office 365 clients pris en charge | Excel 2016 ou une ultérieure sur Mac, Excel 2016 ou une Windows, Excel sur le Web |
| Nom de la société partenaire | For très bien, propriété |
| Site web de l’entreprise | [https://www.forbury.com](https://www.forbury.com) |
| Conditions d’utilisation de l’application | [https://www.forbury.com/terms-of-use](https://www.forbury.com/terms-of-use) |
| Fonctionnalités principales de l’application | Le moyen le plus rapide d’alimenter les évaluations (analyses) de l’immobilier commercial dans votre logiciel For éditeur. |
...
Ces informations ont été fournies par La propriété For en savoir plus sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| URL de la politique de confidentialité | https://www.forbury.com/privacy-policy |
