---
title: Informations d’application pour les données XBRL classées par XBRL US
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/10/2021
...
description: Toutes les informations de sécurité et de conformité disponibles pour les données classées XBRL, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
---
# <a name="xbrl-filed-data"></a>Données XBRL classées

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Dernière mise à jour par le développeur : 2 août 2021</p>

* <a href="https://appsource.microsoft.com/product/office/WA200002591" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par XBRL US à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | Données XBRL classées |
| ID | WA200002591 |
| Office 365 clients pris en charge | Excel 2016 ou version ultérieure sur Mac, Excel 2016 ou ultérieur sur Windows, Excel sur le Web |
| Nom de la société partenaire | XBRL US |
| Site web de la société | [https://xbrl.us](https://xbrl.us) |
| Conditions d’utilisation de l’application | [https://xbrl.us/terms-of-agreement](https://xbrl.us/terms-of-agreement) |
| Fonctionnalités principales de l’application | XBRL US est le consortium à but non lucratif qui crée et soutient des normes de création de rapports d’entreprise gratuites, ouvertes et nonpropriétaires aux États-Unis. XBRL US a dirigé l’élaboration et la mise en œuvre de normes de données pour les organismes gouvernementaux - la Securities and Exchange Commission (SEC), la Federal Energy Regulatory Commission (FERC) et le Department of Energy. XBRL US surveille les données et aide à créer des normes de qualité des données utilisées par la SEC pour aider les entreprises publiques à créer des états financiers XBRL de bonne qualité.  |
| Emplacement du siège social de la société | États-Unis d’Amérique |
| Page d’informations sur l’application | [https://xbrl.us/xbrl-api-community](https://xbrl.us/xbrl-api-community) |
| Quel est l’environnement d’hébergement ou le modèle de service utilisé pour exécuter votre application ? |  |
| Quels fournisseurs de cloud d’hébergement l’application utilise-t-elle ? | GitHub |
...
Ces informations ont été fournies par XBRL US sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
