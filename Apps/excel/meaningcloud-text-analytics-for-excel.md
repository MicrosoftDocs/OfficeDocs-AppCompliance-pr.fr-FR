...
|:----------------|:-------------|
| Nom de l'application | MeaningCloud Text Analytics pour Excel |
| ID | WA200002421 |
...
| Fonctionnalités principales de l’application | Effectuer des analyses de texte directement sur votre feuille Excel de calcul |
