...
<span data-ttu-id="b9ba2-107">Informations fournies par JiJi Technologies Private Limited à Microsoft :</span><span class="sxs-lookup"><span data-stu-id="b9ba2-107">Information provided by JiJi Technologies Private Limited to Microsoft:</span></span>
...
### <a name="identity-information"></a><span data-ttu-id="b9ba2-182">Informations d’identité</span><span class="sxs-lookup"><span data-stu-id="b9ba2-182">Identity information</span></span>

<span data-ttu-id="b9ba2-183">Ces informations ont été fournies par JiJi Technologies Private Limited sur la façon dont cette application gère l’authentification, l’autorisation, les meilleures pratiques d’inscription des applications et d’autres critères d’identité.</span><span class="sxs-lookup"><span data-stu-id="b9ba2-183">This information has been provided by JiJi Technologies Private Limited about how this app handles authentication, authorization, application registration best practices, and other Identity criteria.</span></span>

| <span data-ttu-id="b9ba2-184">**Information**</span><span class="sxs-lookup"><span data-stu-id="b9ba2-184">**Information**</span></span> | <span data-ttu-id="b9ba2-185">**Réponse**</span><span class="sxs-lookup"><span data-stu-id="b9ba2-185">**Response**</span></span> |
|:----------------|:-------------|
| <span data-ttu-id="b9ba2-186">Intégrez-vous La plateforme d’identification Microsoft (Azure AD) ?</span><span class="sxs-lookup"><span data-stu-id="b9ba2-186">Do you integrate with Microsoft Identify Platform (Azure AD)?</span></span>  | <span data-ttu-id="b9ba2-187">Oui</span><span class="sxs-lookup"><span data-stu-id="b9ba2-187">Yes</span></span> |
| <span data-ttu-id="b9ba2-188">Avez-vous examiné et respecté toutes les meilleures pratiques applicables décrites dans la liste de contrôle Plateforme d’identités Microsoft’intégration ?</span><span class="sxs-lookup"><span data-stu-id="b9ba2-188">Have you reviewed and complied with all applicable best practices outlined in the Microsoft identity platform integration checklist?</span></span>  | <span data-ttu-id="b9ba2-189">Oui</span><span class="sxs-lookup"><span data-stu-id="b9ba2-189">Yes</span></span> |
| <span data-ttu-id="b9ba2-190">Votre application utilise-t-elle MSAL (Bibliothèque d’authentification Microsoft) pour l’authentification ?</span><span class="sxs-lookup"><span data-stu-id="b9ba2-190">Does your app use MSAL (Microsoft Authentication Library) for authentication?</span></span> | <span data-ttu-id="b9ba2-191">Oui</span><span class="sxs-lookup"><span data-stu-id="b9ba2-191">Yes</span></span> |
| <span data-ttu-id="b9ba2-192">Votre application prend-elle en charge les stratégies d’accès conditionnel ?</span><span class="sxs-lookup"><span data-stu-id="b9ba2-192">Does your app support Conditional Access policies?</span></span> | <span data-ttu-id="b9ba2-193">Oui</span><span class="sxs-lookup"><span data-stu-id="b9ba2-193">Yes</span></span> |
| <span data-ttu-id="b9ba2-194">Liste des types de stratégies pris en charge</span><span class="sxs-lookup"><span data-stu-id="b9ba2-194">List the types of policies supported</span></span> | <span data-ttu-id="b9ba2-195">Exiger une authentification multifacteur pour les utilisateurs ayant des rôles d’administration, exiger une authentification multifacteur pour les tâches de gestion Azure, bloquer les ouvertures de signature pour les utilisateurs qui tentent d’utiliser des protocoles d’authentification hérités, exiger des emplacements fiables pour l’inscription à l’authentification multifacteur Azure AD, bloquer ou accorder l’accès à partir d’emplacements spécifiques, Blocage du comportement de la signature à risque</span><span class="sxs-lookup"><span data-stu-id="b9ba2-195">Requiring multi-factor authentication for users with administrative roles, Requiring multi-factor authentication for Azure management tasks, Blocking sign-ins for users attempting to use legacy authentication protocols, Requiring trusted locations for Azure AD Multi-Factor Authentication registration, Blocking or granting access from specific locations, Blocking risky sign-in behavior</span></span> |
| <span data-ttu-id="b9ba2-196">Votre application demande-t-elle des autorisations de moindre privilège pour votre scénario ?</span><span class="sxs-lookup"><span data-stu-id="b9ba2-196">Does your app request least privilege permissions for your scenario?</span></span> | <span data-ttu-id="b9ba2-197">Oui</span><span class="sxs-lookup"><span data-stu-id="b9ba2-197">Yes</span></span> |
| <span data-ttu-id="b9ba2-198">Les autorisations enregistrées statiquement de votre application reflètent-elles précisément les autorisations que votre application demande dynamiquement et incrémentiellement ?</span><span class="sxs-lookup"><span data-stu-id="b9ba2-198">Does your app's statically registered permissions accurately reflect the permissions your app will request dynamically and incrementally?</span></span> | <span data-ttu-id="b9ba2-199">Oui</span><span class="sxs-lookup"><span data-stu-id="b9ba2-199">Yes</span></span> |
| <span data-ttu-id="b9ba2-200">Votre application prend-elle en charge l’location multiple ?</span><span class="sxs-lookup"><span data-stu-id="b9ba2-200">Does your app support multi-tenancy?</span></span> | <span data-ttu-id="b9ba2-201">Oui</span><span class="sxs-lookup"><span data-stu-id="b9ba2-201">Yes</span></span> |
| <span data-ttu-id="b9ba2-202">Votre application a-t-elle un client confidentiel ?</span><span class="sxs-lookup"><span data-stu-id="b9ba2-202">Does your app have a confidential client?</span></span> | <span data-ttu-id="b9ba2-203">Oui</span><span class="sxs-lookup"><span data-stu-id="b9ba2-203">Yes</span></span> |
| <span data-ttu-id="b9ba2-204">Êtes-vous propriétaire de tous les URI (Unified Resource Identifier) de redirection enregistrés pour votre application ?</span><span class="sxs-lookup"><span data-stu-id="b9ba2-204">Do you own all of the redirect Unified Resource Identifier (URI) registered for your app?</span></span> | <span data-ttu-id="b9ba2-205">Oui</span><span class="sxs-lookup"><span data-stu-id="b9ba2-205">Yes</span></span> |
