---
title: Informations d’application pour Indicadores Economicos Chile par Birdie
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/31/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour Indicadores Economicos Chile, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
ms.locfileid: "65818461"
---
# <a name="indicadores-economicos-chile"></a>Indicadores Economicos Chili

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Dernière mise à jour par le développeur : 30 mai 2022</p>

* <a href="https://appsource.microsoft.com/product/office/WA104381100" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Birdie à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | Indicadores Economicos Chili |
| ID | WA104381100 |
| Office 365 clients pris en charge | Excel 2013 Service Pack 1 ou version ultérieure sur Windows, Excel sur le Web, Excel 2016 ou version ultérieure sur Mac |
| Nom de la société partenaire | Birdie |
| Site web de la société | [https://www.birdie.cl](https://www.birdie.cl) |
| Conditions d’utilisation de l’application | [https://www.birdie.cl/software/privacidad](https://www.birdie.cl/software/privacidad) |
| Fonctionnalités principales de l’application | Obt&#233;n el valor de la Unidad de Fomento (UF), Euro, D&#243;lar y UTM de Chile de manera sencilla |
| Emplacement du siège social de la société | Chili |
...
Ces informations ont été fournies par Birdie sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
