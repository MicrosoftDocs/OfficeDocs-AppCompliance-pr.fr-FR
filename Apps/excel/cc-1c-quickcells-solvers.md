---
title: Informations d’application pour les solveurs QuickCells par CC-1C
ms.author: elmalova
author: elenamalova
ms.date: 01/05/2021
ms.topic: article
...
description: Toutes les informations de sécurité et de conformité disponibles pour QuickCells Solvers, ses politiques de traitement des données, ses informations sur le catalogue d’applications Microsoft Cloud App Security et les informations de sécurité et de conformité dans le registre STAR de l’ASC.
...
* <a href="https://appsource.microsoft.com/product/office/WA200001864" target="_blank">Voir dans AppSource</a>
