...
<p>Dernière mise à jour par le développeur : 7 juin 2022</p>
...
Informations fournies par Celigo CloudExtend à Microsoft :

| **Information** | **Réponse** |
|:----------------|:-------------|
| Nom de l'application | CloudExtend Analytics pour NetSuite |
| ID | WA200002784 |
| Office 365 clients pris en charge | Excel 2016 ou version ultérieure sur Mac, Excel 2016 ou version ultérieure sur Windows, Excel sur le Web |
| Nom de la société partenaire | Celigo CloudExtend |
| Site web de la société | [https://www.cloudextend.io](https://www.cloudextend.io) |
| Conditions d’utilisation de l’application | [https://www.cloudextend.io/agreements/ssa/2019-12/](https://www.cloudextend.io/agreements/ssa/2019-12/) |
| Fonctionnalités principales de l’application | Pour les utilisateurs NetSuite, CloudExtend Analytics pour NetSuite (CEAN) visualisera vos données pour fournir tous les insights dont vous avez besoin pour prendre la bonne décision commerciale au bon moment. CEAN est un outil qui fournit tous les outils nécessaires pour personnaliser et contrôler vos données afin d’obtenir des insights sur vos données NetSuite. |
| Emplacement du siège social de la société | États-Unis d’Amérique |
| Page d’informations sur l’application | [https://www.cloudextend.io/netsuite/excel-integration/p/ana...](https://www.cloudextend.io/netsuite/excel-integration/p/analytics-for-netsuite/) |
...
Ces informations ont été fournies par Celigo CloudExtend sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont traitées par votre application ? | Données métier de l’utilisateur qu’il a choisi de traiter via notre application. |
...
| Date de certification SOC1 la plus récente | 2022-03-24 |
...
| URL de la politique de confidentialité | https://www.cloudextend.io/privacy/ |
...
| Si votre application n’utilise pas l’une des bibliothèques ci-dessus, quelle bibliothèque ou bibliothèque d’authentification utilise-t-elle ? | Flux de code d’autorisation OAuth 2.0 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Files.ReadWrite.All | application | pour mettre régulièrement à jour les classeurs Excel avec les données les plus récentes | [7040f194-bf08-400e-acb1-69df7939416a](../azure/7040f194-bf08-400e-acb1-69df7939416a.md) |
>| Sites.ReadWrite.All | application | pour obtenir les informations sur le fonctionnement d’Excel sur lequel l’utilisateur travaille s’il se trouve à l’emplacement SharePoint | [7040f194-bf08-400e-acb1-69df7939416a](../azure/7040f194-bf08-400e-acb1-69df7939416a.md) |
>| offline_access | Délégué | pour pouvoir écrire dans Excel lorsque le client n’est pas connecté. Cela est nécessaire, car nous avons planifié des tâches qui écrivent des données dans des tables Excel | [7040f194-bf08-400e-acb1-69df7939416a](../azure/7040f194-bf08-400e-acb1-69df7939416a.md) |
