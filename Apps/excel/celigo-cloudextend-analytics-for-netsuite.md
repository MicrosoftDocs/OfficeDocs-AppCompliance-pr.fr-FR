...
| ID | WA200002784 |
| Clients Office 365 pris en charge | Excel 2016 ou une édition ultérieure sur Mac, Excel 2016 ou une ultérieure sur Windows, Excel sur le web |
...
>|:----------------|:--------------------|:---------------------------------------------------|:--------------------------|:--------------------------|
>| Directory.Read.All | les deux | Lire la collection de sites pour lesquels l’utilisateur a accès pour obtenir des informations sur le workbook partagé par le biais de sites | store siteid to access the workbook offline. | 7040f194-bf08-400e-acb1-69df7939416a |
>| Files.ReadWrite.All | les deux | Lire le contenu du workbook comme des tableaux et des feuilles et pouvoir écrire du contenu dans ces tableaux | détails du workbook tels que l’URL web, l’ID du workbook et l’emplacement du workbook pour y accéder hors connexion | 7040f194-bf08-400e-acb1-69df7939416a |
...
>|:-------------------|:--------------------------|:--------------------------|
>| Chargebee, NetSuite, Salesforce, Intercom, LogBeeet, Amazon AWS | Nom de l’organisation, numéro de compte NetSuite, adresses de messagerie du domaine de l’organisation, informations de contact de facturation | Mise en service des licences, validation et support client de facturation, dépannage et gestion des comptes |
...
<iframe height='1020' title='Informations sur la sécurité des applications Microsoft Cloud' src='https://appmcasinfoprod.azurewebsites.net/#/dashboard/14008' frameborder='no' style='width: 100%;'></iframe>

<a href="https://appmcasinfoprod.azurewebsites.net/#/dashboard/14008" target="_blank">Afficher dans un nouvel onglet</a>
