---
title: Informations d’application pour la gestion des événements par SharePoint| Sapiens
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/23/2022
...
* <a href="https://teams.microsoft.com/l/app/2b8b9b59-d595-46b3-ba0a-602024bab0cc" target="_blank">Afficher dans Teams magasin</a>
...
| Fonctionnalités principales de l’application | Le complément Gestion des événements vous aide à organiser différents types d’événements. Les événements peuvent être planifiés en peu de temps en quelques étapes simples. Les participants peuvent s’inscrire en ligne en un seul clic. En tant qu’organisateur, vous pouvez également inscrire des utilisateurs internes ou externes pour le compte ou envoyer des invitations par e-mail. Les participants reçoivent des demandes de réunion et des mises à jour par e-mail pour s’assurer qu’ils ont toujours les informations les plus récentes dans leur calendrier Outlook. Le complément effectue le suivi de tous les participants au même endroit. |
