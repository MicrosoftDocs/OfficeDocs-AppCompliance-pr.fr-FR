---
title: Informations d’application pour do!book CB by Digital Office Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/20/2021
...
* <a href="https://teams.microsoft.com/l/app/92abac76-5f78-472f-8dfa-e7c23564cd92" target="_blank">Afficher dans Teams magasin</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002597" target="_blank">Afficher dans AppSource</a>
...
| Nom de la société partenaire | Digital Office Inc. |
| Site web de la société | [https://www.do-tools.net](https://www.do-tools.net) |
| Conditions d’utilisation de l’application | [https://www.do-tools.net/agreements/legal/dobookCB_Terms.pdf](https://www.do-tools.net/agreements/legal/dobookCB_Terms.pdf) |
| Fonctionnalités principales de l’application | Rendez les réunions encore plus pratiques avec le conseil&quot; de &quot;partage de matériel! |
| Emplacement du siège social de la société | Japon |
| Page d’informations sur l’application | [https://www.do-tools.net](https://www.do-tools.net) |
...
Ces informations ont été fournies par Digital Office Inc. sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
