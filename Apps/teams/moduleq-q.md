---
title: Informations sur l’application pour Q by ModuleQ
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/31/2022
...
| Fonctionnalités principales de l’application | Q fonctionne comme un collègue approuvé, en suivant le focus de votre client et en vous envoyant les actualités métier que vous devez voir avant de devoir demander. Optimisé par ModuleQ AI et knowledge Graph de Thomson Reuters. |
...
| Quelles données sont traitées par votre application ? | Données de profil utilisateur, métadonnées de messagerie utilisateur, métadonnées de calendrier utilisateur |
