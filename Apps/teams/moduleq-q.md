...
| Quelles données sont stockées dans vos bases de données ? | Données de profil utilisateur, métadonnées de messagerie de l’utilisateur, métadonnées de calendrier utilisateur |
