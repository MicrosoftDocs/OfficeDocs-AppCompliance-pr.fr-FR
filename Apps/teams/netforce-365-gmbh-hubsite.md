---
title: Informations sur l’application hubsite 365 par NetForce 365
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/27/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour HubSite 365, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le Registre CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/ef56f507-2c71-4bb1-ba4a-0a7016f7a210" target="_blank">Afficher dans Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003704" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par NetForce 365 Contrôleh à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | HubSite 365 |
| ID | WA200003704 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | NetForce 365 GmbH |
| Site web de l’entreprise | [https://www.netforce365.com](https://www.netforce365.com) |
| Conditions d’utilisation de l’application | [https://netforce365.com/en/tus](https://netforce365.com/en/tus) |
| Fonctionnalités principales de l’application | Recherchez et partagez les actualités, les connaissances et les événements les plus récents Microsoft 365. |
...
Ces informations ont été fournies par NetForce 365 StoresH sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont stockées dans vos bases de données ? | Adresse de messagerie de l’utilisateur, prénom et nom |
...
| URL de la politique de confidentialité | https://teams.hubsite365.com/privacy-policy |
