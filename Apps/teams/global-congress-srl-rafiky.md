...
| Site web de l’entreprise | [https://rafiky.net/en/](https://rafiky.net/en/) |
| Conditions d’utilisation de l’application | [https://rafiky.net/en/terms-conditions/](https://rafiky.net/en/terms-conditions/) |
| Fonctionnalités principales de l’application | Cette solution de plateforme cloud extrêmement flexible et accessible est conçue pour effectuer une interprétation simultanée à distance de vos événements en ligne. Il&#8217;une vision unique et innovantes de l’interprétation à distance . Il permet aux interpréteurs professionnels de travailler n’importe où à tout moment. |
