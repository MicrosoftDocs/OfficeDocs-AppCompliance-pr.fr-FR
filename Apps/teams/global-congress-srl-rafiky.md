---
title: Informations d’application pour Rafiky par GLOBAL CONGRESS SRL
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/20/2021
...
description: Toutes les informations de sécurité et de conformité disponibles pour Rafiky, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/c4661f80-2c9c-42d4-aec5-5ed6d64adb4d" target="_blank">Afficher dans Teams magasin</a>
...
Informations fournies par la SRL GLOBAL CONGRESS à Microsoft :
...
| Site web de la société | [https://rafiky.net/en/](https://rafiky.net/en/) |
| Conditions d’utilisation de l’application | [https://rafiky.net/en/terms-conditions/](https://rafiky.net/en/terms-conditions/) |
| Fonctionnalités principales de l’application | Rafiky est une solution de plateforme cloud extrêmement flexible et accessible conçue pour effectuer une interprétation simultanée à distance de vos événements en ligne. Il&#8217;une vision unique et innovante de l’interprétation à distance; il permet aux interprètes professionnels de travailler n’importe où à tout moment. |
...
Ces informations ont été fournies par global CONGRESS SRL sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
