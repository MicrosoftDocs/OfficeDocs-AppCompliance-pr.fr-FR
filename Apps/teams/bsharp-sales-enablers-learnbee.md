---
title: Informations sur l’application pour Learnbee par les personnes qui activent les ventes Bsharp
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/10/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour Learnbee, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le Registre CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/222090f5-29ca-4375-aa96-248079d4cacc" target="_blank">Afficher dans Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003761" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Bsharp Sales Enablers à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | Learnbee |
| ID | WA200003761 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | Bsharp Sales Enablers |
| Site web de l’entreprise | [https://learnbee.com](https://learnbee.com) |
| Conditions d’utilisation de l’application | [https://learnbee.com/terms/](https://learnbee.com/terms/) |
| Fonctionnalités principales de l’application | LearnBee vous aide à impliquer votre équipe de premier plan dans l’apprentissage.  |
| Emplacement du siège social de l’entreprise | Inde |
| Page d’informations sur l’application | [https://learnbee.com](https://learnbee.com) |
...
Ces informations ont été fournies par Bsharp Sales Enablers sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| URL de la politique de confidentialité | https://learnbee.com/privacy |
