---
title: Informations sur l’application pour Org@Work par Lundano
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/10/2021
...
ms.locfileid: "64878641"
---
# <a name="orgwork"></a>Org@Work

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Dernière mise à jour par le développeur : 10 août 2021</p>

* <a href="https://teams.microsoft.com/l/app/b9f5d3b0-424e-473d-bcbe-dd01f17f9a41" target="_blank">Afficher dans Teams magasin</a>
...
| Site web de la société | [https://www.lundano.com/en/](https://www.lundano.com/en/) |
| Conditions d’utilisation de l’application | [https://cp.lundano.com/Terms_en.html](https://cp.lundano.com/Terms_en.html) |
| Fonctionnalités principales de l’application | Gérer votre organisation professionnelle et l’occupation des bureaux avec des planifications collaboratives |
| Emplacement du siège social de la société | France |
| Page d’informations sur l’application | [https://www.lundano.com/orgatwork/index.html#](https://www.lundano.com/orgatwork/index.html#) |
...
Lundano a fourni ces informations sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Répertorier les types de stratégies prises en charge | Employé, Responsable de planification et Administrateur |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Délégué | Nous stockons des données. Nous utilisons simplement les données pour connecter l’utilisateur à Org@work | [aa1c54a1-f482-424d-9389-dbd131233483](../azure/aa1c54a1-f482-424d-9389-dbd131233483.md) |
>| email | Délégué | Nous stockons des données. Nous utilisons simplement les données pour connecter l’utilisateur à Org@work | [aa1c54a1-f482-424d-9389-dbd131233483](../azure/aa1c54a1-f482-424d-9389-dbd131233483.md) |
>| offline_access | Délégué | Nous stockons des données. Nous utilisons simplement les données pour connecter l’utilisateur à Org@work | [aa1c54a1-f482-424d-9389-dbd131233483](../azure/aa1c54a1-f482-424d-9389-dbd131233483.md) |
>| openid | Délégué | Nous stockons des données. Nous utilisons simplement les données pour connecter l’utilisateur à Org@work | [aa1c54a1-f482-424d-9389-dbd131233483](../azure/aa1c54a1-f482-424d-9389-dbd131233483.md) |
>| profil | Délégué | Nous stockons des données. Nous utilisons simplement les données pour connecter l’utilisateur à Org@work | [aa1c54a1-f482-424d-9389-dbd131233483](../azure/aa1c54a1-f482-424d-9389-dbd131233483.md) |
