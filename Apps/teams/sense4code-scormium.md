---
title: Informations sur l’application pour Scormium by Sense4code
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/30/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour Scormium, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/ad42b2ed-c5ad-4f2c-99e3-5da268a9c967" target="_blank">Afficher dans le magasin Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004358" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Sense4code à Microsoft :

| **Information** | **Réponse** |
|:----------------|:-------------|
| Nom de l'application | Scormium |
| ID | WA200004358 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | Sense4code |
| Site web de la société | [https://en.scormium.com](https://en.scormium.com) |
| Conditions d’utilisation de l’application | [https://en.scormium.com/podminky-a-pravidla-uziti](https://en.scormium.com/podminky-a-pravidla-uziti) |
| Fonctionnalités principales de l’application | Profitez de la puissance de e-learning, événements, et des chemins d’étude avec Scormium.  |
...
Ces informations ont été fournies par Sense4code sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont traitées par votre application ? | E-mail de l’utilisateur   |
| L’application prend-elle en charge TLS 1.1 ou version ultérieure ? | Non |
...
| URL de la politique de confidentialité | https://en.scormium.com/zasady-ochrany-soukromi |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Délégué | Activer la connexion et lire le profil utilisateur | [ffdbe361-6168-42f7-beef-d1931b7922da](../azure/ffdbe361-6168-42f7-beef-d1931b7922da.md) |
