---
title: Informations sur l’application pour Stack Overflow pour Teams par Stack Overflow
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/30/2022
...
ms.locfileid: "66656159"
---
# <a name="stack-overflow-for-teams"></a>Stack Overflow pour Teams

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Dernière mise à jour par le développeur : 11 octobre 2021</p>

* <a href="https://teams.microsoft.com/l/app/4783e622-5303-4ea7-a211-ef0dd405da73" target="_blank">Afficher dans le magasin Teams</a>
...
| Site web de la société | [https://www.stackoverflow.com](https://www.stackoverflow.com) |
| Conditions d’utilisation de l’application | [https://stackoverflow.com/legal/terms-of-service/teams](https://stackoverflow.com/legal/terms-of-service/teams) |
| Fonctionnalités principales de l’application | Stack Overflow pour Teams est une maison privée et sécurisée pour votre équipe&#8217;questions et réponses. Plus besoin de parcourir les wikis obsolètes et les e-mails perdus&#8212;donner à votre équipe le temps dont elle a besoin pour créer de meilleurs produits. Stack Overflow pour Teams&#8217; intégration à Microsoft Teams connecte votre conversation Microsoft Teams et votre référentiel de connaissances interne. Restez à jour avec les notifications de nouvelles informations, recherchez des réponses existantes, voire démarrez votre question directement à partir de la plateforme Microsoft Teams. |
| Emplacement du siège social de la société | États-Unis d’Amérique |
| Page d’informations sur l’application | [https://stackoverflow.co/teams/integrations/microsoft-teams](https://stackoverflow.co/teams/integrations/microsoft-teams) |
...
| Quelles données sont traitées par votre application ? | Les informations MS Teams sont collectées et traitées par l’application pour être affichées et les références dans l’environnement Stack Overflow pour Teams d’un client. |
| L’application prend-elle en charge TLS 1.1 ou version ultérieure ? | Oui |
| L’application ou l’infrastructure sous-jacente stocke-t-elle des données client Microsoft ? | Oui |
| Quelles données sont stockées dans vos bases de données ? | Informations d’accès à l’API MS Teams |
...
| URL de la politique de confidentialité | https://stackoverflow.com/legal/privacy-policy/integrations/ms-teams/teams-basic-business |
