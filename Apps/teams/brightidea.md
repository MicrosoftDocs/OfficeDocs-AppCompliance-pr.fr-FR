...
<p>Dernière mise à jour par le développeur le: Avril 14, 2021</p>

* <a href="https://teams.microsoft.com/l/app/b37e415d-60f4-416d-81d6-2c5ab0b52ef6" target="_blank">Vue dans Teams magasin</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002795" target="_blank">Voir dans AppSource</a>
...
| ID | WA200002795 WA200002795 |
| Office 365 clients soutenus | Microsoft Teams |
| Nom de l’entreprise partenaire | Brightidea |
...
Ces informations ont été fournies par Brightidea sur la façon dont cette application recueille et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
>|:-------------------|:--------------------------|:--------------------------|
>| Amazon Web Services (AWS) | adresse e-mail/domaine | Pour faire correspondre les auteurs d’idées Teams à leur compte Brightidea; notre base de données d’utilisateurs est dans AWS |
...
<iframe height='1020' title='Microsoft Cloud App Security information' src='https://appmcasinfoprod.azurewebsites.net/#/dashboard/13199' frameborder='no' style='width: 100%;'></iframe>
...
Ces informations ont été fournies par Brightidea sur la façon dont cette application gère l’authentification, l’autorisation, les meilleures pratiques d’enregistrement des applications et d’autres critères d’identité.
