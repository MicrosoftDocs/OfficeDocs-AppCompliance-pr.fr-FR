---
title: Informations sur l’application pour Zest par Zestmeup
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/28/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour Zest, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/2ce8e701-c302-47ff-9061-2bb819681f96" target="_blank">Afficher dans le magasin Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004458" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Zestmeup à Microsoft :

| **Information** | **Réponse** |
|:----------------|:-------------|
| Nom de l'application | Zeste |
| ID | WA200004458 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | Zestmeup |
| Site web de la société | [https://zestmeup.com](https://zestmeup.com) |
| Conditions d’utilisation de l’application | [https://zestmeup.com/en/terms-of-use](https://zestmeup.com/en/terms-of-use) |
| Fonctionnalités principales de l’application | Qu’il s’agit d’enquêtes sur les RH ou d’examens annuels du rendement, numérisez l’expérience des employés avec la solution simple et efficace de Zest. L’intégration à Microsoft Teams vous permet de recevoir des notifications sur les actions en cours ou à effectuer dans l’application Zest. |
...
| Quels fournisseurs de cloud d’hébergement l’application utilise-t-elle ? | OVH |
...
Ces informations ont été fournies par Zestmeup sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| URL de la politique de confidentialité | https://zestmeup.com/en/privacy-policy/ |
