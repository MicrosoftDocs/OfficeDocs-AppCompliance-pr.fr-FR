---
title: Informations sur les applications pour Skillsoft Percipio par Skillsoft
ms.author: elmalova
author: elenamalova
ms.date: 10/26/2021
ms.topic: article
...
description: Toutes les informations de sécurité et de conformité disponibles pour Skillsoft Percipio, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le Registre CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/858597e0-33db-4cc0-bd1e-466b6ceb977a" target="_blank">Afficher dans Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003256" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Skillsoft à Microsoft :

| **Information** | **Réponse** |
|:----------------|:-------------|
| Nom de l'application | Skillsoft Percipio |
| ID | WA200003256 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | Skillsoft |
| Site web de l’entreprise | [https://www.skillsoft.com](https://www.skillsoft.com) |
| Conditions d’utilisation de l’application | [https://www.skillsoft.com/terms-of-use](https://www.skillsoft.com/terms-of-use) |
| Fonctionnalités principales de l’application | Skillsoft Percipio donne accès à la suite complète de contenu et de fonctionnalités de formation Percipio. |
...
Ces informations ont été fournies par Skillsoft sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
