...
| Site web de l’entreprise | [https://app.fifty.do](https://app.fifty.do) |
| Conditions d’utilisation de l’application | [https://app.fifty.do/CGUV.pdf](https://app.fifty.do/CGUV.pdf) |
| Fonctionnalités principales de l’application | 50 vous aident à passer de la connaissance à l’action en vous offrant des défis personnalisés. Ces défis vous aideront à consolider ou à améliorer certaines de vos compétences de base. |
