---
title: Informations sur l’application pour Fifty by Fifty
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: Toutes les informations de sécurité et de conformité disponibles pour Fifty, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
ms.locfileid: "64875421"
---
# <a name="fifty"></a>Fifty

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Dernière mise à jour par le développeur : 7 juin 2021</p>

* <a href="https://teams.microsoft.com/l/app/383cc171-22d5-4df5-87d0-6c656ddcff32" target="_blank">Afficher dans Teams magasin</a>
...
Informations fournies par Fifty à Microsoft :
...
| Site web de la société | [https://app.fifty.do](https://app.fifty.do) |
| Conditions d’utilisation de l’application | [https://app.fifty.do/CGUV.pdf](https://app.fifty.do/CGUV.pdf) |
| Fonctionnalités principales de l’application | Cinquante vous aident à passer de la connaissance à l’action en vous offrant des défis personnalisés. Ces défis vous aideront à consolider ou à améliorer certaines de vos compétences de base. |
| Emplacement du siège social de la société | France |
| Page d’informations sur l’application | [https://www.fifty.do](https://www.fifty.do) |
...
Ces informations ont été fournies par Fifty sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
