...
| Quelles données sont stockées dans vos bases de données ? | Prénom, nom, nom de client |
...
| URL de la politique de confidentialité | https://superquickquestion.com/privacy-policy/ |
...
>|:------------------------|:--------------------|:------------------------------------|
>| Chat.ReadBasic | délégué | Obtenir le nombre de participants dans une conversation |
>| openid | délégué | Connectez-vous aux utilisateurs de l’application pour accéder au point Graph de terminaison |
>| User.Read | délégué | Lire le nom du client utilisateur |
