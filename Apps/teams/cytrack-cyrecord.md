---
title: Informations sur l’application pour CyRecord par CyTrack
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/23/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour CyRecord, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/4073224c-6e1d-4e72-a754-510d91279b3b" target="_blank">Afficher dans le magasin Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004280" target="_blank">Afficher dans AppSource</a>
...
| Fonctionnalités principales de l’application | CyRecord s’adresse aux utilisateurs professionnels qui ont besoin de fonctionnalités avancées pour l’enregistrement vocal de vos appels téléphoniques Microsoft Teams externes.   L’enregistrement des appels fournit des faits indéniables sur les appels téléphoniques, ce qui entraîne un règlement plus rapide des différends. Améliorez le service à la clientèle grâce à l’écoute et à la formation et respectez les exigences réglementaires. |
| Emplacement du siège social de la société | Australie |
| Page d’informations sur l’application | [https://web.cytrack.com/microsoft-teams/call-recording-for-...](https://web.cytrack.com/microsoft-teams/call-recording-for-microsoft-teams/) |
