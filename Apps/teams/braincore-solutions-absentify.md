---
title: Informations sur l’application pour l’absence de solutions BrainCore
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/07/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour l’absence, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/fbd349eb-146f-4e94-af76-df4754f40749" target="_blank">Afficher dans Teams magasin</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003833" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par BrainCore Solutions à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | absentify |
| ID | WA200003833 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | BrainCore Solutions |
| Site web de la société | [https://braincore.solutions](https://braincore.solutions) |
| Conditions d’utilisation de l’application | [https://absentify.com/terms-and-conditions](https://absentify.com/terms-and-conditions) |
| Fonctionnalités principales de l’application | Le moyen le plus simple de gérer les congés des employés - en Microsoft Teams |
| Emplacement du siège social de la société | Suisse |
| Page d’informations sur l’application | [https://absentify.com](https://absentify.com) |
...
Ces informations ont été fournies par BrainCore Solutions sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont traitées par votre application ? | ID d’utilisateur Microsoft, E-mail, DisplayName |
| L’application prend-elle en charge TLS 1.1 ou version ultérieure ? | Oui |
| L’application ou l’infrastructure sous-jacente stocke-t-elle des données client Microsoft ? | Oui |
| Quelles données sont stockées dans vos bases de données ? | ID d’utilisateur Microsoft, E-mail, DisplayName |
...
| URL de la politique de confidentialité | https://absentify.com/privacy-policy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| TeamsActivity.Send | application | Facultatif. Pour envoyer des notifications à Microsoft Teams. | [0f5eabc0-89bf-4cc6-80d1-10094b5919d2](/microsoft-365-app-certification/azure/0f5eabc0-89bf-4cc6-80d1-10094b5919d2) |
>| Calendars.ReadWrite | Délégué | Facultatif : pour créer automatiquement une entrée de calendrier Outlook pour les absences. | [3dbcb38b-8d2f-4e97-9bd1-975fb770b31c](/microsoft-365-app-certification/azure/3dbcb38b-8d2f-4e97-9bd1-975fb770b31c) |
>| User.Read | Délégué | Pour la connexion | [4dce2abf-3f8e-4281-9f7a-d602fc391886](/microsoft-365-app-certification/azure/4dce2abf-3f8e-4281-9f7a-d602fc391886) |
>| User.ReadBasic.All | Délégué | Facultatif : pour afficher les images de profil Microsoft des utilisateurs. | [4dce2abf-3f8e-4281-9f7a-d602fc391886](/microsoft-365-app-certification/azure/4dce2abf-3f8e-4281-9f7a-d602fc391886) |
