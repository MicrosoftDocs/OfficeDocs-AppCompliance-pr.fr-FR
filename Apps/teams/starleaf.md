...
* <a href="https://teams.microsoft.com/l/app/220b3db0-e3be-40df-8148-f0e0c33a986a" target="_blank">Vue dans Teams magasin</a>
* <a href="https://appsource.microsoft.com/product/office/WA200000185" target="_blank">Voir dans AppSource</a>
...
>|:--------------------------------|:---------------------|:--------------------------|
>| Le bot accède à la liste de l’équipe afin de réserver une réunion au nom de l’utilisateur/hôte qui réserve la réunion via le bot. Cela permet à StarLeaf de fournir une expérience de jointure transparente avec un seul bouton pour rejoindre les réunions. | Prénom, nom de famille, adresse e-mail. Cela permet au bot StarLeaf de réserver une réunion au nom de l’utilisateur/hôte qui a interagi avec le bot, et d’inviter les autres membres de l’équipe à la réunion. |  |
