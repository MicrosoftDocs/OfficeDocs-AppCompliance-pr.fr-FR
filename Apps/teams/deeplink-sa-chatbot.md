---
title: Informations sur l’application pour Deeplink Chatbot by Deeplink SA
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/13/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour Deeplink Chatbot, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
ms.locfileid: "66547154"
---
# <a name="deeplink-chatbot"></a>Deeplink Chatbot

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Dernière mise à jour par le développeur : 13 juin 2022</p>

* <a href="https://teams.microsoft.com/l/app/9f859fc4-0b17-4bf7-abff-f50a73cbe5ab" target="_blank">Afficher dans le magasin Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004200" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Deeplink SA à Microsoft :

| **Information** | **Réponse** |
|:----------------|:-------------|
| Nom de l'application | Deeplink Chatbot |
| ID | WA200004200 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | Deeplink SA |
| Site web de la société | [https://www.deeplink.ai](https://www.deeplink.ai) |
| Conditions d’utilisation de l’application | [https://www.deeplink.ai/en/terms/](https://www.deeplink.ai/en/terms/) |
| Fonctionnalités principales de l’application | Deeplink vous permet de configurer un chatbot entièrement personnalisable, également appelé agent conversationnel, optimisé avec l’IA et d’y accéder dans Microsoft Teams, au cœur de vos interactions quotidiennes. Avec Teams, vous ajoutez un nouveau point de contact à un assistant existant et vous fournissez un accès direct aux services améliorés tels qu’un support informatique, un bot de didacticiel ou un agent de configuration. |
| Emplacement du siège social de la société | Suisse |
| Page d’informations sur l’application | [https://www.deeplink.ai/en/integrations/msteams/](https://www.deeplink.ai/en/integrations/msteams/) |
...
Ces informations ont été fournies par Deeplink SA sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont traitées par votre application ? | ID client |
| L’application prend-elle en charge TLS 1.1 ou version ultérieure ? | Oui |
| L’application ou l’infrastructure sous-jacente stocke-t-elle des données client Microsoft ? | Oui |
| Quelles données sont stockées dans vos bases de données ? | ID client |
