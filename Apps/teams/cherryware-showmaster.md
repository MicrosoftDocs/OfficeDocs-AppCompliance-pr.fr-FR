...
ms.locfileid: "66892037"
---
# <a name="showmaster"></a>Showmaster

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Dernière mise à jour par le développeur : 5 juillet 2022</p>

* <a href="https://teams.microsoft.com/l/app/8c9f8e8e-fe2d-4542-84ab-1d30c4a735fc" target="_blank">Afficher dans le magasin Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004411" target="_blank">Afficher dans AppSource</a>
...
| Fonctionnalités principales de l’application | Showmaster crée un cadre passionnant autour de votre conversation pendant le temps d’attente et se brise avec les titres, compte à rebours, la musique et plus encore. |
