...
| Site web de l’entreprise | [https://www.manageengine.com/products/service-desk](https://www.manageengine.com/products/service-desk) |
| Conditions d’utilisation de l’application | [https://ondemand.manageengine.com/terms.html](https://ondemand.manageengine.com/terms.html) |
| Fonctionnalités principales de l’application | ServiceDesk Plus est un logiciel de gestion du service d’aide informatique SaaS. Grâce à l’éventail de fonctionnalités de gestion des services IT, il permet aux responsables de l’information d’organiser efficacement les opérations du service d’aide au sein de l’organisation. Par défaut, ServiceDesk Plus (Cloud) fonctionne avec Azure AD. To get started, sign up for ServiceDesk Plus (Cloud) using an account in your instance of Azure AD. |
| Emplacement du siège social de l’entreprise | États-Unis d’Amérique |
| Page d’informations sur l’application | [https://help.sdpondemand.com/servicedeskplus_cloud_for_teams](https://help.sdpondemand.com/servicedeskplus_cloud_for_teams) |
...
| Quelles données sont stockées dans vos bases de données ? | User id,User Name, Email address |
...
| Liste des types de stratégies pris en charge | Authentification multifacteur, utilisation d’appareils gérés par l’organisation pour des applications spécifiques, blocage des comportements de signature à risque, limitation de l’accès accordé à des personnes autres que les rôles d’administration  |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | délégué | Activer la connexion et lire le profil utilisateur | [127e5be9-da2c-4335-a284-da367379428a](../azure/127e5be9-da2c-4335-a284-da367379428a.md) |
>| offline_access | délégué | Gérer l’accès aux données auxquelles vous avez accordé l’accès | [127e5be9-da2c-4335-a284-da367379428a](../azure/127e5be9-da2c-4335-a284-da367379428a.md) |
