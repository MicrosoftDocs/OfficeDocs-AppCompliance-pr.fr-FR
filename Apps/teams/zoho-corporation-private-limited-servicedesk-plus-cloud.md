...
* <a href="https://teams.microsoft.com/l/app/04fdcea1-3511-499c-966d-099d59aef45f" target="_blank">Afficher dans Teams magasin</a>
...
| Site web de la société | [https://www.manageengine.com/products/service-desk](https://www.manageengine.com/products/service-desk) |
...
| Fonctionnalités principales de l’application | ServiceDesk Plus est un logiciel de gestion du support technique informatique SaaS. Avec la pléthore de fonctionnalités pour la gestion des services informatiques, il aide les responsables informatiques à organiser efficacement les opérations du support technique au sein de l’organisation. Par défaut, ServiceDesk Plus (Cloud) fonctionne avec Azure AD. Pour commencer, inscrivez-vous à ServiceDesk Plus (Cloud) à l’aide d’un compte dans votre instance de Azure AD. |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Délégué | Activer la connexion et lire le profil utilisateur | [127e5be9-da2c-4335-a284-da367379428a](/microsoft-365-app-certification/azure/39cb9f28-b9d0-4bf7-a4f4-d9e38508a0db) |
>| offline_access | Délégué | Gérer l’accès aux données auxquelles vous avez accordé l’accès | [127e5be9-da2c-4335-a284-da367379428a](/microsoft-365-app-certification/azure/39cb9f28-b9d0-4bf7-a4f4-d9e38508a0db) |
