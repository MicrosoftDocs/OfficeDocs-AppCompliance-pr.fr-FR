---
title: Informations d’application pour researcHR
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/20/2021
...
---
# <a name="application-information-for-researchr"></a>Informations sur l’application pour researcHR
...
| Site web de la société | [https://app.researchr.work/corporate](https://app.researchr.work/corporate) |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Channel.Create | application | Nous utilisons cette étendue pour permettre à notre bot de créer un canal sur le client Teams. Voir: https://docs.microsoft.com/en-us/graph/api/channel-post | [82df726e-0de2-46af-b4f1-0645fd95fc97](../azure/82df726e-0de2-46af-b4f1-0645fd95fc97.md) |
