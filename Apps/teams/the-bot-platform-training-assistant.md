---
title: Assistant Informations sur l’application pour la formation par la plateforme Bot
ms.author: elmalova
author: elenamalova
ms.date: 12/07/2021
ms.topic: article
...
description: Toutes les informations de sécurité et de conformité disponibles pour l’Assistant Formation, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le Registre CSA STAR.
...
ms.locfileid: "61350312"
---
# <a name="training-assistant"></a>Assistant Formation

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Last updated by the developer on: August 2, 2021</p>

* <a href="https://teams.microsoft.com/l/app/40049dbc-3781-491d-ad2e-d59009538e45" target="_blank">Afficher dans Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003547" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par la plateforme bot à Microsoft :

| **Information** | **Réponse** |
|:----------------|:-------------|
| Nom de l'application | Assistant Formation |
| ID | WA200003547 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | Plateforme bot |
| Site web de l’entreprise | [https://thebotplatform.com](https://thebotplatform.com) |
| Conditions d’utilisation de l’application | [https://thebotplatform.com/wp-content/uploads/2021/11/TBP-T...](https://thebotplatform.com/wp-content/uploads/2021/11/TBP-Training-Assistant-Customer-Terms-of-Use.pdf) |
| Fonctionnalités principales de l’application | Cet assistant numérique vous permet de prendre en compte une série de modules de formation qui couvrent tout ce que vous devez savoir pour vous installer et travailler sur Teams. Chaque module contient des vidéos de didacticiel et du contenu de formation spécifiques pour vous assurer que votre personnel est pleinement informé de l’étendue des fonctionnalités disponibles sur Microsoft Teams et de leur utilisation. |
...
Ces informations ont été fournies par la plateforme bot sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont stockées dans vos bases de données ? | Prénom  |
...
| URL de la politique de confidentialité | https://thebotplatform.com/wp-content/uploads/2021/11/TBP-Training-Assistant-Privacy-Statement.pdf |
