---
title: Informations d’application pour SimplyDo by SimplyDo
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/20/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour SimplyDo, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/dbf692fe-35c1-4511-9178-9131e6511712" target="_blank">Afficher dans le magasin Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004248" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par SimplyDo à Microsoft :

| **Information** | **Réponse** |
|:----------------|:-------------|
| Nom de l'application | SimplyDo |
| ID | WA200004248 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | SimplyDo |
| Site web de la société | [https://www.simplydo.co.uk](https://www.simplydo.co.uk) |
| Conditions d’utilisation de l’application | [https://www.simplydo.co.uk/terms-of-use](https://www.simplydo.co.uk/terms-of-use) |
| Fonctionnalités principales de l’application | SimplyDo permet aux organisations de capturer les idées et les insights de l’ensemble du personnel, ce qui favorise l’amélioration continue et l’innovation. |
| Emplacement du siège social de la société | Royaume-Uni de Grande-Bretagne et d’Irlande du Nord (le) |
| Page d’informations sur l’application | [https://www.simplydo.co.uk/product](https://www.simplydo.co.uk/product) |
...
Ces informations ont été fournies par SimplyDo sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont traitées par votre application ? | Données de profil utilisateur (nom, service, titre du travail, e-mail). |
| L’application prend-elle en charge TLS 1.1 ou version ultérieure ? | Oui |
| L’application ou l’infrastructure sous-jacente stocke-t-elle des données client Microsoft ? | Oui |
| Quelles données sont stockées dans vos bases de données ? | Données de profil utilisateur (nom, service, titre du travail, e-mail) |
...
| URL de la politique de confidentialité | https://www.simplydo.co.uk/privacy-policy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Délégué | Pour accéder aux données de profil pour l’authentification unique | [dbf692fe-35c1-4511-9178-9131e6511712](../azure/dbf692fe-35c1-4511-9178-9131e6511712.md) |
>| email | Délégué | Pour prendre en charge les fonctionnalités /connexion OpenID Connect | [dbf692fe-35c1-4511-9178-9131e6511712](../azure/dbf692fe-35c1-4511-9178-9131e6511712.md) |
>| offline_access | Délégué | Pour prendre en charge les fonctionnalités /connexion OpenID Connect | [dbf692fe-35c1-4511-9178-9131e6511712](../azure/dbf692fe-35c1-4511-9178-9131e6511712.md) |
>| openid | Délégué | Pour prendre en charge les fonctionnalités /connexion OpenID Connect | [dbf692fe-35c1-4511-9178-9131e6511712](../azure/dbf692fe-35c1-4511-9178-9131e6511712.md) |
