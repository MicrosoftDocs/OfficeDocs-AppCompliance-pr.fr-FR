---
title: Informations sur l’application for Forza Board by Toolpack Solutions
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/29/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour forza Board, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
ms.locfileid: "66656317"
---
# <a name="forza-board"></a>Carte Forza

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Dernière mise à jour par le développeur : 13 juin 2022</p>

* <a href="https://teams.microsoft.com/l/app/b4db3055-5e98-4935-862e-7ffd42761eaa" target="_blank">Afficher dans le magasin Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004274" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Toolpack Solutions à Microsoft :

| **Information** | **Réponse** |
|:----------------|:-------------|
| Nom de l'application | Carte Forza |
| ID | WA200004274 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | Toolpack Solutions |
| Site web de la société | [https://www.toolpack365.com](https://www.toolpack365.com) |
| Conditions d’utilisation de l’application | [https://www.toolpack365.com/kontakt-og-vilkaar](https://www.toolpack365.com/kontakt-og-vilkaar) |
| Fonctionnalités principales de l’application | Libérez votre potentiel avec un indicateur de performance clé intelligent et des rapports pour une meilleure collaboration. |
...
Ces informations ont été fournies par Toolpack Solutions sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont traitées par votre application ? | e-mail et prénom |
| L’application prend-elle en charge TLS 1.1 ou version ultérieure ? | Oui |
| L’application ou l’infrastructure sous-jacente stocke-t-elle des données client Microsoft ? | Oui |
| Quelles données sont stockées dans vos bases de données ? | e-mail et prénom |
...
| URL de la politique de confidentialité | https://www.toolpack365.com/cookie-og-privatlivspolitik |
