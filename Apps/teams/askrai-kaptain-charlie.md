---
title: Informations d’application pour Kaptain Charlie par askR.ai
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 11/29/2021
...
description: Toutes les informations de sécurité et de conformité disponibles pour Kaptain Charlie, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
ms.locfileid: "64881411"
---
# <a name="kaptain-charlie"></a>Kaptain Charlie

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Dernière mise à jour par le développeur : 25 novembre 2021</p>

* <a href="https://teams.microsoft.com/l/app/1f36eaf6-30a3-4488-a73f-4754b91e865d" target="_blank">Afficher dans Teams magasin</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001583" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par askR.ai à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | Kaptain Charlie |
| ID | WA200001583 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | askR.ai |
| Site web de la société | [https://en.askr.ai](https://en.askr.ai) |
| Conditions d’utilisation de l’application | [https://en.askr.ai/terms-of-use-askr-ai](https://en.askr.ai/terms-of-use-askr-ai) |
| Fonctionnalités principales de l’application | Discutez avec vos données ! askR.ai est votre assistant Données personnelles Vous avez des données, mais vous n’aimez pas le processus technique pour y accéder ? Utilisez un assistant données pour répondre à vos questions et vous aider à explorer ! Qu’est-ce que askR.ai, le premier assistant données sur Microsoft Teams ? - Assistant Données personnelles alimenté par l’IA - Fournit des indicateurs de performance clés instantanés et des données viz - Comprendre le vocabulaire métier spécifique - Envoyer des alertes - Suggérer une analyse supplémentaire |
| Emplacement du siège social de la société | France |
| Page d’informations sur l’application | [https://en.askr.ai](https://en.askr.ai) |
...
Ces informations ont été fournies par askR.ai sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| URL de la politique de confidentialité | https://en.askr.ai/terms-of-use-askr-ai |
...
| Si votre application n’utilise pas l’une des bibliothèques ci-dessus, quelle bibliothèque ou bibliothèque d’authentification utilise-t-elle ? | Bibliothèque OAuth |
