---
title: Informations sur l’application pour l’envoi différé par Appfluence Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/27/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour l’envoi différé, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
ms.locfileid: "66247912"
---
# <a name="delayed-send"></a>Envoi différé

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Dernière mise à jour par le développeur : 21 juin 2022</p>

* <a href="https://teams.microsoft.com/l/app/ae64c32a-0eab-47d9-91e4-b693a99f7fc3" target="_blank">Afficher dans le magasin Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004301" target="_blank">Afficher dans AppSource</a>
...
| **Information** | **Réponse** |
|:----------------|:-------------|
| Nom de l'application | Envoi différé |
| ID | WA200004301 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | Appfluence Inc |
| Site web de la société | [https://appfluence.com](https://appfluence.com) |
| Conditions d’utilisation de l’application | [https://delayedsend.com/eula](https://delayedsend.com/eula) |
| Fonctionnalités principales de l’application | Planifiez l’envoi de vos messages à l’avenir à toute conversation privée ou de groupe. |
| Emplacement du siège social de la société | États-Unis d’Amérique |
| Page d’informations sur l’application | [https://delayedsend.com](https://delayedsend.com) |
...
| Quelles données sont traitées par votre application ? | Liste des conversations de groupe et personnelles dans Teams, afin d’aider l’utilisateur à choisir où envoyer un message. |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Chat.ReadBasic | Délégué | Afficher l’utilisateur qui est dans une conversation afin qu’il comprenne où il envoie son message | [93b661be-66e3-4468-b802-64bb952f1471](../azure/93b661be-66e3-4468-b802-64bb952f1471.md) |
>| ChatMessage.Send | Délégué | Envoyer un message au nom de notre utilisateur | [93b661be-66e3-4468-b802-64bb952f1471](../azure/93b661be-66e3-4468-b802-64bb952f1471.md) |
>| User.Read | Délégué | Connectez-vous à l’utilisateur et découvrez son nom. | [93b661be-66e3-4468-b802-64bb952f1471](../azure/93b661be-66e3-4468-b802-64bb952f1471.md) |
>| User.ReadBasic.All | Délégué | Consultez la liste des collaborateurs de l’utilisateur pour autoriser la sélection d’une destination pour son message différé | [93b661be-66e3-4468-b802-64bb952f1471](../azure/93b661be-66e3-4468-b802-64bb952f1471.md) |
>| offline_access | Délégué | Autoriser notre application à agir en tant qu’utilisateur au moment de la planification de la remise des messages | [93b661be-66e3-4468-b802-64bb952f1471](../azure/93b661be-66e3-4468-b802-64bb952f1471.md) |
