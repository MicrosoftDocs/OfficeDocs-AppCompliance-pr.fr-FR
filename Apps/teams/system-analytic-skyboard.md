---
title: Informations sur l’application pour SkyBoard par System Analytic
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/10/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour SkyBoard, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/9322b063-9069-45fc-aaad-e3a0f9a2462a" target="_blank">Afficher dans Teams magasin</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004162" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par System Analytic à Microsoft :

| **Information** | **Réponse** |
|:----------------|:-------------|
| Nom de l'application | SkyBoard |
| ID | WA200004162 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | Analyse système |
| Site web de la société | [https://www.systemanalytic.com](https://www.systemanalytic.com) |
| Conditions d’utilisation de l’application | [https://www.systemanalytic.com/eula.html](https://www.systemanalytic.com/eula.html) |
| Fonctionnalités principales de l’application | Un conseil consultatif numérique complet. |
...
Ces informations ont été fournies par System Analytic sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| URL de la politique de confidentialité | https://vmlyr-digitalsolutions.com/privacy.html |
