---
title: Informations d’application pour SupportRoom par MYSUPPORTROOM LTD
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/16/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour SupportRoom, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/c7004e7c-aa85-4e3e-9b00-47cf3adac85a" target="_blank">Afficher dans le magasin Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004238" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par MYSUPPORTROOM LTD à Microsoft :

| **Information** | **Réponse** |
|:----------------|:-------------|
| Nom de l'application | SupportRoom |
| ID | WA200004238 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | MYSUPPORTROOM LTD |
| Site web de la société | [https://mysupportroom.com](https://mysupportroom.com) |
| Conditions d’utilisation de l’application | [https://mysupportroom.com/terms-and-conditions/](https://mysupportroom.com/terms-and-conditions/) |
| Fonctionnalités principales de l’application | Soutien et insights en matière de santé mentale tout-en-un pour votre personnel |
...
Ces informations ont été fournies par MYSUPPORTROOM LTD sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
