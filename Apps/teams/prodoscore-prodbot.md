...
| **Information** | **Réponse** |
|:----------------|:-------------|
| Nom de l'application | Prodoscore ProdBot |
| ID | WA200002620 |
...
<br />
 | | Votre application expose-t-elle des API web ? | Aucun | | Votre application utilise-t-elle les API d'aperçu ? | Oui, | | Votre application utilise-t-elle des API dépréciées ? | Aucun |
