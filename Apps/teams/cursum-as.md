---
title: Informations sur l’application pour Cursum par Cursum A/S
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/15/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour Cursum, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
ms.locfileid: "66817638"
---
# <a name="cursum"></a>Cursum

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Dernière mise à jour par le développeur : 13 juin 2022</p>

* <a href="https://teams.microsoft.com/l/app/11db7a4c-d454-41b5-a9be-35a5acdd5c9e" target="_blank">Afficher dans le magasin Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004407" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Cursum A/S à Microsoft :

| **Information** | **Réponse** |
|:----------------|:-------------|
| Nom de l'application | Cursum |
| ID | WA200004407 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | Cursum A/S |
| Site web de la société | [https://cursum.com](https://cursum.com) |
| Conditions d’utilisation de l’application | [https://go.microsoft.com/fwlink/?linkid=2041178](https://go.microsoft.com/fwlink/?linkid=2041178) |
| Fonctionnalités principales de l’application | Cursum Core - Apprentissage dans le flux de travail |
...
Ces informations ont été fournies par Cursum A/S sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read.All | les deux | Lire les informations des utilisateurs | [962ef41c-0088-4cf2-b8ac-df68a8111022](../azure/962ef41c-0088-4cf2-b8ac-df68a8111022.md) |
