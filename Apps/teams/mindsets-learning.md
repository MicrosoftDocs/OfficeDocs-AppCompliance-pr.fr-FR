---
title: Informations sur l’application pour les mentalités par état d’esprit Learning
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: Toutes les informations de sécurité et de conformité disponibles pour Mindsets, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/fdc91943-4341-41e6-b4e7-b4625ab8c8f7" target="_blank">Afficher dans Teams magasin</a>
...
Informations fournies par Mindsets Learning à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | Mindsets |
| ID | WA200003000 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | Mindsets Learning |
| Site web de la société | [https://www.mindsets.com](https://www.mindsets.com) |
| Conditions d’utilisation de l’application | [https://www.mindsets.com/terms](https://www.mindsets.com/terms) |
| Fonctionnalités principales de l’application | Mindsets Learning est une plateforme d’apprentissage basée sur un projet d’enquête&amp;. |
| Emplacement du siège social de la société | États-Unis d’Amérique |
| Page d’informations sur l’application | [https://www.mindsets.com](https://www.mindsets.com) |
...
Ces informations ont été fournies par Mindsets Learning sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
