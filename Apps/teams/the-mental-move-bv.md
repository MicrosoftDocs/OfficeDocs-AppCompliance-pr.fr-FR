---
title: Informations d’application pour le déplacement mental par le déplacement mental B.V.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/02/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour The Mental Move, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
ms.locfileid: "65645643"
---
# <a name="the-mental-move"></a>The Mental Move

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Dernière mise à jour par le développeur : 16 février 2022</p>

* <a href="https://teams.microsoft.com/l/app/c5c971cc-3589-4338-a3be-1326db95cb24" target="_blank">Afficher dans Teams magasin</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004016" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par The Mental Move B.V. vers Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | The Mental Move |
| ID | WA200004016 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | The Mental Move B.V. |
| Site web de la société | [https://www.thementalmove.nl](https://www.thementalmove.nl) |
| Conditions d’utilisation de l’application | [https://www.thementalmove.nl/gebruikersvoorwaarden/](https://www.thementalmove.nl/gebruikersvoorwaarden/) |
| Fonctionnalités principales de l’application | Snel aan de slag a rencontré jouw mentale conditie binnen Teams! |
| Emplacement du siège social de la société | Pays-Bas (le) |
| Page d’informations sur l’application | [https://www.thementalmove.nl/ons-aanbod/online-preventiepla...](https://www.thementalmove.nl/ons-aanbod/online-preventieplatform/) |
...
Ces informations ont été fournies par The Mental Move B.V. sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| URL de la politique de confidentialité | https://www.thementalmove.nl/privacy-statement/ |
