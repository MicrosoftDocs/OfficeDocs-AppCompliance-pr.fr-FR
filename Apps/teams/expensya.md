---
title: Informations sur l’application pour Expensya par Expensya
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/04/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour Expensya, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/acbc0cba-5e0a-4bb5-a15c-21bce2863f01" target="_blank">Afficher dans Teams magasin</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003924" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Expensya à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | Expensya |
| ID | WA200003924 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | Expensya |
| Site web de la société | [https://www.expensya.com](https://www.expensya.com) |
| Conditions d’utilisation de l’application | [https://www.expensya.com/en/tou](https://www.expensya.com/en/tou) |
| Fonctionnalités principales de l’application | Expensya automatise les dépenses d’entreprise, de bout en bout, du traitement des factures aux cartes d’entreprise |
...
Ces informations ont été fournies par Expensya sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont traitées par votre application ? | Profil d’entreprise, profils utilisateur (employés) et éléments de dépenses professionnelles |
| L’application prend-elle en charge TLS 1.1 ou version ultérieure ? | Oui |
| L’application ou l’infrastructure sous-jacente stocke-t-elle des données client Microsoft ? | Oui |
| Quelles données sont stockées dans vos bases de données ? | Jetons Microsoft Graph (lors de l’intégration à Teams!) |
...
| URL de la politique de confidentialité | https://www.expensya.com/en/legal |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | application | Nous avons besoin du nom complet et de l’e-mail de l’utilisateur | [6ce7c411-d7c9-4c4f-882e-164447c9b44a](../azure/6ce7c411-d7c9-4c4f-882e-164447c9b44a.md) |
