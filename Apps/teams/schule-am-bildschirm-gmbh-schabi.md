---
title: Informations sur l’application pour Schabi par Magasins am Bildsabim
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/03/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour Schabi, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le Registre CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/8ddc9e63-e032-4639-afa6-b7c806303212" target="_blank">Afficher dans Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003728" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Lasse am Bilds contrôlem ContrôleH à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | Schabi |
| ID | WA200003728 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | Schule am Bildschirm GmbH |
| Site web de l’entreprise | [https://web.schabi.ch](https://web.schabi.ch) |
| Conditions d’utilisation de l’application | [https://www.schabi.ch/Info/AGB](https://www.schabi.ch/Info/AGB) |
| Fonctionnalités principales de l’application | Deine Schabi-Hausaufgaben und Schabi-Seiten direkt in Microsoft Teams! |
| Emplacement du siège social de l’entreprise | Suisse |
| Page d’informations sur l’application | [https://web.schabi.ch](https://web.schabi.ch) |
...
Ces informations ont été fournies par Lasse am Bilds contrôlent la façon dont cette application collecte et stocke les données organisationnelles, ainsi que le contrôle que votre organisation aura sur les données collectées par l’application.
...
| URL de la politique de confidentialité | https://www.schabi.ch/Info/Datenschutz |
