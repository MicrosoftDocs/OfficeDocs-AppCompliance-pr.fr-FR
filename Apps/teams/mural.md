...
<p>Last updated by the developer on: March 31, 2022</p>

* <a href="https://teams.microsoft.com/l/app/c738b607-88dd-4f16-aefe-6a824c65d25d" target="_blank">Afficher dans Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA104381626" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par LA TECHNOLOGIE DNS à Microsoft :
...
| Site web de l’entreprise | [https://mural.co](https://mural.co) |
| Conditions d’utilisation de l’application | [https://mural.co/terms](https://mural.co/terms) |
| Fonctionnalités principales de l’application | Penser et collaborer visuellement |
...
| Quelles données sont traitées par votre application ? | LA CONNEXION REQUIERT uniquement le nom, le nom et l’adresse e-mail à des fins de connexion. Le type de données à traiter/stocker dépend du client |
| L’application prend-elle en charge TLS 1.1 ou une valeur supérieure ? | Oui |
| L’application ou l’infrastructure sous-jacente stocke-t-elle des données client Microsoft ? | Oui |
| Quelles données sont stockées dans vos bases de données ? | LA fonction RAISONRES N’exige que le nom, le nom et l’e-mail de l’utilisateur à des fins de connexion, et que le reste des informations stockées dépend des informations stockées par les clients dans leurs restes. |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Files.Read | délégué | Files.read requis pour le chargement de documents vers LA DOCUMENTATION EN COURS. | [a1ef3a23-74fc-4c91-909f-691cc47a1c8e](../azure/a1ef3a23-74fc-4c91-909f-691cc47a1c8e.md) |
>| User.Read | délégué | User.read, car un sous-nom, un nom et un e-mail doivent être créés pour la création du compte. | [a1ef3a23-74fc-4c91-909f-691cc47a1c8e](../azure/a1ef3a23-74fc-4c91-909f-691cc47a1c8e.md) |
