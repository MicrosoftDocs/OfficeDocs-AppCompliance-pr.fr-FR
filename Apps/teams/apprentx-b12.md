---
title: Informations sur l’application pour B12 by Apprentx
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/11/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour B12, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
ms.locfileid: "65548883"
---
# <a name="b12"></a>B12

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Dernière mise à jour par le développeur : 4 avril 2022</p>

* <a href="https://teams.microsoft.com/l/app/a4a2213d-2466-473b-8772-021094c5f013" target="_blank">Afficher dans Teams magasin</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004073" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Apprentx à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | B12 |
| ID | WA200004073 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | Apprentx |
| Site web de la société | [https://apprentx.rocks](https://apprentx.rocks) |
| Conditions d’utilisation de l’application | [https://blogue.apprentx.rocks/terms-and-conditions](https://blogue.apprentx.rocks/terms-and-conditions) |
| Fonctionnalités principales de l’application | B12 combine le renforcement des connaissances et la pratique pour optimiser l’impact. |
| Emplacement du siège social de la société | Canada |
| Page d’informations sur l’application | [https://apprentx.rocks/en/nos-solutions](https://apprentx.rocks/en/nos-solutions) |
...
Apprentx a fourni ces informations sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont traitées par votre application ? | Nous traitons les jetons d’ID contenant le nom et l’e-mail des utilisateurs pour la fonctionnalité d’authentification unique facultative |
| L’application prend-elle en charge TLS 1.1 ou version ultérieure ? | Oui |
| L’application ou l’infrastructure sous-jacente stocke-t-elle des données client Microsoft ? | Oui |
| Quelles données sont stockées dans vos bases de données ? | Nous stockons les jetons d’accès pour la fonctionnalité de synchronisation de calendrier facultative |
...
| URL de la politique de confidentialité | https://blogue.apprentx.rocks/en/privacy-policy |
...
| Le consentement est-il obtenu auprès d’un parent ou d’un tuteur légal ? | Non |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Délégué | Teams SSO | [228af2d7-23b5-4d1f-a5bf-9a1670e4fb6a](../azure/228af2d7-23b5-4d1f-a5bf-9a1670e4fb6a.md) |
>| email | Délégué | Teams SSO | [228af2d7-23b5-4d1f-a5bf-9a1670e4fb6a](../azure/228af2d7-23b5-4d1f-a5bf-9a1670e4fb6a.md) |
>| offline_access | Délégué | Teams SSO | [228af2d7-23b5-4d1f-a5bf-9a1670e4fb6a](../azure/228af2d7-23b5-4d1f-a5bf-9a1670e4fb6a.md) |
>| openid | Délégué | Teams SSO | [228af2d7-23b5-4d1f-a5bf-9a1670e4fb6a](../azure/228af2d7-23b5-4d1f-a5bf-9a1670e4fb6a.md) |
>| profil | Délégué | Teams SSO | [228af2d7-23b5-4d1f-a5bf-9a1670e4fb6a](../azure/228af2d7-23b5-4d1f-a5bf-9a1670e4fb6a.md) |
>| Calendars.ReadWrite | Délégué | Synchronisation de calendrier | [75932bb9-5e71-449a-b584-b5cc01c2d118](../azure/75932bb9-5e71-449a-b584-b5cc01c2d118.md) |
>| User.Read | Délégué | Synchronisation de calendrier | [75932bb9-5e71-449a-b584-b5cc01c2d118](../azure/75932bb9-5e71-449a-b584-b5cc01c2d118.md) |
