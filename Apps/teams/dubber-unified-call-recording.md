...
* <a href="https://teams.microsoft.com/l/app/f31b8e05-b927-4874-851e-997264d13151" target="_blank">Afficher dans Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003570" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Du dual à Microsoft :

| **Information** | **Réponse** |
|:----------------|:-------------|
| Nom de l'application | Enregistrement d’appels unifiés durd |
| ID | WA200003570 |
...
Ces informations ont été fournies par Dunk sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont stockées dans vos bases de données ? | Nom du client et ID Microsoft, données d’enregistrement/réunion des appels |
