---
title: Informations d’application pour PayaFy par NimbleSoft Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 10/28/2021
...
description: Toutes les informations de sécurité et de conformité disponibles pour PayaFy, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le Registre CSA STAR.
...
ms.locfileid: "63543572"
---
# <a name="payafy"></a>PayaFy

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Last updated by the developer on: October 6, 2021</p>

* <a href="https://teams.microsoft.com/l/app/b6ecb389-d613-4d48-8e4b-90b3cc649fc0" target="_blank">Afficher dans Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003397" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par NimbleSoft Inc. à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | PayaFy |
| ID | WA200003397 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | NimbleSoft Inc. |
| Site web de l’entreprise | [https://payafy.com](https://payafy.com) |
| Conditions d’utilisation de l’application | [https://payafy.com/termsofservice](https://payafy.com/termsofservice) |
| Fonctionnalités principales de l’application | PayaFy permet aux entreprises d’accepter les paiements. Vous pouvez lier un compte Stripe existant ou en inscrire un nouveau. |
| Emplacement du siège social de l’entreprise | États-Unis d’Amérique |
| Page d’informations sur l’application | [https://payafy.com](https://payafy.com) |
...
Ces informations ont été fournies par NimbleSoft Inc. sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont stockées dans vos bases de données ? | Nom et adresse de messagerie |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.ReadWrite.All | les deux | Il lit les informations de base utilisées pour l’inscription des utilisateurs. | [1e96a64b-9c1c-4cbc-b015-70243ea06c9b](../azure/1e96a64b-9c1c-4cbc-b015-70243ea06c9b.md) |
