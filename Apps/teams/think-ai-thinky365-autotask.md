---
title: Informations sur l’application pour Thinky365-Autotask par Think AI
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/30/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour Thinky365-Autotask, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/2291b3d5-ea1d-4605-9a94-ac4523b85c06" target="_blank">Afficher dans le magasin Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004355" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Think AI à Microsoft :

| **Information** | **Réponse** |
|:----------------|:-------------|
| Nom de l'application | Thinky365-Autotask |
| ID | WA200004355 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | Think AI |
| Site web de la société | [https://www.thinky365.com](https://www.thinky365.com) |
| Conditions d’utilisation de l’application | [https://thinky365.com/terms-of-use/](https://thinky365.com/terms-of-use/) |
| Fonctionnalités principales de l’application | Thinky365 Chatbot for Autotask est votre agent virtuel 24&#215;7. Avec ce chatbot, vous serez en mesure d’élever la productivité de votre équipe de service de nouvelles façons innovantes tout en améliorant l’expérience utilisateur globale pour vos clients.  |
...
Ces informations ont été fournies par Think AI sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont stockées dans vos bases de données ? | Points de terminaison de services tels que Microsoft Graph, CRM et Azure |
...
| Répertorier les types de stratégies prises en charge | Stratégie personnalisée |
