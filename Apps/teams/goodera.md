---
title: Informations sur l’application pour Goodera par Goodera
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/17/2021
...
ms.locfileid: "65228548"
---
# <a name="goodera"></a>Goodera

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Dernière mise à jour par le développeur : 9 février 2021</p>

* <a href="https://teams.microsoft.com/l/app/bc78ef2f-db9c-4bac-83de-1571f9dedf2d" target="_blank">Afficher dans Teams magasin</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002136" target="_blank">Afficher dans AppSource</a>
...
| URL du site web du partenaire | [https://goodera.com](https://goodera.com) |
...
Ces informations ont été fournies par Goodera sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
>|:---------------------------------------|:-----------------------------------|:------------------------------------|
>| Nous accédons à l’ID d’e-mail des utilisateurs afin de pouvoir identifier les utilisateurs et les aider à s’inscrire aux opportunités de bénévolat. | ID d’e-mail | Cette piI est stockée uniquement afin que nous sachions à quelles opportunités de bénévolat l’utilisateur s’est inscrit. |
...
<iframe height='1020' title='informations de Microsoft Cloud App Security' src='https://appmcasinfoprod.azurewebsites.net/#/dashboard/36432' frameborder='no'></iframe>
...
Ces informations ont été fournies par Goodera sur la façon dont cette application gère l’authentification, l’autorisation, les meilleures pratiques d’inscription d’application et d’autres critères d’identité.
