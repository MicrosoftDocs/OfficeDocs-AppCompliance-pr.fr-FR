---
title: Informations sur l’application pour Eusoft Rdp Manager par Eusoft S.r.l.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/30/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour Eusoft Rdp Manager, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/cbe80cd5-d89b-45e4-9d24-345b43378b9d" target="_blank">Afficher dans le magasin Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004321" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Eusoft S.r.l. vers Microsoft :

| **Information** | **Réponse** |
|:----------------|:-------------|
| Nom de l'application | Eusoft Rdp Manager |
| ID | WA200004321 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | Eusoft S.r.l. |
| Site web de la société | [https://www.eusoft.it](https://www.eusoft.it) |
| Conditions d’utilisation de l’application | [https://www.eusoft.co.uk/privacy-cookies/](https://www.eusoft.co.uk/privacy-cookies/) |
| Fonctionnalités principales de l’application | Eusoft.Lab RDP Manager est l’application développée par Eusoft pour tester l’affichage des rapports |
...
Ces informations ont été fournies par Eusoft S.r.l. sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| URL de la politique de confidentialité | https://www.eusoft.co.uk/privacy-cookies |
