---
title: Informations d’application pour Squadify par Squadify Holdings Pty Ltd
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/05/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour Squadify, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
<p>Dernière mise à jour par le développeur : 4 juin 2022</p>

* <a href="https://teams.microsoft.com/l/app/110107b9-4326-43d8-bf43-bf10fcdce8ad" target="_blank">Afficher dans le magasin Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004349" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Squadify Holdings Pty Ltd à Microsoft :

| **Information** | **Réponse** |
|:----------------|:-------------|
| Nom de l'application | Squadify |
| ID | WA200004349 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | Squadify Holdings Pty Ltd |
| Site web de la société | [https://www.squadify.net](https://www.squadify.net) |
| Conditions d’utilisation de l’application | [https://www.squadify.net/mst-terms-of-use](https://www.squadify.net/mst-terms-of-use) |
| Fonctionnalités principales de l’application | Squadify pour Microsoft Teams vous permet de collecter les commentaires de votre équipe, de dialoguer et de générer des insights exploitables. Avec Squadify pour Microsoft Teams, vous pouvez configurer une équipe de création en 1 clic et la faire correspondre à votre équipe dans Microsoft Teams. Vous pouvez également lancer Squadifys, suivre leur progression et générer des insights sur les performances de votre équipe afin de commencer à créer les conversations appropriées. |
| Emplacement du siège social de la société | Australie |
| Page d’informations sur l’application | [https://www.squadify.net/our-product](https://www.squadify.net/our-product) |
...
Ces informations ont été fournies par Squadify Holdings Pty Ltd sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont traitées par votre application ? | Nom complet de l’utilisateur et adresse e-mail |
| L’application prend-elle en charge TLS 1.1 ou version ultérieure ? | Oui |
| L’application ou l’infrastructure sous-jacente stocke-t-elle des données client Microsoft ? | Oui |
| Quelles données sont stockées dans vos bases de données ? | Nom complet de l’utilisateur et adresse e-mail |
...
| URL de la politique de confidentialité | https://www.squadify.net/privacy-policy |
