---
title: Informations d’application pour Asa par Two App Studio Pte Ltd.
ms.author: elmalova
author: elenamalova
ms.date: 11/09/2021
ms.topic: article
...
description: Toutes les informations de sécurité et de conformité disponibles pour Asa, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le Registre CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/2973405f-6e3b-45a3-a3a4-7c85d8d3be88" target="_blank">Afficher dans Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003449" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Two App Studio Pte Ltd. à Microsoft :

| **Information** | **Réponse** |
|:----------------|:-------------|
| Nom de l'application | Asa |
| ID | WA200003449 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | Two App Studio Pte Ltd. |
| Site web de l’entreprise | [https://asa.team](https://asa.team) |
| Conditions d’utilisation de l’application | [https://asa.team/terms](https://asa.team/terms) |
| Fonctionnalités principales de l’application | Outil de gestion des espaces de travail distants |
...
Ces informations ont été fournies par Two App Studio Pte Ltd. sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont stockées dans vos bases de données ? | microsoft tenantId pour les utilisateurs et le groupe à partir de qui ils envoient les messages du bot |
...
| URL de la politique de confidentialité | https://asa.team/privacypolicy |
