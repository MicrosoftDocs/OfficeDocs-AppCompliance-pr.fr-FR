---
title: Informations sur l’application pour JustLogin par JustLogin
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/29/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour JustLogin, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
ms.locfileid: "66564606"
---
# <a name="justlogin"></a>JustLogin

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Dernière mise à jour par le développeur : 28 juin 2022</p>

* <a href="https://teams.microsoft.com/l/app/cfbb8888-3227-45fc-a4b7-423af170defa" target="_blank">Afficher dans le magasin Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004314" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par JustLogin à Microsoft :

| **Information** | **Réponse** |
|:----------------|:-------------|
| Nom de l'application | JustLogin |
| ID | WA200004314 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | JustLogin |
| Site web de la société | [https://justlogin.com](https://justlogin.com) |
| Conditions d’utilisation de l’application | [https://justlogin.com/terms/](https://justlogin.com/terms/) |
| Fonctionnalités principales de l’application | JustLogin - Votre logiciel RH convivial pour les employés. |
...
Ces informations ont été fournies par JustLogin sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| URL de la politique de confidentialité | https://justlogin.com/privacy/ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| email | Délégué | besoin d’e-mail pour vous connecter à JustLogin via l’authentification unique | [af5883db-bda9-4d1a-b1ce-022bea20f021](../azure/af5883db-bda9-4d1a-b1ce-022bea20f021.md) |
