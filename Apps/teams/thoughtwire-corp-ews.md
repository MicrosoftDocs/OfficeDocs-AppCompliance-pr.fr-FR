...
<p>Dernière mise à jour par le développeur : 17 juin 2021</p>

* <a href="https://teams.microsoft.com/l/app/ed27363f-755e-4658-b7bf-409d475959d6" target="_blank">Afficher dans Teams magasin</a>
...
| Site web de la société | [https://thoughtwire.com](https://thoughtwire.com) |
| Conditions d’utilisation de l’application | [https://www.thoughtwire.com/end-user-license-agreement/](https://www.thoughtwire.com/end-user-license-agreement/) |
| Fonctionnalités principales de l’application | L’application ThoughtWire prend en charge EarlyWarning, un outil de détection et d’intervention avancé qui a fait ses preuves pour réduire de 61 % les événements bleus du code. La solution d’avertissement précoce est conçue pour détecter la détérioration des patients en fonction des signes vitaux des patients, informer les cliniciens des événements de santé indésirables et leur permettre de prendre des mesures. Le personnel de l’équipe d’intervention a accès au contexte des patients et est conscient de l’état et de la disponibilité de l’équipe qui répond, ce qui permet une réponse rationalisée et des flux de travail de soins aux patients. |
...
| Date de certification SOC2 la plus récente | 2021-03-31 |
| L’application est-elle conforme aux contrôles d’organisation de service (SOC 3) ? | Oui |
| Date de certification SOC3 la plus récente | 2021-03-31 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Group.Create | application | Permet à l’application de créer des groupes/équipes pour les unités/services hospitaliers. | [49a15c37-4eca-48b1-a327-7a8b5a3b399c](../azure/49a15c37-4eca-48b1-a327-7a8b5a3b399c.md) |
>| Group.ReadWrite.All | application | Requis pour que l’application détermine les groupes qu’elle peut avoir besoin de créer/recréer, et pour gérer l’appartenance. | [49a15c37-4eca-48b1-a327-7a8b5a3b399c](../azure/49a15c37-4eca-48b1-a327-7a8b5a3b399c.md) |
>| GroupMember.ReadWrite.All | application | Obligatoire pour que l’application puisse gérer l’appartenance à un groupe. c’est-à-dire l’ajout/la suppression d’infirmières d’une équipe à mesure que les équipes changent. | [49a15c37-4eca-48b1-a327-7a8b5a3b399c](../azure/49a15c37-4eca-48b1-a327-7a8b5a3b399c.md) |
>| TeamMember.ReadWrite.All | application | Obligatoire pour que l’application puisse gérer l’appartenance à un groupe. c’est-à-dire l’ajout/la suppression d’infirmières d’une équipe à mesure que les équipes changent. | [49a15c37-4eca-48b1-a327-7a8b5a3b399c](../azure/49a15c37-4eca-48b1-a327-7a8b5a3b399c.md) |
...
>| User.Read | application | Autorisez l’application à récupérer l’AADID/nom d’utilisateur d’un utilisateur en fonction des besoins lors de la gestion de l’appartenance et/ou de la récupération du nom d’utilisateur pour l’identité de l’utilisateur au sein de notre application. | [49a15c37-4eca-48b1-a327-7a8b5a3b399c](../azure/49a15c37-4eca-48b1-a327-7a8b5a3b399c.md) |
