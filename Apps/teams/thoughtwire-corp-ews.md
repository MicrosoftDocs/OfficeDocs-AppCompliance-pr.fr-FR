...
| Site web de l’entreprise | [https://thoughtwire.com](https://thoughtwire.com) |
...
| Fonctionnalités principales de l’application | L’application ThoughtWire prend en charge EarlyWarning, un outil de détection et d’intervention avancé qui a été démontré pour réduire de 61 % les événements de code bleu. La solution d’avertissement précoce est conçue pour détecter les patient en fonction de leur état vital, informer les notifiés d’événements de santé indésirables et leur permettre d’agir. Le personnel de l’équipe de réponse a accès au contexte des patients et connaît l’état et la disponibilité de l’équipe qui répond, ce qui permet une réponse simplifiée et des flux de travail de soins de patients. |
