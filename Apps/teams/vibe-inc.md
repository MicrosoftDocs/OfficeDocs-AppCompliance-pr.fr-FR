---
title: Informations sur l’application pour l’entreprise
ms.author: elmalova
author: elenamalova
ms.date: 01/20/2022
ms.topic: article
...
* <a href="https://teams.microsoft.com/l/app/f6179d94-de34-4c1b-9303-519fdf048c7e" target="_blank">Afficher dans Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001721" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Son Inc. à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | Vibe |
| ID | WA200001721 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | Vibe Inc |
| Site web de l’entreprise | [https://vibe.us](https://vibe.us) |
| Conditions d’utilisation de l’application | [https://vibe.us/term/](https://vibe.us/term/) |
| Fonctionnalités principales de l’application | Collaboration en temps réel sur une zone de dessin illimitée avec un accès facile à vos fichiers OneDrive données. |
...
Ces informations ont été fournies par Sonas Inc. sur la façon dont cette application collecte et stocke les données organisationnelles, ainsi que sur le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont stockées dans vos bases de données ? | Nom d’affichage, adresse e-mail et image de profil du client |
...
| URL de la politique de confidentialité | https://vibe.us/privacy/ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | délégué | Obtenir les informations d’identité de base de l’utilisateur telles que le nom, le courrier électronique, l’image de profil. | [71a7c2ef-6e5f-4d3d-8665-119a2bef0035](https://docs.microsoft.com/microsoft-365-app-certification/azure/71a7c2ef-6e5f-4d3d-8665-119a2bef0035) |
