...
description: Toutes les informations de sécurité et de conformité disponibles pour la funtivité par Hermis, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
---
# <a name="funtivity-by-hermis"></a>Funtivity par Hermis

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Dernière mise à jour par le développeur : 19 juin 2022</p>

* <a href="https://teams.microsoft.com/l/app/d75e14a9-9bfd-43b4-8430-7264da3b6995" target="_blank">Afficher dans le magasin Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004244" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Hermis, Inc. à Microsoft :

| **Information** | **Réponse** |
|:----------------|:-------------|
| Nom de l'application | Funtivity par Hermis |
| ID | WA200004244 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | Hermis, Inc. |
| Site web de la société | [https://www.herm.is](https://www.herm.is) |
| Conditions d’utilisation de l’application | [https://www.herm.is/terms](https://www.herm.is/terms) |
| Fonctionnalités principales de l’application | Funtivity par Hermis a une pléthore de contenu d’activités &amp; pour un large éventail d’occasions, y compris la création d’équipe, des sessions de réunion, des événements culturels et bien plus encore. Avec plus d’une douzaine d’activités différentes et de nouveaux événements minutieusement conçus chaque semaine, il&#8217;quelque chose pour tous les goûts. |
| Emplacement du siège social de la société | États-Unis d’Amérique |
| Page d’informations sur l’application | [https://www.herm.is/integrations/funtivity-msteams](https://www.herm.is/integrations/funtivity-msteams) |
...
Ces informations ont été fournies par Hermis, Inc. sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont traitées par votre application ? | L’ID du client, l’e-mail de nom &amp; sont utilisés pour inscrire l’utilisateur sur Hermis. |
| L’application prend-elle en charge TLS 1.1 ou version ultérieure ? | Oui |
| L’application ou l’infrastructure sous-jacente stocke-t-elle des données client Microsoft ? | Oui |
| Quelles données sont stockées dans vos bases de données ? | L’e-mail de nom &amp; d’utilisateur est stocké dans notre base de données. L’e-mail de l’utilisateur est chiffré à l’aide d’AES-256-CBC |
...
| URL de la politique de confidentialité | https://www.herm.is/privacy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Délégué | Nous utilisons les détails du profil de l’utilisateur pour inscrire l’utilisateur sur notre plateforme. | [d75e14a9-9bfd-43b4-8430-7264da3b6995](../azure/d75e14a9-9bfd-43b4-8430-7264da3b6995.md) |
>| email | Délégué | Nous utilisons les détails du profil de l’utilisateur pour inscrire l’utilisateur sur notre plateforme. | [d75e14a9-9bfd-43b4-8430-7264da3b6995](../azure/d75e14a9-9bfd-43b4-8430-7264da3b6995.md) |
>| openid | Délégué | Nous utilisons les détails du profil de l’utilisateur pour inscrire l’utilisateur sur notre plateforme. | [d75e14a9-9bfd-43b4-8430-7264da3b6995](../azure/d75e14a9-9bfd-43b4-8430-7264da3b6995.md) |
>| profil | Délégué | Nous utilisons les détails du profil de l’utilisateur pour inscrire l’utilisateur sur notre plateforme. | [d75e14a9-9bfd-43b4-8430-7264da3b6995](../azure/d75e14a9-9bfd-43b4-8430-7264da3b6995.md) |
