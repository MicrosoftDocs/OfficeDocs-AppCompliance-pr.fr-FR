---
title: Informations sur l’application pour OLIVE VLE by OliveGroup
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/12/2021
...
description: Toutes les informations de sécurité et de conformité disponibles pour OLIVE VLE, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/ccb8561b-4f4a-496f-898f-b27e681c3a62" target="_blank">Afficher dans Teams magasin</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003331" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par OliveGroup à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | OLIVE VLE |
| ID | WA200003331 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | OliveGroup |
| Site web de la société | [https://www.olivegroup.io](https://www.olivegroup.io) |
| Conditions d’utilisation de l’application | [https://vle.olivegroup.io/termsofuse](https://vle.olivegroup.io/termsofuse) |
| Fonctionnalités principales de l’application | Olive VLE aide les tuteurs et les prestataires d’éducation à créer et gérer des cours, des programmes d’apprentissage et des apprenants. Les administrateurs des fournisseurs d’éducation peuvent créer leurs propres cours, tests, devoirs, programmes en ligne et les affecter aux apprenants. Microsoft Teams est intégré à l’aide de API Graph afin que les administrateurs puissent également créer une salle de classe vidéo dans Teams et inviter des apprenants à la salle de classe vidéo. Les apprenants peuvent voir et suivre leurs cours, programmes et gérer les preuves de portefeuille. Les administrateurs peuvent également publier des flux d’actualités. |
...
OliveGroup a fourni ces informations sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
