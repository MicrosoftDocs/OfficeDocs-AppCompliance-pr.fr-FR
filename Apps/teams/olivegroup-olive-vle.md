...
| Fonctionnalités principales de l’application | Le VLE olive permet aux fournisseurs de formation et de formation de créer et de gérer des cours, des programmes de formation et des enseignants. Les administrateurs des fournisseurs d’enseignement peuvent créer leurs propres cours en ligne, tests, devoirs, programmes et les affecter à des enseignants. Microsoft Teams est intégrée à l’aide Graph API afin que les administrateurs peuvent également créer une salle de classe vidéo dans Teams et inviter des enseignants à la salle de classe vidéo. Les enseignants peuvent voir et prendre leurs cours, programmes et gérer les preuves de portefeuille. Les administrateurs peuvent également publier des flux d’actualités. |
