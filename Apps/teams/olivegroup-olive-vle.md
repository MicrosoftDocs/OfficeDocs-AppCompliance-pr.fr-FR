---
title: Informations sur l’application POUR OLIVE VLE par OliveGroup
ms.author: elmalova
author: elenamalova
ms.date: 07/12/2021
ms.topic: article
...
description: Toutes les informations de sécurité et de conformité disponibles pour LE VLE OLIVE, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le Registre CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/ccb8561b-4f4a-496f-898f-b27e681c3a62" target="_blank">Afficher dans Teams store</a>
...
| Site web de l’entreprise | [https://www.olivegroup.io](https://www.olivegroup.io) |
| Conditions d’utilisation de l’application | [https://vle.olivegroup.io/termsofuse](https://vle.olivegroup.io/termsofuse) |
| Fonctionnalités principales de l’application | Le VLE olive permet aux fournisseurs de formation et de formation de créer et de gérer des cours, des programmes de formation et des enseignants. Les administrateurs des fournisseurs d’enseignement peuvent créer leurs propres cours en ligne, tests, devoirs, programmes et les affecter à des enseignants. Microsoft Teams est intégrée à l’aide de Graph API afin que les administrateurs peuvent également créer une salle de classe vidéo dans Teams et inviter des enseignants à la salle de classe vidéo. Les enseignants peuvent voir et prendre leurs cours, programmes et gérer les preuves de portefeuille. Les administrateurs peuvent également publier des flux d’actualités. |
| Emplacement du siège social de l’entreprise | Irlande |
...
Ces informations ont été fournies par OliveGroup sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
