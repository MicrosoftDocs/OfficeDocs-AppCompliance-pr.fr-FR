---
title: Informations sur l’application pour KangoGift par KangoGift, Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/03/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour KangoGift, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/a19a36e4-c33d-4988-a706-5c740ccab0eb" target="_blank">Afficher dans le magasin Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004174" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par KangoGift, Inc. à Microsoft :

| **Information** | **Réponse** |
|:----------------|:-------------|
| Nom de l'application | KangoGift |
| ID | WA200004174 |
| Clients Office 365 pris en charge | Microsoft Teams |
| Nom de la société partenaire | KangoGift, Inc. |
| Site web de la société | [https://www.kangogift.com](https://www.kangogift.com) |
| Conditions d’utilisation de l’application | [https://www.kangogift.com/app_terms](https://www.kangogift.com/app_terms) |
| Fonctionnalités principales de l’application | Envoyer la reconnaissance et les éloges. |
...
Ces informations ont été fournies par KangoGift, Inc. sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont traitées par votre application ? | Informations de base sur les utilisateurs : nom, e-mail. Cela est géré dans un contrat distinct que nous avons avec les clients.  |
| L’application prend-elle en charge TLS 1.1 ou version ultérieure ? | Oui |
| L’application ou l’infrastructure sous-jacente stocke-t-elle des données client Microsoft ? | Oui |
| Quelles données sont stockées dans vos bases de données ? | Informations de base sur les utilisateurs : nom, e-mail. Cela est géré dans un contrat distinct que nous avons avec les clients.  |
...
| URL de la politique de confidentialité | https://www.kangogift.com/privacy |
