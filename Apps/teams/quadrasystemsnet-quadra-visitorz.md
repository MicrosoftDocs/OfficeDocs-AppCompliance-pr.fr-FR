---
title: Informations d’application pour Quadra Visitorz par Quadrasystems.net
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/13/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour Quadra Visitorz, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/86458973-657f-4072-8e6a-f1baf684c62f" target="_blank">Afficher dans le magasin Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004199" target="_blank">Afficher dans AppSource</a>
...
| **Information** | **Réponse** |
|:----------------|:-------------|
| Nom de l'application | Quadra Visitorz |
| ID | WA200004199 |
...
| Fonctionnalités principales de l’application | Visitorz est une solution de gestion des visiteurs intuitive, facile à utiliser et évolutive. |
