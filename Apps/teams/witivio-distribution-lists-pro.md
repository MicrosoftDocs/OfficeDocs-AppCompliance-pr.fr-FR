...
* <a href="https://teams.microsoft.com/l/app/4b8d2936-4e5f-4563-83ca-4bdad686c788" target="_blank">Afficher dans Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002977" target="_blank">Afficher dans AppSource</a>
...
| **Information** | **Réponse** |
|:----------------|:-------------|
| Nom de l'application | Listes de distribution Pro |
| ID | WA200002977 |
...
| Fonctionnalités principales de l’application | Les listes Pro pour Microsoft Teams vous offrent un accès facile à vos listes de distribution existantes. L’application affiche les listes et leurs membres sur votre Microsoft Teams. |
...
| Quelles données sont stockées dans vos bases de données ? | ID de liste de distribution |
