---
title: Informations d’application pour HubEngage par HubEngage, Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/17/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour HubEngage, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
ms.locfileid: "66549406"
---
# <a name="hubengage"></a>HubEngage

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Dernière mise à jour par le développeur : 12 janvier 2022</p>

* <a href="https://teams.microsoft.com/l/app/d96b4f99-e4b8-4af8-ba3d-36675f9a5353" target="_blank">Afficher dans le magasin Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003668" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par HubEngage, Inc. à Microsoft :

| **Information** | **Réponse** |
|:----------------|:-------------|
| Nom de l'application | HubEngage |
| ID | WA200003668 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | HubEngage, Inc. |
| Site web de la société | [https://www.hubengage.com](https://www.hubengage.com) |
| Conditions d’utilisation de l’application | [https://www.hubengage.com/privacy-policy/](https://www.hubengage.com/privacy-policy/) |
| Fonctionnalités principales de l’application | HubEngage Teams App vous permet d’accéder aux communications de votre organisation et à d’autres informations pertinentes à partir de Teams. Vous pouvez également envoyer vos propres publications et aimer et commenter d’autres publications. |
...
Ces informations ont été fournies par HubEngage, Inc. sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Date de certification SOC2 la plus récente | 2022-05-20 |
...
| URL de la politique de confidentialité | https://www.hubengage.com/platform-privacy-policy/ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | les deux | Connaître l’utilisateur | [63e17eec-6b5f-476b-a26b-54fde8bd2c83](../azure/63e17eec-6b5f-476b-a26b-54fde8bd2c83.md) |
