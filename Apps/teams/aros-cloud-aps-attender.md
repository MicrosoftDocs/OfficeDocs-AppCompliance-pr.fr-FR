---
title: Informations d’application pour l’intervenant par Aros Cloud ApS
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/16/2022
...
description: 'Toutes les informations de sécurité et de conformité disponibles pour l’utilisateur, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le Registre CSA STAR.'
...
* <a href="https://teams.microsoft.com/l/app/30b8d518-2535-4919-ab8b-d0fab193380f" target="_blank">Afficher dans Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003856" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Aros Cloud ApS à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | Attender |
| ID | WA200003856 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | Aros Cloud ApS |
| Site web de l’entreprise | [https://www.attender.uk](https://www.attender.uk) |
| Conditions d’utilisation de l’application | [https://www.attender.uk/wp-content/uploads/2022/02/Terms-of...](https://www.attender.uk/wp-content/uploads/2022/02/Terms-of-use.pdf) |
| Fonctionnalités principales de l’application | Inscription rapide à l’école qui réduit les abandons d’étudiants et économise du temps d’enseignement. |
| Emplacement du siège social de l’entreprise | Danemark |
| Page d’informations sur l’application | [https://www.attender.uk](https://www.attender.uk) |
...
Ces informations ont été fournies par Aros Cloud ApS sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont traitées par votre application ? | Nom UPN des utilisateurs, nom d’affichage des utilisateurs, données de présence des étudiants, images de profil des étudiants, données de cours des enseignants et des étudiants |
| L’application prend-elle en charge TLS 1.1 ou une valeur supérieure ? | Oui |
| L’application ou l’infrastructure sous-jacente stocke-t-elle des données client Microsoft ? | Oui |
| Quelles données sont stockées dans vos bases de données ? | Nom UPN des utilisateurs, nom d’affichage des utilisateurs, données de présence des étudiants, images de profil des étudiants, données de cours des enseignants et des étudiants |
| Si des infastructures sous-jacentes traitent ou stockent des données client Microsoft, où sont stockées géographiquement ces données ? | Danemark |
...
| URL de la politique de confidentialité | https://www.attender.uk/wp-content/uploads/2022/02/Privacy-Statement.pdf |
...
| Liste des types de stratégies pris en charge | Tous pris en charge par Azure AD |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Group.Read.All | délégué | Déterminer le rôle d’utilisateur | [3741153e-2490-463c-aff7-5283fb1bd1b4](../azure/3741153e-2490-463c-aff7-5283fb1bd1b4.md) |
>| GroupMember.Read.All | délégué | Déterminer le rôle d’utilisateur | [3741153e-2490-463c-aff7-5283fb1bd1b4](../azure/3741153e-2490-463c-aff7-5283fb1bd1b4.md) |
>| User.Read | délégué | Connexion | [3741153e-2490-463c-aff7-5283fb1bd1b4](../azure/3741153e-2490-463c-aff7-5283fb1bd1b4.md) |
>| email | délégué | Obtenir le nom de connexion des utilisateurs. | [3741153e-2490-463c-aff7-5283fb1bd1b4](../azure/3741153e-2490-463c-aff7-5283fb1bd1b4.md) |
>| openid | délégué | Sign On unique | [3741153e-2490-463c-aff7-5283fb1bd1b4](../azure/3741153e-2490-463c-aff7-5283fb1bd1b4.md) |
>| profil | délégué | Informations utilisateur | [3741153e-2490-463c-aff7-5283fb1bd1b4](../azure/3741153e-2490-463c-aff7-5283fb1bd1b4.md) |
