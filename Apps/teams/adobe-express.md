---
title: Informations sur l’application pour Adobe Express par Adobe
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/07/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour Adobe Express, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
ms.locfileid: "66549438"
---
# <a name="adobe-express"></a>Adobe Creative Cloud Express

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Dernière mise à jour par le développeur : 6 avril 2022</p>

* <a href="https://teams.microsoft.com/l/app/85d6a7d0-94aa-11ea-a1d7-2f19374441f9" target="_blank">Afficher dans le magasin Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003946" target="_blank">Afficher dans AppSource</a>
...
| **Information** | **Réponse** |
|:----------------|:-------------|
| Nom de l'application | Adobe Creative Cloud Express |
| ID | WA200003946 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | Adobe |
| Site web de la société | [https://www.adobe.com/express/](https://www.adobe.com/express/) |
| Conditions d’utilisation de l’application | [https://www.adobe.com/legal/terms.html](https://www.adobe.com/legal/terms.html) |
| Fonctionnalités principales de l’application | Adobe Spark vous permet de créer de superbes histoires visuelles, des graphiques sociaux, des pages web et de courtes vidéos en quelques minutes. Maintenant, partagez-les facilement dans Microsoft Teams |
| Emplacement du siège social de la société | États-Unis d’Amérique |
| Page d’informations sur l’application | [https://www.adobe.com/express](https://www.adobe.com/express) |
...
| Date de certification SOC2 la plus récente | 2021-05-12 |
...
| URL de la politique de confidentialité | https://www.adobe.com/privacy/policy.html |
