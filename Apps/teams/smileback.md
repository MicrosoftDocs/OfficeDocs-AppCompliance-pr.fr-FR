...
ms.locfileid: "64880554"
---
# <a name="smileback"></a>SmileBack

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Dernière mise à jour par le développeur : 12 avril 2021</p>

* <a href="https://teams.microsoft.com/l/app/273e3385-93c3-4054-8c03-328b8c3fd9af" target="_blank">Afficher dans Teams magasin</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002623" target="_blank">Afficher dans AppSource</a>
...
| Nom de la société partenaire | SmileBack |
| Site web de la société | [https://smileback.com](https://smileback.com) |
| Conditions d’utilisation de l’application | [https://smileback.com/terms](https://smileback.com/terms) |
| Fonctionnalités principales de l’application | SmileBack est une plateforme de satisfaction client conçue pour les fournisseurs de services gérés, les support technique et les équipes de support informatique. Nos outils&#174; CSAT + NPS aident les professionnels de l’informatique à collecter, signaler et agir sur les commentaires des clients. CSAT (Customer Satisfaction Survey) vous aide à comprendre votre taux de satisfaction client actuel, ce qui vous donne une mesure instantanée et directe de chaque interaction avec le client (tickets de support). L'&#174; NPS (Net Promoter Score) vous donne des insights sur votre relation client globale. |
...
Ces informations ont été fournies par SmileBack sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
