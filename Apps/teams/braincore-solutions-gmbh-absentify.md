---
title: Informations sur l’application pour l’absence de BrainCore Solutions
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/07/2022
...
* <a href="https://teams.microsoft.com/l/app/fbd349eb-146f-4e94-af76-df4754f40749" target="_blank">Afficher dans Teams store</a>
...
Informations fournies à Microsoft par BrainCore Solutions
...
| Nom de la société partenaire | BrainCore Solutions GmbH |
| Site web de l’entreprise | [https://braincore.solutions](https://braincore.solutions) |
...
| Fonctionnalités principales de l’application | Le moyen le plus simple de gérer les congés des employés , Microsoft Teams |
...
Ces informations ont été fournies par BrainCore Solutions AndroidH sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont stockées dans vos bases de données ? | Microsoft User ID,Email,DisplayName |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| TeamsActivity.Send | application | Facultatif. Pour envoyer des notifications à Microsoft Teams. | [0f5eabc0-89bf-4cc6-80d1-10094b5919d2](../azure/0f5eabc0-89bf-4cc6-80d1-10094b5919d2.md) |
>| Calendars.ReadWrite | délégué | Facultatif : pour créer automatiquement une entrée Outlook du calendrier pour les absences. | [3dbcb38b-8d2f-4e97-9bd1-975fb770b31c](../azure/3dbcb38b-8d2f-4e97-9bd1-975fb770b31c.md) |
>| User.Read | délégué | Pour la connexion | [4dce2abf-3f8e-4281-9f7a-d602fc391886](../azure/4dce2abf-3f8e-4281-9f7a-d602fc391886.md) |
>| User.ReadBasic.All | délégué | Facultatif : pour afficher les images de profil Microsoft des utilisateurs. | [4dce2abf-3f8e-4281-9f7a-d602fc391886](../azure/4dce2abf-3f8e-4281-9f7a-d602fc391886.md) |
