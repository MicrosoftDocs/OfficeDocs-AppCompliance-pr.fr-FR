---
title: Informations sur l’application pour Aimful par Aimful
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/31/2022
...
description: 'Toutes les informations de sécurité et de conformité disponibles pour Aimful, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le Registre CSA STAR.'
...
* <a href="https://teams.microsoft.com/l/app/7da7691c-e47a-479e-9bb2-cda07cffd0e5" target="_blank">Afficher dans Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003698" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Aimful à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | Aimful |
| ID | WA200003698 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | Aimful |
| Site web de l’entreprise | [https://aimful.io](https://aimful.io) |
| Conditions d’utilisation de l’application | [https://aimful.io/terms-and-conditions/](https://aimful.io/terms-and-conditions/) |
| Fonctionnalités principales de l’application | Aimful encourage la transformation de la culture de réunion dans votre équipe ou dans votre entreprise  |
| Emplacement du siège social de l’entreprise | États-Unis Amérique |
| Page d’informations sur l’application | [https://aimful.io/how-it-works/](https://aimful.io/how-it-works/) |
...
Ces informations ont été fournies par Aimful sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont traitées par votre application ? | Événements dans le calendrier, la messagerie de l’utilisateur et le fuseau horaire |
| L’application prend-elle en charge TLS 1.1 ou une valeur supérieure ? | Oui |
| L’application ou l’infrastructure sous-jacente stocke-t-elle des données client Microsoft ? | Oui |
| Quelles données sont stockées dans vos bases de données ? | Événements dans le calendrier, la messagerie de l’utilisateur et le fuseau horaire |
...
| URL de la politique de confidentialité | https://aimful.io/policy/ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.ReadWrite | délégué | Accès aux événements de calendrier | [93544582-de9c-42a0-baa5-df3d25e9bd48](../azure/93544582-de9c-42a0-baa5-df3d25e9bd48.md) |
>| MailboxSettings.Read | délégué | Fuseau horaire de l’utilisateur Access | [93544582-de9c-42a0-baa5-df3d25e9bd48](../azure/93544582-de9c-42a0-baa5-df3d25e9bd48.md) |
