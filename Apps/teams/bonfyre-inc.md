---
title: Application Information for Bonfyre by Bonfyre, Inc
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/07/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour Bonfyre, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
ms.locfileid: "66547086"
---
# <a name="bonfyre"></a>Bonfyre

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Dernière mise à jour par le développeur : 30 mars 2022</p>

* <a href="https://teams.microsoft.com/l/app/829fa155-8058-4b1e-b43a-86efb74da5d4" target="_blank">Afficher dans le magasin Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004185" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Bonfyre, Inc à Microsoft :

| **Information** | **Réponse** |
|:----------------|:-------------|
| Nom de l'application | Bonfyre |
| ID | WA200004185 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | Bonfyre, Inc |
| Site web de la société | [https://bonfyreapp.com](https://bonfyreapp.com) |
| Conditions d’utilisation de l’application | [https://bonfyreapp.com/terms-of-use-teams](https://bonfyreapp.com/terms-of-use-teams) |
| Fonctionnalités principales de l’application | Intégrez la puissance des fonctionnalités d’engagement Bonfyre dans le canal de travail que vos employés utilisent tous les jours. |
| Emplacement du siège social de la société | États-Unis d’Amérique |
| Page d’informations sur l’application | [https://bonfyreapp.com/blog/bonfyre-now-integrates-with-mic...](https://bonfyreapp.com/blog/bonfyre-now-integrates-with-microsoft-teams) |
...
Ces informations ont été fournies par Bonfyre, Inc. sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont traitées par votre application ? | Contenu soumis par l’utilisateur et données de profil utilisateur. |
| L’application prend-elle en charge TLS 1.1 ou version ultérieure ? | Oui |
| L’application ou l’infrastructure sous-jacente stocke-t-elle des données client Microsoft ? | Oui |
| Quelles données sont stockées dans vos bases de données ? | Noms d’utilisateur, adresses e-mail et images de profil.  Ces informations peuvent être préalablement partagées lors de l’intégration du client, mais nous synchronisons avec les profils utilisateur pour maintenir les informations à jour. |
...
| URL de la politique de confidentialité | https://bonfyreapp.com/privacy-policy-teams |
