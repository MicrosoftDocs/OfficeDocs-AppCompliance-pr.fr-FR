---
title: Informations d’application pour IdeaScale par IdeaScale
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/21/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour IdeaScale, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le Registre CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/a4de8de4-33b1-4e55-97ac-9f87b5978c0f" target="_blank">Afficher dans Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003868" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par IdeaScale à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | IdeaScale |
| ID | WA200003868 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | IdeaScale |
| Site web de l’entreprise | [https://ideascale.com](https://ideascale.com) |
| Conditions d’utilisation de l’application | [https://ideascale.com/terms-and-conditions-of-use](https://ideascale.com/terms-and-conditions-of-use) |
| Fonctionnalités principales de l’application | IdeaScale est la plateforme de gestion des idées de pointe pour les équipes d’innovation. Tous les membres de votre organisation peuvent partager des idées visibles par d’autres membres de la communauté, et recueillir des commentaires et des ressources pour transformer ces idées en nouveaux produits ou projets. Vous pouvez maintenant connecter votre communauté IdeaScale à votre espace Microsoft Teams de travail pour gérer les idées sans quitter Teams. |
| Emplacement du siège social de l’entreprise | États-Unis d’Amérique |
| Page d’informations sur l’application | [https://ideascale.com/teams/](https://ideascale.com/teams/) |
...
Ces informations ont été fournies par IdeaScale sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| URL de la politique de confidentialité | https://ideascale.com/privacy-policy |
