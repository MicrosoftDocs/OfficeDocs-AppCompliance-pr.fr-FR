---
title: Informations d’application pour COR par COR Global Ltd.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/16/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour COR, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
ms.locfileid: "66248814"
---
# <a name="cor"></a>COR

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Dernière mise à jour par le développeur : 6 septembre 2021</p>

* <a href="https://teams.microsoft.com/l/app/1ff72075-1e25-4b42-bd88-3fdbc9d6d34e" target="_blank">Afficher dans le magasin Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004235" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par COR Global Ltd. à Microsoft :

| **Information** | **Réponse** |
|:----------------|:-------------|
| Nom de l'application | COR |
| ID | WA200004235 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | COR Global Ltd. |
| Site web de la société | [https://projectcor.com](https://projectcor.com) |
| Conditions d’utilisation de l’application | [https://projectcor.com/cor-terms-of-service/](https://projectcor.com/cor-terms-of-service/) |
| Fonctionnalités principales de l’application | Visibilité en temps réel. COR est la solution de gestion destinée aux professionnels et aux équipes créatives qui suggère intelligemment comment gérer des projets, des équipes et des finances avec l’intelligence artificielle. |
| Emplacement du siège social de la société | États-Unis d’Amérique |
| Page d’informations sur l’application | [https://cor.zendesk.com/hc/en-us](https://cor.zendesk.com/hc/en-us) |
...
Ces informations ont été fournies par COR Global Ltd. sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| URL de la politique de confidentialité | https://projectcor.com/cor-privacy-and-personal-data/ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Files.Read.All | application | Intégration à One Drive | [e73458d3-c732-4460-bfb2-9da9086fc714](../azure/e73458d3-c732-4460-bfb2-9da9086fc714.md) |
