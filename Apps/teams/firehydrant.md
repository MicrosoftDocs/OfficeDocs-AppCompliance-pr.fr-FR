---
title: Informations d’application pour FireHydrant par FireHydrant
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/14/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour FireHydrant, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/c18f3920-4098-4907-bc92-43c8559b5e18" target="_blank">Afficher dans Teams magasin</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003794" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par FireHydrant à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | FireHydrant |
| ID | WA200003794 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | FireHydrant |
| Site web de la société | [https://firehydrant.io](https://firehydrant.io) |
| Conditions d’utilisation de l’application | [https://app.firehydrant.io/legal/ssa](https://app.firehydrant.io/legal/ssa) |
| Fonctionnalités principales de l’application | Gérez vos incidents avec FireHydrant.io. |
...
Ces informations ont été fournies par FireHydrant sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont traitées par votre application ? | Identité de l’utilisateur (nom, e-mail), données d’incident provenant des canaux Teams |
| L’application prend-elle en charge TLS 1.1 ou version ultérieure ? | Oui |
| L’application ou l’infrastructure sous-jacente stocke-t-elle des données client Microsoft ? | Oui |
| Quelles données sont stockées dans vos bases de données ? | ID d’équipe, ID de locataire, messages, nom d’utilisateur |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Channel.Create | Délégué | FireHydrant crée des canaux pour le compte de nos utilisateurs pour gérer les incidents | [00485db5-81b3-4299-833a-8d6c366d0ac0](../azure/00485db5-81b3-4299-833a-8d6c366d0ac0.md) |
