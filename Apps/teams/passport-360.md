---
title: Informations de demande pour Passport 360 par Passport 360
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/29/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour Passport 360, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/585570bb-e996-4b0b-89cf-0b5d610ecb65" target="_blank">Afficher dans le magasin Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004322" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Passport 360 à Microsoft :

| **Information** | **Réponse** |
|:----------------|:-------------|
| Nom de l'application | Passport 360 |
| ID | WA200004322 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | Passport 360 |
| Site web de la société | [https://www.passport360.com](https://www.passport360.com) |
| Conditions d’utilisation de l’application | [https://www.passport360.com/privacy-policy/](https://www.passport360.com/privacy-policy/) |
| Fonctionnalités principales de l’application | Solution SaaS pour chiffrer les processus d’intégrité et de sécurité entre les fournisseurs |
...
Ces informations ont été fournies par Passport 360 sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont stockées dans vos bases de données ? | ID de locataire ; nom du principal de l’utilisateur |
| Si l’infastructure sous-jacente traite ou stocke les données client Microsoft, où ces données sont-elles stockées géographiquement ? | Australie, Afrique du Sud, Canada |
...
| URL de la politique de confidentialité | https://www.passport360.com/privacy-policy-2/ |
