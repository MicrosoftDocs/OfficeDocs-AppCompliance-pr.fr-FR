---
title: Informations sur l’application pour le travail hybride OfficeRnD par OfficeRnD
ms.author: elmalova
author: elenamalova
ms.date: 11/11/2021
ms.topic: article
...
description: Toutes les informations de sécurité et de conformité disponibles pour OfficeRnD Hybrid Work, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le Registre CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/ff19eb3c-6afa-4f33-acfd-df1338289524" target="_blank">Afficher dans Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003460" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par OfficeRnD à Microsoft :

| **Information** | **Réponse** |
|:----------------|:-------------|
| Nom de l'application | OfficeRnD Hybrid Work |
| ID | WA200003460 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | OfficeRnd |
| Site web de l’entreprise | [https://officernd.com](https://officernd.com) |
| Conditions d’utilisation de l’application | [https://officernd.com/terms](https://officernd.com/terms) |
| Fonctionnalités principales de l’application | Permet aux employés de trouver et de réserver rapidement des bureaux, des salles de réunion et d’autres espaces. |
...
Ces informations ont été fournies par OfficeRnD sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Avez-vous un logiciel de détection et de prévention des intrusions (IDPS) déployé sur le périmètre de la limite réseau qui permet de soutenir votre application ? | Non |
...
| URL de la politique de confidentialité | https://officernd.com/privacy |
