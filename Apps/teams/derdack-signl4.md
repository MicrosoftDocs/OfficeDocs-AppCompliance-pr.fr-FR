...
ms.locfileid: "66845016"
---
# <a name="signl4"></a>SIGNL4

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Dernière mise à jour par le développeur : 15 juillet 2022</p>

* <a href="https://teams.microsoft.com/l/app/bd19c878-00b7-47cd-9b65-74a2def84427" target="_blank">Afficher dans le magasin Teams</a>
...
| Site web de la société | [https://www.derdack.com](https://www.derdack.com) |
| Conditions d’utilisation de l’application | [https://www.signl4.com/terms_of_use/](https://www.signl4.com/terms_of_use/) |
| Fonctionnalités principales de l’application | Derdack SIGNL4 permet la génération d’alertes mobiles et la réponse aux incidents en tout lieu pour l’exploitation de l’infrastructure critique. Il prend en charge les opérations et les équipes oncall. |
| Emplacement du siège social de la société | Allemagne |
| Page d’informations sur l’application | [https://www.signl4.com](https://www.signl4.com) |
...
Derdack SIGNL4 a fourni ces informations sur la façon dont cette application collecte et stocke les données organisationnelles, ainsi que sur le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont traitées par votre application ? | adresse électronique |
| L’application prend-elle en charge TLS 1.1 ou version ultérieure ? | Oui |
| L’application ou l’infrastructure sous-jacente stocke-t-elle des données client Microsoft ? | Oui |
| Quelles données sont stockées dans vos bases de données ? | adresse e-mail |
...
| URL de la politique de confidentialité | https://www.signl4.com/privacy-policy/ |
