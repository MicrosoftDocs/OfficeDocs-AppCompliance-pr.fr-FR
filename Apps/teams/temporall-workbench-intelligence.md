---
title: Informations d’application pour Workbench Intelligence by Temporall
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/24/2021
...
ms.locfileid: "64879591"
---
# <a name="workbench-intelligence"></a>Workbench Intelligence

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Dernière mise à jour par le développeur : 22 septembre 2021</p>

* <a href="https://teams.microsoft.com/l/app/d5630318-189a-4912-abae-99b1f8f82cce" target="_blank">Afficher dans Teams magasin</a>
...
| Site web de la société | [https://www.temporall.com](https://www.temporall.com) |
| Conditions d’utilisation de l’application | [https://www.temporall.com/eula](https://www.temporall.com/eula) |
| Fonctionnalités principales de l’application | Workbench Intelligence fournit des insights en temps réel pour vous aider à prendre des décisions plus rapides et meilleures. |
...
Ces informations ont été fournies par Temporall sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| AppCatalog.Read.All | Délégué | Obtient la liste des applications Teams installées pour pouvoir obtenir l’ID d’application local pour l’ID externe connu. | [d5630318-189a-4912-abae-99b1f8f82cce](../azure/d5630318-189a-4912-abae-99b1f8f82cce.md) |
>| Channel.ReadBasic.All | application | Nom de l’ID de &amp; canal. Justification : autoriser la jonction/la sortie du canal pour synchroniser l’activité de message.  | [d5630318-189a-4912-abae-99b1f8f82cce](../azure/d5630318-189a-4912-abae-99b1f8f82cce.md) |
>| ChannelMessage.Read.All | application | Type d’activité &amp; de message, ainsi que la cible de l’expéditeur &amp; . Données reçues de ces itinéraires : /teams/${teamId}/channels/${channelId}/messages /teams/${teamId}/channels/${channelId}/messages/${messageId}. Justification : pour pouvoir calculer le rapport de métriques &amp; sur l’activité des messages. Cela constitue le cœur de notre module d’analyse réseau organisationnelle pour pouvoir dessiner un diagramme d’activité entre les équipes d’utilisateurs &amp; . | [d5630318-189a-4912-abae-99b1f8f82cce](../azure/d5630318-189a-4912-abae-99b1f8f82cce.md) |
>| Directory.Read.All | application | ClientId, Liste des utilisateurs, liste des organisations et des sous-canaux. Justification : Nécessaire pour lire &amp; la synchronisation des utilisateurs avec Temporall Workbench | [d5630318-189a-4912-abae-99b1f8f82cce](../azure/d5630318-189a-4912-abae-99b1f8f82cce.md) |
...
>| TeamMember.Read.All | application | Appartenance des utilisateurs à l’équipe. Justification : autorise la synchronisation de tous les utilisateurs dans Teams avec Temporall Workbench | [d5630318-189a-4912-abae-99b1f8f82cce](../azure/d5630318-189a-4912-abae-99b1f8f82cce.md) |
>| TeamsAppInstallation.ReadWriteForTeam.All | application | Lire la liste des applications installées pour Team. Justification : Vérifier si notre application est déjà installée sinon l’installe pour être en mesure d’obtenir une activité de message via l’API graphe | [d5630318-189a-4912-abae-99b1f8f82cce](../azure/d5630318-189a-4912-abae-99b1f8f82cce.md) |
>| TeamsAppInstallation.ReadWriteForUser.All | application | Lire la liste des applications installées. Vérifier si notre application est déjà installée sinon l’installe pour interagir avec l’utilisateur via un questionnaire | [d5630318-189a-4912-abae-99b1f8f82cce](../azure/d5630318-189a-4912-abae-99b1f8f82cce.md) |
>| User.Read | Délégué | Informations de base sur l’entreprise utilisateur &amp; . Justification : utilisée pour catégoriser l’activité des messages par l’utilisateur, permet au bot de participer à la messagerie proactive. | [d5630318-189a-4912-abae-99b1f8f82cce](../azure/d5630318-189a-4912-abae-99b1f8f82cce.md) |
