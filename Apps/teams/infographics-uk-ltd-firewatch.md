---
title: Informations sur l’application pour FireWatch par Infographics UK Ltd.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/30/2021
...
description: Toutes les informations de sécurité et de conformité disponibles pour FireWatch, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
ms.locfileid: "64879321"
---
# <a name="firewatch"></a>FireWatch

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Dernière mise à jour par le développeur : 29 juillet 2021</p>

* <a href="https://teams.microsoft.com/l/app/822055b4-508e-49c8-b7cc-c891ccb5c4eb" target="_blank">Afficher dans Teams magasin</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003303" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Infographics UK Ltd. à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | FireWatch |
| ID | WA200003303 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | Infographies UK Ltd. |
| Site web de la société | [https://www.infographics.co.uk](https://www.infographics.co.uk) |
| Conditions d’utilisation de l’application | [https://www.infographics.co.uk/terms-and-conditions/](https://www.infographics.co.uk/terms-and-conditions/) |
| Fonctionnalités principales de l’application | FireWatch Connecter permet aux services d’incendie et de sauvetage d’intégrer l’application FireWatch à Microsoft Teams afin que les utilisateurs puissent effectuer des tâches directement dans Microsoft Teams. Il fournit actuellement un support et une assistance aux utilisateurs via un bot Microsoft Teams pour effectuer des réservations en cours/arrêt directement dans l’environnement utilisateur Microsoft Teams. Les versions ultérieures incluront la prise en charge d’autres actions via bots et cartes, notamment les demandes de congé FireWatch, les rappels de tâches, etc. |
| Emplacement du siège social de la société | Royaume-Uni de Grande-Bretagne et d’Irlande du Nord (le) |
| Page d’informations sur l’application | [https://www.firewatch.co.uk](https://www.firewatch.co.uk) |
...
Ces informations ont été fournies par Infographics UK Ltd. sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
