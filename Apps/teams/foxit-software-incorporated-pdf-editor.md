...
description: Toutes les informations de sécurité et de conformité disponibles pour l’Éditeur PDF Foxit, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
ms.locfileid: "66249750"
---
# <a name="foxit-pdf-editor"></a>Éditeur PDF Foxit

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Dernière mise à jour par le développeur : 19 août 2021</p>

* <a href="https://teams.microsoft.com/l/app/959a79dd-69d0-4d05-b9a8-b9f02e28c049" target="_blank">Afficher dans le magasin Teams</a>
...
| **Information** | **Réponse** |
|:----------------|:-------------|
| Nom de l'application | Éditeur PDF Foxit |
| ID | WA200003703 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | Foxit Software incorporé |
| Site web de la société | [https://www.foxit.com](https://www.foxit.com) |
...
| Fonctionnalités principales de l’application | Avec l’éditeur PDF Foxit pour Microsoft Teams, vous pouvez faire plus avec les documents sans quitter Microsoft Teams : 1.Secure Collaboration-Share PDF et collaborer avec tout le monde dans votre canal, et les documents stockés dans Microsoft SharePoint ou un lecteur&#65307; affichage de haute qualité 2.Haute qualité- Avec un affichage PDF de haute qualité en toute sécurité et facilement dans Microsoft Teams&#65307; 3.Annoter PDF-Provide commentaires sur les documents via le balisage de texte et annoter les outils PDF ; |
...
| Quelles données sont traitées par votre application ? | E-mail et nom d’utilisateur |
