---
title: Informations sur l’application pour Colloquial by Colloquial Solutions
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/25/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour Colloquial, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
ms.locfileid: "67016907"
---
# <a name="colloquial"></a>Familier

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Dernière mise à jour par le développeur : 30 juin 2022</p>

* <a href="https://teams.microsoft.com/l/app/79b08482-6a09-41ff-a303-7ad2fd9c3531" target="_blank">Afficher dans le magasin Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004395" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Colloquial Solutions à Microsoft :

| **Information** | **Réponse** |
|:----------------|:-------------|
| Nom de l'application | Familier |
| ID | WA200004395 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | Solutions courantes |
| Site web de la société | [https://www.colloquial.io](https://www.colloquial.io) |
| Conditions d’utilisation de l’application | [https://app.colloquial.io/terms](https://app.colloquial.io/terms) |
| Fonctionnalités principales de l’application | Une application directe pour la collecte et le partage des connaissances en matière de fonctionnalités, de processus, d’applications et de technologies dans votre organisation. Communément appelé portefeuille ou catalogue. Cette application vous aide à rassembler et à gérer vos portefeuilles. |
| Emplacement du siège social de la société | Australie |
| Page d’informations sur l’application | [https://www.colloquial.io/solutions](https://www.colloquial.io/solutions) |
...
Ces informations ont été fournies par Colloquial Solutions sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont traitées par votre application ? | Données de profil utilisateur - prénom et nom, ainsi qu’e-mail |
| L’application prend-elle en charge TLS 1.1 ou version ultérieure ? | Oui |
| L’application ou l’infrastructure sous-jacente stocke-t-elle des données client Microsoft ? | Oui |
| Quelles données sont stockées dans vos bases de données ? | Données de profil utilisateur - prénom et nom, ainsi qu’e-mail |
| Si l’infastructure sous-jacente traite ou stocke les données client Microsoft, où ces données sont-elles stockées géographiquement ? | Australie |
...
| Si votre application n’utilise pas l’une des bibliothèques ci-dessus, quelle bibliothèque ou bibliothèque d’authentification utilise-t-elle ? | Nous utilisons le flux de code d’autorisation OAuth2 avec la bibliothèque suivante : https://github.com/RIPAGlobal/omniauth-azure-activedirectory-v2 |
