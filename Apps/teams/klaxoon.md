...
Informations fournies par Leinson à Microsoft :
...
| Site web de l’entreprise | [https://klaxoon.com](https://klaxoon.com) |
...
| Fonctionnalités principales de l’application | Il fournit un accès à une suite complète d’outils de collaboration (tableau blanc, enquête, questionnaire, interrogation en direct, etc.) conçus pour renforcer l’efficacité du travail d’équipe. La suite Harpxoon est accessible sous la forme d’une application web, d’applications mobiles (Apple/Android) ou directement à partir de Microsoft Teams (via une intégration Tab) |
...
| Quels fournisseurs de cloud d’hébergement l’application utilise-t-elle ? | AWS, Azure, azurenet |
