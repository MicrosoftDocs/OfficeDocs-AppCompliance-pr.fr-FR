---
title: Informations d’application pour Klaxoon par Klaxoon
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/21/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour Klaxoon, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
ms.locfileid: "66548103"
---
# <a name="klaxoon"></a>Klaxoon

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Dernière mise à jour par le développeur : 21 juin 2022</p>

* <a href="https://teams.microsoft.com/l/app/6adc8d55-eb37-4537-a66d-743b3cd4511b" target="_blank">Afficher dans le magasin Teams</a>
...
Informations fournies par Klaxoon à Microsoft :
...
| Site web de la société | [https://klaxoon.com](https://klaxoon.com) |
| Conditions d’utilisation de l’application | [https://static.klaxoon.com/website/pdf/eula.pdf](https://static.klaxoon.com/website/pdf/eula.pdf) |
| Fonctionnalités principales de l’application | Klaxoon donne accès à une suite complète d’outils collaboratifs (tableau blanc, enquête, questionnaire, sondage en direct, etc.) conçus pour améliorer l’efficacité du travail d’équipe. La suite Klaxoon est accessible en tant qu’application web, applications mobiles (Apple/Android) ou directement à partir de Microsoft Teams (via une intégration Tab) |
| Emplacement du siège social de la société | France |
| Page d’informations sur l’application | [https://klaxoon.com](https://klaxoon.com) |
| Quel est l’environnement d’hébergement ou le modèle de service utilisé pour exécuter votre application ? | Hybride |
| Quels fournisseurs de cloud d’hébergement l’application utilise-t-elle ? | Azure, Aws, Autres |
...
Ces informations ont été fournies par Klaxoon sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont traitées par votre application ? | email, firstname, lastname, avatar |
| L’application prend-elle en charge TLS 1.1 ou version ultérieure ? | Oui |
| L’application ou l’infrastructure sous-jacente stocke-t-elle des données client Microsoft ? | Oui |
| Quelles données sont stockées dans vos bases de données ? | email, firstname, lastname, avatar |
| Si l’infastructure sous-jacente traite ou stocke les données client Microsoft, où ces données sont-elles stockées géographiquement ? | États-Unis d’Amérique, de France, d’Allemagne |
...
| URL de la politique de confidentialité | https://static.klaxoon.com/website/pdf/privacy-policy.pdf |
...
| Répertorier les types de stratégies prises en charge | s’il vous plaît demander des détails |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Délégué | identification de l’utilisateur et création de compte | [ef685106-cba6-4374-a250-a89d51df6e34](../azure/ef685106-cba6-4374-a250-a89d51df6e34.md) |
>| email | Délégué | identification de l’utilisateur et création de compte | [ef685106-cba6-4374-a250-a89d51df6e34](../azure/ef685106-cba6-4374-a250-a89d51df6e34.md) |
>| offline_access | Délégué | identification de l’utilisateur et création de compte | [ef685106-cba6-4374-a250-a89d51df6e34](../azure/ef685106-cba6-4374-a250-a89d51df6e34.md) |
>| openid | Délégué | identification de l’utilisateur et création de compte | [ef685106-cba6-4374-a250-a89d51df6e34](../azure/ef685106-cba6-4374-a250-a89d51df6e34.md) |
>| profil | Délégué | identification de l’utilisateur et création de compte | [ef685106-cba6-4374-a250-a89d51df6e34](../azure/ef685106-cba6-4374-a250-a89d51df6e34.md) |
