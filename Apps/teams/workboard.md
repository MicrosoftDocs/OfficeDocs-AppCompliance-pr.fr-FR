...
>|:----------------|:--------------------|:---------------------------------------------------|:--------------------------|:--------------------------|
>| User.Read | délégué | adresse de messagerie et ID des utilisateurs.  Il est utilisé pour ma cartographier l’utilisateur sur l’ID utilisateur de WorkBoard | WorkBoard stocke uniquement l’identité de l’utilisateur dans ses bases de données | User.Read |
