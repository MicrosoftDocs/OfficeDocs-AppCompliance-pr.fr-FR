...
>|:---------------------------------------|:-----------------------------------|:------------------------------------|
>| L’ID d’utilisateur est utilisé pour les notifications proactives envoyées Teams par WorkBord | ID et adresse de messagerie de l’utilisateur | Utilisé pour ma cartographier l’utilisateur sur l’ID utilisateur de WorkBoard |
...
Ces informations ont été fournies par Workboard sur la façon dont cette application gère l’authentification, l’autorisation, les meilleures pratiques d’inscription des applications et d’autres critères d’identité.
