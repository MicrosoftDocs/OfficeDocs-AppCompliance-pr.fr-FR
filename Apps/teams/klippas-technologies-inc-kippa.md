---
title: Informations d’application pour Kippa par KLIPPAS Technologies inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 10/13/2021
...
description: Toutes les informations de sécurité et de conformité disponibles pour Kippa, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
ms.locfileid: "64881291"
---
# <a name="kippa"></a>Pérpa

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Dernière mise à jour par le développeur : 13 octobre 2021</p>

* <a href="https://teams.microsoft.com/l/app/49d0e480-ede2-11ea-85fc-27f7e2c29730" target="_blank">Afficher dans Teams magasin</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003327" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par KLIPPAS Technologies inc. à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | Pérpa |
| ID | WA200003327 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | KLIPPAS Technologies inc. |
| Site web de la société | [https://www.kippa.app](https://www.kippa.app) |
| Conditions d’utilisation de l’application | [https://www.kippa.app/terms-of-service/](https://www.kippa.app/terms-of-service/) |
| Fonctionnalités principales de l’application | Définissez rapidement des rappels personnels, partagés ou de canal uniques ou périodiques de l’intérieur de Microsoft Teams |
| Emplacement du siège social de la société | Canada |
| Page d’informations sur l’application | [https://www.kippa.app/kippa-app/](https://www.kippa.app/kippa-app/) |
...
Ces informations ont été fournies par KLIPPAS Technologies inc. sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Répertorier les types de stratégies prises en charge | Identique à Microsoft Teams, car les utilisateurs doivent se connecter à Teams pour accéder à Kippa. |
