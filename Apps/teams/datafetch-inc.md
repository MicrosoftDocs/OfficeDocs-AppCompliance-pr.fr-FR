---
title: Informations sur l’application pour DataFetch par DataFetch, Inc
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/18/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour DataFetch, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/d6756140-a823-11ea-94d9-ddbe638eaf6b" target="_blank">Afficher dans Teams magasin</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003961" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par DataFetch, Inc à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | DataFetch |
| ID | WA200003961 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | DataFetch, Inc |
| Site web de la société | [https://datafetch.io](https://datafetch.io) |
| Conditions d’utilisation de l’application | [https://datafetch.io/terms](https://datafetch.io/terms) |
| Fonctionnalités principales de l’application | Rechercher des sources de données connectées |
...
Ces informations ont été fournies par DataFetch, Inc. sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont stockées dans vos bases de données ? | id, name, tenantId, tenantName |
...
| URL de la politique de confidentialité | https://datafetch.io/privacy-policy |
...
| Répertorier les types de stratégies prises en charge | Les utilisateurs qui sont abonnés à des sources de données au lieu de les posséder ne peuvent pas les supprimer. |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| TeamsAppInstallation.ReadWriteForUser | Délégué | Gérer les applications Teams installées d’un utilisateur | [b3af1387-3ee6-4074-a594-7a768cd00d44](../azure/b3af1387-3ee6-4074-a594-7a768cd00d44.md) |
>| TeamsAppInstallation.ReadWriteSelfForUser | Délégué | Autoriser l’application Teams à se gérer elle-même pour un utilisateur | [b3af1387-3ee6-4074-a594-7a768cd00d44](../azure/b3af1387-3ee6-4074-a594-7a768cd00d44.md) |
>| User.Read | Délégué | Activer la connexion et lire le profil utilisateur | [b3af1387-3ee6-4074-a594-7a768cd00d44](../azure/b3af1387-3ee6-4074-a594-7a768cd00d44.md) |
>| email | Délégué | Afficher l’adresse de messagerie des utilisateurs | [b3af1387-3ee6-4074-a594-7a768cd00d44](../azure/b3af1387-3ee6-4074-a594-7a768cd00d44.md) |
>| offline_access | Délégué | Gérer l’accès aux données auxquelles vous avez accordé l’accès | [b3af1387-3ee6-4074-a594-7a768cd00d44](../azure/b3af1387-3ee6-4074-a594-7a768cd00d44.md) |
>| openid | Délégué | Signer l’identification des utilisateurs | [b3af1387-3ee6-4074-a594-7a768cd00d44](../azure/b3af1387-3ee6-4074-a594-7a768cd00d44.md) |
>| profil | Délégué | Afficher le profil de base des utilisateurs | [b3af1387-3ee6-4074-a594-7a768cd00d44](../azure/b3af1387-3ee6-4074-a594-7a768cd00d44.md) |
