---
title: Informations sur l’application pour actualités - Jalios par Jalios SA
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/31/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour News - Jalios, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
---
# <a name="news---jalios"></a>Actualités - Jalios

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Dernière mise à jour par le développeur : 21 décembre 2021</p>

* <a href="https://teams.microsoft.com/l/app/a8662bd0-31c6-4254-b48f-0f54d0b92fcb" target="_blank">Afficher dans Teams magasin</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003889" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Jalios SA à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | Actualités - Jalios |
| ID | WA200003889 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | Jalios SA |
| Site web de la société | [https://www.jalios.com](https://www.jalios.com) |
| Conditions d’utilisation de l’application | [https://jalios.com/msteams-app/termsofuse](https://jalios.com/msteams-app/termsofuse) |
| Fonctionnalités principales de l’application | Journal d’entreprise numérique dynamique et personnalisable  |
...
Ces informations ont été fournies par Jalios SA sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| URL de la politique de confidentialité | https://jalios.com/msteams-app/privacy |
...
| Si votre application n’utilise pas l’une des bibliothèques ci-dessus, quelle bibliothèque ou bibliothèque d’authentification utilise-t-elle ? | Microsoft Teams SDK client JavaScript |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.Read.All | Délégué | Lire une propriété d’extension de schéma personnalisée  | [5159b699-a8c3-4170-ae49-c22ccb76cdde](../azure/5159b699-a8c3-4170-ae49-c22ccb76cdde.md) |
>| User.Read | Délégué | Lire les données utilisateur pour le connecter à Jalios Workplace | [5159b699-a8c3-4170-ae49-c22ccb76cdde](../azure/5159b699-a8c3-4170-ae49-c22ccb76cdde.md) |
>| offline_access | Délégué | Authentification unique : maintenir l’accès aux données | [5159b699-a8c3-4170-ae49-c22ccb76cdde](../azure/5159b699-a8c3-4170-ae49-c22ccb76cdde.md) |
>| openid | Délégué | Connecter des utilisateurs | [5159b699-a8c3-4170-ae49-c22ccb76cdde](../azure/5159b699-a8c3-4170-ae49-c22ccb76cdde.md) |
