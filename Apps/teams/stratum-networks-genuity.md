---
title: Informations d’application pour Genuity par Stratum Networks
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/29/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour Genuity, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
ms.locfileid: "65628280"
---
# <a name="genuity"></a>Genuity

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Dernière mise à jour par le développeur : 6 avril 2022</p>

* <a href="https://teams.microsoft.com/l/app/1d37e38f-7513-4239-8251-208a749bba7e" target="_blank">Afficher dans Teams magasin</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004008" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Stratum Networks à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | Genuity |
| ID | WA200004008 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | Stratum Networks |
| Site web de la société | [https://secure.gogenuity.com](https://secure.gogenuity.com) |
| Conditions d’utilisation de l’application | [https://gogenuity.com/terms](https://gogenuity.com/terms) |
| Fonctionnalités principales de l’application | Gérer votre support technique Genuity dans le Microsoft Teams |
...
Ces informations ont été fournies par Stratum Networks sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
