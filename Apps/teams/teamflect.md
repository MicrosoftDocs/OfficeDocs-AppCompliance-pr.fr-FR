---
title: Informations sur l’application pour Teamflect par Teamflect
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/26/2021
...
* <a href="https://teams.microsoft.com/l/app/e46015e9-f2ae-4dbc-be6b-f05043192e62" target="_blank">Afficher dans le magasin Teams</a>
...
Informations fournies par Teamflect à Microsoft :
...
| Nom de la société partenaire | Teamflect |
| Site web de la société | [https://teamflect.com](https://teamflect.com) |
| Conditions d’utilisation de l’application | [https://teamflect.com/terms](https://teamflect.com/terms) |
| Fonctionnalités principales de l’application | Teamflect est une solution de gestion des performances tout-en-un et d’engagement des employés conçue pour Microsoft Teams. Il rend les gens plus productifs et plus engagés avec ses modules 1-on-1 Meeting, Goal/OKR, Feedback, Recognition et Tasks |
...
Ces informations ont été fournies par Teamflect sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Répertorier les types de stratégies prises en charge | BlockAccess, RequireMFA |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.Read | application | Nous utilisons cette autorisation pour accéder aux calendriers des utilisateurs afin d’identifier les réunions 1-on-1 | [c5da92a9-873e-4ea1-86c7-03ec9c1384f0](../azure/c5da92a9-873e-4ea1-86c7-03ec9c1384f0.md) |
>| Directory.Read.All | Délégué | Annuaire d’entreprise : nous utilisons cette autorisation pour afficher aux utilisateurs finaux une liste de leurs collègues lorsqu’ils effectuent une recherche | [c5da92a9-873e-4ea1-86c7-03ec9c1384f0](../azure/c5da92a9-873e-4ea1-86c7-03ec9c1384f0.md) |
