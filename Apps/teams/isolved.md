---
title: Informations d’application pour résolues par isolved
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/15/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour la résolution, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
ms.locfileid: "66819041"
---
# <a name="isolved"></a>résolu

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Dernière mise à jour par le développeur : 14 juillet 2022</p>

* <a href="https://teams.microsoft.com/l/app/287fab70-2e10-4bc3-9049-8991d7796d81" target="_blank">Afficher dans le magasin Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004410" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par isolved à Microsoft :

| **Information** | **Réponse** |
|:----------------|:-------------|
| Nom de l'application | résolu |
| ID | WA200004410 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | résolu |
| Site web de la société | [https://www.isolvedhcm.com](https://www.isolvedhcm.com) |
| Conditions d’utilisation de l’application | [https://www.isolvedhcm.com/legal/agreements/employee-terms-...](https://www.isolvedhcm.com/legal/agreements/employee-terms-and-conditions-for-use) |
| Fonctionnalités principales de l’application | Permettre à vos employés d’obtenir rapidement des réponses aux questions relatives aux RH dans Microsoft Teams |
| Emplacement du siège social de la société | États-Unis d’Amérique |
| Page d’informations sur l’application | [https://www.isolvedhcm.com/platform/enhancements/conversati...](https://www.isolvedhcm.com/platform/enhancements/conversational-virtual-assistant) |
...
Ces informations ont été fournies par isolved sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont traitées par votre application ? | ID de locataire Microsoft Azure, ID d’utilisateur Microsoft Azure  |
| L’application prend-elle en charge TLS 1.1 ou version ultérieure ? | Oui |
| L’application ou l’infrastructure sous-jacente stocke-t-elle des données client Microsoft ? | Oui |
| Quelles données sont stockées dans vos bases de données ? | ID de locataire Microsoft Azure, ID d’utilisateur Microsoft Azure  |
...
| Date de certification SOC1 la plus récente | 2021-08-31 |
...
| Date de certification SOC2 la plus récente | 2022-01-31 |
