---
title: Informations sur l’application pour les | de mise en forme Gestion des modèles par eformity
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/11/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour la mise en forme | Gestion des modèles, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
ms.locfileid: "64771445"
---
# <a name="eformity--template-management"></a>eformity | Gestion des modèles

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Dernière mise à jour par le développeur : 19 novembre 2021</p>

* <a href="https://teams.microsoft.com/l/app/74843469-2e76-45e6-acdc-b755a4a4adf0" target="_blank">Afficher dans Teams magasin</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003519" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par eformity à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | eformity - Gestion des modèles |
| ID | WA200003519 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | eformity |
| Site web de la société | [https://eformity.nl](https://eformity.nl) |
| Conditions d’utilisation de l’application | [https://eformity.net/policies/terms-of-use](https://eformity.net/policies/terms-of-use) |
| Fonctionnalités principales de l’application | Utilisez des modèles gérés de manière centralisée pour créer des documents et des présentations à partir de Microsoft Teams. |
...
Ces informations ont été fournies par eformity sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont traitées par votre application ? | User Mail, User Name, User First Name, User Last Name |
| L’application prend-elle en charge TLS 1.1 ou version ultérieure ? | Oui |
| L’application ou l’infrastructure sous-jacente stocke-t-elle des données client Microsoft ? | Oui |
| Quelles données sont stockées dans vos bases de données ? | User Mail, User Name, User First Name, User Last Name |
...
| URL de la politique de confidentialité | https://eformity.net/policies/privacy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Files.ReadWrite.All | Délégué | Enregistrer les modèles générés | [ff50870f-b19b-489c-9766-4bcee4e843eb](../azure/ff50870f-b19b-489c-9766-4bcee4e843eb.md) |
>| User.Read | Délégué | Collecter des données pour la mise à jour du profil utilisateur sur notre plateforme | [ff50870f-b19b-489c-9766-4bcee4e843eb](../azure/ff50870f-b19b-489c-9766-4bcee4e843eb.md) |
>| openid | Délégué | Se connecter à un utilisateur | [ff50870f-b19b-489c-9766-4bcee4e843eb](../azure/ff50870f-b19b-489c-9766-4bcee4e843eb.md) |
>| profil | Délégué | Se connecter à un utilisateur | [ff50870f-b19b-489c-9766-4bcee4e843eb](../azure/ff50870f-b19b-489c-9766-4bcee4e843eb.md) |
