---
title: Informations d’application pour Glowbl par Glowbl
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/19/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour Glowbl, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
ms.locfileid: "66892044"
---
# <a name="glowbl"></a>Glowbl

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Dernière mise à jour par le développeur : 20 décembre 2021</p>

* <a href="https://teams.microsoft.com/l/app/4a32acb6-9163-4dfe-9427-d51a3f53ef42" target="_blank">Afficher dans le magasin Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004368" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Glowbl à Microsoft :

| **Information** | **Réponse** |
|:----------------|:-------------|
| Nom de l'application | Glowbl |
| ID | WA200004368 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | Glowbl |
| Site web de la société | [https://www.glowbl.com](https://www.glowbl.com) |
| Conditions d’utilisation de l’application | [https://www.glowbl.com/en/terms-of-use/](https://www.glowbl.com/en/terms-of-use/) |
| Fonctionnalités principales de l’application | Utilisez votre authentification Microsoft Teams pour vous connecter facilement à Glowbl. - Ajoutez un espace Glowbl dans un onglet de l’équipe créé pour chaque session d’apprentissage, - Créez des événements dans votre calendrier Outlook directement à partir de vos espaces virtuels Glowbl, - Partagez et projetez des fichiers SharePoint ou Un lecteur (Microsoft Word, Microsoft Excel et Microsoft Powerpoint) sur des tables intelligentes Glowbl sans ouvrir une nouvelle fenêtre de navigateur ou partager votre écran |
...
Ces informations ont été fournies par Glowbl sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont traitées par votre application ? | Messagerie utilisateur, prénom, nom |
| L’application prend-elle en charge TLS 1.1 ou version ultérieure ? | Oui |
| L’application ou l’infrastructure sous-jacente stocke-t-elle des données client Microsoft ? | Oui |
| Quelles données sont stockées dans vos bases de données ? | Messagerie utilisateur, prénom, nom |
...
| URL de la politique de confidentialité | https://www.glowbl.com/en/privacy-policy/ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Files.Read | Délégué | Uniquement lorsque les utilisateurs doivent afficher des documents dans une session Glowbl (sélecteur Sharepoint) | [12d736b4-dd63-4d2a-a527-e4ab0edb08e9](../azure/12d736b4-dd63-4d2a-a527-e4ab0edb08e9.md) |
>| Files.Read.All | Délégué | Uniquement lorsque les utilisateurs doivent afficher des documents dans une session Glowbl (sélecteur Sharepoint) | [12d736b4-dd63-4d2a-a527-e4ab0edb08e9](../azure/12d736b4-dd63-4d2a-a527-e4ab0edb08e9.md) |
>| User.Read | Délégué | Connectez-vous à l’utilisateur et lisez le profil utilisateur | [12d736b4-dd63-4d2a-a527-e4ab0edb08e9](../azure/12d736b4-dd63-4d2a-a527-e4ab0edb08e9.md) |
>| email | Délégué | Obtenir un e-mail utilisateur pour les règles d’accès à l’espace Glowbl en fonction des e-mails | [12d736b4-dd63-4d2a-a527-e4ab0edb08e9](../azure/12d736b4-dd63-4d2a-a527-e4ab0edb08e9.md) |
>| openid | Délégué | Utilisateur de connexion | [12d736b4-dd63-4d2a-a527-e4ab0edb08e9](../azure/12d736b4-dd63-4d2a-a527-e4ab0edb08e9.md) |
>| profil | Délégué | Afficher le profil de base utilisateur pour répertorier les participants aux sessions Glowbl | [12d736b4-dd63-4d2a-a527-e4ab0edb08e9](../azure/12d736b4-dd63-4d2a-a527-e4ab0edb08e9.md) |
