---
title: Informations sur l’application pour Weekdone par Weekdone Ltd
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 10/28/2021
...
description: Toutes les informations de sécurité et de conformité disponibles pour Weekdone, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le Registre CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/fa662fca-9224-49e3-9566-f66d2a6949af" target="_blank">Afficher dans Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003399" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Weekdone Ltd à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | Weekdone |
| ID | WA200003399 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | Weekdone Ltd |
| Site web de l’entreprise | [https://weekdone.com](https://weekdone.com) |
| Conditions d’utilisation de l’application | [https://weekdone.com/terms-of-service](https://weekdone.com/terms-of-service) |
| Fonctionnalités principales de l’application | Afficher et mettre à jour vos vérifications hebdomadaires et okrs, et être averti des mises à jour |
| Emplacement du siège social de l’entreprise | Estonie |
| Page d’informations sur l’application | [https://weekdone.com/integrations/microsoft-teams](https://weekdone.com/integrations/microsoft-teams) |
...
Ces informations ont été fournies par Weekdone Ltd sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont stockées dans vos bases de données ? | Adresse IP de l’appareil. Nom et adresse de messagerie du client. |
...
| URL de la politique de confidentialité | https://weekdone.com/privacy |
