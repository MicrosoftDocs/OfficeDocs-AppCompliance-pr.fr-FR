---
title: Informations sur l’application pour le dictionnaire EN-UA par Les consulats d’horizon
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/29/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour le dictionnaire EN-UA, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
ms.locfileid: "66564595"
---
# <a name="en-ua-dictionary"></a>Dictionnaire EN-UA

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Dernière mise à jour par le développeur : 24 mai 2022</p>

* <a href="https://teams.microsoft.com/l/app/1a24a3a3-1fda-4f70-abee-40bba8c638e8" target="_blank">Afficher dans le magasin Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004310" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Skyline Consulatnts à Microsoft :

| **Information** | **Réponse** |
|:----------------|:-------------|
| Nom de l'application | Dictionnaire EN-UA |
| ID | WA200004310 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | Consulats horizon |
| Site web de la société | [https://skylineconsultants.com](https://skylineconsultants.com) |
| Conditions d’utilisation de l’application | [https://skylineconsultants.com/terms-and-conditions/](https://skylineconsultants.com/terms-and-conditions/) |
| Fonctionnalités principales de l’application | English-Ukrainian application de dictionnaire par Skyline Consultants est entièrement organisée pour permettre aux utilisateurs de rechercher les mots inconnus tout en travaillant dans Microsoft Teams. |
...
Ces informations ont été fournies par Skyline Consulatnts sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont traitées par votre application ? | Profil utilisateur |
| L’application prend-elle en charge TLS 1.1 ou version ultérieure ? | Oui |
| L’application ou l’infrastructure sous-jacente stocke-t-elle des données client Microsoft ? | Oui |
| Quelles données sont stockées dans vos bases de données ? | Notre base de données conserve des informations : où l’utilisateur s’est arrêté dans l’application et restaure cet emplacement la prochaine fois que l’utilisateur entre dans l’application. ID d’utilisateur Graph |
...
| Si votre application n’utilise pas l’une des bibliothèques ci-dessus, quelle bibliothèque ou bibliothèque d’authentification utilise-t-elle ? | Microsoft.Graph; Microsoft.TeamsFx; |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Délégué | Pour accéder au profil utilisateur | [2da850e4-5b9d-455c-ae32-bec270de4b60](../azure/2da850e4-5b9d-455c-ae32-bec270de4b60.md) |
