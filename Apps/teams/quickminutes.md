---
title: Informations sur l’application pour QuickMinutes par QuickMinutes
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/18/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour QuickMinutes, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/5f60fe53-d441-4320-8c26-13fdaee9b58a" target="_blank">Afficher dans le magasin Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004414" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par QuickMinutes à Microsoft :

| **Information** | **Réponse** |
|:----------------|:-------------|
| Nom de l'application | QuickMinutes |
| ID | WA200004414 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | QuickMinutes |
| Site web de la société | [https://quickminutes.com](https://quickminutes.com) |
| Conditions d’utilisation de l’application | [https://quickminutes.com/privacy#/terms_of_service](https://quickminutes.com/privacy#/terms_of_service) |
| Fonctionnalités principales de l’application | Simplifiez vos flux de travail en ligne de réunion avec notre assistant numérique intelligent. |
| Emplacement du siège social de la société | Irlande |
| Page d’informations sur l’application | [https://support.quickminutes.com/portal/en-gb/kb/articles/m...](https://support.quickminutes.com/portal/en-gb/kb/articles/microsoft-teams-integration-22-4-2020-1) |
...
Ces informations ont été fournies par QuickMinutes sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont traitées par votre application ? | Nous utilisons les données de profil utilisateur pour remplir les informations utilisateur dans la base de données QuickMinutes lorsque l’utilisateur inscrit un nouveau compte auprès de QuickMinutes à l’aide de l’authentification unique Microsoft. QuickMinutes extrait les données de calendrier des utilisateurs pour afficher les événements dans l’interface utilisateur QuickMinutes. Nous ne stockons pas ces informations dans la base de données QuickMinutes, nous récupérons simplement les informations de API Graph et les affichons à l’utilisateur.  |
| L’application prend-elle en charge TLS 1.1 ou version ultérieure ? | Oui |
| L’application ou l’infrastructure sous-jacente stocke-t-elle des données client Microsoft ? | Oui |
| Quelles données sont stockées dans vos bases de données ? | Informations sur le profil utilisateur, par exemple prénom, nom, Email et image de profil. Nous stockons également les jetons d’accès et d’actualisation MS des utilisateurs. |
...
| URL de la politique de confidentialité | https://quickminutes.com/privacy#/privacy_policy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.ReadWrite | Délégué | L’étendue du calendrier est utilisée par QuickMinutes pour lire/écrire des réunions QuickMinutes dans le calendrier Microsoft de l’utilisateur | [e340e520-b8f4-4752-8e1c-60270c863b12](../azure/e340e520-b8f4-4752-8e1c-60270c863b12.md) |
>| People.Read | Délégué | L’étendue contacts est utilisée par QuickMinutes pour répertorier les contacts des utilisateurs Microsoft lorsqu’ils ajoutent des utilisateurs à leur organisation ou groupe QuickMinutes | [e340e520-b8f4-4752-8e1c-60270c863b12](../azure/e340e520-b8f4-4752-8e1c-60270c863b12.md) |
>| email | Délégué | L’étendue de l’e-mail est utilisée pour donner à QuickMinutes l’accès à l’adresse e-mail principale de l’utilisateur sous la forme de la revendication de courrier électronique. | [e340e520-b8f4-4752-8e1c-60270c863b12](../azure/e340e520-b8f4-4752-8e1c-60270c863b12.md) |
>| openid | Délégué | L’étendue openid est utilisée par QuickMinutes au niveau du point de terminaison de jeton Plateforme d'identités Microsoft pour acquérir des jetons d’ID. Cela permet à QuickMinutes d’utiliser les jetons pour accéder au API Graph pour le compte des utilisateurs. | [e340e520-b8f4-4752-8e1c-60270c863b12](../azure/e340e520-b8f4-4752-8e1c-60270c863b12.md) |
>| profil | Délégué | L’étendue du profil est utilisée par QuickMinutes pour accéder au profil des utilisateurs lorsque nous les enregistrons via l’authentification unique Microsoft et créons leur compte QuickMinutes. | [e340e520-b8f4-4752-8e1c-60270c863b12](../azure/e340e520-b8f4-4752-8e1c-60270c863b12.md) |
