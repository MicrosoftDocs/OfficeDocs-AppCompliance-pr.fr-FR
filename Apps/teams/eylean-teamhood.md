---
title: Informations sur l’application pour teamhood par Eylean
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/29/2021
...
description: Toutes les informations de sécurité et de conformité disponibles pour Teamhood, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
ms.locfileid: "64877681"
---
# <a name="teamhood"></a>Teamhood

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Dernière mise à jour par le développeur : 27 avril 2021</p>

* <a href="https://teams.microsoft.com/l/app/22372c30-c5de-483e-85b4-8d51db246eda" target="_blank">Afficher dans Teams magasin</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002568" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Eylean à Microsoft :
...
| Nom de la société partenaire | Eylean |
| Site web de la société | [https://teamhood.com](https://teamhood.com) |
| Conditions d’utilisation de l’application | [https://teamhood.com/terms-of-use/](https://teamhood.com/terms-of-use/) |
| Fonctionnalités principales de l’application | L’équipe est un logiciel de gestion de projet et de tâches tout-en-un pour une collaboration quotidienne efficace. Teamhood fournit les fonctionnalités nécessaires pour chaque responsable de projet et chaque membre de l’équipe pour planifier, exécuter et générer des rapports sur les données de travail. |
| Emplacement du siège social de la société | Lituanie |
| Page d’informations sur l’application | [https://teamhood.com/features/teamhood-and-microsoft-teams-...](https://teamhood.com/features/teamhood-and-microsoft-teams-integration/) |
...
Ces informations ont été fournies par Eylean sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
