---
title: Informations d’application pour DataMiner par Communications Communications
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 11/22/2021
...
description: Toutes les informations de sécurité et de conformité disponibles pour DataMiner, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le Registre CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/9a09d087-5d07-4481-b34f-cd053eab7925" target="_blank">Afficher dans Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003501" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Communications Communications à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | DataMiner |
| ID | WA200003501 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | Skyline Communications |
| Site web de l’entreprise | [https://www.skyline.be](https://www.skyline.be) |
| Conditions d’utilisation de l’application | [https://dataminer.services/terms/terms-of-service.html](https://dataminer.services/terms/terms-of-service.html) |
| Fonctionnalités principales de l’application | Communications Pare-CsS est le principal fournisseur mondial de solutions de logiciel d’orchestration, de système d’exploitation et NMS multi-fournisseurs de bout en bout pour le secteur des médias TIC et du haut débit. Notre plate-forme de gestion de réseau DataMiner, qui a reçu différents prix, permet une intégration de bout en bout des écosystèmes techniques les plus complexes et a été déployée par des opérateurs de premier plan dans le monde entier. |
| Emplacement du siège social de l’entreprise | Belgique |
| Page d’informations sur l’application | [https://www.skyline.be/dataminer/cloud-services](https://www.skyline.be/dataminer/cloud-services) |
...
Ces informations ont été fournies par Communications Communications sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| URL de la politique de confidentialité | https://dataminer.services/terms/privacy.html |
