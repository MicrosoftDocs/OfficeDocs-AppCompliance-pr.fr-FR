...
* <a href="https://teams.microsoft.com/l/app/5dcf4bd7-eccd-4f6d-b5f0-a4e04aab4ff9" target="_blank">Afficher dans Teams store</a>
...
Informations fournies par les flux amicaux vers Microsoft :
...
| Site web de l’entreprise | [https://friendlyflows.com](https://friendlyflows.com) |
...
Ces informations ont été fournies par des flux coniaux sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
>|:------------------------|:--------------------|:------------------------------------|
>| User.Read | délégué | Authentification |
>| profil | délégué | Authentification |
>| email | délégué | Inscription |
