---
title: Informations sur l’application pour Loop par flux conviviaux
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 11/18/2021
...
* <a href="https://teams.microsoft.com/l/app/5dcf4bd7-eccd-4f6d-b5f0-a4e04aab4ff9" target="_blank">Afficher dans Teams magasin</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003480" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par les flux conviviaux à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | Loop |
| ID | WA200003480 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | Flux convivial |
| Site web de la société | [https://friendlyflows.com](https://friendlyflows.com) |
...
Ces informations ont été fournies par les flux conviviaux sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont traitées par votre application ? | profil utilisateur, entrée utilisateur |
| L’application prend-elle en charge TLS 1.1 ou version ultérieure ? | Oui |
| L’application ou l’infrastructure sous-jacente stocke-t-elle des données client Microsoft ? | Oui |
| Quelles données sont stockées dans vos bases de données ? | profil utilisateur, entrée utilisateur |
...
| URL de la politique de confidentialité | https://friendlyflows.com/privacy-policy/ |
...
| Si votre application n’utilise pas l’une des bibliothèques ci-dessus, quelle bibliothèque ou bibliothèque d’authentification utilise-t-elle ? | Aucune |
