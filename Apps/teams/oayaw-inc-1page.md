---
title: 'Informations sur l’application pour 1Page par OAYAW, Inc.'
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/29/2022
...
description: 'Toutes les informations de sécurité et de conformité disponibles pour 1Page, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le Registre CSA STAR.'
...
<p>Last updated by the developer on: December 31, 2021</p>

* <a href="https://teams.microsoft.com/l/app/2b876f4d-2e6b-4ee7-9b09-8893808c1380" target="_blank">Afficher dans Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003900" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par OAYAW, Inc. à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | 1Page |
| ID | WA200003900 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | OAYAW, Inc. |
| Site web de l’entreprise | [https://www.get1page.com](https://www.get1page.com) |
| Conditions d’utilisation de l’application | [https://www.get1page.com/en/terms-of-use](https://www.get1page.com/en/terms-of-use) |
| Fonctionnalités principales de l’application | Surcharger vos réunions avec les démarrages de conversation récapitulatifs 1Page &amp; , minutes avant chaque réunion |
| Emplacement du siège social de l’entreprise | États-Unis Amérique |
| Page d’informations sur l’application | [https://www.get1page.com](https://www.get1page.com) |
...
Ces informations ont été fournies par OAYAW, Inc. sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont stockées dans vos bases de données ? | Adresse e-mail, nom, événements de calendrier |
| Si des infastructures sous-jacentes traitent ou stockent des données client Microsoft, où sont stockées géographiquement ces données ? | France |
...
| URL de la politique de confidentialité | https://www.get1page.com/en/privacy-policy |
...
| Liste des types de stratégies pris en charge | En fonction des applications qu’il a connectées et des éléments dans l’application achetés, l’utilisateur peut voir ou ne pas voir de cartes spécifiques. |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.ReadWrite | délégué | Avec les informations de calendrier, nous sommes en mesure de fournir des données pertinentes pour les personnes de la réunion. | [d7e20ef1-fc4b-42e0-a74f-a3c9a806aa73](../azure/d7e20ef1-fc4b-42e0-a74f-a3c9a806aa73.md) |
