...
description: Toutes les informations de sécurité et de conformité disponibles pour Dost - Inclusive Language Bot, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
ms.locfileid: "66547114"
---
# <a name="dost---inclusive-language-bot"></a>Dost - Bot de langage inclusif

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Dernière mise à jour par le développeur : 5 mai 2022</p>

* <a href="https://teams.microsoft.com/l/app/14a29007-c5ca-4a2d-9228-b0217d8403d7" target="_blank">Afficher dans le magasin Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004214" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par ishield Technologies, Inc. à Microsoft :

| **Information** | **Réponse** |
|:----------------|:-------------|
| Nom de l'application | Dost - Bot de langage inclusif |
| ID | WA200004214 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | ishield Technologies, Inc. |
| Site web de la société | [https://ishield.ai](https://ishield.ai) |
| Conditions d’utilisation de l’application | [https://ishield.ai/terms-of-service/](https://ishield.ai/terms-of-service/) |
| Fonctionnalités principales de l’application | Promouvoir la messagerie inclusive en milieu de travail, la collaboration et les communications au sein de vos équipes avec l’aide de Dost. Lorsque vous ajoutez Dost à votre espace de travail Microsoft Teams, Dost vous guide dans l’utilisation d’un langage inclusif dans votre messagerie via des suggestions et du matériel éducatif.  Dost expose les moments d’apprentissage en temps réel lorsque les utilisateurs publient des messages contenant des biais inconscients, des microaggressions ou un langage non inclusif avec des recommandations pour le modifier et le rendre plus inclusif. |
| Emplacement du siège social de la société | États-Unis d’Amérique |
| Page d’informations sur l’application | [https://getdost.com](https://getdost.com) |
...
Ces informations ont été fournies par ishield Technologies, Inc. sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont traitées par votre application ? | L’application traite les messages MS Teams dans l’étendue Teams et La conversation, mais ne stocke pas de messages ou de détails utilisateur |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| ChannelMessage.Read.Group | application | Lire les messages dans l’étendue Teams pour fournir des commentaires à l’utilisateur sur un langage non inclusif | [01d607db-287c-4354-943d-f015ac938b90](../azure/01d607db-287c-4354-943d-f015ac938b90.md) |
>| ChatMessage.Read.Chat | application | Lire les messages dans l’étendue de conversation pour fournir des commentaires à l’utilisateur sur un langage non inclusif | [01d607db-287c-4354-943d-f015ac938b90](../azure/01d607db-287c-4354-943d-f015ac938b90.md) |
