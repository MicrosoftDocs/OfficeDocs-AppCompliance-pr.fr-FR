---
title: Informations d’application pour MyCheckins par Cloud Catalogs LLC
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/15/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour MyCheckins, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/6f74dbb7-cd5c-48ac-b3f4-082eabef3808" target="_blank">Afficher dans le magasin Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004375" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Cloud Catalogs LLC à Microsoft :

| **Information** | **Réponse** |
|:----------------|:-------------|
| Nom de l'application | MyCheckins |
| ID | WA200004375 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | Cloud Catalogs LLC |
| Site web de la société | [https://mycheckins.io](https://mycheckins.io) |
| Conditions d’utilisation de l’application | [https://mycheckins.io/terms-and-conditions](https://mycheckins.io/terms-and-conditions) |
| Fonctionnalités principales de l’application | Exécutez des stand-ups asynchrones, des rétrospectives et bien plus encore sur Microsoft Teams. |
| Emplacement du siège social de la société | États-Unis d’Amérique |
| Page d’informations sur l’application | [https://mycheckins.io](https://mycheckins.io) |
...
Ces informations ont été fournies par Cloud Catalogs LLC sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont traitées par votre application ? | Données de profil utilisateur, Email utilisateur, messages utilisateur envoyés au bot |
| L’application prend-elle en charge TLS 1.1 ou version ultérieure ? | Oui |
| L’application ou l’infrastructure sous-jacente stocke-t-elle des données client Microsoft ? | Oui |
| Quelles données sont stockées dans vos bases de données ? | Données de profil utilisateur, Email utilisateur, messages utilisateur envoyés au bot |
...
| URL de la politique de confidentialité | https://mycheckins.io/privacy-policy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | application | Obtention de détails utilisateur tels que le prénom, le nom et l’adresse e-mail | [8f43fc50-571c-4eab-b6ea-675d55e1755e](../azure/8f43fc50-571c-4eab-b6ea-675d55e1755e.md) |
