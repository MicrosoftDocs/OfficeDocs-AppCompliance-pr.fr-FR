...
description: Toutes les informations de sécurité et de conformité disponibles pour social social, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le Registre CSA STAR.
...
ms.locfileid: "60682314"
---
# <a name="social-advocacy"></a>Causes sociales

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Last updated by the developer on: October 24, 2021</p>

* <a href="https://teams.microsoft.com/l/app/b9370833-f71b-4f99-8343-adc3c29c74b1" target="_blank">Afficher dans Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002598" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Oktopost à Microsoft :

| **Information** | **Réponse** |
|:----------------|:-------------|
| Nom de l'application | Causes sociales |
| ID | WA200002598 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | Oktopost |
| Site web de l’entreprise | [https://www.oktopost.com](https://www.oktopost.com) |
| Conditions d’utilisation de l’application | [https://www.oktopost.com/terms](https://www.oktopost.com/terms) |
| Fonctionnalités principales de l’application | Oktopost est une plateforme de gestion des réseaux sociaux et de prise en charge des employés pour B2B. Avec Oktopost, vous pouvez gérer, surveiller et mesurer toutes vos activités de réseaux sociaux au même endroit. Oktopost dispose de deux solutions principales : 1) la gestion des réseaux sociaux, y compris la publication, la surveillance, l’analyse, l’engagement et 2) la collaboration des employés, ce qui permet aux marketingeurs de gérer les programmes de partage social pour les employés. La proposition de valeur unique Oktopost permet également aux marketeurs d’intégrer des données sociales à la pile marketing. |
| Emplacement du siège social de l’entreprise | Israël |
...
Ces informations ont été fournies par Oktopost sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Votre environnement utilise-t-il une protection anti-programme malveillant classique ou des contrôles d’application ? | TraditionalAntiMalware, ApplicationControls |
...
| Un processus formel de gestion des risques de sécurité des informations est-il établi ? | Oui |
...
| URL de la politique de confidentialité | https://www.oktopost.com/privacy |
