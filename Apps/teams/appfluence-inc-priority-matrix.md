...
* <a href="https://teams.microsoft.com/l/app/5be2b320-a5b7-4221-893c-dee506e4e365" target="_blank">Afficher dans le magasin Teams</a>
...
| ID | WA104382005 |
| Fonctionnalités | Bot, Onglet, Extension de la messagerie, Connecteur |
...
| URL de la page d’informations sur l’application Teams | [https://appfluence.com/project-management-integration-for-m...](https://appfluence.com/project-management-integration-for-microsoft-teams/) |
...
>| Files.Read.All | délégué | Nous ne stockons pas d’informations sur les fichiers, sauf si l’utilisateur crée explicitement et en connaissance de cause un élément de matrice prioritaire lié au fichier d’origine. | Dans notre fonctionnalité un-à-un (disponible via notre application web et également nos add-ins Outlook/Teams), nous utilisons cette fonctionnalité pour mettre en évidence les fichiers SharePoint/OneDrive partagés entre deux utilisateurs dans notre système, afin de faciliter les réunions et la collaboration globale. | affadfb6-f17b-428f-97f9-9aae3b6175bc |
...
>| Mail.Read | délégué | Nous stockons les tâches créées dans notre système, avec un lien vers le message d’origine. | Utilisé dans notre add-in Outlook pour transformer les e-mails en tâches et pour afficher le travail partagé en affichage 1:1. | d76f016f-52c7-41b5-835b-900361d7040c |
>| Tasks.Read | délégué | Certaines tâches Outlook/Planner sont répliquées dans notre système pour aider les nouveaux utilisateurs. | Nous a bootstrap de nouveaux comptes d’utilisateurs avec leurs tâches Graph. | d76f016f-52c7-41b5-835b-900361d7040c |
...
<iframe height='1020' title='Informations sur la sécurité des applications Microsoft Cloud' src='https://appmcasinfoprod.azurewebsites.net/#/dashboard/35667' frameborder='no' style='width: 100%;'></iframe>
