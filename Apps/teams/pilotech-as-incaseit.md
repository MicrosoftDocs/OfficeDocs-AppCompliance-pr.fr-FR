...
ms.locfileid: "64875381"
---
# <a name="incaseit"></a>InCaseIT

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Dernière mise à jour par le développeur : 3 août 2021</p>

* <a href="https://teams.microsoft.com/l/app/4420b597-c1d5-4d40-ba81-2b2a78575c81" target="_blank">Afficher dans Teams magasin</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003265" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Pilotech AS à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | InCaseIT |
| ID | WA200003265 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | Pilotech AS |
| Site web de la société | [https://incaseit.com](https://incaseit.com) |
| Conditions d’utilisation de l’application | [https://www.manula.com/manuals/pilotech-as/incaseit2/1/en/t...](https://www.manula.com/manuals/pilotech-as/incaseit2/1/en/topic/1-4-terms-of-use) |
| Fonctionnalités principales de l’application | Système de gestion des crises. système de préparation et de gestion des crises et des incidents. |
| Emplacement du siège social de la société | Norvège |
| Page d’informations sur l’application | [https://www.manula.com/manuals/pilotech-as/incaseit2/1/en/t...](https://www.manula.com/manuals/pilotech-as/incaseit2/1/en/topic/introduction-to-incaseit-version-2-0) |
...
Ces informations ont été fournies par Pilotech AS sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.ReadWrite | Délégué | Les seules données utilisées sont la confirmation explicite par les utilisateurs pour permettre à l’application d’utiliser un jeton d’accès pour appeler le API Graph. | [9af6eceb-6a8b-4710-b51d-dde2ac01cc71](../azure/9af6eceb-6a8b-4710-b51d-dde2ac01cc71.md) |
>| OnlineMeetings.ReadWrite | Délégué | Les seules données utilisées sont la confirmation explicite par les utilisateurs pour permettre à l’application d’utiliser un jeton d’accès pour appeler le API Graph. | [9af6eceb-6a8b-4710-b51d-dde2ac01cc71](../azure/9af6eceb-6a8b-4710-b51d-dde2ac01cc71.md) |
>| User.Read | Délégué | Les seules données utilisées sont la confirmation explicite par les utilisateurs pour permettre à l’application d’utiliser un jeton d’accès pour appeler le API Graph. | [9af6eceb-6a8b-4710-b51d-dde2ac01cc71](../azure/9af6eceb-6a8b-4710-b51d-dde2ac01cc71.md) |
