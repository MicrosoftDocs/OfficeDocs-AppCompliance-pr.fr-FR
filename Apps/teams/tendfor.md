---
title: Informations d’application pour Tendfor par Tendfor
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/16/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour Tendfor, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
ms.locfileid: "64876181"
---
# <a name="tendfor"></a>Tendfor

<p></p><a href="https://aka.ms/appcertification" alt="This Microsoft 365 Certified app has been reviewed by Microsoft against industry standards and controls for security, compliance, and data handling practices. Where applicable, Microsoft has verified the developer's claims of compliance with reasonable and effective practices." target="_blank"><img alt="Click here for more information on the Microsoft Certified app program." src="../media/certified.png" width="650" /></a>
<p>Dernière mise à jour par le développeur : 15 février 2022</p>

* <a href="https://teams.microsoft.com/l/app/212fcd92-bc06-4746-85c4-f7b5d39579ba" target="_blank">Afficher dans Teams magasin</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002996" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Tendfor à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | Tendfor |
| ID | WA200002996 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | Tendfor |
| Site web de la société | [https://www.tendfor.com](https://www.tendfor.com) |
| Conditions d’utilisation de l’application | [https://tendfor.com/tendfor_docs/en/StandardContractMarch20...](https://tendfor.com/tendfor_docs/en/StandardContractMarch2019.pdf) |
| Fonctionnalités principales de l’application | Un centre de contacts complet et une console de standard pour Microsoft Teams. |
| Emplacement du siège social de la société | Suède |
| Page d’informations sur l’application | [https://www.tendfor.com](https://www.tendfor.com) |
...
Ces informations ont été fournies par Tendfor sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont traitées par votre application ? | Données de profil utilisateur, données de calendrier utilisateur, média d’appel |
| L’application prend-elle en charge TLS 1.1 ou version ultérieure ? | Oui |
| L’application ou l’infrastructure sous-jacente stocke-t-elle des données client Microsoft ? | Oui |
| Quelles données sont stockées dans vos bases de données ? | Données de profil utilisateur, données de calendrier utilisateur |
...
| URL de la politique de confidentialité | https://tendfor.com/en/contact/tendfor-privacy-notice/ |
...
| Répertorier les types de stratégies prises en charge | Tous pris en charge par Azure |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Délégué | Pour pouvoir connecter des utilisateurs | [b7e8237f-d86d-4874-8f8b-7faa8f768436](../azure/b7e8237f-d86d-4874-8f8b-7faa8f768436.md) |
>| User.Read.All | application | Pour pouvoir importer des informations utilisateur | [b7e8237f-d86d-4874-8f8b-7faa8f768436](../azure/b7e8237f-d86d-4874-8f8b-7faa8f768436.md) |
>| User.Read.All | Délégué | Pour pouvoir importer des informations utilisateur | [b7e8237f-d86d-4874-8f8b-7faa8f768436](../azure/b7e8237f-d86d-4874-8f8b-7faa8f768436.md) |
