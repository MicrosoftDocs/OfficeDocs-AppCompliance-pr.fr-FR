---
title: Informations sur l’application pour PrivyNow par PT Privy Identitas Digital
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/14/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour PrivyNow, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
ms.locfileid: "66547105"
---
# <a name="privynow"></a>PrivyNow

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Dernière mise à jour par le développeur : 2 mars 2022</p>

* <a href="https://teams.microsoft.com/l/app/00e595af-26e4-46b9-97d1-46e0831b1f02" target="_blank">Afficher dans le magasin Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004229" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par PT Privy Identitas Digital à Microsoft :

| **Information** | **Réponse** |
|:----------------|:-------------|
| Nom de l'application | PrivyNow |
| ID | WA200004229 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | PT Privy Identitas Digital |
| Site web de la société | [https://privynow.com/about-us/](https://privynow.com/about-us/) |
| Conditions d’utilisation de l’application | [https://privynow.com/terms-of-use/](https://privynow.com/terms-of-use/) |
| Fonctionnalités principales de l’application | Signer toutes sortes de documents est une partie essentielle de votre vie quotidienne, et retarder tout changer. Fermez rapidement vos transactions avec PrivyNow. Chargez et partagez un document en 1 minute.   Pour utiliser cette application, les utilisateurs doivent disposer d’un compte PrivyNow actif, veuillez vous inscrire via PrivyNow.com ou contactez notre équipe de support technique pour plus d’informations. |
| Emplacement du siège social de la société | Indonésie |
| Page d’informations sur l’application | [https://privynow.com/guide/](https://privynow.com/guide/) |
...
Ces informations ont été fournies par PT Privy Identitas Digital sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont traitées par votre application ? | Nom complet, e-mails |
| L’application prend-elle en charge TLS 1.1 ou version ultérieure ? | Oui |
| L’application ou l’infrastructure sous-jacente stocke-t-elle des données client Microsoft ? | Oui |
| Quelles données sont stockées dans vos bases de données ? | Nom complet, e-mails |
| Si l’infastructure sous-jacente traite ou stocke les données client Microsoft, où ces données sont-elles stockées géographiquement ? | Indonésie |
...
| URL de la politique de confidentialité | https://privynow.com/terms-of-use/ |
