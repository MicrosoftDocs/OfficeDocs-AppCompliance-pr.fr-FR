---
title: Informations d’application pour TagMyFav par Avishkaram Technologies Pvt Ltd
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/14/2022
...
description: 'Toutes les informations de sécurité et de conformité disponibles pour TagMyFav, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le Registre CSA STAR.'
...
<p>Last updated by the developer on: March 12, 2022</p>

* <a href="https://teams.microsoft.com/l/app/4adaed2f-7c6a-4128-ba20-4fb097581b1b" target="_blank">Afficher dans Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002713" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Avishkaram Technologies Pvt Ltd à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | TagMyFav |
| ID | WA200002713 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | Avishkaram Technologies Pvt Ltd |
| Site web de l’entreprise | [https://www.avishkaram.com](https://www.avishkaram.com) |
| Conditions d’utilisation de l’application | [https://www.tagmyfav.com/terms-conditions](https://www.tagmyfav.com/terms-conditions) |
| Fonctionnalités principales de l’application | TagMyFav pour Microsoft 365 vous offre une solution de signet simple pour faciliter la communication en collaboration&amp;. Enregistrez &amp; les liens de partage lors d’une conversation dans Microsoft Teams, lors de la lecture d’e-mails dans Outlook, lors de la création de documents dans Word ou lors d’une recherche dans un navigateur. TagMyFav est adapté à tous les secteurs tels que le support technique, le support technique, la formation juridique, &amp; l’enseignant des étudiants, le marketing, les ressources humaines, etc. pour organiser et partager les liens utiles pour la collaboration ou la recherche. |
| Emplacement du siège social de l’entreprise | Inde |
| Page d’informations sur l’application | [https://www.tagmyfav.com](https://www.tagmyfav.com) |
...
Ces informations ont été fournies par Avishkaram Technologies Pvt Ltd sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont traitées par votre application ? | Données de profil utilisateur, courrier électronique |
| L’application prend-elle en charge TLS 1.1 ou une valeur supérieure ? | Oui |
| L’application ou l’infrastructure sous-jacente stocke-t-elle des données client Microsoft ? | Oui |
| Quelles données sont stockées dans vos bases de données ? | Email, Name, TimeZone, Microsoft Teams ID |
...
| URL de la politique de confidentialité | https://www.tagmyfav.com/privacy-policy/ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Contacts.Read | délégué | Lire les contacts de l’utilisateur | [f5f2921e-bfb3-4d75-b84f-0b2cc13096f7](../azure/f5f2921e-bfb3-4d75-b84f-0b2cc13096f7.md) |
>| User.Read | délégué | Lire les informations de profil de base des utilisateurs | [f5f2921e-bfb3-4d75-b84f-0b2cc13096f7](../azure/f5f2921e-bfb3-4d75-b84f-0b2cc13096f7.md) |
>| email | délégué | afficher les messages électroniques des utilisateurs | [f5f2921e-bfb3-4d75-b84f-0b2cc13096f7](../azure/f5f2921e-bfb3-4d75-b84f-0b2cc13096f7.md) |
>| offline_access | délégué | Gérer l’accès aux données auxquelles vous avez accordé l’accès | [f5f2921e-bfb3-4d75-b84f-0b2cc13096f7](../azure/f5f2921e-bfb3-4d75-b84f-0b2cc13096f7.md) |
>| openid | délégué | connectez-vous à l’utilisateur | [f5f2921e-bfb3-4d75-b84f-0b2cc13096f7](../azure/f5f2921e-bfb3-4d75-b84f-0b2cc13096f7.md) |
>| profil | délégué | Afficher le profil des utilisateurs | [f5f2921e-bfb3-4d75-b84f-0b2cc13096f7](../azure/f5f2921e-bfb3-4d75-b84f-0b2cc13096f7.md) |
