---
title: Informations d’application pour IQ par NLSQL
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/01/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour IQ, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
ms.locfileid: "65935445"
---
# <a name="iq"></a>IQ

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Dernière mise à jour par le développeur : 18 mai 2022</p>

* <a href="https://teams.microsoft.com/l/app/9d0bdc38-2705-4109-835f-3c14534f923f" target="_blank">Afficher dans le magasin Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004126" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par NLSQL à Microsoft :

| **Information** | **Réponse** |
|:----------------|:-------------|
| Nom de l'application | IQ |
| ID | WA200004126 |
| Clients Office 365 pris en charge | Microsoft Teams |
| Nom de la société partenaire | NLSQL |
| Site web de la société | [https://nlsql.com](https://nlsql.com) |
| Conditions d’utilisation de l’application | [https://www.nlsql.com/terms_of_use](https://www.nlsql.com/terms_of_use) |
| Fonctionnalités principales de l’application | IQ aide les gestionnaires à poser des questions aux entrevues et les candidats à se préparer à l’entrevue. La préparation des questions d’entrevue est le logiciel d’intelligence artificielle qui génère une question aléatoire basée sur l’entrée de position, qui fait une idée parfaite de la façon d’être bien préparé pour l’entrevue. Les candidats peuvent se sentir libres de poser des questions d’entrevue pour une meilleure préparation. |
| Emplacement du siège social de la société | Royaume-Uni de Grande-Bretagne et d’Irlande du Nord (le) |
| Page d’informations sur l’application | [https://www.nlsql.com/blog/post/interview-questions-to-ask-...](https://www.nlsql.com/blog/post/interview-questions-to-ask-candidates-and-managers/) |
...
Ces informations ont été fournies par NLSQL sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Délégué | Activer la connexion et lire le profil utilisateur | [f9555238-64f3-4ec2-a8fc-3787baa157aa](../azure/f9555238-64f3-4ec2-a8fc-3787baa157aa.md) |
