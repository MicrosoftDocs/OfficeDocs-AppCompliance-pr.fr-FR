---
title: Informations d’application pour CyReport par CyTrack
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/24/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour CyReport, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
ms.locfileid: "66549398"
---
# <a name="cyreport"></a>CyReport

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Dernière mise à jour par le développeur : 9 mai 2022</p>

* <a href="https://teams.microsoft.com/l/app/10b18ffa-155e-4b1f-89d5-88401ba0aa64" target="_blank">Afficher dans le magasin Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004272" target="_blank">Afficher dans AppSource</a>
...
| Fonctionnalités principales de l’application | Analyse du temps de travail et création de rapports pour des insights métier sur les interactions de &amp; productivité de votre équipe Microsoft&#8217;.  Solution d’analyse et de création de rapports facile à utiliser pour vos insights métier sur la productivité de votre équipe&#8217;, les interactions avec les clients, les tendances, la qualité des appels, les coûts de communication et bien plus encore. CyReport pour Microsoft Teams améliore la collaboration, les performances et l’efficacité des communications métier, ce qui vous offre une expérience client exceptionnelle. |
| Emplacement du siège social de la société | Australie |
| Page d’informations sur l’application | [https://web.cytrack.com/microsoft-teams/call-reporting-for-...](https://web.cytrack.com/microsoft-teams/call-reporting-for-microsoft-teams/) |
