---
title: Informations sur l’application pour SuperOffice par le logiciel InfoBridge SuperOffice
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 12/10/2021
...
description: Toutes les informations de sécurité et de conformité disponibles pour SuperOffice, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le Registre CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/4f9a1c49-28e3-443c-9007-67c7819407bc" target="_blank">Afficher dans Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003364" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par le logiciel InfoBridge SuperOffice à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | SuperOffice |
| ID | WA200003364 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | Logiciel InfoBridge SuperOffice |
| Site web de l’entreprise | [https://infobridge.com](https://infobridge.com) |
| Conditions d’utilisation de l’application | [https://msteams.superofficeapps.com/Home/TermsAndConditions](https://msteams.superofficeapps.com/Home/TermsAndConditions) |
| Fonctionnalités principales de l’application | Informez-vous sur ce qui se passe pour vos clients, projets et ventes dans SuperOffice CRM. |
| Emplacement du siège social de l’entreprise | Pays-Bas (les) |
| Page d’informations sur l’application | [https://msteams.superofficeapps.com](https://msteams.superofficeapps.com) |
...
Ces informations ont été fournies par superoffice InfoBridge Software sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| URL de la politique de confidentialité | https://msteams.superofficeapps.com/Home/PrivacyPolicy |
