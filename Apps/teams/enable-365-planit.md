---
title: Informations sur l’application pour PlanIt by Enable 365
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/11/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour PlanIt, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
ms.locfileid: "66765136"
---
# <a name="planit"></a>PlanIt

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Dernière mise à jour par le développeur : 7 juillet 2022</p>

* <a href="https://teams.microsoft.com/l/app/49cd11e3-cd7c-422a-9e2c-98a0a40fa418" target="_blank">Afficher dans le magasin Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004211" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Enable 365 à Microsoft :

| **Information** | **Réponse** |
|:----------------|:-------------|
| Nom de l'application | PlanIt |
| ID | WA200004211 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | Activer 365 |
| Site web de la société | [https://www.enable.no](https://www.enable.no) |
| Conditions d’utilisation de l’application | [https://www.enable.no/standard-contract-enable-planit-for-m...](https://www.enable.no/standard-contract-enable-planit-for-microsoft-store/) |
| Fonctionnalités principales de l’application | Outil facile à utiliser pour la planification annuelle. Belle vue visuelle dans un calendrier circulaire, connecté au Planificateur.  |
| Emplacement du siège social de la société | Norvège |
| Page d’informations sur l’application | [https://appsource.microsoft.com/en-us/product/office/WA2000...](https://appsource.microsoft.com/en-us/product/office/WA200004211) |
...
Ces informations ont été fournies par Enable 365 sur la façon dont cette application collecte et stocke les données d’organisation et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont traitées par votre application ? | Données de profil utilisateur, listes SharePoint et calendrier Teams |
| L’application prend-elle en charge TLS 1.1 ou version ultérieure ? | Oui |
| L’application ou l’infrastructure sous-jacente stocke-t-elle des données client Microsoft ? | Oui |
| Quelles données sont stockées dans vos bases de données ? | Données d’autorisation utilisateur et Teams |
| Si l’infastructure sous-jacente traite ou stocke les données client Microsoft, où ces données sont-elles stockées géographiquement ? | Irlande, Norvège |
...
| Authentification multifacteur (MFA) activée pour : | Credential, CodeRepositories |
...
| URL de la politique de confidentialité | https://www.enable.no/eighteen/enable-privacy-policy/ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.ReadBasic.All | Délégué | Identifier l’utilisateur actuel | [49cd11e3-cd7c-422a-9e2c-98a0a40fa418](../azure/49cd11e3-cd7c-422a-9e2c-98a0a40fa418.md) |
>| offline_access | Délégué | Stockage de données Teams | [49cd11e3-cd7c-422a-9e2c-98a0a40fa418](../azure/49cd11e3-cd7c-422a-9e2c-98a0a40fa418.md) |
>| openid | Délégué | Authentification unique | [49cd11e3-cd7c-422a-9e2c-98a0a40fa418](../azure/49cd11e3-cd7c-422a-9e2c-98a0a40fa418.md) |
>| profil | Délégué | Identifier l’utilisateur actuel | [49cd11e3-cd7c-422a-9e2c-98a0a40fa418](../azure/49cd11e3-cd7c-422a-9e2c-98a0a40fa418.md) |
