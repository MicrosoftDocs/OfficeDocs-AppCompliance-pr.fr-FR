---
title: Informations sur l’application pour le portail KURO par Si-Net
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/23/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour le portail KURO, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
ms.locfileid: "65692373"
---
# <a name="kuro-portal"></a>Portail KURO

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Dernière mise à jour par le développeur : 3 mai 2022</p>

* <a href="https://teams.microsoft.com/l/app/c4af7af6-4fa4-4777-bab7-713cda6d0f74" target="_blank">Afficher dans Teams magasin</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004019" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Si-Net à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | Portail KURO |
| ID | WA200004019 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | Si-Net |
| Site web de la société | [https://www.si-net.it](https://www.si-net.it) |
| Conditions d’utilisation de l’application | [https://www.si-net.it/termini-di-utilizzo-kuro/](https://www.si-net.it/termini-di-utilizzo-kuro/) |
| Fonctionnalités principales de l’application | L’application KURO PORTAL pour Teams promet d’être un CRM léger où les utilisateurs peuvent avoir en un coup d’œil toutes les informations client nécessaires, être utilisés comme un annuaire téléphonique pour appeler directement des équipes avec leur propre opérateur téléphonique, envoyer des e-mails directement aux personnes dans les contacts, discuter directement et créer une réunion avec les clients invités du portail Kuro,  recherchez les informations des clients de manière simple et rapide, accédez directement à la collection de documents et à la gestion des documents partagés du client sélectionné&#8217;  |
...
Ces informations ont été fournies par Si-Net sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont traitées par votre application ? | client client et appareil |
...
| URL de la politique de confidentialité | https://www.si-net.it/termini-di-utilizzo-kuro/ |
