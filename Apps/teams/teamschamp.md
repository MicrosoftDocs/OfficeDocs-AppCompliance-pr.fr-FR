...
description: Toutes les informations disponibles sur la sécurité et la conformité pour TeamsChamp, ses politiques de traitement des données, ses informations sur le catalogue d’applications Microsoft Cloud App Security et les informations de sécurité et de conformité dans le registre STAR de l’ASC.
...
* <a href="https://teams.microsoft.com/l/app/4fea4594-3f83-4e33-9929-9af6b78a7340" target="_blank">Vue dans Teams magasin</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001487" target="_blank">Voir dans AppSource</a>
...
| Nom de l’entreprise partenaire | TeamsChamp |
| URL du site web partenaire | [https://www.teamschamp.com/](https://www.teamschamp.com/) |
| URL de la page Teams’informations d’application | [https://www.teamschamp.com](https://www.teamschamp.com) |
...
Ces informations ont été fournies par TeamsChamp sur la façon dont cette application recueille et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
>|:----------------|:--------------------|:---------------------------------------------------|:--------------------------|:--------------------------|
>| User.Read | Délégué | Connectez-vous et lisez le profil des utilisateurs | Aucune donnée stockée dans notre bbdd | 79d7af39-4f57-4e95-adaf-ec8ff756d0df |
>| User.ReadBasic.All | Délégué | Lire le profil de base de tous les utilisateurs | Aucune donnée stockée dans notre bbdd | 79d7af39-4f57-4e95-adaf-ec8ff756d0df |
>| profil | Délégué | Afficher le profil de base des utilisateurs | Aucune donnée stockée dans notre bbdd | 79d7af39-4f57-4e95-adaf-ec8ff756d0df |
...
>|:-------------------|:--------------------------|:--------------------------|
>| Paiements à nu | Nom de la comnpany, CIF/TVA ID, Adresse fiscale | Paiements |
...
>Informarion personnelle en tant que nom complet, e-mail
...
<iframe height='1020' title='Microsoft Cloud App Security information' src='https://appmcasinfoprod.azurewebsites.net/#/dashboard/36549' frameborder='no' style='width: 100%;'></iframe>

<a href="https://appmcasinfoprod.azurewebsites.net/#/dashboard/36549" target="_blank">Afficher dans un nouvel onglet</a>
...
Ces informations ont été fournies par TeamsChamp sur la façon dont cette application gère l’authentification, l’autorisation, les meilleures pratiques d’enregistrement des applications et d’autres critères d’identité.
