---
title: Informations d’application pour EducationHUB Lesmateriaal par Smartersoft B.V.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/29/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour EducationHUB Lesmateriaal, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/f5558ae7-a166-41bd-997b-f8cc1eddebac" target="_blank">Afficher dans le magasin Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004326" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Smartersoft B.V. vers Microsoft :

| **Information** | **Réponse** |
|:----------------|:-------------|
| Nom de l'application | EducationHUB Lesmateriaal |
| ID | WA200004326 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | Smartersoft B.V. |
| Site web de la société | [https://smartersoft.nl](https://smartersoft.nl) |
| Conditions d’utilisation de l’application | [https://content.educationhub.nl/terms](https://content.educationhub.nl/terms) |
| Fonctionnalités principales de l’application | Permettre aux écoles de fournir un accès direct au contenu numérique fourni à l’école au lieu de forcer les élèves à accéder à un autre site web. |
| Emplacement du siège social de la société | Pays-Bas (le) |
| Page d’informations sur l’application | [https://content.educationhub.nl](https://content.educationhub.nl) |
...
Ces informations ont été fournies par Smartersoft B.V. sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont traitées par votre application ? | ID d’utilisateur, appartenance au groupe, contenu personnel ajouté à l’application |
| L’application prend-elle en charge TLS 1.1 ou version ultérieure ? | Oui |
| L’application ou l’infrastructure sous-jacente stocke-t-elle des données client Microsoft ? | Oui |
| Quelles données sont stockées dans vos bases de données ? | ID d’utilisateur, ID de groupe, liens fournis par l’utilisateur vers du contenu scolaire numérique |
...
| Répertorier les types de stratégies prises en charge | Tout, la plateforme Microsoft est chargée de nous donner un jeton pour un utilisateur. L’administrateur décide de la façon dont l’utilisateur est validé/forcé d’utiliser l’authentification multifacteur |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Group.Read.All | Délégué | Informations d’accès enregistrées dans les attributs d’extension de groupe | [d3c78487-7def-49e1-9d17-40e94d66ac5b](../azure/d3c78487-7def-49e1-9d17-40e94d66ac5b.md) |
>| Team.ReadBasic.All | Délégué | Informations sur les équipes d’utilisateurs | [d3c78487-7def-49e1-9d17-40e94d66ac5b](../azure/d3c78487-7def-49e1-9d17-40e94d66ac5b.md) |
>| User.Read | Délégué | Connexion | [d3c78487-7def-49e1-9d17-40e94d66ac5b](../azure/d3c78487-7def-49e1-9d17-40e94d66ac5b.md) |
