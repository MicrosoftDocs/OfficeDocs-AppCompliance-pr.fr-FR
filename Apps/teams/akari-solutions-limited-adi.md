---
title: Informations sur l’application pour ADI par Akari Solutions Limited
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/29/2021
...
ms.locfileid: "64879831"
---
# <a name="adi"></a>ADI

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Dernière mise à jour par le développeur : 28 avril 2021</p>

* <a href="https://teams.microsoft.com/l/app/de5717a1-6884-4b96-8b1e-ee17b5d778f3" target="_blank">Afficher dans Teams magasin</a>
...
Informations fournies par Akari Solutions Limited to Microsoft :
...
| Site web de la société | [https://akari.io](https://akari.io) |
| Conditions d’utilisation de l’application | [https://akari.io/adi-terms-and-conditions/](https://akari.io/adi-terms-and-conditions/) |
| Fonctionnalités principales de l’application | ADI est là pour vous aider à répondre à tous vos besoins en matière d’accessibilité et pour augmenter vos programmes de gestion des changements. Vous pouvez demander à ADI de vous donner des réponses, des conseils et des informations sur l’utilisation des fonctionnalités d’accessibilité dans Microsoft Teams, vous pouvez en savoir plus sur les handicaps cachés et situationnels et les outils et conseils adaptés peuvent vous aider. ADI vous répondra avec un mélange de réponses conversationnelles textuelles, de vidéos de taille octet et de liens conceptuels provenant de diverses sources. |
| Emplacement du siège social de la société | Royaume-Uni de Grande-Bretagne et d’Irlande du Nord (le) |
| Page d’informations sur l’application | [https://akari.io/adi](https://akari.io/adi) |
...
Ces informations ont été fournies par Akari Solutions Limited sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
