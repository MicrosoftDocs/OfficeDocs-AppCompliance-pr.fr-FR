---
title: Informations d’application pour MetaWorkspace by Wafer Systems
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/07/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour MetaWorkspace, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
ms.locfileid: "64876151"
---
# <a name="metaworkspace"></a>MetaWorkspace

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Dernière mise à jour par le développeur : 24 novembre 2021</p>

* <a href="https://teams.microsoft.com/l/app/431b1597-8da3-45ca-9b36-ff245ea7c442" target="_blank">Afficher dans Teams magasin</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003747" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Wafer Systems à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | MetaWorkspace |
| ID | WA200003747 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | Systèmes Wafer |
| Site web de la société | [https://www.wafersystems.com](https://www.wafersystems.com) |
| Conditions d’utilisation de l’application | [https://cloud.rd.virsical.cn/service](https://cloud.rd.virsical.cn/service) |
...
Ces informations ont été fournies par Wafer Systems sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
