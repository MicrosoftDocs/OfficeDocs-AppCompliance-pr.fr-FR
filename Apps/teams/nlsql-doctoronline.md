---
title: Informations d’application pour DoctorOnline par NLSQL
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/12/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour DoctorOnline, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/f9555238-64f3-4ec2-a8fc-3787baa157aa" target="_blank">Afficher dans Teams magasin</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004082" target="_blank">Afficher dans AppSource</a>
...
|:----------------|:-------------|
| Nom de l'application | DoctorOnline |
| ID | WA200004082 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | NLSQL |
| Site web de la société | [https://nlsql.com](https://nlsql.com) |
| Conditions d’utilisation de l’application | [https://doctoronline.bsmu.edu.ua/terms](https://doctoronline.bsmu.edu.ua/terms) |
| Fonctionnalités principales de l’application | Réservez un support gratuit pour les soins de santé en ligne. Plus de 500+ médecins ukrainiens autorisés avec différentes catégories. |
| Emplacement du siège social de la société | Royaume-Uni de Grande-Bretagne et d’Irlande du Nord (le) |
| Page d’informations sur l’application | [https://doctoronline.bsmu.edu.ua](https://doctoronline.bsmu.edu.ua) |
