---
title: Informations sur l’application pour Grafana OnCall par Grafana Labs
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/27/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour Grafana OnCall, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/ed13a4a6-7d9c-4904-913c-402dbca12d1e" target="_blank">Afficher dans le magasin Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004307" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Grafana Labs à Microsoft :

| **Information** | **Réponse** |
|:----------------|:-------------|
| Nom de l'application | Grafana OnCall |
| ID | WA200004307 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | Grafana Labs |
| Site web de la société | [https://grafana.com](https://grafana.com) |
| Conditions d’utilisation de l’application | [https://grafana.com/legal/terms/](https://grafana.com/legal/terms/) |
| Fonctionnalités principales de l’application | Le moyen le plus simple d’effectuer la gestion des appels |
...
Ces informations ont été fournies par Grafana Labs sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| URL de la politique de confidentialité | https://grafana.com/legal/terms |
...
| Les individus disposent-ils d’une option pour s’opposer au traitement ? | Non |
