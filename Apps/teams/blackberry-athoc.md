...
* <a href="https://teams.microsoft.com/l/app/f18b3ce0-a7a9-4fb7-96be-9b4a7dee68f7" target="_blank">Afficher dans Teams magasin</a>
...
| Site web de la société | [https://www.blackberry.com](https://www.blackberry.com) |
| Conditions d’utilisation de l’application | [https://www.athoc.com/pss/terms.html#](https://www.athoc.com/pss/terms.html#) |
| Fonctionnalités principales de l’application | L’intégration de BlackBerry AtHoc à Teams fournit une gestion transparente des événements critiques au sein de votre organisation &#8211; tout à partir d’une interface utilisateur familière où vous&#8217;déjà authentifié. Sans quitter Teams, l’intégration de BlackBerry AtHoc permet aux gestionnaires d’urgence et d’incident de : &#8226; publier des alertes, en un clic, sur n’importe quel appareil &#8226; groupes de distribution prédéfinis cibles dans Teams &#8226; Collaborer dans Teams pour gérer les incidents en temps réel |
| Emplacement du siège social de la société | États-Unis d’Amérique |
| Page d’informations sur l’application | [https://www.blackberry.com/us/en/products/blackberry-athoc](https://www.blackberry.com/us/en/products/blackberry-athoc) |
| Quel est l’environnement d’hébergement ou le modèle de service utilisé pour exécuter votre application ? |  |
| Quels fournisseurs de cloud d’hébergement l’application utilise-t-elle ? | Azure, AWS, SelfHosted |
...
| Date de certification SOC3 la plus récente | 2020-09-01 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| ChannelMessage.Send | Délégué | Nous accédons aux informations de base de l’utilisateur&#8217;telles que le nom du principal et le lien vers le canal général teams (pour lequel l’utilisateur connecté est autorisé) pour envoyer la carte d’alerte aux équipes. | [f18b3ce0-a7a9-4fb7-96be-9b4a7dee68f7](../azure/f18b3ce0-a7a9-4fb7-96be-9b4a7dee68f7.md) |
...
>| openid | Délégué | Nous accédons aux informations de base de l’utilisateur&#8217;telles que le nom du principal et le lien vers le canal général teams (pour lequel l’utilisateur connecté est autorisé) pour envoyer la carte d’alerte aux équipes. | [f18b3ce0-a7a9-4fb7-96be-9b4a7dee68f7](../azure/f18b3ce0-a7a9-4fb7-96be-9b4a7dee68f7.md) |
