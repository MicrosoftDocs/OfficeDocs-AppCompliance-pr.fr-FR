---
title: Informations d’application pour Qooper par COG LLC TECHNOLOGIES, LLC
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/25/2021
...
description: Toutes les informations de sécurité et de conformité disponibles pour Qooper, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le Registre CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/fadca663-cc96-4756-8a3b-271000082238" target="_blank">Afficher dans Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002964" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par COG COG LLC à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | Qooper |
| ID | WA200002964 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | COGNATA TECHNOLOGIES, LLC |
| Site web de l’entreprise | [https://qooper.io](https://qooper.io) |
| Conditions d’utilisation de l’application | [https://qooper.io/terms-of-use](https://qooper.io/terms-of-use) |
| Fonctionnalités principales de l’application | Atteindre des objectifs avec un contenu de connexions &amp; significatif. Entourez vos utilisateurs de connexions significatives et de contenu par le biais de la formation, de l’accompagnement d’homologues, de l’apprentissage communautaire et de la mise en réseau. Le Qooper s’associe avec des sociétés, des entreprises et des organisations à but non lucratif de toutes tailles pour automatiser le travail de gestion des programmes, connecter des personnes sur une plateforme interactive d’apprentissage et afficher des analyses de programmes. |
| Emplacement du siège social de l’entreprise | États-Unis d’Amérique |
| Page d’informations sur l’application | [https://qooper.io](https://qooper.io) |
...
Ces informations ont été fournies par COG SMARTPHONE TECHNOLOGIES, LLC sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
