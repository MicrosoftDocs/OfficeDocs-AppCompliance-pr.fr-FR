---
title: Informations sur l’application pour startgrid par Startgrid
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/09/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour Startgrid, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le Registre CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/6624420b-7199-41d2-98ff-90d745e039a7" target="_blank">Afficher dans Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003838" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Startgrid à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | Startgrid |
| ID | WA200003838 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | Startgrid |
| Site web de l’entreprise | [https://app.startgrid.com](https://app.startgrid.com) |
| Conditions d’utilisation de l’application | [https://corp.startgrid.com/terms-of-use](https://corp.startgrid.com/terms-of-use) |
| Fonctionnalités principales de l’application | Recherchez, partagez et évaluez des solutions technologiques pour résoudre les problèmes plus rapidement. |
| Emplacement du siège social de l’entreprise | États-Unis d’Amérique |
| Page d’informations sur l’application | [https://corp.startgrid.com/platform](https://corp.startgrid.com/platform) |
...
Ces informations ont été fournies par Startgrid sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| URL de la politique de confidentialité | https://corp.startgrid.com/privacy-policy |
