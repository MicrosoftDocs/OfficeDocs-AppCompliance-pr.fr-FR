---
title: Informations sur l’application pour maintenant l’agent virtuel par ServiceNow
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/18/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour Now Virtual Agent, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
ms.locfileid: "66852698"
---
# <a name="now-virtual-agent"></a>Agent désormais virtuel

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Dernière mise à jour par le développeur : 16 juillet 2022</p>

* <a href="https://teams.microsoft.com/l/app/49471a10-fdbc-4ffb-b0b8-944f3df985d9" target="_blank">Afficher dans le magasin Teams</a>
...
| Site web de la société | [https://www.servicenow.com](https://www.servicenow.com) |
| Conditions d’utilisation de l’application | [https://www.servicenow.com/terms-of-use.html](https://www.servicenow.com/terms-of-use.html) |
| Fonctionnalités principales de l’application | L’agent virtuel Now vous permet d’effectuer des tâches ServiceNow de routine directement dans Microsoft Teams, ce qui vous permet de travailler plus efficacement à l’aide de la conversation.  |
| Emplacement du siège social de la société | États-Unis d’Amérique |
| Page d’informations sur l’application | [https://store.servicenow.com](https://store.servicenow.com) |
...
| Répertorier les types de stratégies prises en charge | Les administrateurs peuvent choisir de bloquer/débloquer notre application pour leur locataire MS Teams particulier |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| TeamsAppInstallation.ReadWriteForUser | Délégué | Maintenant, l’agent virtuel utilise cette autorisation pour lire, installer, mettre à niveau et désinstaller les applications Teams installées pour l’utilisateur connecté.  | [5a87eaa0-a00c-4382-9bdd-cdada0b6820f](../azure/5a87eaa0-a00c-4382-9bdd-cdada0b6820f.md) |
>| User.ReadBasic.All | Délégué | L’application utilise cette autorisation pour lire le profil de l’utilisateur | [5a87eaa0-a00c-4382-9bdd-cdada0b6820f](../azure/5a87eaa0-a00c-4382-9bdd-cdada0b6820f.md) |
>| offline_access | Délégué | Cela est nécessaire pour obtenir le jeton d’actualisation. Nous utilisons /authorize endpoint | [5a87eaa0-a00c-4382-9bdd-cdada0b6820f](../azure/5a87eaa0-a00c-4382-9bdd-cdada0b6820f.md) |
>| openid | Délégué | Maintenant, l’application Agent virtuel utilise le protocole d’authentification OpenID Connect (OIDC) | [5a87eaa0-a00c-4382-9bdd-cdada0b6820f](../azure/5a87eaa0-a00c-4382-9bdd-cdada0b6820f.md) |
