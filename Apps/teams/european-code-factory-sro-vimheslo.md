---
title: Informations sur l’application pour vimheslo par European Code Factory s.r.o.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/08/2022
...
* <a href="https://teams.microsoft.com/l/app/73ee6b52-6b68-41c1-a7c5-91919e05b845" target="_blank">Afficher dans Teams magasin</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003843" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par European Code Factory s.r.o. vers Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | vimheslo |
| ID | WA200003843 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | European Code Factory s.r.o. |
| Site web de la société | [https://ecodef.cz](https://ecodef.cz) |
| Conditions d’utilisation de l’application | [https://ecodef.cz/terms_of_use.html](https://ecodef.cz/terms_of_use.html) |
| Fonctionnalités principales de l’application | Gestionnaire de mots de passe |
| Emplacement du siège social de la société | Tchéquie |
| Page d’informations sur l’application | [https://vimheslo.cz](https://vimheslo.cz) |
...
Ces informations ont été fournies par European Code Factory s.r.o. sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Files.Read.All | Délégué | Les données sont stockées dans OneDrive ou SharePoint bibliothèque de documents, l’application doit lire les données. | [73ee6b52-6b68-41c1-a7c5-91919e05b845](/microsoft-365-app-certification/azure/73ee6b52-6b68-41c1-a7c5-91919e05b845) |
>| Sites.Read.All | Délégué | Application in Team context store data in related SharePoint Document library, application need to read site name to setup path, where file with data is located. | [73ee6b52-6b68-41c1-a7c5-91919e05b845](/microsoft-365-app-certification/azure/73ee6b52-6b68-41c1-a7c5-91919e05b845) |
>| User.Read | Délégué | L’application doit connaître les OneDrive personnelles pour y stocker des données personnelles. | [73ee6b52-6b68-41c1-a7c5-91919e05b845](/microsoft-365-app-certification/azure/73ee6b52-6b68-41c1-a7c5-91919e05b845) |
>| email | Délégué | Pour autoriser le partage de données. | [73ee6b52-6b68-41c1-a7c5-91919e05b845](/microsoft-365-app-certification/azure/73ee6b52-6b68-41c1-a7c5-91919e05b845) |
