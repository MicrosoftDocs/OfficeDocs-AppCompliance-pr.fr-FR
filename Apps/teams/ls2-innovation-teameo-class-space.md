---
title: Informations sur l’application pour l’espace de classe Teameo par LS2 Innovation
ms.author: elmalova
author: elenamalova
ms.date: 01/03/2022
ms.topic: article
...
description: Toutes les informations de sécurité et de conformité disponibles pour l’espace de classe Teameo, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le Registre CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/ec7d1cd2-2a06-4f96-baa5-1cc88026a835" target="_blank">Afficher dans Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003630" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par LS2 Innovation à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | Teameo Class Space |
| ID | WA200003630 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | LS2 Innovation |
| Site web de l’entreprise | [https://teameo.io](https://teameo.io) |
| Conditions d’utilisation de l’application | [https://teameo.io/legal/terms-of-service.html](https://teameo.io/legal/terms-of-service.html) |
| Fonctionnalités principales de l’application | L’espace de classe Teameo permet aux enseignants d’afficher les détails, les applications et les liens du cours. |
...
Ces informations ont été fournies par LS2 Innovation sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont stockées dans vos bases de données ? | Informations utilisateur (nom, e-mail), informations sur le client (id, nom) |
...
| URL de la politique de confidentialité | https://teameo.io/legal/privacy-policy.html |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| AppCatalog.ReadWrite.All | application | Gestion de Teams App pour Espace Num&#233;rique | [05525b77-8ca6-462f-8902-15788cb405c6](https://docs.microsoft.com/microsoft-365-app-certification/azure/05525b77-8ca6-462f-8902-15788cb405c6) |
