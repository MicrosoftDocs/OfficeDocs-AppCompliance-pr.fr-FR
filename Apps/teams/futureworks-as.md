---
title: Informations sur l’application pour Futureworks par Futureworks AS
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/03/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour Futureworks, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le Registre CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/80a90c8c-6199-454b-b0ff-bd5fba480275" target="_blank">Afficher dans Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003510" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Futureworks AS à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | Futureworks |
| ID | WA200003510 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | Futureworks AS |
| Site web de l’entreprise | [https://app.futureworks.com](https://app.futureworks.com) |
| Conditions d’utilisation de l’application | [https://www.futureworks.com/terms-of-service](https://www.futureworks.com/terms-of-service) |
| Fonctionnalités principales de l’application | Plateforme de gestion des objectifs et des performances, basée sur okR : objectifs et résultats clés. |
| Emplacement du siège social de l’entreprise | Norvège |
| Page d’informations sur l’application | [https://futureworks.no](https://futureworks.no) |
...
Ces informations ont été fournies par Futureworks AS sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
