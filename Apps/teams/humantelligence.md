---
title: Informations d’application pour Humantelligence par Humantelligence
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/29/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour Humantelligence, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le Registre CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/4082650b-ff26-4eae-b0af-ac0bed45228d" target="_blank">Afficher dans Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002650" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Humantelligence à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | Humantelligence |
| ID | WA200002650 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | Humantelligence |
| Site web de l’entreprise | [https://humantelligence.com](https://humantelligence.com) |
| Conditions d’utilisation de l’application | [https://humantelligence.com/terms/](https://humantelligence.com/terms/) |
| Fonctionnalités principales de l’application | Communiquez plus efficacement avec vos collègues à l’aide de Humantelligence. |
| Emplacement du siège social de l’entreprise | États-Unis Amérique |
| Page d’informations sur l’application | [https://humantelligence.com](https://humantelligence.com) |
...
Ces informations ont été fournies par Humantelligence sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| URL de la politique de confidentialité | https://humantelligence.com/privacy |
