---
title: Informations sur l’application pour UKG Pro par UKG, Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 10/12/2021
...
description: Toutes les informations de sécurité et de conformité disponibles pour ukg Pro, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
ms.locfileid: "64881261"
---
# <a name="ukg-pro"></a>UkG Pro

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Dernière mise à jour par le développeur : 12 octobre 2021</p>

* <a href="https://teams.microsoft.com/l/app/f2120944-5201-4c71-8314-770f7806fff0" target="_blank">Afficher dans Teams magasin</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003173" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par UKG, Inc. à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | UkG Pro |
| ID | WA200003173 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | UKG, Inc. |
| Site web de la société | [https://ukg.com](https://ukg.com) |
| Conditions d’utilisation de l’application | [https://ukg.com](https://ukg.com) |
| Fonctionnalités principales de l’application | Accédez facilement aux informations des employés, affichez les détails du salaire et effectuez d’autres actions RH à la demande. |
| Emplacement du siège social de la société | États-Unis d’Amérique |
| Page d’informations sur l’application | [https://ukg.com](https://ukg.com) |
...
Ces informations ont été fournies par UKG, Inc. sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Date de certification SOC1 la plus récente | 2021-01-01 |
