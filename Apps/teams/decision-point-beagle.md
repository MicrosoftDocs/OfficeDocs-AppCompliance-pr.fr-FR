...
* <a href="https://teams.microsoft.com/l/app/a0f836a9-178e-4407-9c26-4579dcd17bd1" target="_blank">Afficher dans Teams magasin</a>
...
Informations fournies par Decision Point à Microsoft :
...
| Site web de la société | [https://decisionpoint.ai](https://decisionpoint.ai) |
| Conditions d’utilisation de l’application | [https://beagleanalytics.ai/wp-content/uploads/2021/02/Terms...](https://beagleanalytics.ai/wp-content/uploads/2021/02/Terms-of-Use.pdf) |
| Fonctionnalités principales de l’application | Beagle est un outil DÉCISIONNEL basé sur la conversation qui est intégré à des plateformes telles que MS Teams. Beagle réduit les obstacles à l’adoption et élimine la nécessité d’une formation (des individus) en prenant des données aux personnes par le biais d’une application de collaboration.  Beagle montre les données pertinentes à un utilisateur sous la forme de cartes Insight et lui permet d’approfondir ses connaissances à l’aide de filtres et d’accélérer la prise de décision.  |
| Emplacement du siège social de la société | Inde |
| Page d’informations sur l’application | [https://beagleanalytics.ai](https://beagleanalytics.ai) |
| Quel est l’environnement d’hébergement ou le modèle de service utilisé pour exécuter votre application ? |  |
| Quels fournisseurs de cloud d’hébergement l’application utilise-t-elle ? | Azure, SelfHosted |
...
Ces informations ont été fournies par Decision Point sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
