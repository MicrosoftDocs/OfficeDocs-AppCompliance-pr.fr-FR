---
title: Informations d’application pour Creately par Creately
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/30/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour Creately, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
ms.locfileid: "66656223"
---
# <a name="creately"></a>Création

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Dernière mise à jour par le développeur : 23 juin 2022</p>

* <a href="https://teams.microsoft.com/l/app/dddf988d-00af-480f-b419-76a357a72460" target="_blank">Afficher dans le magasin Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004335" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Creately à Microsoft :

| **Information** | **Réponse** |
|:----------------|:-------------|
| Nom de l'application | Création |
| ID | WA200004335 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | Création |
| Site web de la société | [https://creately.com](https://creately.com) |
| Conditions d’utilisation de l’application | [https://creately.com/tos](https://creately.com/tos) |
| Fonctionnalités principales de l’application | Avec Creately, vous pouvez faire l’expérience de la collaboration visuelle comme jamais auparavant. À présent, planifiez, analysez et exécutez tout votre travail sans quitter Microsoft Teams. Creately offre un canevas visuel infini et libre pour organiser des pensées, réfléchir à des solutions, concevoir des processus et collaborer en temps réel avec des collègues. |
...
Ces informations ont été fournies par Creately sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont traitées par votre application ? | E-mail de l’utilisateur, nom complet de l’utilisateur |
...
| URL de la politique de confidentialité | https://creately.com/privacy/ |
