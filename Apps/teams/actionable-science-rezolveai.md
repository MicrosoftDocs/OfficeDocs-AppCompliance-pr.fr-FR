---
title: Informations sur l’application pour Rezolve.ai par la science exploitable
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/03/2021
...
* <a href="https://teams.microsoft.com/l/app/762a660d-9fa5-461b-be81-310c102ba820" target="_blank">Afficher dans Teams magasin</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002724" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Actionable Science à Microsoft :
...
| Site web de la société | [https://www.rezolve.ai](https://www.rezolve.ai) |
| Conditions d’utilisation de l’application | [https://www.rezolve.ai/generalTerms](https://www.rezolve.ai/generalTerms) |
| Fonctionnalités principales de l’application | L’application fournit des fonctionnalités complètes de Employee Service Desk, notamment la possibilité de créer et de mettre à jour des tickets b) Répondre aux questions de routine c) Automatiser des tâches courantes telles que l’approvisionnement ou l’intégration  |
...
Ces informations ont été fournies par Actionable Science sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Date de certification SOC1 la plus récente | 2019-12-31 |
| L’application est-elle conforme aux contrôles d’organisation de service (SOC 2) ? | Oui |
| Date de certification SOC2 la plus récente | 2019-12-31 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Délégué | Activer la connexion et lire le profil utilisateur | [eb628055-f790-4ef0-9fce-ac95b4c61466](../azure/eb628055-f790-4ef0-9fce-ac95b4c61466.md) |
