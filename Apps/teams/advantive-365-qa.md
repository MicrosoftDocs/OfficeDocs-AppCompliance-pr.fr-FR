...
ms.locfileid: "64881021"
---
# <a name="365-qa"></a>365-QA

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Dernière mise à jour par le développeur : 28 décembre 2021</p>

* <a href="https://teams.microsoft.com/l/app/03e51569-33a8-4000-abb6-9a825e33ece2" target="_blank">Afficher dans Teams magasin</a>
...
| Site web de la société | [https://www.advantive.be](https://www.advantive.be) |
| Conditions d’utilisation de l’application | [https://www.advantive.be/terms-of-service-en/](https://www.advantive.be/terms-of-service-en/) |
| Fonctionnalités principales de l’application | Advantive est une équipe enthousiaste de professionnels des TIC, qui utilisent la technologie Microsoft pour développer et implémenter des solutions tic innovantes. Nous offrons des conseils, des produits et des services de qualité supérieure basés sur les fonctionnalités Standard de Microsoft. Cela permet aux clients d’Adventive&#8217;d’accroître leur efficacité et de tirer parti des circonstances qui changent rapidement. Notre activité principale est de fournir des services qui incluent des conseils, le développement, la mise en œuvre, le support de projet et la maintenance. |
| Emplacement du siège social de la société | Belgique |
| Page d’informations sur l’application | [https://www.advantive.be/365-qa-how-to/](https://www.advantive.be/365-qa-how-to/) |
