---
title: Informations d’application pour La structure de fichiers par Stockage facilité
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
| Site web de l’entreprise | [https://storagemadeeasy.com](https://storagemadeeasy.com) |
| Conditions d’utilisation de l’application | [https://www.storagemadeeasy.com/terms](https://www.storagemadeeasy.com/terms) |
| Fonctionnalités principales de l’application | Recherchez, parcourez, modifiez et partagez des fichiers stockés sur des fichiers Azure, des Stockage Azure blob et d’autres stockages. |
...
| Quels fournisseurs de cloud d’hébergement l’application utilise-t-elle ? | SelfHosted, Azure, AWS, GCP, IBMCloud, Users peuvent se connecter aux services Wasabi, Backblaze, Cloudian, Dropbox, Box.com, Salesforce, S3-Compatible, FTP et WebDAV |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Files.ReadWrite | application | Données de fichier lues ou écrites lorsque l’utilisateur télécharge, télécharge ou modifie des fichiers spécifiés via l’application. | [0752d800-857f-49bd-87eb-e60985516c67](../azure/0752d800-857f-49bd-87eb-e60985516c67.md) |
>| Sites.ReadWrite.All | application | Métadonnées collectées pour tous les fichiers et dossiers&#8217;utilisateur fournissant une vue fédérée dans tous les services de fichiers. | [0752d800-857f-49bd-87eb-e60985516c67](../azure/0752d800-857f-49bd-87eb-e60985516c67.md) |
