---
title: Informations sur l’application pour File Fabric par Stockage Facilité
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: Toutes les informations de sécurité et de conformité disponibles pour File Fabric, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
<p>Dernière mise à jour par le développeur : 30 juin 2021</p>

* <a href="https://teams.microsoft.com/l/app/bd063a87-1e4d-42cf-baea-8cab71839e35" target="_blank">Afficher dans Teams magasin</a>
...
Informations fournies par Stockage Facile à Microsoft :
...
| Site web de la société | [https://storagemadeeasy.com](https://storagemadeeasy.com) |
| Conditions d’utilisation de l’application | [https://www.storagemadeeasy.com/terms](https://www.storagemadeeasy.com/terms) |
| Fonctionnalités principales de l’application | Recherchez, parcourez, modifiez et partagez des fichiers stockés sur Azure Files, Stockage Blob Azure et d’autres stockages. |
| Emplacement du siège social de la société | Royaume-Uni de Grande-Bretagne et d’Irlande du Nord (le) |
| Page d’informations sur l’application | [https://docs.storagemadeeasy.com/microsoft-teams](https://docs.storagemadeeasy.com/microsoft-teams) |
| Quel est l’environnement d’hébergement ou le modèle de service utilisé pour exécuter votre application ? |  |
| Quels fournisseurs de cloud d’hébergement l’application utilise-t-elle ? | Les utilisateurs auto-hébergés, Azure, AWS, GCP, IBMCloud, peuvent se connecter aux services Wasabi, Backblaze, Cloudian, Dropbox, Box.com, Salesforce, S3 compatible, FTP et WebDAV |
...
Ces informations ont été fournies par Stockage Easy sur la façon dont cette application collecte et stocke les données d’organisation et le contrôle que votre organisation aura sur les données collectées par l’application.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Files.ReadWrite | application | Données de fichier lues ou écrites lorsque l’utilisateur télécharge, charge ou modifie des fichiers spécifiés via l’application. | [0752d800-857f-49bd-87eb-e60985516c67](../azure/0752d800-857f-49bd-87eb-e60985516c67.md) |
>| Sites.ReadWrite.All | application | Métadonnées collectées pour tous les fichiers et dossiers&#8217;utilisateur fournissant une vue fédérée sur tous les services de fichiers. | [0752d800-857f-49bd-87eb-e60985516c67](../azure/0752d800-857f-49bd-87eb-e60985516c67.md) |
