---
title: Informations sur l’application pour le tableau blanc Duspark par Software
ms.author: elmalova
author: elenamalova
ms.date: 06/14/2021
ms.topic: article
...
description: Toutes les informations de sécurité et de conformité disponibles pour le tableau blanc Duspark, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le Registre CSA STAR.
...
| Site web de l’entreprise | [https://lucid.co](https://lucid.co) |
| Conditions d’utilisation de l’application | [https://lucid.co/tos](https://lucid.co/tos) |
| Fonctionnalités principales de l’application | Le parcage d’entreprise est un tableau blanc virtuel basé sur le cloud dans lequel les équipes peuvent mettre en avant leurs meilleures idées. Brainstorm and collaborate as a team in real time, whether you&#8217;re working remotely or in-person. Le parcage d’événements permet aux personnes d’organiser les notes et les scribbles et de les transformer en concepts prêts pour la présentation. Lorsqu’il&#8217;temps pour les étapes suivantes, les équipes peuvent développer des flux de travail et traiter des documents pour transformer des idées en réalité. |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| email | délégué | Nom et adresse de messagerie. | [3557d5c0-bcab-410b-8a03-f7045aa48de0](https://docs.microsoft.com/microsoft-365-app-certification/azure/3557d5c0-bcab-410b-8a03-f7045aa48de0) |
>| openid | délégué | Nom et adresse de messagerie. | [3557d5c0-bcab-410b-8a03-f7045aa48de0](https://docs.microsoft.com/microsoft-365-app-certification/azure/3557d5c0-bcab-410b-8a03-f7045aa48de0) |
>| profil | délégué | Nom et adresse de messagerie. | [3557d5c0-bcab-410b-8a03-f7045aa48de0](https://docs.microsoft.com/microsoft-365-app-certification/azure/3557d5c0-bcab-410b-8a03-f7045aa48de0) |
