---
title: Informations sur l’application pour Lucidspark Whiteboard by Lucid Software
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/14/2021
...
description: Toutes les informations de sécurité et de conformité disponibles pour Lucidspark Whiteboard, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
ms.locfileid: "64875391"
---
# <a name="lucidspark-whiteboard"></a>Tableau de bord Lucidspark

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Dernière mise à jour par le développeur : 13 mai 2021</p>

* <a href="https://teams.microsoft.com/l/app/e9ab21fa-5fd5-48bb-a85d-4de7ced89cd1" target="_blank">Afficher dans Teams magasin</a>
...
Informations fournies par Lucid Software à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | Tableau de bord Lucidspark |
| ID | WA200002583 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | Logiciel Lucid |
| Site web de la société | [https://lucid.co](https://lucid.co) |
| Conditions d’utilisation de l’application | [https://lucid.co/tos](https://lucid.co/tos) |
| Fonctionnalités principales de l’application | Lucidspark est un tableau blanc virtuel basé sur le cloud où les équipes peuvent mettre en lumière leurs meilleures idées. Réfléchissez et collaborez en équipe en temps réel, que vous&#8217;travaillez à distance ou en personne. Lucidspark permet aux utilisateurs d’organiser les notes et les gribouillis et de les transformer en concepts prêts pour la présentation. Quand il&#8217;temps pour les étapes suivantes, les équipes peuvent développer des flux de travail et traiter des documents pour transformer des idées en réalité. |
| Emplacement du siège social de la société | États-Unis d’Amérique |
| Page d’informations sur l’application | [https://lucidchart.zendesk.com](https://lucidchart.zendesk.com) |
...
Ces informations ont été fournies par Lucid Software sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| email | Délégué | Nom et adresse e-mail. | [3557d5c0-bcab-410b-8a03-f7045aa48de0](../azure/3557d5c0-bcab-410b-8a03-f7045aa48de0.md) |
>| openid | Délégué | Nom et adresse e-mail. | [3557d5c0-bcab-410b-8a03-f7045aa48de0](../azure/3557d5c0-bcab-410b-8a03-f7045aa48de0.md) |
>| profil | Délégué | Nom et adresse e-mail. | [3557d5c0-bcab-410b-8a03-f7045aa48de0](../azure/3557d5c0-bcab-410b-8a03-f7045aa48de0.md) |
