...
| Quelles données sont stockées dans vos bases de données ? | Graph données, données Office 365 gestion des données |
| Si des infastructures sous-jacentes traitent ou stockent des données client Microsoft, où sont stockées géographiquement ces données ? | Autriche |
...
| Liste des types de stratégies pris en charge | Application à plusieurs clients, dépend des paramètres&#180;client |
...
>|:------------------------|:--------------------|:------------------------------------|
>| User.Read.All | application | Utilisé pour sélectionner une personne à qui vous souhaitez envoyer un message électronique. |
>| TeamSettings.Read.All | application | Utilisé pour sélectionner une équipe dans laquelle vous souhaitez publier un message à partir du centre de messages. |
>| Mail.Send | application | Utilisé pour envoyer des messages directement à partir de l’application vers des canaux ou des personnes individuelles.  |
>| Channel.ReadBasic.All | application | Utilisé pour sélectionner un canal dans lequel vous souhaitez publier un message à partir du centre de messages. |
