---
title: Informations d’application pour Cloud Hub par atwork GmbH
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 11/22/2021
...
description: Toutes les informations de sécurité et de conformité disponibles pour Cloud Hub, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
ms.locfileid: "64877781"
---
# <a name="cloud-hub"></a>Cloud Hub

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Dernière mise à jour par le développeur : 22 novembre 2021</p>

* <a href="https://teams.microsoft.com/l/app/0c46172d-7923-422d-902e-f27aaad6994d" target="_blank">Afficher dans Teams magasin</a>
...
Informations fournies par atwork GmbH à Microsoft :
...
Ces informations ont été fournies par atwork GmbH sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont traitées par votre application ? | Données utilisateur, données de connexion, données d’authentification, données de locataire, données de service Azure, données Graph, données de gestion Office 365 |
| L’application prend-elle en charge TLS 1.1 ou version ultérieure ? | Oui |
| L’application ou l’infrastructure sous-jacente stocke-t-elle des données client Microsoft ? | Oui |
| Quelles données sont stockées dans vos bases de données ? | données Graph, données de gestion Office 365 |
| Si l’infastructure sous-jacente traite ou stocke les données client Microsoft, où ces données sont-elles stockées géographiquement ? | Autriche |
...
| Si votre application n’utilise pas l’une des bibliothèques ci-dessus, quelle bibliothèque ou bibliothèque d’authentification utilise-t-elle ? | Dernière version |
| Votre application prend-elle en charge les stratégies d’accès conditionnel ? | Oui |
| Répertorier les types de stratégies prises en charge | Application multilocataire, dépend des paramètres du client&#180; |
...
>| Mail.Send | application | Utilisé pour envoyer des messages directement à partir de l’application à des canaux ou à des personnes individuelles.  | [b5d4e933-e001-4168-83f8-abdd974877bd](../azure/b5d4e933-e001-4168-83f8-abdd974877bd.md) |
...
>| User.Read.All | application | Utilisé pour sélectionner une personne à laquelle vous souhaitez envoyer un e-mail. | [b5d4e933-e001-4168-83f8-abdd974877bd](../azure/b5d4e933-e001-4168-83f8-abdd974877bd.md) |
