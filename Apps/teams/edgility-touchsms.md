---
title: Informations d’application pour touchSMS par Edgility
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/12/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour touchSMS, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/d4275409-72a2-423e-9557-e088f0e68f20" target="_blank">Afficher dans Teams magasin</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003655" target="_blank">Afficher dans AppSource</a>
...
|:----------------|:-------------|
| Nom de l'application | touchSMS |
| ID | WA200003655 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | Edgility |
| Site web de la société | [https://touchsms.com.au](https://touchsms.com.au) |
| Conditions d’utilisation de l’application | [https://www.touchsms.com.au/legal/](https://www.touchsms.com.au/legal/) |
| Fonctionnalités principales de l’application | Chez touchSMS, nous nous concentrons sur le développement de solutions de communication intégrées pour les outils métier quotidiens. Ces solutions permettent aux utilisateurs d’envoyer des rappels, des promotions, des alertes et des notifications par SMS, directement à partir de produits Microsoft tels que Excel, Outlook et Teams. Les utilisateurs peuvent tirer parti de la conversation bidirectionnelle en recevant des réponses PAR SMS dans Microsoft Outlook et Teams. |
| Emplacement du siège social de la société | Australie |
| Page d’informations sur l’application | [https://www.touchsms.com.au/sms-integrations/microsoft-365/](https://www.touchsms.com.au/sms-integrations/microsoft-365/) |
