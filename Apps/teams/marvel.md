---
title: Informations sur l’application pour Marvel de Marvel
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/05/2021
...
description: Toutes les informations de sécurité et de conformité disponibles pour Marvel, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/2e7fb70e-f75d-4e85-997e-90ce89000f43" target="_blank">Afficher dans Teams magasin</a>
...
Informations fournies par Marvel à Microsoft :
...
| Site web de la société | [https://marvelapp.com](https://marvelapp.com) |
| Conditions d’utilisation de l’application | [https://marvelapp.com/terms/](https://marvelapp.com/terms/) |
| Fonctionnalités principales de l’application | Marvel - Wireframe, Design et Prototypage pour tout le monde |
| Emplacement du siège social de la société | Royaume-Uni de Grande-Bretagne et d’Irlande du Nord (le) |
| Page d’informations sur l’application | [https://marvelapp.com](https://marvelapp.com) |
...
Ces informations ont été fournies par Marvel sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
