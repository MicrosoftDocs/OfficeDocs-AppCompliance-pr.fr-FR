---
title: Informations sur l’application pour Zoho Notebook par Zoho Corporation Private Limited
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/11/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour Zoho Notebook, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/fc4f087a-a781-4f19-be85-86977bf45c95" target="_blank">Afficher dans Teams magasin</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001616" target="_blank">Afficher dans AppSource</a>
...
|:----------------|:-------------|
| Nom de l'application | Zoho Notebook |
| ID | WA200001616 |
...
| Fonctionnalités principales de l’application | Que vous&#8217;capturer une pensée, créer une liste de contrôle, enregistrer une idée ou prendre quelques instants, la prise de notes peut être amusante avec Notebook. Il est disponible sur iOS, Android, Mac, Windows et Linux. L’application est optimisée pour les smartphones et les tablettes.  Les cartes de notes peuvent être organisées en blocs-notes. Vous pouvez empiler les cartes de notes associées en tant que groupes.  Toutes vos notes sont synchronisées en toute transparence sur différents appareils et sur le cloud Zoho. Quel que soit l’appareil que vous utilisez, vos notes sont toujours à jour. |
| Emplacement du siège social de la société | États-Unis d’Amérique |
| Page d’informations sur l’application | [https://help.zoho.com/portal/en/kb/notebook](https://help.zoho.com/portal/en/kb/notebook) |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Channel.ReadBasic.All | Délégué | Lire les noms et descriptions des canaux | [9944c8e1-fc22-4546-8023-9459b75c472a](../azure/9944c8e1-fc22-4546-8023-9459b75c472a.md) |
>| ChannelMessage.Send | Délégué | Envoyer des messages du canal | [9944c8e1-fc22-4546-8023-9459b75c472a](../azure/9944c8e1-fc22-4546-8023-9459b75c472a.md) |
>| ChatMessage.Send | Délégué | Envoyer des messages de la conversation aux utilisateurs | [9944c8e1-fc22-4546-8023-9459b75c472a](../azure/9944c8e1-fc22-4546-8023-9459b75c472a.md) |
>| Team.ReadBasic.All | Délégué | Accéder en lecture aux noms et les descriptions des équipes | [9944c8e1-fc22-4546-8023-9459b75c472a](../azure/9944c8e1-fc22-4546-8023-9459b75c472a.md) |
>| User.Read | Délégué | Activer la connexion et lire le profil utilisateur | [9944c8e1-fc22-4546-8023-9459b75c472a](../azure/9944c8e1-fc22-4546-8023-9459b75c472a.md) |
>| offline_access | Délégué | Gérer l’accès aux données auxquelles vous avez accordé l’accès | [9944c8e1-fc22-4546-8023-9459b75c472a](../azure/9944c8e1-fc22-4546-8023-9459b75c472a.md) |
