---
title: Informations sur l’application pour Eden par Eden
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/22/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour Eden, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/bb8a8db6-14d2-4bde-820d-c601586df0a5" target="_blank">Afficher dans le magasin Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004430" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Eden à Microsoft :

| **Information** | **Réponse** |
|:----------------|:-------------|
| Nom de l'application | Eden |
| ID | WA200004430 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | Eden |
| Site web de la société | [https://www.edenworkplace.com](https://www.edenworkplace.com) |
| Conditions d’utilisation de l’application | [https://www.edenworkplace.com/terms-of-service](https://www.edenworkplace.com/terms-of-service) |
| Fonctionnalités principales de l’application | Eden Workplace est la suite complète de logiciels pour le bureau moderne. |
...
Ces informations ont été fournies par Eden sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| URL de la politique de confidentialité | https://www.edenworkplace.com/privacy-policy |
