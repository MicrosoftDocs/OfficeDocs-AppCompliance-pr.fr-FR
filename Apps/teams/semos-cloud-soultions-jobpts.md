---
title: Informations d’application pour JobPts by Semos Cloud Soultions
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
ms.locfileid: "64879631"
---
# <a name="jobpts"></a>JobPts

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Dernière mise à jour par le développeur : 7 juillet 2021</p>

* <a href="https://teams.microsoft.com/l/app/601a47bc-f201-4398-a0cb-593ea081f265" target="_blank">Afficher dans Teams magasin</a>
...
Informations fournies par Semos Cloud Soultions à Microsoft :
...
| Site web de la société | [https://semoscloud.com](https://semoscloud.com) |
| Conditions d’utilisation de l’application | [https://semoscloud.com/terms-of-use/](https://semoscloud.com/terms-of-use/) |
| Fonctionnalités principales de l’application | Reconnaître facilement vos collègues pour un travail bien fait sans quitter MsTeams |
| Emplacement du siège social de la société | États-Unis d’Amérique |
| Page d’informations sur l’application | [https://semoscloud.com/product/jobpts](https://semoscloud.com/product/jobpts) |
...
Ces informations ont été fournies par Semos Cloud Soultions sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Répertorier les types de stratégies prises en charge | Authentification multifacteur, restriction des emplacements utilisateur et des plages d’adresses IP |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Délégué | Lire les informations de base de l’entreprise | [1ac9e5c6-4850-4864-96c5-b91e4512334e](../azure/1ac9e5c6-4850-4864-96c5-b91e4512334e.md) |
>| email | Délégué | Il est utilisé pour le mappage des utilisateurs AzureAD avec des utilisateurs dans l’outil JobPts | [1ac9e5c6-4850-4864-96c5-b91e4512334e](../azure/1ac9e5c6-4850-4864-96c5-b91e4512334e.md) |
>| offline_access | Délégué | Maintenir l’accès aux données | [1ac9e5c6-4850-4864-96c5-b91e4512334e](../azure/1ac9e5c6-4850-4864-96c5-b91e4512334e.md) |
>| openid | Délégué | Pour permettre aux utilisateurs de se connecter avec leur compte professionnel | [1ac9e5c6-4850-4864-96c5-b91e4512334e](../azure/1ac9e5c6-4850-4864-96c5-b91e4512334e.md) |
>| profil | Délégué | Pour pouvoir afficher les informations de base de l’utilisateur (nom d’utilisateur) | [1ac9e5c6-4850-4864-96c5-b91e4512334e](../azure/1ac9e5c6-4850-4864-96c5-b91e4512334e.md) |
