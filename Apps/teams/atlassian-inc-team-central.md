---
title: Informations sur les applications pour Team Central par Atlassian, Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/15/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour Team Central, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/69883cee-eb8c-41c2-9533-7fdb0762e913" target="_blank">Afficher dans Teams magasin</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003760" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Atlassian, Inc. à Microsoft :

| **Information** | **Réponse** |
|:----------------|:-------------|
| Nom de l'application | Team Central |
| ID | WA200003760 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | Atlassian, Inc. |
| Site web de la société | [https://atlassian.com](https://atlassian.com) |
| Conditions d’utilisation de l’application | [https://atlassian.com/legal/cloud-terms-of-service](https://atlassian.com/legal/cloud-terms-of-service) |
| Fonctionnalités principales de l’application | Libérer une communication plus saine entre vos équipes |
...
Ces informations ont été fournies par Atlassian, Inc. sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
