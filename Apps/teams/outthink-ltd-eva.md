---
title: Informations sur l’application pour Eva par OutThink Ltd
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/30/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour Eva, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/eddbe35e-8260-4878-99d2-946c4aac73f4" target="_blank">Afficher dans le magasin Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004345" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par OutThink Ltd à Microsoft :

| **Information** | **Réponse** |
|:----------------|:-------------|
| Nom de l'application | Eva |
| ID | WA200004345 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | OutThink Ltd |
| Site web de la société | [https://www.outthink.io](https://www.outthink.io) |
| Conditions d’utilisation de l’application | [https://outthink.io/wp-content/uploads/OutThink-SaaS-Terms-...](https://outthink.io/wp-content/uploads/OutThink-SaaS-Terms-and-Conditions.pdf) |
| Fonctionnalités principales de l’application | Eva est un assistant IA qui offre un support virtuel aux clients OutThink qui cherchent à gérer les risques de cybersécurité au sein de leur organisation.  Il fournit aux employés des mises à jour régulières sur leur progression de la formation et fournit des commentaires efficaces sur leurs performances, ce qui contribue à accroître les connaissances en cybersécurité. |
| Emplacement du siège social de la société | Royaume-Uni de Grande-Bretagne et d’Irlande du Nord (le) |
| Page d’informations sur l’application | [https://docs.outthink.io/integration-with-microsoft-teams/](https://docs.outthink.io/integration-with-microsoft-teams/) |
...
Ces informations ont été fournies par OutThink Ltd sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont traitées par votre application ? | Données de messagerie utilisateur, informations de disponibilité et de disponibilité du calendrier utilisateur |
...
| URL de la politique de confidentialité | https://outthink.io/privacy-policy/ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.ReadWrite | Délégué | Recherchez les emplacements gratuits disponibles suivants dans le calendrier de l’utilisateur pour lui permettre de réserver un emplacement pour la formation en cybersécurité via l’application Teams. | [07c3de2f-6e55-4fae-8c97-90964ff2b934](../azure/07c3de2f-6e55-4fae-8c97-90964ff2b934.md) |
>| User.Read | Délégué | Identification des utilisateurs par adresse e-mail, afin d’envoyer des messages à un utilisateur avec une adresse de messagerie d’entreprise donnée. | [07c3de2f-6e55-4fae-8c97-90964ff2b934](../azure/07c3de2f-6e55-4fae-8c97-90964ff2b934.md) |
