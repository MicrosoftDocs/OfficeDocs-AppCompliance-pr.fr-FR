---
title: Informations d’application pour Bonusly par Bonusly
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/17/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour Bonusly, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/c06753b3-85de-4054-9a99-dcd869dc0836" target="_blank">Afficher dans Teams magasin</a>
* <a href="https://appsource.microsoft.com/product/office/WA104381622" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Bonusly à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | Bonusly |
| ID | WA104381622 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | Bonusly |
| Site web de la société | [https://bonus.ly](https://bonus.ly) |
| Conditions d’utilisation de l’application | [https://bonus.ly/terms_of_service](https://bonus.ly/terms_of_service) |
| Fonctionnalités principales de l’application | Reconnaissance fréquente et opportune spark en intégrant Bonusly à Microsoft Teams |
| Emplacement du siège social de la société | États-Unis d’Amérique |
| Page d’informations sur l’application | [https://bonus.ly/integrations/teams](https://bonus.ly/integrations/teams) |
...
Ces informations ont été fournies par Bonusly sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont traitées par votre application ? | Adresse e-mail, prénom, nom, date de naissance (si fonctionnalité utilisée), Date d’embauche (si fonctionnalité utilisée) |
...
| Date de certification SOC2 la plus récente | 2022/4/28 |
...
| URL de la politique de confidentialité | https://bonus.ly/privacy_policy |
