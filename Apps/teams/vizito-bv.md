---
title: Informations sur l’application pour Vizito par Vizito BV
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/15/2022
...
* <a href="https://teams.microsoft.com/l/app/b6e2ef19-7612-4ab7-a700-9669d49b88b9" target="_blank">Afficher dans Teams magasin</a>
...
| Site web de la société | [https://www.vizito.eu](https://www.vizito.eu) |
| Conditions d’utilisation de l’application | [https://vizito.eu/terms-and-conditions](https://vizito.eu/terms-and-conditions) |
| Fonctionnalités principales de l’application | Inscription des visiteurs SaaS avec Teams notifications pour les arrivées de visiteurs. |
| Emplacement du siège social de la société | Belgique |
| Page d’informations sur l’application | [https://www.vizito.eu](https://www.vizito.eu) |
...
| URL de la politique de confidentialité | https://vizito.eu/privacypolicy/ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Délégué | Utilisateur correspondant pour envoyer une notification sur la connexion de visiteur terminée. | [b6e2ef19-7612-4ab7-a700-9669d49b88b9](../azure/b6e2ef19-7612-4ab7-a700-9669d49b88b9.md) |
