---
title: Informations d’application pour la sécurité Push par sécurité Push
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/15/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour Push Security, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
ms.locfileid: "66817637"
---
# <a name="push-security"></a>Sécurité Push

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Dernière mise à jour par le développeur : 12 juillet 2022</p>

* <a href="https://teams.microsoft.com/l/app/db06ca6c-96a2-48ef-804e-54295b5c035a" target="_blank">Afficher dans le magasin Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002833" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Push Security à Microsoft :

| **Information** | **Réponse** |
|:----------------|:-------------|
| Nom de l'application | Sécurité Push |
| ID | WA200002833 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | Sécurité Push |
| Site web de la société | [https://pushsecurity.com](https://pushsecurity.com) |
| Conditions d’utilisation de l’application | [https://pushsecurity.com/legal/terms/](https://pushsecurity.com/legal/terms/) |
| Fonctionnalités principales de l’application | Nous aidons les entreprises à être plus productives avec SaaS en permettant aux employés d’utiliser des applications en toute sécurité. |
| Emplacement du siège social de la société | Royaume-Uni de Grande-Bretagne et d’Irlande du Nord (le) |
| Page d’informations sur l’application | [https://pushsecurity.com/kb/10004/](https://pushsecurity.com/kb/10004/) |
...
Ces informations ont été fournies par Push Security sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont traitées par votre application ? | Push traite les heures de travail du client pour fournir des alertes lorsque le client travaille.  |
| L’application prend-elle en charge TLS 1.1 ou version ultérieure ? | Oui |
| L’application ou l’infrastructure sous-jacente stocke-t-elle des données client Microsoft ? | Oui |
| Quelles données sont stockées dans vos bases de données ? | Push stocke les heures de travail du client pour fournir des alertes lorsque le client travaille.  |
...
| URL de la politique de confidentialité | https://pushsecurity.com/legal/privacy/ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Channel.ReadBasic.All | application | Répertorier les canaux pour faciliter l’installation du bot  | [4ed8651a-5a01-44f0-abdf-536bbc441c02](../azure/4ed8651a-5a01-44f0-abdf-536bbc441c02.md) |
>| MailboxSettings.Read | application | Interroger les heures de travail du client afin que nous ne les en avertissions pas après les heures de travail | [4ed8651a-5a01-44f0-abdf-536bbc441c02](../azure/4ed8651a-5a01-44f0-abdf-536bbc441c02.md) |
>| Team.ReadBasic.All | application | Répertorier les équipes pour faciliter l’installation du bot  | [4ed8651a-5a01-44f0-abdf-536bbc441c02](../azure/4ed8651a-5a01-44f0-abdf-536bbc441c02.md) |
>| TeamsAppInstallation.ReadWriteSelfForTeam.All | application | Autoriser le bot à s’installer pour une équipe | [4ed8651a-5a01-44f0-abdf-536bbc441c02](../azure/4ed8651a-5a01-44f0-abdf-536bbc441c02.md) |
>| TeamsAppInstallation.ReadWriteSelfForUser.All | application | Autoriser le bot à s’installer pour un utilisateur | [4ed8651a-5a01-44f0-abdf-536bbc441c02](../azure/4ed8651a-5a01-44f0-abdf-536bbc441c02.md) |
>| User.Read.All | application | Répertorier les utilisateurs afin que nous puissions les transmettre | [4ed8651a-5a01-44f0-abdf-536bbc441c02](../azure/4ed8651a-5a01-44f0-abdf-536bbc441c02.md) |
