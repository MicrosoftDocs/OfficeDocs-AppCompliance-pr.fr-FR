---
title: Vue d’ensemble de la collaboration Power BI
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/27/2021
...
---
# <a name="power-bi-collaboration-overview"></a>Vue d’ensemble de la collaboration Power BI

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Dernière mise à jour par le développeur : 14 juin 2021</p>

* <a href="https://teams.microsoft.com/l/app/90381cb0-998f-4ba3-9699-130201de5ddb" target="_blank">Afficher dans Teams magasin</a>
...
| Site web de la société | [https://www.ataira.com](https://www.ataira.com) |
| Conditions d’utilisation de l’application | [https://www.ataira.com/TermsofUse](https://www.ataira.com/TermsofUse) |
| Fonctionnalités principales de l’application | Le complément Ataira vous permet d’afficher vos tableaux de bord et rapports Power BI. Envoyez des notifications à vos groupes et équipes d’entreprise, ajoutez des actions de suivi, incorporez Power BI liens publics, ajoutez des commentaires aux points de données dans vos rapports et ajoutez des fichiers de données en tant que sources de données à vos rapports Power BI et mettez à jour en temps réel. Permettre à votre équipe de décisionnel de collaborer plus étroitement sur vos efforts décisionnels dans un seul emplacement. |
...
Ataira a fourni ces informations sur la façon dont cette application collecte et stocke les données organisationnelles, ainsi que sur le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Répertorier les types de stratégies prises en charge | Authentification multifacteur Autorisant uniquement Intune appareils inscrits à accéder à des services spécifiques limitant les emplacements utilisateur et les plages d’adresses IP |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Délégué | Autorisations également pour ChannelMessage.Send Team.ReadBasic.All User.Read. Ceux-ci sont utilisés pour permettre à l’utilisateur de sélectionner le groupe Teams et le canal pour les notifications | [00738e07-f9a4-4bf5-b6f9-851ec7ea31d5](../azure/00738e07-f9a4-4bf5-b6f9-851ec7ea31d5.md) |
