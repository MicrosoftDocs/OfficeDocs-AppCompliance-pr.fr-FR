...
description: Toutes les informations de sécurité et de conformité disponibles pour Status Hero, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/7917afd4-9825-4c1d-b683-ce1fcb77d5b4" target="_blank">Afficher dans le magasin Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004205" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Status Hero, Inc. à Microsoft :

| **Information** | **Réponse** |
|:----------------|:-------------|
| Nom de l'application | Status Hero |
| ID | WA200004205 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | Status Hero, Inc. |
| Site web de la société | [https://statushero.com](https://statushero.com) |
| Conditions d’utilisation de l’application | [https://statushero.com/terms](https://statushero.com/terms) |
| Fonctionnalités principales de l’application | Status Hero transforme les archivages asynchrones et les données des outils de votre équipe en rapports concis et perspicaces. |
| Emplacement du siège social de la société | États-Unis d’Amérique |
| Page d’informations sur l’application | [https://statushero.com/integrations/microsoft-teams](https://statushero.com/integrations/microsoft-teams) |
...
Ces informations ont été fournies par Status Hero, Inc. sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Date de certification SOC2 la plus récente | 2021-11-01 |
...
| URL de la politique de confidentialité | https://statushero.com/privacy |
