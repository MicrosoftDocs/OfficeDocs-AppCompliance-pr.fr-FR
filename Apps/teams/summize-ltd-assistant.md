---
title: Informations sur l’application pour l’Assistant Sommer par Summize (Ltd)
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/11/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour l’Assistant Summize, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le Registre CSA STAR.
...
ms.locfileid: "63551343"
---
# <a name="summize-assistant"></a>Assistant Somme

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Last updated by the developer on: November 17, 2021</p>

* <a href="https://teams.microsoft.com/l/app/24d7e745-c1ed-4f60-a843-ba1629ef3ed4" target="_blank">Afficher dans Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003577" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Summize (Ltd) à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | Assistant Somme |
| ID | WA200003577 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | Summize (Ltd) |
| Site web de l’entreprise | [https://www.summize.com](https://www.summize.com) |
| Conditions d’utilisation de l’application | [https://www.summize.com/terms-and-conditions](https://www.summize.com/terms-and-conditions) |
| Fonctionnalités principales de l’application | Summize facilite la révision et la création du contrat. La somme change la façon dont les entreprises comprennent et interagissent avec les contrats. À l’aide de notre logiciel intelligent et conversationnel, nous surfacturons vos processus de contrat et déverrouillez les informations contractuelles.  Sommer l’application Assistant dans Teams permet aux utilisateurs de télécharger des contrats (formats PDF et docx) à réviser.  Les utilisateurs peuvent également créer des contrats à l’aide de modèles créés dans l’application Summize.   |
...
Ces informations ont été fournies par Summize (Ltd) sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont stockées dans vos bases de données ? | Documents d’origine et avis des clients sur les documents |
...
| URL de la politique de confidentialité | https://app.summize.com/assets/documents/SummizePrivacyPolicy.pdf |
