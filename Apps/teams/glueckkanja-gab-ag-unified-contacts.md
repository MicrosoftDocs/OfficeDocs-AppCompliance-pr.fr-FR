---
title: Informations d’application pour les contacts unifiés par glueckkanja-gab AG
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/23/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour les contacts unifiés, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le Registre CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/085251c0-aef3-11ea-bccf-6fc12269b243" target="_blank">Afficher dans Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003877" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par glueckkanja-gab AG à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | Contacts unifiés |
| ID | WA200003877 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | glueckkanja-gab AG |
| Site web de l’entreprise | [https://www.glueckkanja-gab.com/en](https://www.glueckkanja-gab.com/en) |
| Conditions d’utilisation de l’application | [https://www.glueckkanja-gab.com/en/products/unified-contact...](https://www.glueckkanja-gab.com/en/products/unified-contacts/terms-and-conditions) |
| Fonctionnalités principales de l’application | Recherche unifiée pour Azure AD, vos contacts d’entreprise, Exchange Online et vos contacts personnels. |
| Emplacement du siège social de l’entreprise | Allemagne |
| Page d’informations sur l’application | [https://www.glueckkanja-gab.com/en/products/unified-contacts](https://www.glueckkanja-gab.com/en/products/unified-contacts) |
...
Ces informations ont été fournies par glueckkanja-gab AG sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| URL de la politique de confidentialité | https://www.glueckkanja-gab.com/en/products/unified-contacts/privacy |
...
| Le consentement est-il obtenu auprès d’un parent ou d’un guardian juridique ? | Non |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Contacts.Read.Shared | délégué | Les contacts unifiés nécessitent l’accès aux données de contact dans le client pour fournir des fonctionnalités de base. | [83ff0fe1-a544-4390-bd72-3aaaa040db7e](../azure/83ff0fe1-a544-4390-bd72-3aaaa040db7e.md) |
>| Directory.Read.All | délégué | Les contacts unifiés nécessitent l’accès aux données de contact dans le client pour fournir des fonctionnalités de base. | [83ff0fe1-a544-4390-bd72-3aaaa040db7e](../azure/83ff0fe1-a544-4390-bd72-3aaaa040db7e.md) |
>| User.Read | délégué | Les contacts unifiés nécessitent l’accès aux données de contact dans le client pour fournir des fonctionnalités de base. | [83ff0fe1-a544-4390-bd72-3aaaa040db7e](../azure/83ff0fe1-a544-4390-bd72-3aaaa040db7e.md) |
