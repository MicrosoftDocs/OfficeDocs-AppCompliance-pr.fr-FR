---
title: Informations sur l’application pour Team Today by Team Today Ltd
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 12/10/2021
...
description: Toutes les informations de sécurité et de conformité disponibles pour Team Today, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
ms.locfileid: "66249756"
---
# <a name="team-today"></a>Équipe aujourd’hui
...
* <a href="https://teams.microsoft.com/l/app/d1d8d8c3-5199-45c2-afcc-aaab4dd8da5d" target="_blank">Afficher dans le magasin Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003572" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Team Today Ltd à Microsoft :

| **Information** | **Réponse** |
|:----------------|:-------------|
| Nom de l'application | Équipe aujourd’hui |
| ID | WA200003572 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | Team Today Ltd |
| Site web de la société | [https://team-tracker.com](https://team-tracker.com) |
| Conditions d’utilisation de l’application | [https://team-tracker.com/terms-and-conditions.html](https://team-tracker.com/terms-and-conditions.html) |
| Fonctionnalités principales de l’application | Team Tracker est une première application utilisateur pour réserver des hot desks et voir |
...
Ces informations ont été fournies par Team Today Ltd sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont traitées par votre application ? | ID d’événement de calendrier |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.ReadWrite | Délégué | Une fois qu’un utilisateur a établi ses activités pour les semaines à venir, Team Tracker met à jour le calendrier des utilisateurs et leur disponibilité en fonction de leur sélection.  | [d1d8d8c3-5199-45c2-afcc-aaab4dd8da5d](../azure/d1d8d8c3-5199-45c2-afcc-aaab4dd8da5d.md) |
>| MailboxSettings.Read | Délégué | Permet d’obtenir le fuseau horaire pour la création d’événements de calendrier | [d1d8d8c3-5199-45c2-afcc-aaab4dd8da5d](../azure/d1d8d8c3-5199-45c2-afcc-aaab4dd8da5d.md) |
...
>| email | Délégué | Utilisé pour vérifier l’e-mail des utilisateurs | [d1d8d8c3-5199-45c2-afcc-aaab4dd8da5d](../azure/d1d8d8c3-5199-45c2-afcc-aaab4dd8da5d.md) |
>| openid | Délégué | Permet aux utilisateurs de se connecter avec leur compte Office 365 | [d1d8d8c3-5199-45c2-afcc-aaab4dd8da5d](../azure/d1d8d8c3-5199-45c2-afcc-aaab4dd8da5d.md) |
