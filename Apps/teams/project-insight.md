---
title: Informations sur l’application pour Project Insight par Project Insight
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/22/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour Project Insight, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
ms.locfileid: "64879261"
---
# <a name="project-insight"></a>Aperçu du projet

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Dernière mise à jour par le développeur : 21 mars 2022</p>

* <a href="https://teams.microsoft.com/l/app/57a8236b-4ed2-453e-b785-02a887e16a5b" target="_blank">Afficher dans Teams magasin</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003171" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Project Insight à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | Aperçu du projet |
| ID | WA200003171 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | Aperçu du projet |
| Site web de la société | [https://projectinsight.com](https://projectinsight.com) |
| Conditions d’utilisation de l’application | [https://projectinsight.com/legal/license-agreement](https://projectinsight.com/legal/license-agreement) |
| Fonctionnalités principales de l’application | Project Insight permet à votre équipe de gérer son travail, ses projets, son temps et ses dépenses directement à partir de Teams. |
| Emplacement du siège social de la société | États-Unis d’Amérique |
| Page d’informations sur l’application | [https://projectinsight.com/features/microsoft-teams-integra...](https://projectinsight.com/features/microsoft-teams-integration) |
...
Ces informations ont été fournies par Project Insight sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont traitées par votre application ? | informations de base sur le profil utilisateur |
| L’application prend-elle en charge TLS 1.1 ou version ultérieure ? | Oui |
| L’application ou l’infrastructure sous-jacente stocke-t-elle des données client Microsoft ? | Oui |
| Quelles données sont stockées dans vos bases de données ? | ID de compte d’utilisateur |
...
| Date de certification SOC1 la plus récente | 2022-01-18 |
...
| Date de certification SOC2 la plus récente | 2022-01-18 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| TeamsAppInstallation.ReadWriteForUser.All | Délégué | Pour permettre l’installation de notre application pour les utilisateurs dans le locataire Microsoft Teams | [2201df78-1d70-41da-ba2b-c19b00da1215](../azure/2201df78-1d70-41da-ba2b-c19b00da1215.md) |
>| User.Read.All | Délégué | Mise en correspondance des utilisateurs entre notre système et le locataire Microsoft Teams | [2201df78-1d70-41da-ba2b-c19b00da1215](../azure/2201df78-1d70-41da-ba2b-c19b00da1215.md) |
>| offline_access | Délégué | Utilisé pour demander un jeton d’actualisation | [2201df78-1d70-41da-ba2b-c19b00da1215](../azure/2201df78-1d70-41da-ba2b-c19b00da1215.md) |
