...
* <a href="https://teams.microsoft.com/l/app/eb668aa5-abb2-445c-81b4-3c174db84fe2" target="_blank">Afficher dans Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001535" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Sangoma à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | Switchvox |
| ID | WA200001535 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | Sangoma |
| Site web de l’entreprise | [https://www.sangoma.com](https://www.sangoma.com) |
...
Ces informations ont été fournies par Sangoma sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont stockées dans vos bases de données ? | Enregistrements de l’historique des appels (y compris le numéro, le nom, le courrier électronique du contact) pour les appels initiés via l’application |
...
| URL de la politique de confidentialité | https://cdn.sangoma.com/wp-content/uploads/Privacy-Policy.pdf |
...
>|:------------------------|:--------------------|:------------------------------------|
>| User.Read.All | délégué | Effectuer une recherche de contacts d’annuaire |
>| Group.Read.All | délégué | Effectuer la résolution des membres du groupe |
>| Chat.Read | délégué | Effectuer la résolution des membres de conversation |
