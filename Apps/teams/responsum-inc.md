---
title: Informations sur l’application pour le responsum par Responsum Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/07/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour Responsum, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/652dd9a4-1b9f-49a7-ac6f-dbfbc993f825" target="_blank">Afficher dans Teams magasin</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003743" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Responsum Inc. à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | Responsum |
| ID | WA200003743 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | Responsum Inc. |
| Site web de la société | [https://www.responsum.ai](https://www.responsum.ai) |
| Conditions d’utilisation de l’application | [https://www.responsum.ai/terms-of-service](https://www.responsum.ai/terms-of-service) |
| Fonctionnalités principales de l’application | Assistant Commercial IA pour mettre à jour les informations de vos outils de vente et tirer des enseignements des connaissances de votre équipe. |
...
Responsum Inc. a fourni ces informations sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont traitées par votre application ? | Événements de calendrier utilisateur |
