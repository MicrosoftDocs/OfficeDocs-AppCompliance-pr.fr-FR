---
title: Informations sur l’application pour BravoNow par Les services logiciels de SpadeWorx
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/10/2021
...
description: Toutes les informations de sécurité et de conformité disponibles pour BravoNow, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/272032ad-0c2e-4928-910e-5d52b19f70d5" target="_blank">Afficher dans Teams magasin</a>
...
Informations fournies par Les services logiciels de SpadeWorx à Microsoft :
...
| Site web de la société | [https://www.spadeworx.com](https://www.spadeworx.com) |
| Conditions d’utilisation de l’application | [https://docs.pozitive.io/BRAVO_TermsOfService.pdf](https://docs.pozitive.io/BRAVO_TermsOfService.pdf) |
| Fonctionnalités principales de l’application | Bravo est une plateforme de reconnaissance d’employés d’égal à égal. |
| Emplacement du siège social de la société | Inde |
| Page d’informations sur l’application | [https://bravo.pozitive.io](https://bravo.pozitive.io) |
...
Ces informations ont été fournies par Les services logiciels de PelleWorx sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Délégué | Adresse e-mail des utilisateurs. | [272032ad-0c2e-4928-910e-5d52b19f70d5](../azure/272032ad-0c2e-4928-910e-5d52b19f70d5.md) |
