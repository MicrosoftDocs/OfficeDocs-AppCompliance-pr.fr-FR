---
title: Informations sur l’application pour Breakthru par Breakthru
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/29/2022
...
ms.locfileid: "65152091"
---
# <a name="breakthru"></a>Breakthru

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Dernière mise à jour par le développeur : 28 avril 2022</p>

* <a href="https://teams.microsoft.com/l/app/693aa4f0-e16c-11ea-ab9b-11514b3de7ae" target="_blank">Afficher dans Teams magasin</a>
...
| Site web de la société | [https://breakthru.me](https://breakthru.me) |
| Conditions d’utilisation de l’application | [https://breakthru.me/terms](https://breakthru.me/terms) |
| Fonctionnalités principales de l’application | Des pauses minuscules pour partager et jouer, intégrés directement dans votre journée. |
| Emplacement du siège social de la société | États-Unis d’Amérique |
| Page d’informations sur l’application | [https://breakthru.me](https://breakthru.me) |
...
| Quelles données sont stockées dans vos bases de données ? | Adresse e-mail. Microsoft Teams ID de locataire. Microsoft Teams ID. Nous maintenons un historique des sauts que vous avez sélectionnés et vous permet de définir des rappels pour participer à une pause. |
| Si l’infastructure sous-jacente traite ou stocke les données client Microsoft, où ces données sont-elles stockées géographiquement ? | États-Unis d’Amérique, d’Allemagne, du Royaume-Uni de Grande-Bretagne et d’Irlande du Nord (le) |
...
| URL de la politique de confidentialité | https://breakthru.me/privacy#h.wc7yv5k6csnq |
