---
title: Informations d’application pour Plumm par Plumm Health LTD
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 10/14/2021
...
ms.locfileid: "64875371"
---
# <a name="plumm"></a>Plumm

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Dernière mise à jour par le développeur : 18 août 2021</p>

* <a href="https://teams.microsoft.com/l/app/d66da813-3337-4f88-8e08-f01c0bbb8f34" target="_blank">Afficher dans Teams magasin</a>
...
Informations fournies par Plumm Health LTD à Microsoft :
...
| Site web de la société | [https://www.plummhealth.com](https://www.plummhealth.com) |
| Conditions d’utilisation de l’application | [https://www.plummhealth.com/terms-of-use](https://www.plummhealth.com/terms-of-use) |
| Fonctionnalités principales de l’application | Plumm offre aux employés le soutien dont ils ont besoin pour leur bien-être mental. Chaque membre plumm a accès à un soutien en santé mentale de haute qualité avec un réseau mondial de plus de 150 thérapeutes accrédités, une bibliothèque numérique de cours de bien-être dirigés par un thérapeute, des séances de conversation et des médiations guidées &#8211; tous au même endroit. Les utilisateurs peuvent communiquer avec des thérapeutes pour une vidéothérapie en ligne 1:1 ou discuter en privé avec eux de leurs besoins. Des cours en ligne et des méditations dirigés par un thérapeute fournissent un soutien autonome. |
...
Ces informations ont été fournies par Plumm Health LTD sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| TeamsActivity.Send | application | Nous utilisons userID dans cette autorisation. Il est utilisé pour envoyer des notifications requises à l’utilisateur en fonction de son utilisation de notre service. Cela est important pour que l’utilisateur reçoive les notifications appropriées pour son compte sur notre application. | [b1d1c038-a1f3-4802-be93-0f4a66589e73](../azure/b1d1c038-a1f3-4802-be93-0f4a66589e73.md) |
>| TeamsAppInstallation.ReadWriteForUser.All | application | Nous recevons l’ID d’installation à l’aide de cette autorisation. Cela est important pour nous afin d’être en mesure d’envoyer la notification appropriée et correcte pour chaque utilisateur individuel. | [b1d1c038-a1f3-4802-be93-0f4a66589e73](../azure/b1d1c038-a1f3-4802-be93-0f4a66589e73.md) |
>| User.Read | Délégué | Nous collectons le nom, l’image et le courrier électronique de nos utilisateurs par le biais de cette autorisation. Cela est nécessaire pour que nous puissions identifier des utilisateurs individuels, et ces points de données doivent être affichés lorsque cela est nécessaire, par exemple, une page de profil individuelle et une communication par e-mail/notification. | [b1d1c038-a1f3-4802-be93-0f4a66589e73](../azure/b1d1c038-a1f3-4802-be93-0f4a66589e73.md) |
>| User.Read.All | application | Cette autorisation permet à notre application de lire les profils utilisateur sans utilisateur connecté. Dans ce cas, nous collectons actuellement uniquement le nom, l’image de profil et l’e-mail. Cela est nécessaire pour que nous puissions identifier des utilisateurs individuels, et ces points de données doivent être affichés lorsque cela est nécessaire, par exemple, une page de profil individuelle et une communication par e-mail/notification. | [b1d1c038-a1f3-4802-be93-0f4a66589e73](../azure/b1d1c038-a1f3-4802-be93-0f4a66589e73.md) |
>| email | Délégué | L’ID d’e-mail de l’utilisateur est collecté. Nous avons besoin de ces données pour accorder l’accès à l’utilisateur pour nos services et nous connecter à notre application et recevoir des notifications concernant leurs comptes et nos services sur cet ID de messagerie.  | [b1d1c038-a1f3-4802-be93-0f4a66589e73](../azure/b1d1c038-a1f3-4802-be93-0f4a66589e73.md) |
