---
title: Informations d’application pour GoLinks par GoLinks
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/18/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour GoLinks, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le Registre CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/c1abaf93-e823-4e9a-a810-34a47e77ef71" target="_blank">Afficher dans Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003853" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par GoLinks à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | GoLinks |
| ID | WA200003853 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | GoLinks |
| Site web de l’entreprise | [https://www.golinks.io](https://www.golinks.io) |
| Conditions d’utilisation de l’application | [https://www.golinks.io/terms.php](https://www.golinks.io/terms.php) |
| Fonctionnalités principales de l’application | GoLinks, appelés liens go, golinks, go/links ou go-links, sont des liens courts intuitifs et faciles à mémoriser, partagés par les équipes. Il transforme des URL longues et peu lisibles en liens go lisibles qui peuvent être utilisés directement dans les navigateurs, les e-mails, les conversations et les conversations. GoLinks permet aux entreprises d’accéder efficacement et de partager des informations et des ressources de travail à grande échelle. |
| Emplacement du siège social de l’entreprise | États-Unis d’Amérique |
| Page d’informations sur l’application | [https://www.golinks.io/golinks.php](https://www.golinks.io/golinks.php) |
...
Ces informations ont été fournies par GoLinks sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont stockées dans vos bases de données ? | Nous stockons uniquement l’ID client de Microsoft. |
...
| Date de certification SOC2 la plus récente |  2021-10-31 |
...
| URL de la politique de confidentialité | https://www.golinks.io/privacy.php |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| ChannelMessage.Read.Group | application | Nous avons besoin d’accéder aux messages dans les canaux publics pour vérifier si le message contient un lien d’accès. | [c1abaf93-e823-4e9a-a810-34a47e77ef71](../azure/c1abaf93-e823-4e9a-a810-34a47e77ef71.md) |
