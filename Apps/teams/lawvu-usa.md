---
title: Informations d’application pour LawVu USA par LawVu
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/04/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour LawVu USA, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
ms.locfileid: "64682129"
---
# <a name="lawvu-usa"></a>LawVu Etats-Unis

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Dernière mise à jour par le développeur : 22 février 2022</p>

* <a href="https://teams.microsoft.com/l/app/410462ec-76c7-45ac-9f57-61e6f82a6792" target="_blank">Afficher dans Teams magasin</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003911" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par LawVu à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | LawVu Etats-Unis |
| ID | WA200003911 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | LawVu |
| Site web de la société | [https://lawvu.com](https://lawvu.com) |
...
| Fonctionnalités principales de l’application | Les utilisateurs professionnels peuvent déclencher des demandes légales directement à partir de Teams.  L’intégration capture tous les champs pertinents, y compris le contenu et les pièces jointes du message d’origine, et crée l’affaire dans LawVu afin qu’elle&#8217;partie de l’équipe juridique&#8217;système d’enregistrement. |
| Emplacement du siège social de la société | Nouvelle-Zélande |
...
Ces informations ont été fournies par LawVu sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont stockées dans vos bases de données ? | Le fichier pièce jointe dans les équipes MS est extrait dans notre magasin de données. |
...
| Avez-vous des contrats de partage de données en place avec un service tiers avec lequel vous partagez des données client Microsoft ? |  |
...
| Date de certification SOC1 la plus récente |  2021-02-28 |
...
| Date de certification SOC2 la plus récente |  2021-02-11 |
...
| URL de la politique de confidentialité | https://lawvu.com/trust-center/privacy/gdpr |
