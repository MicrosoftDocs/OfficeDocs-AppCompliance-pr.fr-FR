...
Informations fournies par MiHCM à Microsoft :

| **Information** | **Réponse** |
|:----------------|:-------------|
| Nom de l'application | Tzé |
| ID | WA200002417 |
...
Ces informations ont été fournies par MiHCM sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| URL de la politique de confidentialité | https://mia.work/privacy-policy |
...
>|:------------------------|:--------------------|:------------------------------------|
>| User.Read | délégué | Pour identifier de manière unique un utilisateur |
>| Group.Read.All | délégué | Pour lire les tâches du Planificateur Microsoft de l’utilisateur |
>| MailboxSettings.Read | application | Pour lire le fuseau horaire de l’utilisateur |
>| Calendars.Read | application | Pour lire les événements de calendrier programmés de l’utilisateur |
