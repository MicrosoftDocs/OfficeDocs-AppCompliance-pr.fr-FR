---
title: Informations d’application pour Vocean par Vocean AB
ms.author: elmalova
author: elenamalova
ms.date: 10/21/2021
ms.topic: article
...
description: Toutes les informations de sécurité et de conformité disponibles pour Vocean, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le Registre CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/b96db765-b9ef-43c7-a02d-fdfb973a6fe6" target="_blank">Afficher dans Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003276" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Vocean AB à Microsoft :

| **Information** | **Réponse** |
|:----------------|:-------------|
| Nom de l'application | Vocean |
| ID | WA200003276 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | Vocean AB |
| Site web de l’entreprise | [https://www.vocean.com](https://www.vocean.com) |
| Conditions d’utilisation de l’application | [https://vocean.com/wp-content/uploads/2021/01/terms-and-con...](https://vocean.com/wp-content/uploads/2021/01/terms-and-conditions.pdf) |
| Fonctionnalités principales de l’application | Plateforme d’idées qui, avec de nouveaux outils, génère des idées fortes et résout les problèmes critiques de l’entreprise |
...
Ces informations ont été fournies par Vocean AB sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Les pratiques de codage sécurisé prennent-ils en compte les classes de vulnérabilité courantes telles qu’OWASP top 10 ? | Non |
...
| URL de la politique de confidentialité | https://vocean.com/wp-content/uploads/2021/01/privacy-policy.pdf |
