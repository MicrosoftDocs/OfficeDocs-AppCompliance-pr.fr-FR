---
title: Informations d’application pour Axelleron par Axelleron
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/12/2021
...
description: Toutes les informations de sécurité et de conformité disponibles pour Axelleron, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/d813aed5-1071-460c-a088-1e6beedfe29a" target="_blank">Afficher dans Teams magasin</a>
...
| Site web de la société | [https://axelleron.com](https://axelleron.com) |
| Conditions d’utilisation de l’application | [https://axelleron.com/terms-of-services.html](https://axelleron.com/terms-of-services.html) |
| Fonctionnalités principales de l’application | Axelleron est une plateforme de productivité collaborative qui simplifie et accélère le travail d’équipe pharmaceutique et biotechnologique. |
...
Ces informations ont été fournies par Axelleron sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
