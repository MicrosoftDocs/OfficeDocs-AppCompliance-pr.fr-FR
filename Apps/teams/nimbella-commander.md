---
title: Informations sur l’application pour commander par Nimbella
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: Toutes les informations de sécurité et de conformité disponibles pour Commander, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/be4751a5-db56-4e45-bb27-397e0aa614b1" target="_blank">Afficher dans Teams magasin</a>
...
| Site web de la société | [https://www.nimbella.com](https://www.nimbella.com) |
| Conditions d’utilisation de l’application | [https://nimbella.com/terms](https://nimbella.com/terms) |
| Fonctionnalités principales de l’application | Générez, exécutez et partagez des commandes personnalisées. |
| Emplacement du siège social de la société | États-Unis d’Amérique |
| Page d’informations sur l’application | [https://nimbella.com/integrations/commander/microsoft-teams](https://nimbella.com/integrations/commander/microsoft-teams) |
| Quel est l’environnement d’hébergement ou le modèle de service utilisé pour exécuter votre application ? |  |
| Quels fournisseurs de cloud d’hébergement l’application utilise-t-elle ? | Azure, GCP, DigitalOcean |
