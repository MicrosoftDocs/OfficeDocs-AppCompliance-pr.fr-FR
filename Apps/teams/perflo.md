---
title: Informations d’application pour Perflo par Perflo
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/03/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour Perflo, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le Registre CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/abce776c-943c-4f4b-9f8b-53aa73af701e" target="_blank">Afficher dans Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003721" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Perflo à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | Perflo |
| ID | WA200003721 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | Perflo |
| Site web de l’entreprise | [https://www.perflo.co](https://www.perflo.co) |
| Conditions d’utilisation de l’application | [https://www.perflo.co/terms](https://www.perflo.co/terms) |
| Fonctionnalités principales de l’application | Envoi de micro-enquêtes à des équipes et production de rapports pour les responsables. |
| Emplacement du siège social de l’entreprise | États-Unis d’Amérique |
| Page d’informations sur l’application | [https://www.perflo.co](https://www.perflo.co) |
...
Ces informations ont été fournies par Perflo sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont stockées dans vos bases de données ? | Canaux, Teams, nom de profil utilisateur, images de profil, ID Teams MS |
...
| Date de certification SOC2 la plus récente |  2021-10-22 |
...
| URL de la politique de confidentialité | https://www.perflo.co/privacy |
