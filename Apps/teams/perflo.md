...
* <a href="https://teams.microsoft.com/l/app/374c7844-f88a-43f3-b6d5-5cf58b5b293e" target="_blank">Afficher dans le magasin Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004251" target="_blank">Afficher dans AppSource</a>
...
| Site web de la société | [https://www.perflo.co](https://www.perflo.co) |
| Conditions d’utilisation de l’application | [https://www.perflo.co/terms](https://www.perflo.co/terms) |
| Fonctionnalités principales de l’application | Solution de diagnostic d’équipe ultime qui permet aux équipes de s’améliorer en permanence. |
...
| Quelles données sont traitées par votre application ? | ID MS Teams, image de profil |
| L’application prend-elle en charge TLS 1.1 ou version ultérieure ? | Oui |
| L’application ou l’infrastructure sous-jacente stocke-t-elle des données client Microsoft ? | Oui |
| Quelles données sont stockées dans vos bases de données ? | ID MS Teams, image de profil |
