---
title: Informations sur l’application pour Joye par Joye Pte Ltd
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/31/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour Joye, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le Registre CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/6c75be83-05a8-4515-9c7b-b5f759b99b7f" target="_blank">Afficher dans Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003413" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Joye Pte Ltd à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | Joye |
| ID | WA200003413 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | Joye Pte Ltd |
| Site web de l’entreprise | [https://www.joye.ai](https://www.joye.ai) |
| Conditions d’utilisation de l’application | [https://www.joye.ai/terms](https://www.joye.ai/terms) |
| Fonctionnalités principales de l’application | Imagine après un appel stressant, Joye vous invite à recharger et à accroître à nouveau votre productivité. Bienvenue dans Joye. Le&#8217;est aussi simple que 1-2-3 !  1 : parlez votre avis dans un espace sûr et anonyme. Vous pouvez parler, écrire ou suivre notre réflexion guidée.  2 : Joye vous comprend et vous donne de bons conseils, tout comme votre compagnon ou un ami qui vous aurait guidé. Vous pouvez désormais gérer votre niveau de jeu quotidien ! 3 : Félicitations ! Vous êtes prêt à prendre en compte le reste de votre journée.  |
| Emplacement du siège social de l’entreprise | Singapour |
| Page d’informations sur l’application | [https://www.joye.ai](https://www.joye.ai) |
...
Ces informations ont été fournies par Joye Pte Ltd sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont stockées dans vos bases de données ? | Profil utilisateur, calendrier de libre/occupé. Autres entrées que l’utilisateur fournit dans l’application |
| Si des infastructures sous-jacentes traitent ou stockent des données client Microsoft, où sont stockées géographiquement ces données ? | États-Unis Amérique, Singapour |
...
| Date de certification SOC1 la plus récente |  2021-09-23 |
...
| Date de certification SOC2 la plus récente |  2021-09-23 |
| L’application est-elle conforme aux contrôles d’organisation de service (SOC 3) ? | Oui |
| Date de certification SOC3 la plus récente |  2021-09-23 |
...
| URL de la politique de confidentialité | https://joye.ai/privacy/ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.Read | application | Pour lire le modèle de temps libre dans le calendrier et demander à l’utilisateur de prendre une pause de bien-être physique au bon moment | [42f7cf35-98e6-417e-b5da-8913a5bbec79](../azure/42f7cf35-98e6-417e-b5da-8913a5bbec79.md) |
>| MailboxSettings.Read | délégué | informations utilisateur pour obtenir le fuseau horaire | [42f7cf35-98e6-417e-b5da-8913a5bbec79](../azure/42f7cf35-98e6-417e-b5da-8913a5bbec79.md) |
>| User.Read | délégué | informations et informations de la signature utilisateur | [42f7cf35-98e6-417e-b5da-8913a5bbec79](../azure/42f7cf35-98e6-417e-b5da-8913a5bbec79.md) |
>| User.Read.All | application | Lire les informations de tous les utilisateurs, et en parallèle pour que l’administrateur Teams installer automatiquement l’application pour tous les utilisateurs | [42f7cf35-98e6-417e-b5da-8913a5bbec79](../azure/42f7cf35-98e6-417e-b5da-8913a5bbec79.md) |
>| email | délégué | informations utilisateur pour pouvoir lire le calendrier get.calendar | [42f7cf35-98e6-417e-b5da-8913a5bbec79](../azure/42f7cf35-98e6-417e-b5da-8913a5bbec79.md) |
>| offline_access | délégué | informations d’utilisation | [42f7cf35-98e6-417e-b5da-8913a5bbec79](../azure/42f7cf35-98e6-417e-b5da-8913a5bbec79.md) |
>| openid | délégué | informations utilisateur | [42f7cf35-98e6-417e-b5da-8913a5bbec79](../azure/42f7cf35-98e6-417e-b5da-8913a5bbec79.md) |
>| profil | délégué | informations utilisateur | [42f7cf35-98e6-417e-b5da-8913a5bbec79](../azure/42f7cf35-98e6-417e-b5da-8913a5bbec79.md) |
