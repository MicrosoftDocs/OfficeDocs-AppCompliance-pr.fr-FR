---
title: Informations d’application pour BitFractal par BitFractal
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/26/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour BitFractal, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/2908a48e-21b7-48e4-89fc-7f4a433952fa" target="_blank">Afficher dans le magasin Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004172" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par BitFractal à Microsoft :

| **Information** | **Réponse** |
|:----------------|:-------------|
| Nom de l'application | BitFractal |
| ID | WA200004172 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | BitFractal |
| Site web de la société | [https://www.bitfractal.com](https://www.bitfractal.com) |
| Conditions d’utilisation de l’application | [https://www.bitfractal.com/termsofuse](https://www.bitfractal.com/termsofuse) |
| Fonctionnalités principales de l’application | BitFractal apporte l’IA aux utilisateurs professionnels d’une manière simple et efficace pour automatiser les processus quotidiens en connectant AI Cognitive Services d’Azure à l’interface conviviale de Teams, puis en y ajoutant une couche de productivité et de collaboration en tirant parti des fonctionnalités Teams telles que les bots, les onglets, les extensions de message, etc. |
| Emplacement du siège social de la société | États-Unis d’Amérique |
| Page d’informations sur l’application | [https://www.bitfractal.com](https://www.bitfractal.com) |
...
Ces informations ont été fournies par BitFractal sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont traitées par votre application ? | Données de profil utilisateur (DisplayName, Email, ObjectId, TenantId) |
| L’application prend-elle en charge TLS 1.1 ou version ultérieure ? | Oui |
| L’application ou l’infrastructure sous-jacente stocke-t-elle des données client Microsoft ? | Oui |
| Quelles données sont stockées dans vos bases de données ? | Données de profil utilisateur (DisplayName, Email, ObjectId, TenantId) |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Délégué | Obtenir des informations de profil utilisateur de base pour que l’application interagisse avec l’utilisateur | [6a1d567b-1106-46a0-83bc-ffe9ada78b9b](../azure/6a1d567b-1106-46a0-83bc-ffe9ada78b9b.md) |
>| User.Read | Délégué | Obtenir des informations de profil utilisateur de base pour que l’application interagisse avec l’utilisateur | [8f261936-59e1-44b3-8234-a746c5e4eab7](../azure/8f261936-59e1-44b3-8234-a746c5e4eab7.md) |
>| User.Read | Délégué | Obtenir des informations de profil utilisateur de base pour que l’application interagisse avec l’utilisateur | [fb5ad138-bf16-44c0-bdc2-2a9c0e6f246f](../azure/fb5ad138-bf16-44c0-bdc2-2a9c0e6f246f.md) |
