---
title: Informations d’application pour NewCOS par Newtech
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/27/2022
...
ms.locfileid: "67053089"
---
# <a name="newcos"></a>NewCOS

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Dernière mise à jour par le développeur : 26 juillet 2022</p>

* <a href="https://teams.microsoft.com/l/app/205214d0-e04b-11e9-9332-5b5c97b60069" target="_blank">Afficher dans le magasin Teams</a>
...
| Site web de la société | [https://newtech.com.ar](https://newtech.com.ar) |
| Conditions d’utilisation de l’application | [https://newtech.com.ar/termsofservice](https://newtech.com.ar/termsofservice) |
| Fonctionnalités principales de l’application | Déployez une solution de communication intelligente rapidement, facilement et en mode service. La plateforme NewCOS vous permet d’exécuter, de gérer, de surveiller et de prendre en charge votre installation rapidement, facilement et sans intervention du service informatique.  Nous allons avec vous pour que le processus d’adoption de la technologie soit réussi. Nous faciliteons l’adaptation des changements dans les espaces de travail collaboratifs d’aujourd’hui. Grâce à l’adoption de Microsoft 365, nous pouvons accélérer le processus de transformation numérique au sein de votre organisation.  |
| Emplacement du siège social de la société | Argentine |
| Page d’informations sur l’application | [https://newtech.com.ar/newcosnt/](https://newtech.com.ar/newcosnt/) |
...
| Quelles données sont traitées par votre application ? | Données de profil utilisateur, enregistrement d’appel |
| L’application prend-elle en charge TLS 1.1 ou version ultérieure ? | Oui |
| L’application ou l’infrastructure sous-jacente stocke-t-elle des données client Microsoft ? | Oui |
| Quelles données sont stockées dans vos bases de données ? | Données de profil utilisateur, enregistrement d’appel |
| Si l’infastructure sous-jacente traite ou stocke les données client Microsoft, où ces données sont-elles stockées géographiquement ? | Brésil |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Délégué | Activer la connexion et lire le profil utilisateur | [07d4a8e0-3d1d-4f70-bdc2-f46593d7fa0e](../azure/07d4a8e0-3d1d-4f70-bdc2-f46593d7fa0e.md) |
>| offline_access | Délégué | Gérer l’accès aux données auxquelles vous avez accordé l’accès | [07d4a8e0-3d1d-4f70-bdc2-f46593d7fa0e](../azure/07d4a8e0-3d1d-4f70-bdc2-f46593d7fa0e.md) |
>| openid | Délégué | Connecter des utilisateurs | [07d4a8e0-3d1d-4f70-bdc2-f46593d7fa0e](../azure/07d4a8e0-3d1d-4f70-bdc2-f46593d7fa0e.md) |
>| profil | Délégué | Afficher le profil de base des utilisateurs | [07d4a8e0-3d1d-4f70-bdc2-f46593d7fa0e](../azure/07d4a8e0-3d1d-4f70-bdc2-f46593d7fa0e.md) |
