---
title: Informations sur l’application pour les décisions par décision
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/18/2021
...
ms.locfileid: "64881341"
---
# <a name="decisions"></a>Décisions

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Dernière mise à jour par le développeur : 2 juin 2021</p>

* <a href="https://teams.microsoft.com/l/app/d3d1be68-066c-4967-a74b-9edcf902dcfb" target="_blank">Afficher dans Teams magasin</a>
...
Informations fournies par Décisions à Microsoft :
...
| Site web de la société | [https://www.meetingdecisions.com](https://www.meetingdecisions.com) |
...
| Fonctionnalités principales de l’application | Faites en sorte que vos réunions comptent avec un générateur d’ordres du jour, des modèles de minutes et d’autres éléments intégrés à Teams. |
| Emplacement du siège social de la société | Norvège |
...
Ces informations ont été fournies par Décisions sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont traitées par votre application ? |  |
| L’application prend-elle en charge TLS 1.1 ou version ultérieure ? |  |
| L’application ou l’infrastructure sous-jacente stocke-t-elle des données client Microsoft ? | Oui |
| Quelles données sont stockées dans vos bases de données ? |  |
| Si l’infastructure sous-jacente traite ou stocke les données client Microsoft, où ces données sont-elles stockées géographiquement ? |  |
| Disposez-vous d’un processus de location et d’élimination des données établi ? |  |
| Combien de temps les données sont-ils conservées après la résiliation du compte ? | Supprimé dans les 3 mois |
| Disposez-vous d’un processus de gestion de l’accès aux données établi ? |  |
| Transférez-vous des données client ou du contenu client vers des tiers ou des sous-processeurs ? |  |
...
| Répertorier les types de stratégies prises en charge | Tous |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.ReadWrite | Délégué | Permet de lire les informations de l’utilisateur&#8217;calendrier pour activer des fonctionnalités telles que la liste des réunions et la recherche. Il permet également à l’utilisateur de supprimer des réunions spécifiques du calendrier lorsque l’élément est supprimé des décisions. | [1064f7e4-a9e2-467d-8d42-f45cc59f145d](../azure/1064f7e4-a9e2-467d-8d42-f45cc59f145d.md) |
>| Chat.ReadWrite | Délégué | Permet d’envoyer des décisions de vote et de créer des listes d’orateurs pour les éléments de l’ordre du jour individuels directement à la conversation de réunion Microsoft Teams. | [1064f7e4-a9e2-467d-8d42-f45cc59f145d](../azure/1064f7e4-a9e2-467d-8d42-f45cc59f145d.md) |
>| Directory.Read.All | Délégué | Utilisé pour collecter des informations de base sur le locataire Office 365 lors de l’inscription, telles que le nom du locataire et les domaines vérifiés. Il est également nécessaire de vérifier les appartenances aux groupes. | [1064f7e4-a9e2-467d-8d42-f45cc59f145d](../azure/1064f7e4-a9e2-467d-8d42-f45cc59f145d.md) |
>| Files.Read.All | Délégué | Permet de lire les fichiers partagés avec l’utilisateur afin de fusionner ces fichiers dans le livre de réunion PDF. | [1064f7e4-a9e2-467d-8d42-f45cc59f145d](../azure/1064f7e4-a9e2-467d-8d42-f45cc59f145d.md) |
>| Files.ReadWrite.All | Délégué | Utilisé pour fournir aux utilisateurs la prise en charge des annotations de fichiers personnels. Les fichiers annotés sont stockés en privé dans le OneDrive Entreprise de l’utilisateur&#8217;. | [1064f7e4-a9e2-467d-8d42-f45cc59f145d](../azure/1064f7e4-a9e2-467d-8d42-f45cc59f145d.md) |
>| Group.ReadWrite.All | Délégué | Permet de créer des structures de dossiers dans le site SharePoint Office 365 Group&#8217;pour les agendas des réunions, les fichiers associés et les conversations de groupe.   Remarque : les utilisateurs de Décisions n’auront jamais accès aux ressources (par exemple, les groupes) auxquelles ils n’ont pas encore accès dans le locataire Office 365 de votre organisation. | [1064f7e4-a9e2-467d-8d42-f45cc59f145d](../azure/1064f7e4-a9e2-467d-8d42-f45cc59f145d.md) |
>| Mail.Send | Délégué | Permet aux utilisateurs de Décisions d’envoyer des notifications aux participants à la réunion, telles que des mises à jour de l’ordre du jour et des liens vers la réunion pour les co-auteurs. Les e-mails sont envoyés aux participants à la réunion ou à la liste de distribution sélectionnée par le propriétaire de la réunion. Toutes les notifications et e-mails envoyés sont activement effectués par les utilisateurs de Decisions.  Remarque : cela ne permet pas à l’utilisateur d’accéder à sa boîte de réception par le biais de Décisions. | [1064f7e4-a9e2-467d-8d42-f45cc59f145d](../azure/1064f7e4-a9e2-467d-8d42-f45cc59f145d.md) |
>| MailboxSettings.Read | Délégué | Permet d’identifier les préférences linguistiques d’un utilisateur&#8217;. | [1064f7e4-a9e2-467d-8d42-f45cc59f145d](../azure/1064f7e4-a9e2-467d-8d42-f45cc59f145d.md) |
>| Notes.ReadWrite | Délégué | Utilisé pour configurer des blocs-notes privés pour les réunions afin de prendre des notes et de préparer des remarques et des questions. Il permet également de stocker les minutes de réunion de groupe dans leur bloc-notes OneNote partagé, si le groupe choisit d’utiliser OneNote. | [1064f7e4-a9e2-467d-8d42-f45cc59f145d](../azure/1064f7e4-a9e2-467d-8d42-f45cc59f145d.md) |
>| Sites.ReadWrite.All | Délégué | Permet de créer des structures de dossiers dans des canaux privés pour les informations de réunion. | [1064f7e4-a9e2-467d-8d42-f45cc59f145d](../azure/1064f7e4-a9e2-467d-8d42-f45cc59f145d.md) |
>| Tasks.ReadWrite | Délégué | Utilisé pour synchroniser les tâches et les décisions sur Planificateur Microsoft. Il permet également aux utilisateurs d’exporter des tâches et des décisions pour Excel. | [1064f7e4-a9e2-467d-8d42-f45cc59f145d](../azure/1064f7e4-a9e2-467d-8d42-f45cc59f145d.md) |
>| TeamsAppInstallation.ReadWriteForUser | Délégué | Requis pour installer l’application Décisions par programmation dans la conversation. Cela est nécessaire avant d’ajouter l’onglet Décisions pour l’expérience de réunion. | [1064f7e4-a9e2-467d-8d42-f45cc59f145d](../azure/1064f7e4-a9e2-467d-8d42-f45cc59f145d.md) |
>| TeamsAppInstallation.ReadWriteForUser.All | Délégué | Requis pour installer l’application Décisions par programmation dans la conversation. Cela est nécessaire avant d’ajouter l’onglet Décisions pour l’expérience de réunion. | [1064f7e4-a9e2-467d-8d42-f45cc59f145d](../azure/1064f7e4-a9e2-467d-8d42-f45cc59f145d.md) |
>| TeamsTab.Create | Délégué | Exiger l’ajout de l’onglet Réunion/Canal dans Teams. | [1064f7e4-a9e2-467d-8d42-f45cc59f145d](../azure/1064f7e4-a9e2-467d-8d42-f45cc59f145d.md) |
>| TeamsTab.Read.All | Délégué | Requis pour vérifier si l’onglet est installé ou non. | [1064f7e4-a9e2-467d-8d42-f45cc59f145d](../azure/1064f7e4-a9e2-467d-8d42-f45cc59f145d.md) |
>| User.ReadBasic.All | Délégué | Permet d’afficher le prénom et le nom, la photo et l’adresse e-mail des membres du groupe et des participants externes. | [1064f7e4-a9e2-467d-8d42-f45cc59f145d](../azure/1064f7e4-a9e2-467d-8d42-f45cc59f145d.md) |
