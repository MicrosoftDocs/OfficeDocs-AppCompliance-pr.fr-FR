---
title: Informations d’application pour Kunjani par FACEBOARD (PTY) LTD
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 10/10/2021
...
description: Toutes les informations de sécurité et de conformité disponibles pour Kunjani, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
ms.locfileid: "64875431"
---
# <a name="kunjani"></a>Kunjani

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Dernière mise à jour par le développeur : 10 octobre 2021</p>

* <a href="https://teams.microsoft.com/l/app/6b4ac65a-764d-4021-bf3f-40cb2d137a33" target="_blank">Afficher dans Teams magasin</a>
...
| Site web de la société | [https://www.kunjani.co](https://www.kunjani.co) |
| Conditions d’utilisation de l’application | [https://www.kunjani.co/termsandconditions](https://www.kunjani.co/termsandconditions) |
| Fonctionnalités principales de l’application | Liven up your Meeting with an interactive Kunjani game designed by you. |
| Emplacement du siège social de la société | Royaume-Uni de Grande-Bretagne et d’Irlande du Nord (le) |
| Page d’informations sur l’application | [https://Kunjani.co](https://Kunjani.co) |
...
| Date de certification SOC3 la plus récente | 2021-01-01 |
