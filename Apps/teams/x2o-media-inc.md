---
title: Informations sur l’application pour X2O par X2O Media, Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/15/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour X2O, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/647624e1-056f-43cb-a112-b9bc64c81ef4" target="_blank">Afficher dans le magasin Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003735" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par X2O Media, Inc. à Microsoft :

| **Information** | **Réponse** |
|:----------------|:-------------|
| Nom de l'application | X2O |
| ID | WA200003735 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | X2O Media, Inc. |
| Site web de la société | [https://www.x2omedia.com](https://www.x2omedia.com) |
| Conditions d’utilisation de l’application | [https://www.x2omedia.com/en/terms-of-use/](https://www.x2omedia.com/en/terms-of-use/) |
| Fonctionnalités principales de l’application | Communiquez des informations métier avec des canaux X2O à votre personnel mondial. |
...
Ces informations ont été fournies par X2O Media, Inc. sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Date de certification SOC1 la plus récente | 2020-05-14 |
...
| Date de certification SOC2 la plus récente | 2020-05-14 |
...
| URL de la politique de confidentialité | https://www.x2omedia.com/privacy |
