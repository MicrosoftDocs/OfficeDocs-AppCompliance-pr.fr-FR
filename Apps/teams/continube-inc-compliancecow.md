---
title: Informations d’application pour ComplianceCow par ContiNube Inc
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/17/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour ComplianceCow, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/be1720d1-f7ae-4f6e-ab02-e6911a51bc92" target="_blank">Afficher dans le magasin Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004247" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par ContiNube Inc à Microsoft :

| **Information** | **Réponse** |
|:----------------|:-------------|
| Nom de l'application | ComplianceCow |
| ID | WA200004247 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | ContiNube Inc |
| Site web de la société | [https://compliancecow.com](https://compliancecow.com) |
| Conditions d’utilisation de l’application | [https://compliancecow.com/trust/termsandconditions](https://compliancecow.com/trust/termsandconditions) |
| Fonctionnalités principales de l’application | Workflows minimalistes pour Security GRC et Assurance |
| Emplacement du siège social de la société | États-Unis d’Amérique |
| Page d’informations sur l’application | [https://compliancecow.com/docs#compliancecow-chat-applicati...](https://compliancecow.com/docs#compliancecow-chat-applications) |
...
Ces informations ont été fournies par ContiNube Inc. sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont traitées par votre application ? | Données de conformité |
| L’application prend-elle en charge TLS 1.1 ou version ultérieure ? | Oui |
| L’application ou l’infrastructure sous-jacente stocke-t-elle des données client Microsoft ? | Oui |
| Quelles données sont stockées dans vos bases de données ? | Données de conformité |
