---
title: Informations d’application pour isLucid by UAB Lucid Agreements
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/02/2021
...
<p>Dernière mise à jour par le développeur : 9 août 2021</p>

* <a href="https://teams.microsoft.com/l/app/a5711b63-5e70-4e4e-b040-0d714b64f684" target="_blank">Afficher dans Teams magasin</a>
...
Informations fournies par les contrats Lucid UAB à Microsoft :
...
| Site web de la société | [https://islucid.com](https://islucid.com) |
| Conditions d’utilisation de l’application | [https://islucid.com/eula/](https://islucid.com/eula/) |
| Fonctionnalités principales de l’application | Activez l’équipe dans Microsoft Teams appel pour capturer et créer des tâches à partir de la transcription en temps réel. Intégrez ces tâches à des logiciels de gestion Project existants. |
| Emplacement du siège social de la société | Lituanie |
...
Ces informations ont été fournies par UAB Lucid Agreements sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calls.AccessMedia.All | les deux | Avec un consentement spécifique de l’utilisateur pour chaque appel séparément (transcription initiée), il accède au flux audio. Le flux audio est transféré à un service de transcription afin que les utilisateurs bénéficient d’autres fonctionnalités. | [98b70422-b0b2-41bf-8673-60d85f5d38c7](../azure/98b70422-b0b2-41bf-8673-60d85f5d38c7.md) |
>| Calls.JoinGroupCall.All | les deux | Avec un consentement spécifique de l’utilisateur pour chaque appel séparément (transcription initiée), il accède au flux audio. Le flux audio est transféré à un service de transcription afin que les utilisateurs bénéficient d’autres fonctionnalités. | [98b70422-b0b2-41bf-8673-60d85f5d38c7](../azure/98b70422-b0b2-41bf-8673-60d85f5d38c7.md) |
>| Group.ReadWrite.All | les deux | Lorsque l’utilisateur utilise l’intégration à Planificateur Microsoft pour créer des tâches à partir de l’appel et le stocker automatiquement dans le Planificateur MS, isLucid collecte pour ces groupes, plans et assignés disponibles pour cet utilisateur. Sans cette autorisation, l’utilisateur ne serait pas en mesure de créer une tâche à partir de la transcription à l’aide d’isLucid | [98b70422-b0b2-41bf-8673-60d85f5d38c7](../azure/98b70422-b0b2-41bf-8673-60d85f5d38c7.md) |
>| OnlineMeetings.Read.All | les deux | L’application collecte les titres des réunions afin que les utilisateurs plus tard (une fois la réunion terminée) puissent trouver plus facilement les transcriptions et tâches précédentes. | [98b70422-b0b2-41bf-8673-60d85f5d38c7](../azure/98b70422-b0b2-41bf-8673-60d85f5d38c7.md) |
>| Tasks.ReadWrite | les deux | Lorsque l’utilisateur utilise l’intégration à Planificateur Microsoft pour créer des tâches à partir de l’appel et le stocker automatiquement dans le Planificateur MS, isLucid collecte pour ces groupes, plans et assignés disponibles pour cet utilisateur. Sans cette autorisation, l’utilisateur ne serait pas en mesure de créer une tâche à partir de la transcription à l’aide d’isLucid | [98b70422-b0b2-41bf-8673-60d85f5d38c7](../azure/98b70422-b0b2-41bf-8673-60d85f5d38c7.md) |
>| User.ReadWrite.All | les deux | Lorsque l’utilisateur utilise l’intégration à Planificateur Microsoft pour créer des tâches à partir de l’appel et le stocker automatiquement dans le Planificateur MS, isLucid collecte pour ces groupes, plans et assignés disponibles pour cet utilisateur. Sans cette autorisation, l’utilisateur ne serait pas en mesure de créer une tâche à partir de la transcription à l’aide d’isLucid | [98b70422-b0b2-41bf-8673-60d85f5d38c7](../azure/98b70422-b0b2-41bf-8673-60d85f5d38c7.md) |
>| openid | les deux | ID d’utilisateur, ID de locataire collecté pour fournir Azure Active Directory fonctionnalités de connexion à nos utilisateurs | [98b70422-b0b2-41bf-8673-60d85f5d38c7](../azure/98b70422-b0b2-41bf-8673-60d85f5d38c7.md) |
