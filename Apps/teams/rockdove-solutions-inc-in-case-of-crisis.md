...
| Site web de la société | [https://www.rockdovesolutions.com](https://www.rockdovesolutions.com) |
...
| Fonctionnalités principales de l’application | In Case of Crisis est la plateforme spécialement conçue pour la gestion dynamique des problèmes et du cycle de vie de la gestion des crises. Notre application permet aux organisations de partager et d’activer facilement des playbooks actionnables qui incluent vos protocoles de réponse et les meilleures pratiques en cas de situation.  Vous pouvez également gérer et capturer le cycle de vie complet des problèmes qui affectent votre entreprise, de la création de rapports initiale à la résolution.   |
...
RockDove Solutions, Inc. a fourni ces informations sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont traitées par votre application ? | Planification des conférences, partage de fichiers dans un canal |
| L’application prend-elle en charge TLS 1.1 ou version ultérieure ? | Oui |
| L’application ou l’infrastructure sous-jacente stocke-t-elle des données client Microsoft ? | Oui |
| Quelles données sont stockées dans vos bases de données ? | Planification des conférences, partage de fichiers dans un canal |
...
| URL de la politique de confidentialité | https://www.rockdovesolutions.com/privacy-policy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.ReadWrite | Délégué | Partage d’invitations de calendrier avec les membres de l’équipe Gestion des problèmes | [6b4a2fee-5642-41a7-b452-d555fac690b0](../azure/6b4a2fee-5642-41a7-b452-d555fac690b0.md) |
>| Channel.ReadBasic.All | Délégué | Afin que nous puissions charger et partager des fichiers pour les membres de l’équipe gestion des problèmes | [6b4a2fee-5642-41a7-b452-d555fac690b0](../azure/6b4a2fee-5642-41a7-b452-d555fac690b0.md) |
>| Files.ReadWrite | Délégué | Pour les problèmes liés au calendrier de gestion et aux modifications et notifications de fichiers | [6b4a2fee-5642-41a7-b452-d555fac690b0](../azure/6b4a2fee-5642-41a7-b452-d555fac690b0.md) |
>| Files.ReadWrite.All | Délégué | Pour les problèmes liés au calendrier de gestion et aux modifications et notifications de fichiers | [6b4a2fee-5642-41a7-b452-d555fac690b0](../azure/6b4a2fee-5642-41a7-b452-d555fac690b0.md) |
>| Sites.ReadWrite.All | Délégué | Pour les problèmes liés au calendrier de gestion et aux modifications et notifications de site | [6b4a2fee-5642-41a7-b452-d555fac690b0](../azure/6b4a2fee-5642-41a7-b452-d555fac690b0.md) |
>| Team.ReadBasic.All | Délégué | Nous permet de répertorier les équipes auxquelles l’utilisateur a accès pour la gestion des problèmes | [6b4a2fee-5642-41a7-b452-d555fac690b0](../azure/6b4a2fee-5642-41a7-b452-d555fac690b0.md) |
>| email | Délégué | Étant donné que nous l’utilisons comme ID d’utilisateur principal avec OAuth 2.0 et Azure Active Directory | [6b4a2fee-5642-41a7-b452-d555fac690b0](../azure/6b4a2fee-5642-41a7-b452-d555fac690b0.md) |
>| offline_access | Délégué | Pour les problèmes liés au calendrier de gestion et aux modifications et notifications de fichiers | [6b4a2fee-5642-41a7-b452-d555fac690b0](../azure/6b4a2fee-5642-41a7-b452-d555fac690b0.md) |
>| openid | Délégué | Utilisé pour l’authentification unique Sign-On (SSO) | [6b4a2fee-5642-41a7-b452-d555fac690b0](../azure/6b4a2fee-5642-41a7-b452-d555fac690b0.md) |
