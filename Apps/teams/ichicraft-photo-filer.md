---
title: Informations d’application pour Photo Filer par Ichicraft
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/23/2022
...
ms.locfileid: "64879721"
---
# <a name="photo-filer"></a>Photo Filer

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Dernière mise à jour par le développeur : 25 février 2022</p>

* <a href="https://teams.microsoft.com/l/app/28fdbeb3-f306-4d78-a1d8-2c1bef32e6ea" target="_blank">Afficher dans Teams magasin</a>
...
Informations fournies par Ichicraft à Microsoft :
...
| Nom de la société partenaire | Ichicraft |
| Site web de la société | [https://photofiler.ichicraft.com](https://photofiler.ichicraft.com) |
...
Ces informations ont été fournies par Ichicraft sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| ChannelMessage.Send | Délégué | Création d’un message de conversation avec un petit résumé des photos qui ont été téléchargées par l’utilisateur. | [e54fe734-bab8-48b2-9ec8-05c2545cc49d](../azure/e54fe734-bab8-48b2-9ec8-05c2545cc49d.md) |
>| Files.ReadWrite.All | Délégué | Lecture de la structure des dossiers et chargement de fichiers dans la bibliothèque de documents SharePoint. | [e54fe734-bab8-48b2-9ec8-05c2545cc49d](../azure/e54fe734-bab8-48b2-9ec8-05c2545cc49d.md) |
>| User.Read | Délégué | Lire à partir du profil des utilisateurs. | [e54fe734-bab8-48b2-9ec8-05c2545cc49d](../azure/e54fe734-bab8-48b2-9ec8-05c2545cc49d.md) |
