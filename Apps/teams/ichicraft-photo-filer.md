---
title: Informations sur l’application pour le filer de photos par Ichiitch
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/23/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour Photo Filer, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le Registre CSA STAR.
...
ms.locfileid: "64463858"
---
# <a name="photo-filer"></a>Photo Filer

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Last updated by the developer on: February 25, 2022</p>

* <a href="https://teams.microsoft.com/l/app/28fdbeb3-f306-4d78-a1d8-2c1bef32e6ea" target="_blank">Afficher dans Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003881" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Ichiitch à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | Photo Filer |
| ID | WA200003881 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | Ichiichi qu’il s’y soit |
| Site web de l’entreprise | [https://photofiler.ichicraft.com](https://photofiler.ichicraft.com) |
| Conditions d’utilisation de l’application | [https://photofiler.ichicraft.com/terms/](https://photofiler.ichicraft.com/terms/) |
| Fonctionnalités principales de l’application | Le moyen le plus simple de partager et d’archiver vos photos dans Microsoft Teams. |
| Emplacement du siège social de l’entreprise | Pays-Bas (les) |
| Page d’informations sur l’application | [https://photofiler.ichicraft.com](https://photofiler.ichicraft.com) |
...
Ces informations ont été fournies par Ichiitch sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| ChannelMessage.Send | délégué | Création d’un message de conversation avec un petit résumé des photos qui ont été téléchargées par l’utilisateur. | [e54fe734-bit8-48b2-9ec8-05c2545cc49d](../azure/e54fe734-bab8-48b2-9ec8-05c2545cc49d.md) |
>| Files.ReadWrite.All | délégué | Lecture de la structure des dossiers et téléchargement de fichiers dans la bibliothèque SharePoint documents. | [e54fe734-bit8-48b2-9ec8-05c2545cc49d](../azure/e54fe734-bab8-48b2-9ec8-05c2545cc49d.md) |
>| User.Read | délégué | Lire le profil des utilisateurs. | [e54fe734-bit8-48b2-9ec8-05c2545cc49d](../azure/e54fe734-bab8-48b2-9ec8-05c2545cc49d.md) |
