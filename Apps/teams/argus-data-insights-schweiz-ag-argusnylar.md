---
title: Informations d’application pour ARGUSnylar par ARGUS DATA INSIGHTS Schweiz AG
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/26/2021
...
description: Toutes les informations de sécurité et de conformité disponibles pour ARGUSnylar, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/f14455f8-5bbe-4da9-8df3-9c5533057569" target="_blank">Afficher dans Teams magasin</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003186" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par ARGUS DATA INSIGHTS Schweiz AG à Microsoft :
...
| Site web de la société | [https://www.argusdatainsights.ch/en/](https://www.argusdatainsights.ch/en/) |
| Conditions d’utilisation de l’application | [https://portal.nylar.org/terms-of-use](https://portal.nylar.org/terms-of-use) |
| Fonctionnalités principales de l’application | ARGUSnylar est l’extension utile pour votre compte. |
| Emplacement du siège social de la société | Suisse |
| Page d’informations sur l’application | [https://portal.nylar.org/help](https://portal.nylar.org/help) |
...
Ces informations ont été fournies par ARGUS DATA INSIGHTS Schweiz AG sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| openid | application | / | [5c1f85d2-d744-4159-8c01-16e9a7b1207b](../azure/5c1f85d2-d744-4159-8c01-16e9a7b1207b.md) |
