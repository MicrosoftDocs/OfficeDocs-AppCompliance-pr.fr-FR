---
title: Informations sur l’application pour ChurnZero par ChurnZero
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/08/2021
...
* <a href="https://teams.microsoft.com/l/app/c2e66b59-725d-4c56-8a0e-ee2587031d9f" target="_blank">Afficher dans Teams magasin</a>
...
| Site web de la société | [https://churnzero.net](https://churnzero.net) |
| Conditions d’utilisation de l’application | [https://churnzero.net/terms-of-use](https://churnzero.net/terms-of-use) |
| Fonctionnalités principales de l’application | ChurnZero est une plateforme de réussite client en temps réel qui permet aux entreprises d’abonnements de lutter contre l’activité, de développer les comptes actuels, d’augmenter l’adoption des produits et d’optimiser l’expérience client. |
...
ChurnZero a fourni ces informations sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Date de certification SOC2 la plus récente | 2020-11-18 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Délégué | ID d’objet Azure de l’utilisateur délégué à mettre en corrélation avec un utilisateur ChurnZero, afin d’identifier et d’autoriser cet utilisateur lors d’une prochaine session de bot. | [c2e66b59-725d-4c56-8a0e-ee2587031d9f](../azure/c2e66b59-725d-4c56-8a0e-ee2587031d9f.md) |
