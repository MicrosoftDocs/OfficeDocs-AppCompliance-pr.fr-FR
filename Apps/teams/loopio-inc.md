---
title: Informations sur l’application pour Loopio par Loopio Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/16/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour Loopio, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/c2f87ddb-d2e0-4268-851f-88d57ac6e0a0" target="_blank">Afficher dans Teams magasin</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004103" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Loopio Inc. à Microsoft :

| **Information** | **Réponse** |
|:----------------|:-------------|
| Nom de l'application | Loopio |
| ID | WA200004103 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | Loopio Inc. |
| Site web de la société | [https://www.loopio.com](https://www.loopio.com) |
| Conditions d’utilisation de l’application | [https://loopio.com/terms/](https://loopio.com/terms/) |
| Fonctionnalités principales de l’application | Recherchez et partagez le contenu de la bibliothèque Loopio tout en restant au courant des tâches avec les notifications Loopio ! |
...
Loopio Inc. a fourni ces informations sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont stockées dans vos bases de données ? | ID de Teams utilisateur |
...
| URL de la politique de confidentialité | https://loopio.com/privacy/ |
