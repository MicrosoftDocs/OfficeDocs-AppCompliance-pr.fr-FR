---
title: Informations sur l’application pour Lebotbot par Ltd
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 11/29/2021
...
* <a href="https://teams.microsoft.com/l/app/d75ef5c2-4314-4e42-b830-a2af05872a4c" target="_blank">Afficher dans Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003224" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Contrôlebot Ltd à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | Geekbot |
| ID | WA200003224 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | Geekbot Ltd |
| Site web de l’entreprise | [https://geekbot.com](https://geekbot.com) |
| Conditions d’utilisation de l’application | [https://geekbot.com/tos/](https://geekbot.com/tos/) |
| Fonctionnalités principales de l’application | Exécutez des standups, des équipes d’équipe et des enquêtes asynchrones, en partageant les connaissances de l’équipe sur plusieurs fuseaux horaires. |
| Emplacement du siège social de l’entreprise | Chypre |
| Page d’informations sur l’application | [https://help.geekbot.com/en/](https://help.geekbot.com/en/) |
...
Ces informations ont été fournies par Lebot Ltd sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont stockées dans vos bases de données ? | Données de profil utilisateur, données de messagerie utilisateur, Microsoft Teams d’équipe (ID d’équipe, données de canal), rapports |
...
| URL de la politique de confidentialité | https://geekbot.com/privacy/ |
