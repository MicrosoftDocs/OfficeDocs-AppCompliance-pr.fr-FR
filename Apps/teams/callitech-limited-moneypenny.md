---
title: Informations d’application pour Moneypenny par CALLITECH LIMITED
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 11/08/2021
...
* <a href="https://teams.microsoft.com/l/app/ff5b7b81-ef94-441d-bc7c-eb04e53a188f" target="_blank">Afficher dans Teams magasin</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003396" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par CALLITECH LIMITED à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | Moneypenny |
| ID | WA200003396 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | CALLITECH LIMITED |
| Site web de la société | [https://www.moneypenny.com](https://www.moneypenny.com) |
| Conditions d’utilisation de l’application | [https://www.moneypenny.com/uk/microsoft-teams-terms-and-con...](https://www.moneypenny.com/uk/microsoft-teams-terms-and-conditions/) |
| Fonctionnalités principales de l’application | La fonctionnalité principale de l’application est que Teams utilisateurs à intégrer leurs organisations pour recevoir des appels de Moneypenny via un bot |
...
Ces informations ont été fournies par CALLITECH LIMITED sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont traitées par votre application ? | ID de locataire Microsoft, ID d’objet Microsoft |
| L’application prend-elle en charge TLS 1.1 ou version ultérieure ? | Oui |
| L’application ou l’infrastructure sous-jacente stocke-t-elle des données client Microsoft ? | Oui |
| Quelles données sont stockées dans vos bases de données ? | ID de locataire Microsoft, ID d’objet Microsoft |
...
| Si votre application n’utilise pas l’une des bibliothèques ci-dessus, quelle bibliothèque ou bibliothèque d’authentification utilise-t-elle ? | Microsoft Identity Web |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calls.AccessMedia.All | application | Pour diffuser du contenu multimédia du bot vers l’utilisateur Teams | [8277a51c-3ad6-446c-9b7e-e3f6e27257c1](../azure/8277a51c-3ad6-446c-9b7e-e3f6e27257c1.md) |
>| Calls.Initiate.All | application | Pour appeler un utilisateur Teams via un bot | [8277a51c-3ad6-446c-9b7e-e3f6e27257c1](../azure/8277a51c-3ad6-446c-9b7e-e3f6e27257c1.md) |
