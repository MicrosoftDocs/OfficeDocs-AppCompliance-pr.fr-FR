...
| Site web de l’entreprise | [https://www.complish.app](https://www.complish.app) |
...
| Fonctionnalités principales de l’application | Le fait d’être compliqué facilite la mise en place de bonnes habitudes à distance en rendant le travail visible, connecté aux objectifs et en promouvant des discussions axées. |
...
Ces informations ont été fournies par Cauziy Pty Ltd sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
