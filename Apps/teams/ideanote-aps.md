---
title: Informations sur l’application pour Ideanote par Ideanote ApS
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/23/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour Ideanote, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le Registre CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/b18682e5-87f8-413a-9af4-be50bcee1049" target="_blank">Afficher dans Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003876" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Ideanote ApS à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | Ideanote |
| ID | WA200003876 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | Ideanote ApS |
| Site web de l’entreprise | [https://ideanote.io](https://ideanote.io) |
| Conditions d’utilisation de l’application | [https://ideanote.io/legal/terms](https://ideanote.io/legal/terms) |
| Fonctionnalités principales de l’application | Collecter, développer et gérer des idées avec une innovation pilotée par des objectifs. |
| Emplacement du siège social de l’entreprise | Danemark |
| Page d’informations sur l’application | [https://ideanote.io](https://ideanote.io) |
...
Ces informations ont été fournies par Ideanote ApS sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont stockées dans vos bases de données ? | Informations sur le jeton JWT obtenu auprès de l’utilisateur. Nom d’utilisateur, courrier électronique de l’utilisateur. |
...
| URL de la politique de confidentialité | https://ideanote.io/legal/privacy-policy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | délégué | Nous avons besoin d’informations sur l’utilisateur pour se connecter automatiquement à la personne à son compte Ideanote. | [d7db1079-6f45-4373-bb2b-ae5d71169b31](../azure/d7db1079-6f45-4373-bb2b-ae5d71169b31.md) |
