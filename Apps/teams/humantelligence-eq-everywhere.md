---
title: Informations d’application pour EQ Partout par Humantelligence
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/29/2022
...
description: 'Toutes les informations de sécurité et de conformité disponibles pour EQ Everywhere, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le Registre CSA STAR.'
zone_pivot_groups: app-info-data-security-compliance-privsection-zerotrust
---
# <a name="eq-everywhere"></a>EQ Partout
...
|:----------------|:-------------|
| Nom de l'application | EQ Partout |
| ID | WA200002650 |
