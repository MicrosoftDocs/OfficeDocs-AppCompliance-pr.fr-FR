...
* <a href="https://teams.microsoft.com/l/app/d4460828-ddde-4619-b40b-39412667f7a3" target="_blank">Afficher dans Teams magasin</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003916" target="_blank">Afficher dans AppSource</a>
...
| Site web de la société | [https://highside.io](https://highside.io) |
| Conditions d’utilisation de l’application | [https://highside.io/terms-of-service](https://highside.io/terms-of-service) |
| Fonctionnalités principales de l’application | Fichiers de messagerie &amp; chiffrés E2E pour Microsoft Teams. |
| Emplacement du siège social de la société | États-Unis d’Amérique |
| Page d’informations sur l’application | [https://highside.io/secureteams](https://highside.io/secureteams) |
...
| Quelles données sont traitées par votre application ? | Utilisateur Microsoft UUID, nom d’utilisateur, adresse e-mail de l’utilisateur |
| L’application prend-elle en charge TLS 1.1 ou version ultérieure ? | Oui |
| L’application ou l’infrastructure sous-jacente stocke-t-elle des données client Microsoft ? | Oui |
| Quelles données sont stockées dans vos bases de données ? | Utilisateur Microsoft UUID, nom d’utilisateur, adresse e-mail de l’utilisateur |
...
| URL de la politique de confidentialité | https://highside.io/privacy-policy |
