---
title: Informations sur l’application pour OfficeSuite par Windstream
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/03/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour OfficeSuite, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le Registre CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/bf9c1c49-a529-451e-a81d-ac94cfdbec3e" target="_blank">Afficher dans Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200000618" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Windstream à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | OfficeSuite |
| ID | WA200000618 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | WindStream |
| Site web de l’entreprise | [https://www.windstreamenterprise.com](https://www.windstreamenterprise.com) |
| Conditions d’utilisation de l’application | [https://www.windstream.com/about/legal/Terms-and-Conditions](https://www.windstream.com/about/legal/Terms-and-Conditions) |
| Fonctionnalités principales de l’application | Application d’appel, de réunion et de notification d’appel |
...
Ces informations ont été fournies par Windstream sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Date de certification SOC2 la plus récente |  2021-11-03 |
| L’application est-elle conforme aux contrôles d’organisation de service (SOC 3) ? | Oui |
| Date de certification SOC3 la plus récente |  2021-11-04 |
...
| URL de la politique de confidentialité | https://www.windstream.com/about/legal/privacy-policy |
