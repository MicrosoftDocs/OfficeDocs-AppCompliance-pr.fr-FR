---
title: Informations sur l’application pour Mes rappels par Appfluence Inc
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/01/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour Mes rappels, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
ms.locfileid: "66655955"
---
# <a name="my-reminders"></a>Mes rappels

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Dernière mise à jour par le développeur : 23 juin 2022</p>

* <a href="https://teams.microsoft.com/l/app/ae64c32a-0eab-47d9-91e4-b693569f7fc3" target="_blank">Afficher dans le magasin Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004342" target="_blank">Afficher dans AppSource</a>
...
| **Information** | **Réponse** |
|:----------------|:-------------|
| Nom de l'application | Mes rappels |
| ID | WA200004342 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | Appfluence Inc |
| Site web de la société | [https://appfluence.com](https://appfluence.com) |
| Conditions d’utilisation de l’application | [https://teamsreminder.com/eula](https://teamsreminder.com/eula) |
| Fonctionnalités principales de l’application | Planifiez un message de rappel à vous renvoyer via notre bot de conversation. |
| Emplacement du siège social de la société | États-Unis d’Amérique |
| Page d’informations sur l’application | [https://teamsreminder.com](https://teamsreminder.com) |
...
| Quelles données sont traitées par votre application ? | Répertoriez les conversations de l’utilisateur dans Teams, afin d’aider l’utilisateur à indiquer si un rappel est lié à une conversation spécifique. |
...
| Si votre application n’utilise pas l’une des bibliothèques ci-dessus, quelle bibliothèque ou bibliothèque d’authentification utilise-t-elle ? | next-auth/react |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Chat.ReadBasic | Délégué | Afficher l’utilisateur qui participe à une conversation afin qu’il comprenne si un rappel est associé à une conversation | [6b0ce2dd-a270-4ade-babb-7cf54bab8edd](../azure/6b0ce2dd-a270-4ade-babb-7cf54bab8edd.md) |
>| User.Read | Délégué | Connectez-vous à l’utilisateur et découvrez son nom. | [6b0ce2dd-a270-4ade-babb-7cf54bab8edd](../azure/6b0ce2dd-a270-4ade-babb-7cf54bab8edd.md) |
>| User.ReadBasic.All | Délégué | Afficher l’avatar des collaborateurs associés lorsque nous planifiez un rappel lié à une conversation personnelle avec eux | [6b0ce2dd-a270-4ade-babb-7cf54bab8edd](../azure/6b0ce2dd-a270-4ade-babb-7cf54bab8edd.md) |
>| offline_access | Délégué | Autoriser notre application à agir en tant qu’utilisateur au moment de la planification de la remise du rappel | [6b0ce2dd-a270-4ade-babb-7cf54bab8edd](../azure/6b0ce2dd-a270-4ade-babb-7cf54bab8edd.md) |
>| profil | Délégué | Connectez-vous à l’utilisateur et découvrez son nom. | [6b0ce2dd-a270-4ade-babb-7cf54bab8edd](../azure/6b0ce2dd-a270-4ade-babb-7cf54bab8edd.md) |
