---
title: 'Informations sur l’application POUR LALIQUEICA par OKWAVE, Inc.'
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/29/2022
...
description: 'Toutes les informations de sécurité et de conformité disponibles pour LA LOIICA, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le Registre CSA STAR.'
zone_pivot_groups: app-info-data-security-compliance-privsection-zerotrust
---
# <a name="gratica"></a>LASICA

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Last updated by the developer on: March 3, 2022</p>

* <a href="https://teams.microsoft.com/l/app/6ba0345a-119f-439d-baf1-ddef0908ed5b" target="_blank">Afficher dans Teams store</a>
...
|:----------------|:-------------|
| Nom de l'application | LASICA |
| ID | WA200003888 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | OKWAVE, Inc. |
| Site web de l’entreprise | [https://okwave.co.jp](https://okwave.co.jp) |
