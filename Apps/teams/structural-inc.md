---
title: Informations d’application pour structural par Structural Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: Toutes les informations de sécurité et de conformité disponibles pour Structural, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
ms.locfileid: "64875311"
---
# <a name="structural"></a>Structural

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Dernière mise à jour par le développeur : 21 juin 2021</p>

* <a href="https://teams.microsoft.com/l/app/7d83045e-58b6-471a-b574-a544420254b7" target="_blank">Afficher dans Teams magasin</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002514" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Structural Inc. à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | Structural |
| ID | WA200002514 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | Structural Inc. |
| Site web de la société | [https://www.structural.com](https://www.structural.com) |
| Conditions d’utilisation de l’application | [https://www.structural.com/terms-of-service](https://www.structural.com/terms-of-service) |
| Fonctionnalités principales de l’application | Connecter les gens les uns aux autres et aux opportunités |
| Emplacement du siège social de la société | États-Unis d’Amérique |
| Page d’informations sur l’application | [https://www.structural.com](https://www.structural.com) |
| Quel est l’environnement d’hébergement ou le modèle de service utilisé pour exécuter votre application ? | Iaas |
| Quels fournisseurs de cloud d’hébergement l’application utilise-t-elle ? | AWS, GCP |
...
Ces informations ont été fournies par Structural Inc. sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Date de certification SOC2 la plus récente | 2020-07-22 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.AccessAsUser.All | Délégué | Oui : Pour authentifier les utilisateurs lors de l’authentification unique. | [fb6dddd39-35f2-4110-a45d-d2e73b946cae](../azure/fb6ddd39-35f2-4110-a45d-d2e73b946cae.md) |
>| email | Délégué | Oui : Pour authentifier les utilisateurs lors de l’authentification unique. | [fb6dddd39-35f2-4110-a45d-d2e73b946cae](../azure/fb6ddd39-35f2-4110-a45d-d2e73b946cae.md) |
>| offline_access | Délégué | Oui : Pour authentifier les utilisateurs lors de l’authentification unique. | [fb6dddd39-35f2-4110-a45d-d2e73b946cae](../azure/fb6ddd39-35f2-4110-a45d-d2e73b946cae.md) |
>| openid | Délégué | Oui : Pour authentifier les utilisateurs lors de l’authentification unique. | [fb6dddd39-35f2-4110-a45d-d2e73b946cae](../azure/fb6ddd39-35f2-4110-a45d-d2e73b946cae.md) |
>| profil | Délégué | Oui : Pour authentifier les utilisateurs lors de l’authentification unique. | [fb6dddd39-35f2-4110-a45d-d2e73b946cae](../azure/fb6ddd39-35f2-4110-a45d-d2e73b946cae.md) |
