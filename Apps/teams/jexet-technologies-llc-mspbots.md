---
title: Informations sur les applications pour MSPBots par Jexet Technologies LLC
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 11/23/2021
...
* <a href="https://teams.microsoft.com/l/app/10fcc57c-8d49-4f94-a516-a75de60bc969" target="_blank">Afficher dans Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001128" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Jexet Technologies LLC à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | MSPBots |
| ID | WA200001128 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | Jexet Technologies LLC |
| Site web de l’entreprise | [https://mspbots.ai](https://mspbots.ai) |
| Conditions d’utilisation de l’application | [https://mspbots.ai/termsofuse/](https://mspbots.ai/termsofuse/) |
| Fonctionnalités principales de l’application | Plateforme d’aide à la demande, automatisation pour les tâches répétitives du fournisseur de services gérés informatiques à l’aide de bots personnalisables. |
...
Ces informations ont été fournies par Jexet Technologies LLC sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont stockées dans vos bases de données ? | Données des profils utilisateur |
...
| URL de la politique de confidentialité | https://mspbots.ai/home/data-security/ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| ChannelMessage.Send | application | Envoyer un message au canal | [a2af9d71-95f1-4236-be2c-c105ab9b7ee9](../azure/a2af9d71-95f1-4236-be2c-c105ab9b7ee9.md) |
>| ChatMessage.Send | application | Envoyer un message à la conversation | [a2af9d71-95f1-4236-be2c-c105ab9b7ee9](../azure/a2af9d71-95f1-4236-be2c-c105ab9b7ee9.md) |
>| profil | application | obtenir les informations utilisateur de l’application d’utilisation | [a2af9d71-95f1-4236-be2c-c105ab9b7ee9](../azure/a2af9d71-95f1-4236-be2c-c105ab9b7ee9.md) |
