---
title: Informations d’application pour le connecteur SMARTUC ENA par ENA
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/11/2022
...
<p>Dernière mise à jour par le développeur : 11 mars 2022</p>

* <a href="https://teams.microsoft.com/l/app/029cfd5a-4413-499d-bda6-a2a0a3f5e70e" target="_blank">Afficher dans Teams magasin</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003354" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par l’ENA à Microsoft :
...
| Site web de la société | [https://www.ena.com](https://www.ena.com) |
| Conditions d’utilisation de l’application | [https://www.ena.com/legal/aup/](https://www.ena.com/legal/aup/) |
| Fonctionnalités principales de l’application | L’application connecte l’ensemble de produits SMARTUC ENA à l’application Teams, ce qui permet aux utilisateurs finaux d’effectuer des appels téléphoniques enA SmartUC à partir de Teams. |
...
| Quels fournisseurs de cloud d’hébergement l’application utilise-t-elle ? | En outre, les parties du service géré par Metaswitch sont hébergées dans Azure. Vous devez également inclure des détails sur la façon dont votre propre infrastructure (par exemple, les serveurs EAS) est hébergée. |
...
Ces informations ont été fournies par l’ENA sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont traitées par votre application ? | L’EUII/OII suivant peut être transféré vers l’API JSON CommPortal via le proxy MCT : adresse IP, numéro de téléphone de l’utilisateur appelant, mot de passe, jeton d’authentification CommPortal, ID de session CommPortal, numéro de téléphone de l’appelé lors du placement d’un appel, Domaines des adresses e-mail. |
