---
title: Informations d’application pour enA SmartUC Connector par ENA
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/11/2022
...
* <a href="https://teams.microsoft.com/l/app/029cfd5a-4413-499d-bda6-a2a0a3f5e70e" target="_blank">Afficher dans Teams store</a>
...
| Site web de l’entreprise | [https://www.ena.com](https://www.ena.com) |
| Conditions d’utilisation de l’application | [https://www.ena.com/legal/aup/](https://www.ena.com/legal/aup/) |
| Fonctionnalités principales de l’application | L’application connecte l’ensemble de produits ENA SmartUC à l’application Teams, ce qui permet aux utilisateurs finaux d’effectuer des appels téléphoniques enA SmartUC à partir de l’Teams. |
...
| Quels fournisseurs de cloud d’hébergement l’application utilise-t-elle ? | Autrement, les parties du service géré par Metaswitch sont hébergées dans Azure. Vous devez également inclure des détails sur la façon dont votre propre infrastructure (par exemple, les serveurs EAS) est hébergée. |
