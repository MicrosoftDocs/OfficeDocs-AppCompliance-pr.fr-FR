---
title: Informations sur l’application pour onsight Connecter par Librestream
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/29/2021
...
description: Toutes les informations de sécurité et de conformité disponibles pour Onsight Connecter, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
ms.locfileid: "64876331"
---
# <a name="onsight-connect"></a>Onsight Connect

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Dernière mise à jour par le développeur : 13 avril 2021</p>

* <a href="https://teams.microsoft.com/l/app/c01f5608-4ade-4749-aafa-9e5449a5bcb4" target="_blank">Afficher dans Teams magasin</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002769" target="_blank">Afficher dans AppSource</a>
...
| Nom de la société partenaire | Librestream |
| Site web de la société | [https://librestream.com](https://librestream.com) |
| Conditions d’utilisation de l’application | [https://librestream.com/support-archives/software-eula/](https://librestream.com/support-archives/software-eula/) |
| Fonctionnalités principales de l’application | Améliorez votre stratégie de transformation numérique pour permettre à vos employés et clients d’accéder immédiatement au contenu, aux personnes, aux données intelligentes et aux conseils nécessaires pour inspecter et résoudre rapidement les problèmes. Déployée à l’échelle mondiale, la plateforme onsight augmente l’efficacité opérationnelle dans des secteurs tels que la fabrication, l’aviation, l’énergie, les équipements lourds et les service après-vente. |
...
Ces informations ont été fournies par Librestream sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
