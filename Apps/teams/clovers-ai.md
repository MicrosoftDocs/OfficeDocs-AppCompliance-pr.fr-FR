---
title: Informations sur l’application pour les clovers par clovers AI
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/22/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour Clovers, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/1356036b-5fa7-42ce-8079-5741f2acfc5f" target="_blank">Afficher dans Teams magasin</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003795" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Clovers AI à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | Clovers |
| ID | WA200003795 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | IA des clovers |
| Site web de la société | [https://clovers.ai](https://clovers.ai) |
| Conditions d’utilisation de l’application | [https://clovers.ai/terms-of-use/](https://clovers.ai/terms-of-use/) |
| Fonctionnalités principales de l’application | Clovers - le guide d’entretien pour aider les équipes à embaucher plus efficacement |
...
Ces informations ont été fournies par Clovers AI sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Date de certification SOC2 la plus récente | 2021-10-25 |
