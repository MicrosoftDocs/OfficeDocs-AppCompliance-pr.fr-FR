...
| Site web de l’entreprise | [https://www.diamondsoftsolutions.com](https://www.diamondsoftsolutions.com) |
| Conditions d’utilisation de l’application | [https://www.dbit.io/termsofuse.html](https://www.dbit.io/termsofuse.html) |
| Fonctionnalités principales de l’application | Solutions de gestion de mot de passe débit moins complexes. DBit est un outil de gestion des mots de passe pour les petites et grandes équipes. Avec DBit, vous pouvez partager en toute sécurité des mots de passe entre les membres de l’équipe. Les mots de passe partagés et les mots de passe générés expireront automatiquement après une durée définie de minutes. Vos mots de passe sont chiffrés en mémoire sur nos serveurs et ne sont jamais stockés sur le stockage sur disque. Une fois vos mots de passe arrivés à expiration, ils sont supprimés de la mémoire de notre serveur. Cette application est développée par Diamondsoft Solutions, LLC |
