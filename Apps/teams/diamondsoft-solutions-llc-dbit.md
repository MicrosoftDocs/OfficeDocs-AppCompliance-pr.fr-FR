---
title: Informations sur l’application pour DBit by Diamondsoft Solutions, LLC
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 11/29/2021
...
* <a href="https://teams.microsoft.com/l/app/b28bb657-8edd-47ae-a912-c5fc11b3e89e" target="_blank">Afficher dans Teams magasin</a>
...
| Site web de la société | [https://www.diamondsoftsolutions.com](https://www.diamondsoftsolutions.com) |
| Conditions d’utilisation de l’application | [https://www.dbit.io/termsofuse.html](https://www.dbit.io/termsofuse.html) |
| Fonctionnalités principales de l’application | Solutions de gestion des mots de passe DBit avec moins de tracas. DBit est un outil de gestion des mots de passe pour les petites et grandes équipes. Avec DBit, vous pouvez partager en toute sécurité des mots de passe entre les membres de l’équipe. Les mots de passe partagés et les mots de passe générés expirent automatiquement après une durée définie de minutes. Vos mots de passe sont chiffrés en mémoire sur nos serveurs et ne sont jamais stockés dans le stockage sur disque. Une fois que vos mots de passe expirent, ils sont supprimés de la mémoire de notre serveur. Cette application est développée par Diamondsoft Solutions, LLC |
...
| Quelles données sont traitées par votre application ? | TenantId |
