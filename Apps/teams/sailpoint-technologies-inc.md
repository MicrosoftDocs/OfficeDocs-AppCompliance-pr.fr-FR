---
title: Informations sur l’application pour Sailpoint par SailPoint Technologies, Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/01/2021
...
description: Toutes les informations de sécurité et de conformité disponibles pour Sailpoint, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/ceca14aa-4fd9-4a8b-b51f-ee05bf98accc" target="_blank">Afficher dans Teams magasin</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002761" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par SailPoint Technologies, Inc. à Microsoft :
...
| Site web de la société | [https://sailpoint.com](https://sailpoint.com) |
| Conditions d’utilisation de l’application | [https://www.sailpoint.com/legal/customer-agreements/](https://www.sailpoint.com/legal/customer-agreements/) |
| Fonctionnalités principales de l’application | La solution de sécurité des identités de SailPoint associe la gestion des accès à la sécurité des identités, garantissant ainsi aux travailleurs l’accès approprié pour faire leur travail&#8211;pas plus, ni moins. |
...
Ces informations ont été fournies par SailPoint Technologies, Inc. sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Date de certification SOC1 la plus récente | 2020-10-31 |
