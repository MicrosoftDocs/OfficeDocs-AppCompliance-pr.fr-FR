---
title: Informations sur l’application pour Panopto par Panopto
ms.author: elmalova
author: elenamalova
ms.date: 03/07/2022
ms.topic: article
...
description: Toutes les informations de sécurité et de conformité disponibles pour Panopto, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le Registre CSA STAR.
...
ms.locfileid: "63081087"
---
# <a name="panopto"></a>Panopto

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Last updated by the developer on: February 22, 2022</p>

* <a href="https://teams.microsoft.com/l/app/adb3c870-c01c-11eb-a2cc-4dbd838985a1" target="_blank">Afficher dans Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003801" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Panopto à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | Panopto |
| ID | WA200003801 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | Panopto |
| Site web de l’entreprise | [https://www.panopto.com](https://www.panopto.com) |
| Conditions d’utilisation de l’application | [https://www.panopto.com/terms-of-service/](https://www.panopto.com/terms-of-service/) |
| Fonctionnalités principales de l’application | Exportez Teams enregistrements dans Panopto et recherchez, partagez et visualisez des vidéos Panopto sans quitter Teams.  Ajoute des fonctionnalités telles qu’un index visuel de chaque réunion et un sous-titre fermé vérifié par l’homme. Fonctionnalités Access Panopto sans quitter Teams : créez un onglet de canal mappé à un dossier Panopto, recherchez et partagez des vidéos Panopto, présentez des vidéos Panopto dans les réunions prévues et recevez des notifications lorsqu’une nouvelle vidéo Panopto est prête. Vous avez besoin d’un site Panopto ? Visitez www.panopto.com/plans pour commencer. |
...
Ces informations ont été fournies par Panopto sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont stockées dans vos bases de données ? | Métadonnées sur Teams enregistrements de réunions et Teams canaux. |
...
| Date de certification SOC2 la plus récente |  2021-08-19 |
| L’application est-elle conforme aux contrôles d’organisation de service (SOC 3) ? | Oui |
| Date de certification SOC3 la plus récente |  2021-10-13 |
...
| URL de la politique de confidentialité | https://www.panopto.com/privacy/ |
