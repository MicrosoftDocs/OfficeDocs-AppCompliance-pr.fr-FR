---
title: Informations sur l’application pour Findit by CTELO
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/14/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour Findit, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
ms.locfileid: "64881363"
---
# <a name="findit"></a>Findit

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Dernière mise à jour par le développeur : 25 janvier 2022</p>

* <a href="https://teams.microsoft.com/l/app/ccb8d21c-9c7b-492f-b372-438621384db8" target="_blank">Afficher dans Teams magasin</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003849" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par CTELO à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | Findit |
| ID | WA200003849 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | CTELO |
| Site web de la société | [https://www.ctelo.com](https://www.ctelo.com) |
| Conditions d’utilisation de l’application | [https://www.ctelo.com/terms-conditions](https://www.ctelo.com/terms-conditions) |
| Fonctionnalités principales de l’application | Recherchez des emplacements de calendrier gratuits pour les collègues, Teams l’état et les informations de contact. |
...
Ces informations ont été fournies par CTELO sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont traitées par votre application ? | Entrées de calendrier et informations de contact. |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.Read | Délégué | Autoriser l’application à lire les événements dans les calendriers utilisateur. | [2e57054c-4326-46ed-8482-40d9a6d20e79](../azure/2e57054c-4326-46ed-8482-40d9a6d20e79.md) |
>| Contacts.Read | Délégué | Autoriser l’application à lire les contacts utilisateur. | [2e57054c-4326-46ed-8482-40d9a6d20e79](../azure/2e57054c-4326-46ed-8482-40d9a6d20e79.md) |
>| Group.Read.All | Délégué | Autoriser l’application à lire des groupes d’utilisateurs. | [2e57054c-4326-46ed-8482-40d9a6d20e79](../azure/2e57054c-4326-46ed-8482-40d9a6d20e79.md) |
>| Presence.Read.All | Délégué | Autoriser l’application à lire les informations de présence de tous les utilisateurs. | [2e57054c-4326-46ed-8482-40d9a6d20e79](../azure/2e57054c-4326-46ed-8482-40d9a6d20e79.md) |
>| User.Read | Délégué | Autoriser l’application à lire le profil utilisateur. | [2e57054c-4326-46ed-8482-40d9a6d20e79](../azure/2e57054c-4326-46ed-8482-40d9a6d20e79.md) |
>| User.Read.All | Délégué | Autoriser l’application à lire tous les profils utilisateur. | [2e57054c-4326-46ed-8482-40d9a6d20e79](../azure/2e57054c-4326-46ed-8482-40d9a6d20e79.md) |
