---
title: Informations d’application pour les réunions multilingues KUDO par KUDO, Inc.
ms.author: elmalova
author: elenamalova
ms.date: 11/15/2021
ms.topic: article
...
description: Toutes les informations de sécurité et de conformité disponibles pour les réunions multilingues KUDO, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le Registre CSA STAR.
...
ms.locfileid: "62200737"
---
# <a name="kudo-multilingual-meetings"></a>Réunions multilingues KUDO

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Last updated by the developer on: November 12, 2021</p>

* <a href="https://teams.microsoft.com/l/app/9ae3d116-3feb-48c6-b3c4-b61dceb760af" target="_blank">Afficher dans Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003295" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par KUDO, Inc. à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | Réunions multilingues KUDO |
| ID | WA200003295 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | KUDO, Inc. |
| Site web de l’entreprise | [https://kudoway.com](https://kudoway.com) |
| Conditions d’utilisation de l’application | [https://kudoway.com/terms-of-use/](https://kudoway.com/terms-of-use/) |
| Fonctionnalités principales de l’application | KUDO permet aux entreprises de communiquer globalement dans plusieurs langues. |
...
Ces informations ont été fournies par KUDO, Inc. sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont stockées dans vos bases de données ? | ID de courrier électronique |
...
| URL de la politique de confidentialité | https://kudoway.com/privacy-policy/ |
