---
title: Informations d’application pour Process Street by Process Street
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/13/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour Process Street, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/6910821c-1244-4a0b-9d64-f0fc396b8e7c" target="_blank">Afficher dans Teams magasin</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003933" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Process Street à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | Process Street |
| ID | WA200003933 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | Process Street |
| Site web de la société | [https://www.process.st](https://www.process.st) |
| Conditions d’utilisation de l’application | [https://www.process.st/terms/](https://www.process.st/terms/) |
| Fonctionnalités principales de l’application | Une plateforme moderne de gestion des processus pour la création, le partage et l’automatisation de vos processus de base. |
...
Ces informations ont été fournies par Process Street sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| URL de la politique de confidentialité | https://www.process.st/help/docs/gdpr-statement/ |
