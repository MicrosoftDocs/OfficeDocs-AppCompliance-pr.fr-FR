---
title: Informations sur les applications pour CoffeePals par CoffeePals Technologies Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/31/2022
...
Informations fournies par CoffeePals Technologies Inc. à Microsoft :
...
| Nom de la société partenaire | CoffeePals Technologies Inc. |
| Site web de l’entreprise | [https://coffeepals.co](https://coffeepals.co) |
| Conditions d’utilisation de l’application | [https://coffeepals.co/terms-of-service](https://coffeepals.co/terms-of-service) |
| Fonctionnalités principales de l’application | CoffeePals associe les personnes de manière aléatoire pour se réunir et discuter pour former des connexions personnelles. Il inclut d’autres fonctionnalités qui permettent aux employés de mieux se connecter. |
| Emplacement du siège social de l’entreprise | Canada |
| Page d’informations sur l’application | [https://coffeepals.co/product](https://coffeepals.co/product) |
| Quel est l’environnement d’hébergement ou le modèle de service utilisé pour exécuter votre application ? | Paas |
| Quels fournisseurs de cloud d’hébergement l’application utilise-t-elle ? | Aws, MongoDB, Heroku |
...
Ces informations ont été fournies par CoffeePals Technologies Inc. sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont stockées dans vos bases de données ? | Données de profil utilisateur, données d’utilisation de l’utilisateur, adresse de messagerie de l’utilisateur, historique des correspondances utilisateur, Paramètres utilisateur, Paramètres organisation, nom de l’organisation, nom de l’équipe, avatar de l’organisation, données de rapport de correspondance, photo de profil utilisateur, appartenance à l’équipe de l’utilisateur, commentaires de l’utilisateur |
...
| URL de la politique de confidentialité | https://coffeepals.co/privacy |
