---
title: Informations sur l’application pour les SMS du greffier par Unnamed Ventures, LLC.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/04/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour les SMS du greffier, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
ms.locfileid: "64682147"
---
# <a name="clerk-sms"></a>SMS du greffier

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Dernière mise à jour par le développeur : 6 octobre 2021</p>

* <a href="https://teams.microsoft.com/l/app/88c50b69-8e4b-4383-b70f-c8295d5431a0" target="_blank">Afficher dans Teams magasin</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003376" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Unnamed Ventures, LLC. vers Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | SMS du greffier |
| ID | WA200003376 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | Unnamed Ventures, LLC. |
| Site web de la société | [https://clerk.chat/teams](https://clerk.chat/teams) |
| Conditions d’utilisation de l’application | [https://clerk.chat/legal/terms/](https://clerk.chat/legal/terms/) |
| Fonctionnalités principales de l’application | Envoyer et recevoir des SMS/MMS à l’intérieur de Microsoft Teams.  |
| Emplacement du siège social de la société | États-Unis d’Amérique |
| Page d’informations sur l’application | [https://clerk.chat/teams](https://clerk.chat/teams) |
...
Ces informations ont été fournies par Unnamed Ventures, LLC. sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| URL de la politique de confidentialité | https://clerk.chat/legal/privacy |
