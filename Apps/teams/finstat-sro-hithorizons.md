---
title: Informations sur l’application pour HitHorizons par FinStat s.r.o.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/15/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour HitHorizons, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/2b492ea3-0727-4789-90d7-8e2079d46717" target="_blank">Afficher dans Teams magasin</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001411" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par FinStat s.r.o. vers Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | HitHorizons |
| ID | WA200001411 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | FinStat s.r.o. |
| Site web de la société | [https://www.hithorizons.com](https://www.hithorizons.com) |
| Conditions d’utilisation de l’application | [https://www.hithorizons.com/legal/terms-and-conditions](https://www.hithorizons.com/legal/terms-and-conditions) |
| Fonctionnalités principales de l’application | Accédez à la base de données HitHorizons de plus de 75 millions d’entreprises d’Europe et d’au-delà dans Microsoft Teams |
| Emplacement du siège social de la société | Slovaquie |
| Page d’informations sur l’application | [https://www.hithorizons.com/services/microsoft/teams](https://www.hithorizons.com/services/microsoft/teams) |
...
Ces informations ont été fournies par FinStat s.r.o. sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
