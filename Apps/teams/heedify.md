...
* <a href="https://teams.microsoft.com/l/app/0587c0da-1445-4875-a9f3-2b8083b7338f" target="_blank">Afficher dans Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003512" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Heedify à Microsoft :

| **Information** | **Réponse** |
|:----------------|:-------------|
| Nom de l'application | Heedify |
| ID | WA200003512 |
...
Ces informations ont été fournies par Heedify sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont stockées dans vos bases de données ? | Informations de présence et détails des appels (à partir du centre d’appels)  |
...
| URL de la politique de confidentialité | https://heedify.io/privacy |
...
>|:------------------------|:--------------------|:------------------------------------|
>| Presence.Read.All | délégué | Les informations de présence sont nécessaires pour l’agent du centre de contacts afin de mieux gérer les appels et les contacts, en particulier en cas de transfert d’appel  |
>| User.Read.All | délégué | pour gérer le contact, l’utilisateur connecté doit être en mesure de parcourir les utilisateurs et de lire leurs informations, y compris leur départ et leur responsable (en cas de réceptionniste)  |
>| Calendars.Read | délégué | Le réceptionniste doit vérifier le calendrier des utilisateurs avant de transférer un appel ou de partager les informations avec le client au téléphone |
>| Contacts.ReadWrite | délégué | L’application doit être en mesure d’ajouter des contacts à l’utilisateur(agent) et de lire ses contacts également  |
>| Contacts.ReadWrite.Shared | délégué | l’application doit être en mesure d’ajouter un contact de partage avec d’autres utilisateurs (agent) et de lire également leurs contacts partagés  |
