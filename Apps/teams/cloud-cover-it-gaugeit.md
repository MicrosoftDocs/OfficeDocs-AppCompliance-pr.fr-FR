---
title: Informations d’application pour gauge.it par cloud cover IT
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/23/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour gauge.it, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le Registre CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/9e9e5036-942e-42b4-8b7a-855a59d1c1a1" target="_blank">Afficher dans Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003874" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par cloud cover it à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | gauge.it |
| ID | WA200003874 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | Cloud Cover IT |
| Site web de l’entreprise | [https://www.cloudcoverit.co.uk](https://www.cloudcoverit.co.uk) |
| Conditions d’utilisation de l’application | [https://www.cloudcoverit.co.uk/terms](https://www.cloudcoverit.co.uk/terms) |
| Fonctionnalités principales de l’application | Créez et partagez des listes de contrôle à l’aide de modèles à un groupe, à une équipe ou même à vous-même. |
...
Ces informations ont été fournies par cloud cover it sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont stockées dans vos bases de données ? | ID client, canal et conversation |
...
| URL de la politique de confidentialité | https://www.cloudcoverit.co.uk/privacy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | délégué | Accéder à l’ID Active Directory | [898cccfe-ed44-4140-ad2f-c5dd98a12820](../azure/898cccfe-ed44-4140-ad2f-c5dd98a12820.md) |
