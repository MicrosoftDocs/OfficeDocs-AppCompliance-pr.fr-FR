---
title: Informations sur l’application pour Happyforce par Happyforce SL
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/26/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour Happyforce, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
Informations fournies par Happyforce SL à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | Happyforce |
| ID | WA200002078 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | Happyforce SL |
...
Ces informations ont été fournies par Happyforce SL sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
