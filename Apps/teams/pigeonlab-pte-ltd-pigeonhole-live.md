---
title: Informations d’application pour Pigeonhole Live par PigeonLab Pte Ltd
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/26/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour Pigeonhole Live, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
ms.locfileid: "65749411"
---
# <a name="pigeonhole-live"></a>Pigeonhole Live

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Dernière mise à jour par le développeur : 23 mai 2022</p>

* <a href="https://teams.microsoft.com/l/app/96ecd0d3-9351-4fcb-ac50-08c85e36ab26" target="_blank">Afficher dans Teams magasin</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001472" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par PigeonLab Pte Ltd à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | Pigeonhole Live |
| ID | WA200001472 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | PigeonLab Pte Ltd |
| Site web de la société | [https://pigeonholelive.com](https://pigeonholelive.com) |
| Conditions d’utilisation de l’application | [https://pigeonholelive.com/terms](https://pigeonholelive.com/terms) |
| Fonctionnalités principales de l’application | Stimuler l’interactivité dans vos réunions avec Q&amp;As, Sondages et Questionnaires |
| Emplacement du siège social de la société | Singapour |
| Page d’informations sur l’application | [https://pigeonholelive.com/microsoft-teams-meetings/](https://pigeonholelive.com/microsoft-teams-meetings/) |
...
Cette information a été fournie par PigeonLab Pte Ltd sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont traitées par votre application ? | E-mail et nom, autres données capturées dans le cadre de l’utilisation de l’interactivité d’audience de Pigeonhole Live |
| L’application prend-elle en charge TLS 1.1 ou version ultérieure ? | Oui |
| L’application ou l’infrastructure sous-jacente stocke-t-elle des données client Microsoft ? | Oui |
| Quelles données sont stockées dans vos bases de données ? | E-mail et nom, autres données capturées dans le cadre de l’utilisation de l’interactivité d’audience de Pigeonhole Live |
| Si l’infastructure sous-jacente traite ou stocke les données client Microsoft, où ces données sont-elles stockées géographiquement ? | États-Unis d’Amérique, Allemagne |
...
| URL de la politique de confidentialité | https://www.pigeonholelive.com/privacy |
