---
title: Informations sur l’application pour Rattle by Rattle
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/02/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour Rattle, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
ms.locfileid: "65628276"
---
# <a name="rattle"></a>Rattle

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Dernière mise à jour par le développeur : 2 mai 2022</p>

* <a href="https://teams.microsoft.com/l/app/bacd48e3-a2e1-48db-992f-609eb58ac326" target="_blank">Afficher dans Teams magasin</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004030" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Rattle à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | Rattle |
| ID | WA200004030 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | Rattle |
| Site web de la société | [https://www.gorattle.com](https://www.gorattle.com) |
| Conditions d’utilisation de l’application | [https://www.gorattle.com/terms-of-service](https://www.gorattle.com/terms-of-service) |
| Fonctionnalités principales de l’application | Rattle est un outil d’automatisation sans code permettant de gérer les Salesforce à partir de MS Teams |
...
Cette information a été fournie par Rattle sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| URL de la politique de confidentialité | https://www.gorattle.com/privacy-policy |
