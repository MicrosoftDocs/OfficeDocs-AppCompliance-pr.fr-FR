---
title: Informations d’application pour ticketing as a service by kitameraki limited
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/06/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour Ticketing As A Service, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
ms.locfileid: "65357066"
---
# <a name="ticketing-as-a-service"></a>Ticketing As A Service

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Dernière mise à jour par le développeur : 5 avril 2022</p>

* <a href="https://teams.microsoft.com/l/app/aa6b770e-6b8c-4096-9648-5239295ecadc" target="_blank">Afficher dans Teams magasin</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003945" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par kitameraki limitées à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | Ticketing As A Service |
| ID | WA200003945 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | kitameraki limité |
| Site web de la société | [https://TeamsWork.app](https://TeamsWork.app) |
| Conditions d’utilisation de l’application | [https://TeamsWork.app/terms](https://TeamsWork.app/terms) |
| Fonctionnalités principales de l’application | Interface utilisateur intuitive simple &amp; , application mobile prête, authentification unique, conformité de la sécurité &amp; , haute disponibilité, prêt pour l’analytique |
| Emplacement du siège social de la société | Hong Kong |
| Page d’informations sur l’application | [https://www.teamswork.app/ticketingapp](https://www.teamswork.app/ticketingapp) |
...
Ces informations ont été fournies par kitameraki limitées sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont traitées par votre application ? | Données d’abonnement SaaS, données de référence de conversation Teams, données de ticket |
| L’application prend-elle en charge TLS 1.1 ou version ultérieure ? | Oui |
| L’application ou l’infrastructure sous-jacente stocke-t-elle des données client Microsoft ? | Oui |
| Quelles données sont stockées dans vos bases de données ? | Données d’abonnement SaaS, données de référence de conversation Teams, données de ticket |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| AppCatalog.Read.All | Délégué | Pour vérifier si l’application est installée sur l’utilisateur | [aa6b770e-6b8c-4096-9648-5239295ecadc](../azure/aa6b770e-6b8c-4096-9648-5239295ecadc.md) |
>| Group.Read.All | Délégué | Pour obtenir la liste des membres et propriétaires de l’équipe, important pour le cas d’utilisation de l’application | [aa6b770e-6b8c-4096-9648-5239295ecadc](../azure/aa6b770e-6b8c-4096-9648-5239295ecadc.md) |
>| TeamsAppInstallation.ReadWriteForUser | Délégué | Pour installer l’application à l’utilisateur afin que le ycan soit connecté au bot de notification | [aa6b770e-6b8c-4096-9648-5239295ecadc](../azure/aa6b770e-6b8c-4096-9648-5239295ecadc.md) |
>| User.Read.All | Délégué | Pour obtenir le profil complet de l’utilisateur | [aa6b770e-6b8c-4096-9648-5239295ecadc](../azure/aa6b770e-6b8c-4096-9648-5239295ecadc.md) |
>| offline_access | Délégué | Pour accéder aux données en situation hors connexion | [aa6b770e-6b8c-4096-9648-5239295ecadc](../azure/aa6b770e-6b8c-4096-9648-5239295ecadc.md) |
>| openid | Délégué | Pour se connecter à l’utilisateur comme lui-même | [aa6b770e-6b8c-4096-9648-5239295ecadc](../azure/aa6b770e-6b8c-4096-9648-5239295ecadc.md) |
>| profil | Délégué | Pour obtenir le profil de base de l’utilisateur | [aa6b770e-6b8c-4096-9648-5239295ecadc](../azure/aa6b770e-6b8c-4096-9648-5239295ecadc.md) |
