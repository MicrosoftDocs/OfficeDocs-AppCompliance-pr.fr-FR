---
title: Informations d’application pour FinTech Studios par FinTech Studios
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/13/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour FinTech Studios, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
ms.locfileid: "64974381"
---
# <a name="fintech-studios"></a>FinTech Studios

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Dernière mise à jour par le développeur : 1er mars 2022</p>

* <a href="https://teams.microsoft.com/l/app/65e85032-940c-4d03-ad03-029fe9fff997" target="_blank">Afficher dans Teams magasin</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003969" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par FinTech Studios à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | FinTech Studios |
| ID | WA200003969 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | FinTech Studios |
| Site web de la société | [https://www.fintechstudios.com](https://www.fintechstudios.com) |
| Conditions d’utilisation de l’application | [https://www.fintechstudios.com/eula](https://www.fintechstudios.com/eula) |
| Fonctionnalités principales de l’application | Business Intelligence piloté par l’IA |
| Emplacement du siège social de la société | États-Unis d’Amérique |
| Page d’informations sur l’application | [https://www.fintechstudios.com/products](https://www.fintechstudios.com/products) |
...
Ces informations ont été fournies par FinTech Studios sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont traitées par votre application ? | Données de profil utilisateur, noms/ID d’équipe, noms/ID de canal (aucune donnée de message), noms/ID de conversation (aucune donnée de message) |
| L’application prend-elle en charge TLS 1.1 ou version ultérieure ? | Oui |
| L’application ou l’infrastructure sous-jacente stocke-t-elle des données client Microsoft ? | Oui |
| Quelles données sont stockées dans vos bases de données ? | Données de profil utilisateur (nom, e-mail, accès Graph Microsoft + jetons d’actualisation) |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Channel.ReadBasic.All | Délégué | Pour inviter l’utilisateur à utiliser des canaux pour partager du contenu à partir d’un module de tâches dans l’application | [93b14320-d9b5-4876-b621-172af4d36985](../azure/93b14320-d9b5-4876-b621-172af4d36985.md) |
>| ChannelMessage.Send | Délégué | Pour envoyer du contenu partagé à des canaux à partir d’un module de tâches dans l’application | [93b14320-d9b5-4876-b621-172af4d36985](../azure/93b14320-d9b5-4876-b621-172af4d36985.md) |
>| Chat.ReadBasic | Délégué | Pour inviter l’utilisateur à partager du contenu à partir d’un module de tâche dans l’application | [93b14320-d9b5-4876-b621-172af4d36985](../azure/93b14320-d9b5-4876-b621-172af4d36985.md) |
>| ChatMessage.Send | Délégué | Pour envoyer du contenu partagé à des conversations à partir d’un module de tâches dans l’application | [93b14320-d9b5-4876-b621-172af4d36985](../azure/93b14320-d9b5-4876-b621-172af4d36985.md) |
>| Team.ReadBasic.All | Délégué | Il est nécessaire d’obtenir les équipes aux laquelle un utilisateur peut accéder pour pouvoir accéder aux canaux disponibles pour l’utilisateur. | [93b14320-d9b5-4876-b621-172af4d36985](../azure/93b14320-d9b5-4876-b621-172af4d36985.md) |
>| User.Read | Délégué | Pour obtenir des informations d’identification et de communication sur l’utilisateur | [93b14320-d9b5-4876-b621-172af4d36985](../azure/93b14320-d9b5-4876-b621-172af4d36985.md) |
