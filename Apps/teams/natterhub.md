...
* <a href="https://teams.microsoft.com/l/app/ba5cb8a1-85ca-426c-99fe-9b73cca34128" target="_blank">Afficher dans Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003420" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Natterhub à Microsoft :

| **Information** | **Réponse** |
|:----------------|:-------------|
| Nom de l'application | Natterhub |
| ID | WA200003420 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | Natterhub |
| Site web de l’entreprise | [https://natterhub.com](https://natterhub.com) |
...
Ces informations ont été fournies par Natterhub sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont stockées dans vos bases de données ? | ID du client, prénom de l’utilisateur, nom d’utilisateur, courrier électronique de l’utilisateur |
...
| URL de la politique de confidentialité | https://natterhub.com/legal#privacy |
