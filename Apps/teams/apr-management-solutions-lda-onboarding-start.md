---
title: Informations sur l’application pour l’intégration Démarrer par APR - Solutions de gestion Lda.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/17/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour le démarrage de l’intégration, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
ms.locfileid: "65454996"
---
# <a name="onboarding-start"></a>Démarrage de l’intégration

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Dernière mise à jour par le développeur : 8 avril 2022</p>

* <a href="https://teams.microsoft.com/l/app/35729029-db8c-4cf5-b71f-9dc9511e0563" target="_blank">Afficher dans Teams magasin</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004025" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par APR - Management Solutions Lda. vers Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | Démarrage de l’intégration |
| ID | WA200004025 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | APR - Solutions de gestion Lda. |
| Site web de la société | [https://www.apr.pt](https://www.apr.pt) |
| Conditions d’utilisation de l’application | [https://www.apr.pt/terms-and-conditions/](https://www.apr.pt/terms-and-conditions/) |
| Fonctionnalités principales de l’application | Automatiser le processus d’intégration de l’organisation et communiquer facilement les nouveaux employés. |
...
Ces informations ont été fournies par APR - Management Solutions Lda. sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| URL de la politique de confidentialité | https://www.apr.pt/privacy-statement/ |
