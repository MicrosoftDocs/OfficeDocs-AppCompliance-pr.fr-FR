...
>| offline_access | délégué | refreshToken. | Permet à notre application de recevoir des jetons d’actualisation et d’actualiser le jeton d’th pour le compte de l’utilisateur lorsqu’il utilise l’application. | c68947ae-a07f-44ce-9a13-7b559251731d |
...
>|:-------------------|:-------------------|:--------------------------|:--------------------------|:---------------------------------------------------|:--------------------------|
>| API Bot Framework | Oui | Nous utilisons l’API Bot Framework pour remettre des messages en tant qu’application pour l’application Teams. Smartsheet stocke les informations userId pour suivre les personnes avec qui le bot Smartsheet parle. |  | Aucune |  |
