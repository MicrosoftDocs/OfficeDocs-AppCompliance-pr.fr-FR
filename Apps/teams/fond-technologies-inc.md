---
title: Informations sur l’application pour Fond par Fond Technologies, Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/04/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour Fond, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le Registre CSA STAR.
...
ms.locfileid: "63538152"
---
# <a name="fond"></a>Fond

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Last updated by the developer on: December 17, 2021</p>

* <a href="https://teams.microsoft.com/l/app/d25d7cc9-0a7e-41e2-ad98-f446141a8ffa" target="_blank">Afficher dans Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003631" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Fond Technologies, Inc. à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | Fond |
| ID | WA200003631 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | Fond Technologies, Inc. |
| Site web de l’entreprise | [https://fond.co](https://fond.co) |
| Conditions d’utilisation de l’application | [https://www.fond.co/tos/](https://www.fond.co/tos/) |
| Fonctionnalités principales de l’application | Faire la fête aux réussites de vos collègues avec Fond |
| Emplacement du siège social de l’entreprise | États-Unis d’Amérique |
| Page d’informations sur l’application | [https://fond.co/products/features/fond-teams-integration/](https://fond.co/products/features/fond-teams-integration/) |
...
Ces informations ont été fournies par Fond Technologies, Inc. sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont stockées dans vos bases de données ? | ID client client, nom de l’équipe, nom du canal, URL de webhook |
...
| Date de certification SOC2 la plus récente |  2020-09-01 |
...
| URL de la politique de confidentialité | https://www.fond.co/privacy/ |
