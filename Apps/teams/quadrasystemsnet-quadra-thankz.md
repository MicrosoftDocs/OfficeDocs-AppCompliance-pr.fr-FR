---
title: Informations sur l’application pour Quadra Thankz par Quadrasystems.net
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/19/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour Quadra Thankz, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
ms.locfileid: "64880601"
---
# <a name="quadra-thankz"></a>Quadra Thankz

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Dernière mise à jour par le développeur : 19 janvier 2022</p>

* <a href="https://teams.microsoft.com/l/app/a013c4a4-0683-4125-8c05-4004c2c3cc6f" target="_blank">Afficher dans Teams magasin</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003671" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Quadrasystems.net à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | Quadra Thankz |
| ID | WA200003671 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | Quadrasystems.net |
| Site web de la société | [https://www.quadrasystems.net](https://www.quadrasystems.net) |
| Conditions d’utilisation de l’application | [https://www.quadrasystems.net/tou](https://www.quadrasystems.net/tou) |
| Fonctionnalités principales de l’application | Thankz est la clé de la création d’entreprises plus heureuses. Basé sur l’interface Microsoft Teams familière, il s’agit d’un tout nouveau moyen de communiquer avec des personnes que vous travaillez avec vous tous les jours.  Thankz est un outil qui permet aux utilisateurs de se reconnaître mutuellement de manière amusante.&#160; Il fournit des fonctionnalités d’entreprise et d’utilisateur final enrichies, qui permettent des fonctionnalités telles que les classements, la budgétisation et les contrôles. Thankz aide vos employés à se sentir connectés, appréciés et récompensés. |
...
Ces informations ont été fournies par Quadrasystems.net sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Répertorier les types de stratégies prises en charge | Toutes les stratégies d’accès conditionnel AAD  |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read.All | application | Pour obtenir les informations du responsable d’un utilisateur  | [5d8eb1a9-2188-4292-86f6-f4964d49e8b3](../azure/5d8eb1a9-2188-4292-86f6-f4964d49e8b3.md) |
