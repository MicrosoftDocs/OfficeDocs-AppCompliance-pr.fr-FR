---
title: Informations sur l’application pour PerformYard par PerformYard
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/13/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour PerformYard, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
ms.locfileid: "66547106"
---
# <a name="performyard"></a>PerformYard

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Dernière mise à jour par le développeur : 10 juin 2022</p>

* <a href="https://teams.microsoft.com/l/app/ae947de1-da03-4e37-a420-3c5316f01e73" target="_blank">Afficher dans le magasin Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004215" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par PerformYard à Microsoft :

| **Information** | **Réponse** |
|:----------------|:-------------|
| Nom de l'application | PerformYard |
| ID | WA200004215 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | PerformYard |
| Site web de la société | [https://performyard.com](https://performyard.com) |
| Conditions d’utilisation de l’application | [https://www.performyard.com/master-subscription-agreement](https://www.performyard.com/master-subscription-agreement) |
| Fonctionnalités principales de l’application | PerformYard facilite la gestion des performances pour tout le monde. Flexible pour les ressources humaines &amp; simples pour les employés. |
...
Ces informations ont été fournies par PerformYard sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont traitées par votre application ? | Les informations d’identification du locataire, les noms de toutes les équipes et de tous les canaux qui y sont présents ; événements d’installation et de désinstallation. |
| L’application prend-elle en charge TLS 1.1 ou version ultérieure ? | Oui |
| L’application ou l’infrastructure sous-jacente stocke-t-elle des données client Microsoft ? | Oui |
| Quelles données sont stockées dans vos bases de données ? | Informations d’identification du locataire, noms de toutes les équipes et de tous les canaux. |
...
| Date de certification SOC2 la plus récente | 2022-06-01 |
...
| URL de la politique de confidentialité | https://www.performyard.com/privacy |
