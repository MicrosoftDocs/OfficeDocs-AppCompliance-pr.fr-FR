---
title: Informations d’application pour Standuply par Standuply Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/24/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour Standuply, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/1250b735-e9df-4d5b-ae82-da96c55c64e4" target="_blank">Afficher dans Teams magasin</a>
...
|:----------------|:-------------|
| Nom de l'application | Autonome |
| ID | WA200003001 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | Standuply Inc. |
| Site web de la société | [https://standuply.com](https://standuply.com) |
| Conditions d’utilisation de l’application | [https://standuply.com/terms](https://standuply.com/terms) |
| Fonctionnalités principales de l’application | Automatise de manière autonome les processus de gestion et fournit un système de QA&amp; interne pour améliorer la productivité de votre équipe. |
...
| Quelles données sont traitées par votre application ? | P.3 de https://standuply.com/privacy-policy |
| L’application prend-elle en charge TLS 1.1 ou version ultérieure ? | Oui |
| L’application ou l’infrastructure sous-jacente stocke-t-elle des données client Microsoft ? | Oui |
| Quelles données sont stockées dans vos bases de données ? | P.3 de https://standuply.com/privacy-policy |
...
| URL de la politique de confidentialité | https://standuply.com/privacy-policy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| MailboxSettings.Read | application | Pour envoyer des rapports sur un fuseau horaire individuel des utilisateurs | [e9f5cb58-89eb-4f80-9a6c-b73823b62176](../azure/e9f5cb58-89eb-4f80-9a6c-b73823b62176.md) |
