---
title: Informations sur l’application pour les discussions personnalisées par Pogo Studio
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/05/2022
...
* <a href="https://teams.microsoft.com/l/app/a1f5ad93-accd-463f-a8d5-904c77015815" target="_blank">Afficher dans le magasin Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004309" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Pogo Studio à Microsoft :
...
| Site web de la société | [https://pogodigitalhealth.com](https://pogodigitalhealth.com) |
| Conditions d’utilisation de l’application | [https://teams.tailored-talks.com/pdf/TermsOfUse.pdf](https://teams.tailored-talks.com/pdf/TermsOfUse.pdf) |
| Fonctionnalités principales de l’application | Les conférences personnalisées permettent aux cliniciens de partager des présentations personnalisées avec les patients. |
...
Ces informations ont été fournies par Pogo Studio sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont traitées par votre application ? | client |
...
| URL de la politique de confidentialité | https://teams.tailored-talks.com/pdf/PrivacyPolicy.pdf |
...
| Répertorier les types de stratégies prises en charge | Les stratégies peuvent être ciblées sur des utilisateurs et des groupes spécifiques, ce qui donne aux administrateurs un contrôle précis sur l’accès. |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | application | Identifier l’utilisateur | [61f93bfb-a23c-4043-9187-fbd3326e614b](../azure/61f93bfb-a23c-4043-9187-fbd3326e614b.md) |
>| openid | application | Identifier l’utilisateur | [61f93bfb-a23c-4043-9187-fbd3326e614b](../azure/61f93bfb-a23c-4043-9187-fbd3326e614b.md) |
>| profil | application | Identifier l’utilisateur | [61f93bfb-a23c-4043-9187-fbd3326e614b](../azure/61f93bfb-a23c-4043-9187-fbd3326e614b.md) |
