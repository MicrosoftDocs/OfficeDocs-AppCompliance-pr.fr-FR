...
| Site web de l’entreprise | [https://www.esi-asia.com](https://www.esi-asia.com) |
...
| Si des infastructures sous-jacentes traitent ou stockent des données client Microsoft, où sont stockées géographiquement ces données ? | Hong Kong |
...
>|:------------------------|:--------------------|:------------------------------------|
>| Calendars.ReadWrite | application | Écriture en lecture-écriture de calendriers |
>| Calendars.ReadWrite | délégué | Écriture en lecture-écriture de calendriers |
>| Mail.Send | délégué | envoyer un message électronique |
>| Mail.Send | application | envoyer un message électronique |
>| User.Read | délégué | lire l’utilisateur |
>| User.Read.All | application | lire l’utilisateur |
