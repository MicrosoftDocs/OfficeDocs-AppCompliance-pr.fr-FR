---
title: Informations d’application pour Aster par Entrup
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/29/2021
...
ms.locfileid: "66249744"
---
# <a name="aster"></a>Aster

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Dernière mise à jour par le développeur : 28 septembre 2021</p>

* <a href="https://teams.microsoft.com/l/app/2d8e8042-66df-4605-8c3a-9ca8962f3e99" target="_blank">Afficher dans le magasin Teams</a>
...
Informations fournies par Entrup à Microsoft :
...
| Nom de la société partenaire | Entrup |
| Site web de la société | [https://asterapp.co](https://asterapp.co) |
| Conditions d’utilisation de l’application | [https://asterapp.co/conditions-generales/](https://asterapp.co/conditions-generales/) |
| Fonctionnalités principales de l’application | Minutes de réunion qui vous font gagner du temps ! |
| Emplacement du siège social de la société | France |
| Page d’informations sur l’application | [https://asterapp.co/solution/](https://asterapp.co/solution/) |
| Quel est l’environnement d’hébergement ou le modèle de service utilisé pour exécuter votre application ? |  |
| Quels fournisseurs de cloud d’hébergement l’application utilise-t-elle ? | Azure, OVH Cloud (France) |
...
Ces informations ont été fournies par Entrup sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.Read.All | Délégué | Liste des répertoires pour l’envoi de tâches du Planificateur de documents Sharepoint | [27c89ce8-b449-4959-b801-988d8b727512](../azure/27c89ce8-b449-4959-b801-988d8b727512.md) |
>| Group.ReadWrite.All | Délégué | Liste des groupes pour l’envoi de tâches du Planificateur de documents Sharepoint dans des groupes existants ou créés | [27c89ce8-b449-4959-b801-988d8b727512](../azure/27c89ce8-b449-4959-b801-988d8b727512.md) |
>| Notes.ReadWrite.All | Délégué | Contenu des notes à écrire dans OneNote | [27c89ce8-b449-4959-b801-988d8b727512](../azure/27c89ce8-b449-4959-b801-988d8b727512.md) |
>| Tasks.ReadWrite.Shared | Délégué | Tâches, affectation, échéances | [27c89ce8-b449-4959-b801-988d8b727512](../azure/27c89ce8-b449-4959-b801-988d8b727512.md) |
>| User.Read | Délégué | E-mail de l’utilisateur pour l’identification de l’utilisateur | [27c89ce8-b449-4959-b801-988d8b727512](../azure/27c89ce8-b449-4959-b801-988d8b727512.md) |
>| offline_access | Délégué | Aucune donnée collectée, juste pour actualiser le jeton de manière insaisissable | [27c89ce8-b449-4959-b801-988d8b727512](../azure/27c89ce8-b449-4959-b801-988d8b727512.md) |
