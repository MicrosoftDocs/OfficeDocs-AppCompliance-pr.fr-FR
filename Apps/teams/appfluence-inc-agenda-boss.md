---
title: Informations sur l’application pour Agenda Boss par Appfluence Inc
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/16/2021
...
description: Toutes les informations de sécurité et de conformité disponibles pour Agenda Boss, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
ms.locfileid: "64881011"
---
# <a name="agenda-boss"></a>Agenda Boss

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Dernière mise à jour par le développeur : 16 mai 2021</p>

* <a href="https://teams.microsoft.com/l/app/ae645efa-0e64-47d9-91e4-b693a99f7f87" target="_blank">Afficher dans Teams magasin</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002607" target="_blank">Afficher dans AppSource</a>
...
|:----------------|:-------------|
| Nom de l'application | Agenda Boss |
| ID | WA200002607 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | Appfluence Inc |
| Site web de la société | [https://agendaboss.com](https://agendaboss.com) |
| Conditions d’utilisation de l’application | [https://agendaboss.com/eula](https://agendaboss.com/eula) |
| Fonctionnalités principales de l’application | Rassemblez toutes vos tâches et événements de calendrier, puis agrégez-les dans une liste linéaire simple. |
| Emplacement du siège social de la société | États-Unis d’Amérique |
| Page d’informations sur l’application | [https://agendaboss.com/about](https://agendaboss.com/about) |
