---
title: Informations d’application pour Hero par Happyforce par Happyforce
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/26/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour Hero by Happyforce, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
ms.locfileid: "65749406"
---
# <a name="hero-by-happyforce"></a>Hero par Happyforce

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Dernière mise à jour par le développeur : 24 mai 2022</p>

* <a href="https://teams.microsoft.com/l/app/de22bf49-b60e-44e7-a583-050a6e1918b5" target="_blank">Afficher dans Teams magasin</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002078" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Happyforce à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | Hero par Happyforce |
| ID | WA200002078 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | Happyforce |
| Site web de la société | [https://www.myhappyforce.com](https://www.myhappyforce.com) |
| Conditions d’utilisation de l’application | [https://www.myhappyforce.com/en/terms-conditions](https://www.myhappyforce.com/en/terms-conditions) |
| Fonctionnalités principales de l’application | Écoutez vos employés et faites-les prospérer en transformant votre organisation par le biais de commentaires. |
| Emplacement du siège social de la société | Espagne |
| Page d’informations sur l’application | [https://www.myhappyforce.com](https://www.myhappyforce.com) |
...
Ces informations ont été fournies par Happyforce sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| URL de la politique de confidentialité | https://myhappyforce.com/es/politica-de-privacidad/ |
