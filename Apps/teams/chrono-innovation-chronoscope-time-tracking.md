---
title: Informations d’application pour chronoscope Time Tracking by Chrono Innovation
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
* <a href="https://teams.microsoft.com/l/app/5b3ded07-fa1a-4fd8-a323-e5fe3f8cf740" target="_blank">Afficher dans Teams magasin</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003095" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Chrono Innovation à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | Chronoscope Time Tracking |
| ID | WA200003095 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | Chrono Innovation |
| Site web de la société | [https://www.chronoinnovation.com](https://www.chronoinnovation.com) |
| Conditions d’utilisation de l’application | [https://www.chronoscope.app/terms-of-service](https://www.chronoscope.app/terms-of-service) |
| Fonctionnalités principales de l’application | Chronoscope est une plateforme de gestion du temps intelligente qui augmente la précision des données et réduit les erreurs d’entrée de temps. Grâce à un assistant intelligent qui s’intègre à votre écosystème existant, Chronoscope facilite l’entrée dans le temps et offre une visibilité des données afin de prendre de meilleures décisions métier. |
| Emplacement du siège social de la société | Canada |
| Page d’informations sur l’application | [https://www.chronoscope.app](https://www.chronoscope.app) |
...
Ces informations ont été fournies par Chrono Innovation sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| AccessReview.Read.All | application | teams tenantId, teams addObjectId et teams user account information. Lors de la liaison d’utilisateurs Chronoscope, nous validons que l’e-mail correspond à un compte Teams afin que nous puissions lier le compte sans étape manuelle de l’utilisateur | [9bc8244d-a186-4b12-809e-c47b3eee73c6](../azure/9bc8244d-a186-4b12-809e-c47b3eee73c6.md) |
