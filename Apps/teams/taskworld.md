---
title: Informations d’application pour Taskworld par Taskworld
ms.author: elmalova
author: elenamalova
ms.date: 11/10/2021
ms.topic: article
...
description: Toutes les informations de sécurité et de conformité disponibles pour Taskworld, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le Registre CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/f8be25a9-34d4-499f-9464-d5d3792de6bf" target="_blank">Afficher dans Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003441" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Taskworld à Microsoft :

| **Information** | **Réponse** |
|:----------------|:-------------|
| Nom de l'application | Taskworld |
| ID | WA200003441 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | Taskworld |
| Site web de l’entreprise | [https://taskworld.com](https://taskworld.com) |
| Conditions d’utilisation de l’application | [https://taskworld.com/terms-privacy-security/customer-terms...](https://taskworld.com/terms-privacy-security/customer-terms-of-service/) |
| Fonctionnalités principales de l’application | Recevez vos notifications Taskworld dans Teams et collaborez plus efficacement ! |
...
Ces informations ont été fournies par Taskworld sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| URL de la politique de confidentialité | https://taskworld.com/terms-privacy-security/privacy/ |
