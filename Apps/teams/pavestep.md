---
title: Informations d’application pour Pavestep par Pavestep
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/23/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour Pavestep, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/aaa83b14-3857-43e0-88ca-b726f5df5db3" target="_blank">Afficher dans Teams magasin</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004114" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Pavestep à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | Pavestep |
| ID | WA200004114 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | Pavestep |
| Site web de la société | [https://www.pavestep.com](https://www.pavestep.com) |
| Conditions d’utilisation de l’application | [https://www.pavestep.com/user-agreement](https://www.pavestep.com/user-agreement) |
| Fonctionnalités principales de l’application | Pavestep est une solution intuitive de gestion des performances. |
...
Pavestep a fourni ces informations sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont traitées par votre application ? | Prénoms, noms, e-mails, rôles de travail |
| L’application prend-elle en charge TLS 1.1 ou version ultérieure ? | Oui |
| L’application ou l’infrastructure sous-jacente stocke-t-elle des données client Microsoft ? | Oui |
| Quelles données sont stockées dans vos bases de données ? | Prénoms, noms, e-mails, rôles de travail |
