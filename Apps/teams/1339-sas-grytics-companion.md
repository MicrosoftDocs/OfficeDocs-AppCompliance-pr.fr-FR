---
title: Informations d’application pour Grytics Companion by 1339 SAS
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/15/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour Grytics Companion, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
ms.locfileid: "66547206"
---
# <a name="grytics-companion"></a>Compagnon Grytics

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Dernière mise à jour par le développeur : 3 juin 2022</p>

* <a href="https://teams.microsoft.com/l/app/54ab7c02-a92f-4a87-9f59-764e42009fbc" target="_blank">Afficher dans le magasin Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004217" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par 1339 SAS à Microsoft :

| **Information** | **Réponse** |
|:----------------|:-------------|
| Nom de l'application | Compagnon Grytics |
| ID | WA200004217 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | 1339 SAS |
| Site web de la société | [https://grytics.com](https://grytics.com) |
| Conditions d’utilisation de l’application | [https://grytics.com/terms](https://grytics.com/terms) |
| Fonctionnalités principales de l’application | Les utilisateurs peuvent comparer &amp; l’analyse de l’activité des tendances &amp; des réseaux sociaux d’entreprise qui ont été ajoutés à leurs comptes Grytics |
...
Ces informations ont été fournies par 1339 SAP sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont traitées par votre application ? | E-mail, nom |
| L’application prend-elle en charge TLS 1.1 ou version ultérieure ? | Oui |
| L’application ou l’infrastructure sous-jacente stocke-t-elle des données client Microsoft ? | Oui |
| Quelles données sont stockées dans vos bases de données ? | Nom, Adresse e-mail pour les utilisateurs de l’application.  |
| Si l’infastructure sous-jacente traite ou stocke les données client Microsoft, où ces données sont-elles stockées géographiquement ? | Irlande, France |
...
| URL de la politique de confidentialité | https://grytics.com/privacy-policy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.Read.All | application | Nécessaire pour permettre aux administrateurs Grytics d’autoriser leurs utilisateurs Grytics à utiliser l’application sur Teams et à faire correspondre leur ID d’utilisateur sur AAD | [94efdec0-aa15-42e4-b45a-cd6437be5752](../azure/94efdec0-aa15-42e4-b45a-cd6437be5752.md) |
>| User.Read | Délégué | Nécessaire pour le flux d’authentification unique | [94efdec0-aa15-42e4-b45a-cd6437be5752](../azure/94efdec0-aa15-42e4-b45a-cd6437be5752.md) |
>| User.Read.All | application | Nécessaire pour permettre aux administrateurs Grytics d’autoriser leurs utilisateurs Grytics à utiliser l’application sur Teams et à faire correspondre leur ID d’utilisateur sur AAD | [94efdec0-aa15-42e4-b45a-cd6437be5752](../azure/94efdec0-aa15-42e4-b45a-cd6437be5752.md) |
>| email | Délégué | Nécessaire pour le flux d’authentification unique | [94efdec0-aa15-42e4-b45a-cd6437be5752](../azure/94efdec0-aa15-42e4-b45a-cd6437be5752.md) |
>| offline_access | Délégué | Nécessaire pour le flux d’authentification unique | [94efdec0-aa15-42e4-b45a-cd6437be5752](../azure/94efdec0-aa15-42e4-b45a-cd6437be5752.md) |
>| profil | Délégué | Nécessaire pour le flux d’authentification unique | [94efdec0-aa15-42e4-b45a-cd6437be5752](../azure/94efdec0-aa15-42e4-b45a-cd6437be5752.md) |
