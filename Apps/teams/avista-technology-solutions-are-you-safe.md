---
title: Informations d’application pour Are You Coffre? par Avista Technology Solutions
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/21/2022
...
* <a href="https://teams.microsoft.com/l/app/884e521a-dadc-41e9-a8af-fcaa907e783e" target="_blank">Afficher dans Teams magasin</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003863" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Avista Technology Solutions à Microsoft :
...
| Site web de la société | [https://safetybot.in](https://safetybot.in) |
| Conditions d’utilisation de l’application | [https://safetybot.in/terms.html](https://safetybot.in/terms.html) |
| Fonctionnalités principales de l’application | &quot;AreYouSafe?&quot; bot est votre assistant de gestion des crises personnalisé. Idéal pour les administrateurs de la sécurité et le personnel des RH à configurer et à utiliser en cas d’urgence.  Vous n’avez pas besoin d’autres logiciels ou services pour utiliser cette application. Notre bot est facile à utiliser et évite d’avoir à échanger entre les applications Teams et externes tout au long de la crise.  Utilisez notre bot pour connaître l’état de vos employés affectés par un incident majeur. &quot;AreYouSafe?&quot; bot vous aide à offrir une assistance aux personnes dans le besoin en fournissant des mises à jour en temps réel. |
| Emplacement du siège social de la société | Inde |
| Page d’informations sur l’application | [https://safetybot.in](https://safetybot.in) |
...
Ces informations ont été fournies par Avista Technology Solutions sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
