---
title: Informations d’application pour TaskCall by TaskCall Services cloud, S.L.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/31/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour TaskCall, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/eea91208-6850-4a61-8508-64b6c45d23a1" target="_blank">Afficher dans Teams magasin</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003914" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par TaskCall Services cloud, S.L. vers Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | TaskCall |
| ID | WA200003914 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | TaskCall Services cloud, S.L. |
| Site web de la société | [https://taskcallapp.com](https://taskcallapp.com) |
| Conditions d’utilisation de l’application | [https://www.taskcallapp.com/terms-of-service](https://www.taskcallapp.com/terms-of-service) |
| Fonctionnalités principales de l’application | L’intégration bidirectionnelle Microsoft Teams de TaskCall simplifie la communication et la collaboration IT-Ops en permettant la gestion des incidents à partir de Microsoft Teams. |
| Emplacement du siège social de la société | Espagne |
| Page d’informations sur l’application | [https://docs.taskcallapp.com/integrations/v1/microsoft-team...](https://docs.taskcallapp.com/integrations/v1/microsoft-teams-integration-guide) |
...
Ces informations ont été fournies par TaskCall Services cloud, S.L. sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
