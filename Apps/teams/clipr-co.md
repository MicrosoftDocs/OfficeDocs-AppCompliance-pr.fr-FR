---
title: Informations d’application pour CLIPr par CLIPr Co
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/21/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour CLIPr, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
ms.locfileid: "66952609"
---
# <a name="clipr"></a>CLIPr

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Dernière mise à jour par le développeur : 3 décembre 2021</p>

* <a href="https://teams.microsoft.com/l/app/2d6b2a6d-a20d-4206-a11c-e01d34d0d3a0" target="_blank">Afficher dans le magasin Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003612" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par CLIPr Co à Microsoft :

| **Information** | **Réponse** |
|:----------------|:-------------|
| Nom de l'application | CLIPr |
| ID | WA200003612 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | CLIPr Co |
| Site web de la société | [https://www.clipr.ai](https://www.clipr.ai) |
| Conditions d’utilisation de l’application | [https://www.clipr.ai/terms-of-use](https://www.clipr.ai/terms-of-use) |
| Fonctionnalités principales de l’application | CLIPr utilise l’IA/Machine Learning pour rendre le contenu vidéo pouvant faire l’objet d’une recherche et d’une action. |
...
Ces informations ont été fournies par CLIPr Co sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont traitées par votre application ? | Nous recueillons le nom et l’adresse e-mail de l’utilisateur. |
| L’application prend-elle en charge TLS 1.1 ou version ultérieure ? | Oui |
| L’application ou l’infrastructure sous-jacente stocke-t-elle des données client Microsoft ? | Oui |
| Quelles données sont stockées dans vos bases de données ? | Nom d’utilisateur, adresse e-mail et nom d’entreprise attaché à son ID de locataire.  |
...
| URL de la politique de confidentialité | https://www.clipr.ai/privacy-policy |
