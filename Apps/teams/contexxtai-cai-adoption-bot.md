...
>|:---------------------------------------|:-----------------------------------|:------------------------------------|
>| Dans Bot Framework, l’ID d’utilisateur est transmis automatiquement pour pouvoir communiquer avec l’utilisateur. Les données d’utilisation supplémentaires de C.AI Adoption Analytics sont utilisées pour individualiser l’expérience d’apprentissage pour l’utilisateur, donc, en envoyant uniquement des conseils appropriés et utiles aux utilisateurs, qui ne connaissent peut-être pas ces conseils. | Non |  |
