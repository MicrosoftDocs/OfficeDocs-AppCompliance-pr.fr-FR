---
title: Informations sur l’application pour la matrice de décision du bout des doigts par doigt
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/26/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour la matrice de décision du bout des doigts, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
---
# <a name="fingertip-decision-matrix"></a>Matrice de décision du bout des doigts

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Dernière mise à jour par le développeur : 6 octobre 2021</p>

* <a href="https://teams.microsoft.com/l/app/9d9390bb-2d73-4c5e-9609-0ee86fc620ce" target="_blank">Afficher dans le magasin Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004070" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Le bout des doigts à Microsoft :

| **Information** | **Réponse** |
|:----------------|:-------------|
| Nom de l'application | Matrice de décision du bout des doigts |
| ID | WA200004070 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | Doigt |
| Site web de la société | [https://www.fingertip.org](https://www.fingertip.org) |
| Conditions d’utilisation de l’application | [https://www.fingertip.org/terms-of-use/](https://www.fingertip.org/terms-of-use/) |
| Fonctionnalités principales de l’application | La matrice de décision du bout des doigts vous aide à choisir entre plusieurs alternatives lorsque vous devez prendre en compte de nombreux facteurs différents. Il apporte plus de clarté et de transparence dans le processus et vous aide à hiérarchiser vos alternatives tout en réduisant l’impact des biais. Avec la matrice de décision à portée de main, vous pouvez collaborer pour prendre des décisions plus précisément ensemble, à l’aide de Microsoft Teams. |
| Emplacement du siège social de la société | Finlande |
| Page d’informations sur l’application | [https://www.fingertip.org/solutions/fingertip-decision-matr...](https://www.fingertip.org/solutions/fingertip-decision-matrix/) |
...
Ces informations ont été fournies par Fingertip sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont traitées par votre application ? | Informations de profil utilisateur, ID de locataire |
| L’application prend-elle en charge TLS 1.1 ou version ultérieure ? | Oui |
| L’application ou l’infrastructure sous-jacente stocke-t-elle des données client Microsoft ? | Oui |
| Quelles données sont stockées dans vos bases de données ? | Informations de profil utilisateur, ID de locataire |
| Si l’infastructure sous-jacente traite ou stocke les données client Microsoft, où ces données sont-elles stockées géographiquement ? | Finlande |
...
| Répertorier les types de stratégies prises en charge | Authentification multifacteur, permettant uniquement à Intune appareils inscrits d’accéder à des services spécifiques, en limitant les emplacements utilisateur et les plages d’adresses IP |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Délégué | Informations de profil de base pour la création d’utilisateurs | [5a6a4d82-42ce-42c4-88f0-df529fe54dcc](../azure/5a6a4d82-42ce-42c4-88f0-df529fe54dcc.md) |
>| User.ReadBasic.All | Délégué | Informations de profil de base pour la création d’utilisateurs | [5a6a4d82-42ce-42c4-88f0-df529fe54dcc](../azure/5a6a4d82-42ce-42c4-88f0-df529fe54dcc.md) |
>| email | Délégué | Informations de profil de base pour la création d’utilisateurs | [5a6a4d82-42ce-42c4-88f0-df529fe54dcc](../azure/5a6a4d82-42ce-42c4-88f0-df529fe54dcc.md) |
>| offline_access | Délégué | Car si l’utilisateur se déconnecte | [5a6a4d82-42ce-42c4-88f0-df529fe54dcc](../azure/5a6a4d82-42ce-42c4-88f0-df529fe54dcc.md) |
>| openid | Délégué | Connexion | [5a6a4d82-42ce-42c4-88f0-df529fe54dcc](../azure/5a6a4d82-42ce-42c4-88f0-df529fe54dcc.md) |
>| profil | Délégué | Informations de profil de base pour la création d’utilisateurs | [5a6a4d82-42ce-42c4-88f0-df529fe54dcc](../azure/5a6a4d82-42ce-42c4-88f0-df529fe54dcc.md) |
