---
title: Informations d’application pour Gfacility par Gfacility
ms.author: elmalova
author: elenamalova
ms.date: 11/17/2021
ms.topic: article
...
description: Toutes les informations de sécurité et de conformité disponibles pour Gfacility, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le Registre CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/0f553268-ba1c-4bb0-953c-def3e00aac7d" target="_blank">Afficher dans Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003474" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Gfacility à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | Gfacility |
| ID | WA200003474 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | Gfacility |
| Site web de l’entreprise | [https://gfacility.com](https://gfacility.com) |
| Conditions d’utilisation de l’application | [https://gfacility.com/terms-of-use](https://gfacility.com/terms-of-use) |
| Fonctionnalités principales de l’application | Assurer le suivi de vos réunions avec Gfacility dans Microsoft Teams |
...
Ces informations ont été fournies par Gfacility sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| URL de la politique de confidentialité | https://gfacility.com/privacy-policy |
