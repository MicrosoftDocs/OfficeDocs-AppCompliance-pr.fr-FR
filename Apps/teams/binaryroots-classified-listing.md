---
title: Informations sur l’application pour la liste classifiée par BinaryRoots
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/01/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour la liste classifiée, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
ms.locfileid: "65938689"
---
# <a name="classified-listing"></a>Liste classifiée

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Dernière mise à jour par le développeur : 23 mai 2022</p>

* <a href="https://teams.microsoft.com/l/app/0c824060-9c8c-11ec-a1de-3143e9005d6a" target="_blank">Afficher dans le magasin Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004155" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par BinaryRoots à Microsoft :

| **Information** | **Réponse** |
|:----------------|:-------------|
| Nom de l'application | Liste classifiée |
| ID | WA200004155 |
| Clients Office 365 pris en charge | Microsoft Teams |
| Nom de la société partenaire | BinaryRoots |
| Site web de la société | [https://binaryroots.com](https://binaryroots.com) |
| Conditions d’utilisation de l’application | [https://binaryroots.com/classifiedapp-terms-and-conditions](https://binaryroots.com/classifiedapp-terms-and-conditions) |
| Fonctionnalités principales de l’application | Une application Teams pour créer/héberger la Place de marché Buy/Sell interne pour votre organisation...  |
| Emplacement du siège social de la société | Inde |
...
Ces informations ont été fournies par BinaryRoots sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont stockées dans vos bases de données ? | Seuls les ID : ID de locataire, ID d’utilisateur administrateur, URL de site et ID de site, ID de liste/bibliothèque |
...
| URL de la politique de confidentialité | https://binaryroots.com/classified-app-privacy-policy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Channel.ReadBasic.All | Délégué | Pour afficher le canal lors de l’utilisation des fonctionnalités de partage | [e8a37d29-e4be-4ce1-ae06-bbd1ad1968e3](../azure/e8a37d29-e4be-4ce1-ae06-bbd1ad1968e3.md) |
>| ChannelMessage.Send | Délégué | Pour envoyer un message à l’utilisateur/canal pour le compte de l’utilisateur lorsque la fonctionnalité de partage est utilisée | [e8a37d29-e4be-4ce1-ae06-bbd1ad1968e3](../azure/e8a37d29-e4be-4ce1-ae06-bbd1ad1968e3.md) |
>| Chat.ReadWrite | Délégué | Pour envoyer un message à l’utilisateur/canal pour le compte de l’utilisateur lorsque la fonctionnalité de partage est utilisée | [e8a37d29-e4be-4ce1-ae06-bbd1ad1968e3](../azure/e8a37d29-e4be-4ce1-ae06-bbd1ad1968e3.md) |
>| ChatMessage.Send | Délégué | Pour envoyer un message à l’utilisateur/canal pour le compte de l’utilisateur lorsque la fonctionnalité de partage est utilisée | [e8a37d29-e4be-4ce1-ae06-bbd1ad1968e3](../azure/e8a37d29-e4be-4ce1-ae06-bbd1ad1968e3.md) |
>| Sites.FullControl.All | Délégué | Créer des bibliothèques de listes obligatoires sur une collection de sites ciblée; cette opération n’est requise que pour la première installation pour les administrateurs de locataires | [e8a37d29-e4be-4ce1-ae06-bbd1ad1968e3](../azure/e8a37d29-e4be-4ce1-ae06-bbd1ad1968e3.md) |
>| Sites.Manage.All | Délégué | Créer des bibliothèques de listes obligatoires sur une collection de sites ciblée; cette opération n’est requise que pour la première installation pour les administrateurs de locataires | [e8a37d29-e4be-4ce1-ae06-bbd1ad1968e3](../azure/e8a37d29-e4be-4ce1-ae06-bbd1ad1968e3.md) |
>| Team.ReadBasic.All | Délégué | Pour remplir la liste déroulante des équipes et des canaux lorsque des fonctionnalités de partage sont utilisées. | [e8a37d29-e4be-4ce1-ae06-bbd1ad1968e3](../azure/e8a37d29-e4be-4ce1-ae06-bbd1ad1968e3.md) |
>| TeamsActivity.Send | Délégué | Pour envoyer une notification de flux d’activité à l’administrateur et au créateur de publication pour des fonctionnalités d’indicateur inappropriées  | [e8a37d29-e4be-4ce1-ae06-bbd1ad1968e3](../azure/e8a37d29-e4be-4ce1-ae06-bbd1ad1968e3.md) |
>| User.Read | Délégué | Lire les informations de base des utilisateurs pour afficher l’administrateur/qui a publié, leurs photos, leur adresse e-mail de nom dans la carte de liste | [e8a37d29-e4be-4ce1-ae06-bbd1ad1968e3](../azure/e8a37d29-e4be-4ce1-ae06-bbd1ad1968e3.md) |
>| User.ReadBasic.All | Délégué | Lire les informations de base des utilisateurs pour afficher l’administrateur/qui a publié, leurs photos, leur adresse e-mail de nom dans la carte de liste | [e8a37d29-e4be-4ce1-ae06-bbd1ad1968e3](../azure/e8a37d29-e4be-4ce1-ae06-bbd1ad1968e3.md) |
