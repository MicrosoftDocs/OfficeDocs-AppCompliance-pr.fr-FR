---
title: Informations d’application pour le présentateur CT par customertimes
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/15/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour le présentateur CT, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
ms.locfileid: "66817625"
---
# <a name="ct-presenter"></a>Présentateur CT

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Dernière mise à jour par le développeur : 30 juin 2022</p>

* <a href="https://teams.microsoft.com/l/app/f33e9d75-e765-49f9-b7b2-d4bfa89066a0" target="_blank">Afficher dans le magasin Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004401" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Customertimes à Microsoft :

| **Information** | **Réponse** |
|:----------------|:-------------|
| Nom de l'application | Présentateur CT |
| ID | WA200004401 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | Customertimes |
| Site web de la société | [https://customertimes.com](https://customertimes.com) |
| Conditions d’utilisation de l’application | [https://rd.ctclm.com/eula](https://rd.ctclm.com/eula) |
| Fonctionnalités principales de l’application | Présentation à distance |
| Emplacement du siège social de la société | France |
| Page d’informations sur l’application | [https://help.customertimes.com/articles/](https://help.customertimes.com/articles/) |
...
Ces informations ont été fournies par Customertimes sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
