---
title: Informations sur l’application pour SightCall par SightCall
ms.author: elmalova
author: elenamalova
ms.date: 02/17/2022
ms.topic: article
...
description: Toutes les informations de sécurité et de conformité disponibles pour SightCall, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le Registre CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/c5312ffd-d146-4515-89e0-b43fa5282368" target="_blank">Afficher dans Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003675" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par SightCall à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | SightCall |
| ID | WA200003675 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | SightCall |
| Site web de l’entreprise | [https://sightcall.com](https://sightcall.com) |
| Conditions d’utilisation de l’application | [https://sightcall.com/terms-conditions](https://sightcall.com/terms-conditions) |
| Fonctionnalités principales de l’application | SightCall est une plateforme cloud vidéo de qualité entreprise |
...
Ces informations ont été fournies par SightCall sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Date de certification SOC2 la plus récente |  2021-06-25 |
| L’application est-elle conforme aux contrôles d’organisation de service (SOC 3) ? | Oui |
| Date de certification SOC3 la plus récente |  2021-06-25 |
...
| URL de la politique de confidentialité | https://sightcall.com/privacy-policy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| email | délégué | requis pour la sign-in | [c5312ffd-d146-4515-89e0-b43fa5282368](https://docs.microsoft.com/microsoft-365-app-certification/azure/c5312ffd-d146-4515-89e0-b43fa5282368) |
>| profil | délégué | requis pour la sign-in | [c5312ffd-d146-4515-89e0-b43fa5282368](https://docs.microsoft.com/microsoft-365-app-certification/azure/c5312ffd-d146-4515-89e0-b43fa5282368) |
