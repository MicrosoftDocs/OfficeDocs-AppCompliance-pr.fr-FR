...
| Site web de l’entreprise | [https://www.zoho.com](https://www.zoho.com) |
| Conditions d’utilisation de l’application | [https://www.zoho.com/terms.html](https://www.zoho.com/terms.html) |
| Fonctionnalités principales de l’application | Zoho Sign est une application de signature numérique sécurisée basée sur le cloud qui vous permet de signer, d’envoyer et de gérer vos formalités professionnelles juridiquement et électroniquement. Vous pouvez créer facilement des flux de travail de signature électronique pour collecter des signatures, authentifier les signataires, déclencher des rappels et suivre l’état de signature et d’approbation en temps réel. Zoho Sign vous permet également de gérer toutes vos formalités directement à partir des applications Microsoft à partir de votre navigateur web et d’y aller avec des applications mobiles. |
| Emplacement du siège social de l’entreprise | États-Unis d’Amérique |
| Page d’informations sur l’application | [https://www.zoho.com/sign/help/teams-extension.html](https://www.zoho.com/sign/help/teams-extension.html) |
...
| Si des infastructures sous-jacentes traitent ou stockent des données client Microsoft, où sont stockées géographiquement ces données ? | Inde, Japon, Australie, Chine, Pays-Bas (le), Irlande, États-Unis d’Amérique |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | délégué | Activer la connexion et lire le profil utilisateur | [a67ee0a9-b008-4e90-986d-1eb8d55a81d6](../azure/a67ee0a9-b008-4e90-986d-1eb8d55a81d6.md) |
