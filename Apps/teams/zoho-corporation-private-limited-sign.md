---
title: Informations d’application pour zoho sign by Zoho Corporation Private Limited
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/17/2022
...
* [Afficher dans Teams magasin](https://teams.microsoft.com/l/app/7a22873b-81e6-48ed-aee3-6f0e7dd5a104)
* [Afficher dans AppSource](https://appsource.microsoft.com/product/office/WA104382011)
...
| Fonctionnalités principales de l’application | Zoho Sign est une application de signature numérique sécurisée basée sur le cloud qui vous permet de signer, d’envoyer et de gérer vos documents métier légalement et électroniquement. Vous pouvez créer des flux de travail de signature électronique sans effort pour collecter des signatures, authentifier les signataires, déclencher des rappels et suivre l’état de signature et d’approbation en temps réel. Zoho Sign vous permet également de gérer tous vos documents directement à partir des applications Microsoft à partir de votre navigateur web et en déplacement avec des applications mobiles. |
