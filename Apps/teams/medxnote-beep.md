---
title: Informations sur l’application pour Beep by Medxnote
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/18/2022
...
<p>Dernière mise à jour par le développeur : 11 mai 2022</p>

* <a href="https://teams.microsoft.com/l/app/6b8b29d8-5beb-4eae-915e-5a56a0e1f5a6" target="_blank">Afficher dans le magasin Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004364" target="_blank">Afficher dans AppSource</a>
...
| **Information** | **Réponse** |
|:----------------|:-------------|
| Nom de l'application | Beep |
| ID | WA200004364 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | Medxnote |
| Site web de la société | [https://medxnote.com](https://medxnote.com) |
| Conditions d’utilisation de l’application | [https://medxnote.com/terms-conditions/](https://medxnote.com/terms-conditions/) |
| Fonctionnalités principales de l’application | Améliorez la collaboration clinique avec l’intégration des tâches EPR de MedxPlanner dans Microsoft Teams. |
...
| Quelles données sont traitées par votre application ? | ID de locataire, profil utilisateur, balises |
...
| URL de la politique de confidentialité | https://medxnote.com/privacy-policy/ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.ReadWrite.All | les deux | Nous obtenons les informations d’organisation de l’utilisateur | [5d0905b2-a6de-4480-b5e0-059140592517](../azure/5d0905b2-a6de-4480-b5e0-059140592517.md) |
>| TeamsActivity.Send | application | Cette autorisation est utilisée pour envoyer l’activité à l’utilisateur. Nous l’utilisons donc pour créer une activité par programmation dans le flux de l’utilisateur, afin de lui faire savoir que la tâche est mise à jour. | [5d0905b2-a6de-4480-b5e0-059140592517](../azure/5d0905b2-a6de-4480-b5e0-059140592517.md) |
>| TeamworkTag.ReadWrite | application | Nous utilisons cette autorisation pour obtenir et créer les balises à l’intérieur des équipes dans Microsoft Teams. Afin que nous puissions les mentionner par programmation. | [5d0905b2-a6de-4480-b5e0-059140592517](../azure/5d0905b2-a6de-4480-b5e0-059140592517.md) |
>| User.Read | Délégué | À l’aide de cette autorisation, nous obtenons les informations de base des utilisateurs telles que displayName, mail, userPrincipalName, id et photo. | [5d0905b2-a6de-4480-b5e0-059140592517](../azure/5d0905b2-a6de-4480-b5e0-059140592517.md) |
>| User.Read.All | application | À l’aide de cela, nous récupérons le total des propriétés. | [5d0905b2-a6de-4480-b5e0-059140592517](../azure/5d0905b2-a6de-4480-b5e0-059140592517.md) |
>| User.ReadWrite.All | application | À l’aide de cela, nous obtenons les équipes jointes des utilisateurs. | [5d0905b2-a6de-4480-b5e0-059140592517](../azure/5d0905b2-a6de-4480-b5e0-059140592517.md) |
