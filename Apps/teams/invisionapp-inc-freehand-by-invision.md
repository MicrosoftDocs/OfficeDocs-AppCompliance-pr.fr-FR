---
title: Informations d’application pour Freehand par InVision par InVisionApp, Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/06/2021
...
description: Toutes les informations de sécurité et de conformité disponibles pour Freehand by InVision, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
ms.locfileid: "64879701"
---
# <a name="freehand-by-invision"></a>Main levée par InVision

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Dernière mise à jour par le développeur : 6 mai 2021</p>

* <a href="https://teams.microsoft.com/l/app/67cf2c5a-db0e-4256-a423-14010cbeafdd" target="_blank">Afficher dans Teams magasin</a>
...
Informations fournies par InVisionApp, Inc. à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | Main levée par InVision |
| ID | WA104381362 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | InVisionApp Inc. |
| Site web de la société | [https://www.invisionapp.com](https://www.invisionapp.com) |
| Conditions d’utilisation de l’application | [https://www.invisionapp.com/legal/terms-of-service](https://www.invisionapp.com/legal/terms-of-service) |
| Fonctionnalités principales de l’application | Collaborez en temps réel avec un tableau blanc en ligne. |
| Emplacement du siège social de la société | États-Unis d’Amérique |
| Page d’informations sur l’application | [https://www.invisionapp.com/freehand](https://www.invisionapp.com/freehand) |
...
Ces informations ont été fournies par InVisionApp, Inc. sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Date de certification SOC2 la plus récente | 2020-05-13 |
| L’application est-elle conforme aux contrôles d’organisation de service (SOC 3) ? | Oui |
| Date de certification SOC3 la plus récente | 2020-06-12 |
