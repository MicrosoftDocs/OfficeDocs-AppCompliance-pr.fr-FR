---
title: Informations d’application pour hommage par Tribute Co.
ms.author: elmalova
author: elenamalova
ms.date: 04/16/2021
ms.topic: article
...
description: Toutes les informations disponibles sur la sécurité et la conformité pour Tribute, ses politiques de traitement des données, ses informations sur le catalogue d’applications Microsoft Cloud App Security et les informations de sécurité et de conformité dans le registre STAR de l’ASC.
...
* <a href="https://teams.microsoft.com/l/app/cfb46a87-a75b-4045-9f22-a0ae0614fd60" target="_blank">Vue dans Teams magasin</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002589" target="_blank">Voir dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Tribute Co. à Microsoft:

| **Information** | **Réponse** |
|:----------------|:-------------|
| Nom de l'application | Tribute |
| ID | WA200002589 WA200002589 |
| Office 365 clients soutenus | Microsoft Teams |
| Nom de l’entreprise partenaire | Tribute Co. |
| URL du site web partenaire | [https://www.tributementorship.com](https://www.tributementorship.com) |
| URL de la page Teams’informations d’application | [https://www.tributementorship.com/how-it-works](https://www.tributementorship.com/how-it-works) |
...
Ces informations ont été fournies par Tribute Co. sur la façon dont cette application recueille et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
>Nous sommes un processeur de données, pas un contrôleur. 
...
Ces informations ont été fournies par Tribute Co. sur la façon dont cette application gère l’authentification, l’autorisation, les meilleures pratiques d’enregistrement des applications et d’autres critères d’identité.
