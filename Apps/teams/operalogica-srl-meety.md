---
title: Informations d’application pour Meety par operaLogica srl
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/20/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour Meety, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/9a68d494-f5ae-4e0c-ad18-478bf6fcd101" target="_blank">Afficher dans le magasin Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004258" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par operaLogica srl à Microsoft :

| **Information** | **Réponse** |
|:----------------|:-------------|
| Nom de l'application | Meety |
| ID | WA200004258 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | operaLogica srl |
| Site web de la société | [https://meety.business](https://meety.business) |
| Conditions d’utilisation de l’application | [https://meety.business/termsofuse](https://meety.business/termsofuse) |
| Fonctionnalités principales de l’application | Collecter et organiser des réunions et améliorer l’expérience de réunion avec les cibles, les tâches et l’historique des réunions |
| Emplacement du siège social de la société | Italie |
...
Ces informations ont été fournies par operaLogica srl sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont traitées par votre application ? | E-mail, nom, nom, réunion insérée |
| L’application prend-elle en charge TLS 1.1 ou version ultérieure ? | Oui |
| L’application ou l’infrastructure sous-jacente stocke-t-elle des données client Microsoft ? | Oui |
| Quelles données sont stockées dans vos bases de données ? | E-mail, nom, nom, réunion insérée |
...
| URL de la politique de confidentialité | https://meety.business/privacy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.ReadWrite | Délégué | Possibilité d’ajouter une réunion à un thread | [9a68d494-f5ae-4e0c-ad18-478bf6fcd101](../azure/9a68d494-f5ae-4e0c-ad18-478bf6fcd101.md) |
>| Chat.Read | Délégué | Lire des informations sur la réunion | [9a68d494-f5ae-4e0c-ad18-478bf6fcd101](../azure/9a68d494-f5ae-4e0c-ad18-478bf6fcd101.md) |
>| Chat.ReadBasic | Délégué | Lire des informations sur la réunion | [9a68d494-f5ae-4e0c-ad18-478bf6fcd101](../azure/9a68d494-f5ae-4e0c-ad18-478bf6fcd101.md) |
>| OnlineMeetingArtifact.Read.All | Délégué | Lire des informations sur les artefacts de la réunion pour améliorer l’expérience utilisateur | [9a68d494-f5ae-4e0c-ad18-478bf6fcd101](../azure/9a68d494-f5ae-4e0c-ad18-478bf6fcd101.md) |
>| OnlineMeetings.Read | Délégué | Lire l’ID de la réunion pour ajouter des données supplémentaires | [9a68d494-f5ae-4e0c-ad18-478bf6fcd101](../azure/9a68d494-f5ae-4e0c-ad18-478bf6fcd101.md) |
>| User.Read | Délégué | Obtenir des informations sur l’utilisateur qui utilise l’application | [9a68d494-f5ae-4e0c-ad18-478bf6fcd101](../azure/9a68d494-f5ae-4e0c-ad18-478bf6fcd101.md) |
