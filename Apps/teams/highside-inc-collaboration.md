---
title: Informations sur l’application pour la collaboration HighSide par HighSide, Inc
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/31/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour HighSide Collaboration, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le Registre CSA STAR.
...
<p>Last updated by the developer on: January 31, 2022</p>

* <a href="https://teams.microsoft.com/l/app/d4460828-ddde-4619-b40b-39412667f7a3" target="_blank">Afficher dans Teams store</a>
...
|:----------------|:-------------|
| Nom de l'application | HighSide Collaboration |
| ID | WA200003916 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | HighSide, Inc |
| Site web de l’entreprise | [https://highside.io](https://highside.io) |
| Conditions d’utilisation de l’application | [https://highside.io/terms-of-service](https://highside.io/terms-of-service) |
| Fonctionnalités principales de l’application | Fichiers de messagerie chiffrée &amp; E2E pour Microsoft Teams. |
...
| Quelles données sont stockées dans vos bases de données ? | User Microsoft UUID, User Name, User Email Address |
