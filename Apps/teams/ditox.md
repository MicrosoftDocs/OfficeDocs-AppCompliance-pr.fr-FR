---
title: Informations sur l’application pour Ditox par Ditox
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/08/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour Ditox, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
ms.locfileid: "66549426"
---
# <a name="ditox"></a>Ditox

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Dernière mise à jour par le développeur : 18 mars 2022</p>

* <a href="https://teams.microsoft.com/l/app/cbc9c980-47b3-11ec-9859-730e001beb96" target="_blank">Afficher dans le magasin Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004193" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Ditox à Microsoft :

| **Information** | **Réponse** |
|:----------------|:-------------|
| Nom de l'application | Ditox |
| ID | WA200004193 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | Ditox |
| Site web de la société | [https://www.ditox.nl](https://www.ditox.nl) |
| Conditions d’utilisation de l’application | [https://www.ditox.nl/wp-content/uploads/2022/03/Ditox-Hybri...](https://www.ditox.nl/wp-content/uploads/2022/03/Ditox-Hybrid-Working-App-Terms-of-Use-2021.pdf) |
| Fonctionnalités principales de l’application | Hybride werken voor teams, werkafspraken, digitale vaardigheden, manager en medewerker, pragmatisch |
| Emplacement du siège social de la société | Pays-Bas (le) |
| Page d’informations sur l’application | [https://www.ditox.nl/de-ditox-app/](https://www.ditox.nl/de-ditox-app/) |
...
Ces informations ont été fournies par Ditox sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| URL de la politique de confidentialité | https://www.ditox.nl/privacyverklaring/ |
