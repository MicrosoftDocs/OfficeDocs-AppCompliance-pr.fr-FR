---
title: Informations d’application pour Orca par ORCA SECURITY LTD
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/31/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour Orca, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/50423b81-408b-4699-a850-9a0514ee42c3" target="_blank">Afficher dans Teams magasin</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004132" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par ORCA SECURITY LTD à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | Orca |
| ID | WA200004132 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | ORCA SECURITY LTD |
| Site web de la société | [https://orca.security](https://orca.security) |
| Conditions d’utilisation de l’application | [https://orca.security/terms-of-use](https://orca.security/terms-of-use) |
| Fonctionnalités principales de l’application | La sécurité Orca pour Microsoft Teams fournit une image en temps réel de l’état de sécurité de votre environnement cloud. À l’aide des deux outils combinés dans une même vue, les utilisateurs peuvent créer une discussion productive sur les problèmes de sécurité dans leur environnement cloud Les alertes Orca détaillent un risque cloud spécifique qui inclut les résultats des risques de sécurité et la ressource cloud connectée qui pose le risque. |
...
Ces informations ont été fournies par ORCA SECURITY LTD sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont traitées par votre application ? | Teams ID d’utilisateur, ID d’équipe, nom de l’équipe |
| L’application prend-elle en charge TLS 1.1 ou version ultérieure ? | Oui |
| L’application ou l’infrastructure sous-jacente stocke-t-elle des données client Microsoft ? | Oui |
| Quelles données sont stockées dans vos bases de données ? | Teams ID d’utilisateur, ID d’équipe, nom de l’équipe |
...
| Date de certification SOC2 la plus récente | 2022-04-01 |
...
| URL de la politique de confidentialité | https://orca.security/privacy-policy/ |
