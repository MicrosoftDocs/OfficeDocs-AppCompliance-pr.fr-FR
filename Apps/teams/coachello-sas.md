---
title: Informations d’application pour Coachello par Coachello SAS
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/29/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour Coachello, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
<p>Dernière mise à jour par le développeur : 4 mars 2022</p>

* <a href="https://teams.microsoft.com/l/app/b6b8f190-e24d-4387-937f-8683cc78a6d4" target="_blank">Afficher dans le magasin Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003997" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Coachello SAS à Microsoft :

| **Information** | **Réponse** |
|:----------------|:-------------|
| Nom de l'application | Coachello |
| ID | WA200003997 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | Coachello SAS |
| Site web de la société | [https://coachello.io](https://coachello.io) |
| Conditions d’utilisation de l’application | [https://www.coachello.io/terms-and-conditions](https://www.coachello.io/terms-and-conditions) |
| Fonctionnalités principales de l’application | Aider les talents à prospérer grâce à un coaching à la demande de haute qualité par le biais de MS Teams. Dans l’application Coachello, vous pouvez effectuer une évaluation, choisir votre coach et travailler avec lui pendant les sessions de coaching 1:1. |
| Emplacement du siège social de la société | France |
| Page d’informations sur l’application | [https://resources.coachello.io/teams-client-manual](https://resources.coachello.io/teams-client-manual) |
| Quel est l’environnement d’hébergement ou le modèle de service utilisé pour exécuter votre application ? | Paas |
| Quels fournisseurs de cloud d’hébergement l’application utilise-t-elle ? | Aws, netlify |
...
Ces informations ont été fournies par Coachello SAS sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont traitées par votre application ? | Noms d’utilisateur, niveau de satisfaction de la session, résultats des évaluations |
| L’application prend-elle en charge TLS 1.1 ou version ultérieure ? | Oui |
| L’application ou l’infrastructure sous-jacente stocke-t-elle des données client Microsoft ? | Oui |
| Quelles données sont stockées dans vos bases de données ? | Noms d’utilisateur, niveau de satisfaction de la session, résultats des évaluations |
...
| URL de la politique de confidentialité | https://coachello.io/privacy-policy/ |
...
| Répertorier les types de stratégies prises en charge | Plans Freemium + Premium |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| OnlineMeetings.ReadWrite | application | Afin de leur permettre de réserver des réunions directement dans leur calendrier avec l’entraîneur de leur choix sur le sujet de leur choix | [0b1d36f2-4057-42a1-bfdd-5b7b6b3b8016](../azure/0b1d36f2-4057-42a1-bfdd-5b7b6b3b8016.md) |
>| User.Read | application | Pour adapter l’expérience de l’application à la langue et à l’emplacement de l’utilisateur  | [0b1d36f2-4057-42a1-bfdd-5b7b6b3b8016](../azure/0b1d36f2-4057-42a1-bfdd-5b7b6b3b8016.md) |
>| email | application | Afin de faciliter les séances de coaching 1:1 avec nos entraîneurs (confirmation de réservation) | [0b1d36f2-4057-42a1-bfdd-5b7b6b3b8016](../azure/0b1d36f2-4057-42a1-bfdd-5b7b6b3b8016.md) |
>| openid | application | Pour connecter en toute sécurité un utilisateur à Coachello | [0b1d36f2-4057-42a1-bfdd-5b7b6b3b8016](../azure/0b1d36f2-4057-42a1-bfdd-5b7b6b3b8016.md) |
>| profil | application | Afin de personnaliser l’expérience utilisateur sur l’application de Coachello | [0b1d36f2-4057-42a1-bfdd-5b7b6b3b8016](../azure/0b1d36f2-4057-42a1-bfdd-5b7b6b3b8016.md) |
