...
* <a href="https://teams.microsoft.com/l/app/424b1333-fbf0-4941-acbe-336bf1f316ae" target="_blank">Afficher dans Teams store</a>
...
Informations fournies par Smartnotation B.V. à Microsoft :
...
| Site web de l’entreprise | [https://www.smartnotation.com/landing/](https://www.smartnotation.com/landing/) |
...
| Fonctionnalités principales de l’application | La smartnotation est une solution de minutes de réunion facile à utiliser et activée pour la voix. Vos notes, actions et décisions sont faciles à gérer et vos informations sont toujours disponibles. Par-dessus tout, cela vous permet, ainsi qu’à votre équipe, de vous concentrer sur votre activité principale. Vous pouvez entièrement intégrer Smartnotation à MS Teams. Ajoutez un connecteur pour être averti de toutes les mises à jour importantes, de nouvelles notes, actions et décisions pour un projet spécifique, configurez un onglet ou utilisez Smartnotation directement. |
