...
* <a href="https://teams.microsoft.com/l/app/424b1333-fbf0-4941-acbe-336bf1f316ae" target="_blank">Afficher dans Teams magasin</a>
* <a href="https://appsource.microsoft.com/product/office/WA200000681" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Smartnotation B.V. vers Microsoft :
...
| Site web de la société | [https://www.smartnotation.com/landing/](https://www.smartnotation.com/landing/) |
| Conditions d’utilisation de l’application | [https://www.smartnotation.com/public/tos.pdf](https://www.smartnotation.com/public/tos.pdf) |
| Fonctionnalités principales de l’application | Smartnotation est une solution de minutes de réunion avec voix facile à utiliser. Vos notes, actions et décisions sont faciles à gérer et vos informations sont toujours disponibles. Par-dessus tout, elle élimine les surcharges inutiles qui vous permettent, vous et votre équipe, de vous concentrer sur votre cœur de métier. Vous pouvez intégrer smartnotation complètement à MS Teams. Ajoutez un connecteur pour être averti de toutes les mises à jour importantes, nouvelles notes, actions et décisions pour un projet spécifique, configurer un onglet ou utiliser smartnotation directement. |
| Emplacement du siège social de la société | Pays-Bas (le) |
| Page d’informations sur l’application | [https://www.smartnotation.com/landing/integrations/](https://www.smartnotation.com/landing/integrations/) |
| Quel est l’environnement d’hébergement ou le modèle de service utilisé pour exécuter votre application ? |  |
| Quels fournisseurs de cloud d’hébergement l’application utilise-t-elle ? | Totaaldomein B.V. |
...
Ces informations ont été fournies par Smartnotation B.V. sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
