---
title: Informations sur l’application pour le Gestionnaire d’utilisateurs externes par Solutions2ShareShare
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/24/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour le Gestionnaire d’utilisateurs externes, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le Registre CSA STAR.
...
ms.locfileid: "64463824"
---
# <a name="external-user-manager"></a>Gestionnaire d’utilisateurs externes

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Last updated by the developer on: March 24, 2022</p>

* <a href="https://teams.microsoft.com/l/app/e41aa305-2f95-4a15-a2b7-026338541850" target="_blank">Afficher dans Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003014" target="_blank">Afficher dans AppSource</a>
...
|:----------------|:-------------|
| Nom de l'application | Gestionnaire d’utilisateurs externes |
| ID | WA200003014 |
...
| Fonctionnalités principales de l’application | Gérer les utilisateurs externes dans Microsoft Teams |
| Emplacement du siège social de l’entreprise | Allemagne |
| Page d’informations sur l’application | [https://www.solutions2share.com/external-user-manager](https://www.solutions2share.com/external-user-manager) |
...
| Quelles données sont stockées dans vos bases de données ? | TenantID,User Principal Name,External User E-Mail |
