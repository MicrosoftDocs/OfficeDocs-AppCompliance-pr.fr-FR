...
* <a href="https://teams.microsoft.com/l/app/88579a1e-a40e-4ff4-ac0a-789bab11b0a1" target="_blank">Afficher dans Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA104381965" target="_blank">Afficher dans AppSource</a>
...
| Site web de l’entreprise | [https://elmah.io](https://elmah.io) |
| Conditions d’utilisation de l’application | [https://elmah.io/legal/terms-of-use/](https://elmah.io/legal/terms-of-use/) |
| Fonctionnalités principales de l’application | elmah.io est un service de surveillance de la journalisation des erreurs et du temps de travail pour les développeurs web .NET. elmah.io s’intègre à toutes les principales infrastructure web et de journalisation et offre une expérience d’analyse étendue sur les applications web, Windows et mobiles. |
| Emplacement du siège social de l’entreprise | Danemark |
| Page d’informations sur l’application | [https://docs.elmah.io/elmah-io-apps-teams/](https://docs.elmah.io/elmah-io-apps-teams/) |
...
Ces informations ont été fournies par elmah.io sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont stockées dans vos bases de données ? | Nom et e-mail |
...
| URL de la politique de confidentialité | https://elmah.io/legal/privacy-policy/ |
