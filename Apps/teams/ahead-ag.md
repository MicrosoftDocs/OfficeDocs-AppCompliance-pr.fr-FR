...
Ces informations ont été fournies par le groupe de disponibilité préalable sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont traitées par votre application ? | Données pertinentes pour le bon fonctionnement du produit intranet à venir. Cela inclut, sans s’y limiter, les actualités, les informations relatives au ciblage du contenu vers des groupes d’utilisateurs spécifiques, la navigation et les notifications. |
| L’application prend-elle en charge TLS 1.1 ou version ultérieure ? | Oui |
| L’application ou l’infrastructure sous-jacente stocke-t-elle des données client Microsoft ? | Oui |
| Quelles données sont stockées dans vos bases de données ? | Données pertinentes pour le bon fonctionnement du produit intranet à venir. Cela inclut, sans s’y limiter, les actualités, les informations relatives au ciblage du contenu vers des groupes d’utilisateurs spécifiques, la navigation et les notifications. Les données relatives à l’utilisateur sont des copies en lecture seule d’Azure AD. Cela est limité à l’ID et au nom de l’utilisateur et à leur appartenance aux groupes Azure AD qui ont été marqués comme pertinents à l’avance. |
