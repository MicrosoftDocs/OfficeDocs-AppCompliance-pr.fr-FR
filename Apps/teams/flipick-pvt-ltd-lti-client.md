...
* <a href="https://teams.microsoft.com/l/app/bfed1af2-2c16-4536-9780-8e21d7fc7d79" target="_blank">Afficher dans Teams magasin</a>
...
| Site web de la société | [https://flipick.com](https://flipick.com) |
| Conditions d’utilisation de l’application | [https://flipick.com/terms-of-use/](https://flipick.com/terms-of-use/) |
| Fonctionnalités principales de l’application | L’application fournit une authentification unique (SSO) avec un serveur LTI (Learning Tools Interoperability) pour lancer des cours. Il s’agit d’un consommateur d’outils LTI et prend en charge LTI de base (BLTI). |
