...
| Site web de l’entreprise | [https://flipick.com](https://flipick.com) |
| Conditions d’utilisation de l’application | [https://flipick.com/terms-of-use/](https://flipick.com/terms-of-use/) |
| Fonctionnalités principales de l’application | L’application fournit une signature unique (SSO) avec un serveur LTI (Learning Tools Interoperability) pour lancer des cours. Il s’agit d’un consommateur d’outils LTI qui prend en charge l’outil BLTI (Basic LTI). |
