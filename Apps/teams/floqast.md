---
title: Informations sur l’application pour FloQast par FloQast
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/26/2021
...
description: Toutes les informations de sécurité et de conformité disponibles pour FloQast, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/326749cd-77f8-4579-8944-6837ebeb175d" target="_blank">Afficher dans Teams magasin</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003117" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par FloQast à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | FaqQast |
| ID | WA200003117 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | FaqQast |
| Site web de la société | [https://floqast.com](https://floqast.com) |
| Conditions d’utilisation de l’application | [https://floqast.com/terms-of-use/](https://floqast.com/terms-of-use/) |
| Fonctionnalités principales de l’application | FloQast fournit une solution de gestion étroite ainsi qu’une automatisation des flux de travail conçue pour aider les comptables à effectuer la clôture du mois. |
| Emplacement du siège social de la société | États-Unis d’Amérique |
| Page d’informations sur l’application | [https://floqast.com](https://floqast.com) |
...
FloQast a fourni ces informations sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Date de certification SOC2 la plus récente | 2/28/2021 |
