---
title: Informations sur l’application pour WorkJam Home by WorkJam
ms.author: elmalova
author: elenamalova
ms.date: 08/19/2021
ms.topic: article
...
description: Toutes les informations de sécurité et de conformité disponibles pour WorkJam Home, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le Registre CSA STAR.
...
ms.locfileid: "62251493"
---
# <a name="workjam-home"></a>WorkJam Home

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Last updated by the developer on: June 29, 2021</p>

* <a href="https://teams.microsoft.com/l/app/f80b33b4-695d-423f-a5e7-d464ad6893d1" target="_blank">Afficher dans Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003060" target="_blank">Afficher dans AppSource</a>
...
|:----------------|:-------------|
| Nom de l'application | WorkJam Home |
| ID | WA200003060 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | WorkJam |
| Site web de l’entreprise | [https://www.workjam.com](https://www.workjam.com) |
...
| Fonctionnalités principales de l’application | WorkJam est la solution Espace de travail numérique que les chefs d’entreprise choisissent d’orchestrer pour leurs employés &#8212; comme plateforme de productivité de votre productivité de productivité ou au sein de votre solution d’employé de premier plan. Disponible dans plus de 37 langues et déployée dans plus de 38 pays, WorkJam fournit une orchestration de main-d’œuvre totale via la gestion des tâches de pointe, la gestion des équipes, les enquêtes et les outils de micro-apprentissage.  |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| TeamsActivity.Send | application | Envoi de notifications aux utilisateurs finaux. | [0b87cb84-073e-4cf6-a1ef-45d864ef2918](https://docs.microsoft.com/microsoft-365-app-certification/azure/0b87cb84-073e-4cf6-a1ef-45d864ef2918) |
>| User.Read | délégué | Pour l’identification et l’authentification | [0b87cb84-073e-4cf6-a1ef-45d864ef2918](https://docs.microsoft.com/microsoft-365-app-certification/azure/0b87cb84-073e-4cf6-a1ef-45d864ef2918) |
