---
title: Informations d’application pour Squadcast par Squadcast
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/19/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour Squadcast, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
ms.locfileid: "66892045"
---
# <a name="squadcast"></a>Squadcast

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Dernière mise à jour par le développeur : 10 janvier 2022</p>

* <a href="https://teams.microsoft.com/l/app/7792759a-43e8-4dc8-9f55-e7b0382c4a67" target="_blank">Afficher dans le magasin Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004390" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Squadcast à Microsoft :

| **Information** | **Réponse** |
|:----------------|:-------------|
| Nom de l'application | Squadcast |
| ID | WA200004390 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | Squadcast |
| Site web de la société | [https://www.squadcast.com](https://www.squadcast.com) |
| Conditions d’utilisation de l’application | [https://www.squadcast.com/terms](https://www.squadcast.com/terms) |
| Fonctionnalités principales de l’application | Gestion efficace des incidents directement à partir de MS Teams. |
| Emplacement du siège social de la société | États-Unis d’Amérique |
| Page d’informations sur l’application | [https://support.squadcast.com/docs/msteams](https://support.squadcast.com/docs/msteams) |
...
Ces informations ont été fournies par Squadcast sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont traitées par votre application ? | Données de profil utilisateur : nom d’utilisateur uniquement, Email |
| L’application prend-elle en charge TLS 1.1 ou version ultérieure ? | Oui |
| L’application ou l’infrastructure sous-jacente stocke-t-elle des données client Microsoft ? | Oui |
| Quelles données sont stockées dans vos bases de données ? | ID d’équipe, nom de l’équipe, ID de canal, nom de canal, ID de locataire |
...
| URL de la politique de confidentialité | https://www.squadcast.com/privacy |
