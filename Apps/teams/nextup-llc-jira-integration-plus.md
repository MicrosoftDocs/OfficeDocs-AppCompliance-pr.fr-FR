---
title: Informations sur l’application pour Jira Integration Plus par Nextup, LLC
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/11/2022
...
* <a href="https://teams.microsoft.com/l/app/a3394b99-8ae6-48cb-bb45-898fd4c49f93" target="_blank">Afficher dans Teams store</a>
...
| Site web de l’entreprise | [https://www.nextup.ai](https://www.nextup.ai) |
| Conditions d’utilisation de l’application | [https://www.nextup.ai/terms](https://www.nextup.ai/terms) |
| Fonctionnalités principales de l’application | Recherchez les problèmes existants de Jira à modifier ou à discuter sur Teams, ou créez de nouveaux problèmes. Envoie des problèmes dans un message. Commentez un problème ou consultez les détails. Modifiez l’état, affectez-le, et bien plus encore. Utilisez Jira via une interface de ligne de commande (CLI). Commenter, journaler le travail, etc. Recevoir des notifications pour les problèmes sur un canal (connecteurs). Créez de nouveaux problèmes à partir de messages avec extension de messagerie. Gérer les problèmes à l’aide de tableaux (onglets). Recherchez les problèmes en cliquant sur notre icône sous n’importe quel message Teams. |
