---
title: Informations sur l’application pour Jira Integration Plus by Nextup, LLC
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/11/2022
...
<p>Dernière mise à jour par le développeur : 2 décembre 2021</p>

* <a href="https://teams.microsoft.com/l/app/a3394b99-8ae6-48cb-bb45-898fd4c49f93" target="_blank">Afficher dans Teams magasin</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003847" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Nextup, LLC à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | Jira Integration Plus |
| ID | WA200003847 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | Nextup, LLC |
| Site web de la société | [https://www.nextup.ai](https://www.nextup.ai) |
| Conditions d’utilisation de l’application | [https://www.nextup.ai/terms](https://www.nextup.ai/terms) |
| Fonctionnalités principales de l’application | Recherchez les problèmes Jira existants à modifier ou à discuter sur Teams, ou créez de nouveaux problèmes. Envoie des problèmes dans un message. Commentez un problème ou consultez les détails. Modifiez l’état, affectez-le, etc. Utilisez Jira via une interface de ligne de commande (CLI). Commentaire, travail des journaux, etc. Recevez des notifications pour les problèmes sur un canal (connecteurs). Créez de nouveaux problèmes à partir de messages avec l’extension de messagerie. Gérer les problèmes à l’aide de tableaux (onglets). Recherchez les problèmes en cliquant sur notre icône sous un message dans Teams. |
...
Ces informations ont été fournies par Nextup, LLC sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont traitées par votre application ? | Identificateurs uniques et adresses e-mail |
...
| Date de certification SOC1 la plus récente | 2021-04-01 |
...
| URL de la politique de confidentialité | https://www.nextup.ai/data-processing-agreement/ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| AccessReview.Read.All | les deux | Nous utilisons cette API pour vérifier que les utilisateurs ont l’autorisation d’accéder à notre application | [0f22abfb-b687-489d-9fd6-ad1bc95d6d68](/microsoft-365-app-certification/azure/0f22abfb-b687-489d-9fd6-ad1bc95d6d68) |
>| AccessReview.ReadWrite.All | les deux | Nous utilisons cette API pour vérifier que les utilisateurs ont l’autorisation d’accéder à notre application | [0f22abfb-b687-489d-9fd6-ad1bc95d6d68](/microsoft-365-app-certification/azure/0f22abfb-b687-489d-9fd6-ad1bc95d6d68) |
>| Directory.Read.All | les deux | Nous utilisons cette API pour nous assurer que les utilisateurs ont l’autorisation d’utiliser le bot dans l’application Teams et l’équipe et le canal | [0f22abfb-b687-489d-9fd6-ad1bc95d6d68](/microsoft-365-app-certification/azure/0f22abfb-b687-489d-9fd6-ad1bc95d6d68) |
>| Directory.Read.All | les deux | Nous utilisons cette API pour nous assurer que les utilisateurs ont l’autorisation d’utiliser le bot dans l’application Teams et l’équipe et le canal | [0f22abfb-b687-489d-9fd6-ad1bc95d6d68](/microsoft-365-app-certification/azure/0f22abfb-b687-489d-9fd6-ad1bc95d6d68) |
>| Files.ReadWrite.All | les deux | Nous utilisons cette API pour accepter les fichiers des utilisateurs, qu’ils peuvent attacher aux problèmes Jira | [0f22abfb-b687-489d-9fd6-ad1bc95d6d68](/microsoft-365-app-certification/azure/0f22abfb-b687-489d-9fd6-ad1bc95d6d68) |
>| Files.ReadWrite.All | les deux | Nous utilisons cette API pour accepter les fichiers des utilisateurs, qu’ils peuvent attacher aux problèmes Jira | [0f22abfb-b687-489d-9fd6-ad1bc95d6d68](/microsoft-365-app-certification/azure/0f22abfb-b687-489d-9fd6-ad1bc95d6d68) |
>| Sites.Read.All | les deux | Nous utilisons cette API pour voir à quels sites l’utilisateur a accès afin qu’il puisse créer des tickets à des emplacements appropriés | [0f22abfb-b687-489d-9fd6-ad1bc95d6d68](/microsoft-365-app-certification/azure/0f22abfb-b687-489d-9fd6-ad1bc95d6d68) |
>| Sites.Read.All | les deux | Nous utilisons cette API pour voir à quels sites l’utilisateur a accès afin qu’il puisse créer des tickets à des emplacements appropriés | [0f22abfb-b687-489d-9fd6-ad1bc95d6d68](/microsoft-365-app-certification/azure/0f22abfb-b687-489d-9fd6-ad1bc95d6d68) |
>| User.ReadWrite.All | les deux | Nous utilisons cette API pour permettre à un utilisateur administrateur de donner à son organisation la possibilité d’utiliser notre application avec Jira. | [0f22abfb-b687-489d-9fd6-ad1bc95d6d68](/microsoft-365-app-certification/azure/0f22abfb-b687-489d-9fd6-ad1bc95d6d68) |
>| User.ReadWrite.All | les deux | Nous utilisons cette API pour permettre à un utilisateur administrateur de donner à son organisation la possibilité d’utiliser notre application avec Jira. | [0f22abfb-b687-489d-9fd6-ad1bc95d6d68](/microsoft-365-app-certification/azure/0f22abfb-b687-489d-9fd6-ad1bc95d6d68) |
