---
title: Informations sur l’application pour feeder par Really Simple i Stockholm AB
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/17/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour Feeder, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
ms.locfileid: "66246011"
---
# <a name="feeder"></a>Alimentation

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Dernière mise à jour par le développeur : 8 juin 2022</p>

* <a href="https://teams.microsoft.com/l/app/6810f6a8-1f9a-4504-a916-e2d9814062e0" target="_blank">Afficher dans le magasin Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004254" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Really Simple i Stockholm AB à Microsoft :

| **Information** | **Réponse** |
|:----------------|:-------------|
| Nom de l'application | Alimentation |
| ID | WA200004254 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | Vraiment simple i Stockholm AB |
| Site web de la société | [https://feeder.co](https://feeder.co) |
| Conditions d’utilisation de l’application | [https://feeder.co/teams-license](https://feeder.co/teams-license) |
| Fonctionnalités principales de l’application | Obtenir des mises à jour d’actualités à partir de flux RSS et d’autres sources numériques |
...
| Quels fournisseurs de cloud d’hébergement l’application utilise-t-elle ? | OVH, DigitalOcean, Aws |
...
Ces informations ont été fournies par Really Simple i Stockholm AB sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont traitées par votre application ? | E-mail, adresse IP, ID de locataire |
| L’application prend-elle en charge TLS 1.1 ou version ultérieure ? | Oui |
| L’application ou l’infrastructure sous-jacente stocke-t-elle des données client Microsoft ? | Oui |
| Quelles données sont stockées dans vos bases de données ? | E-mail, ID de locataire |
| Si l’infastructure sous-jacente traite ou stocke les données client Microsoft, où ces données sont-elles stockées géographiquement ? | Canada, France |
...
| URL de la politique de confidentialité | https://feeder.co/help/legal/privacy-policy/ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | les deux | Authentification et connexion des utilisateurs | [d6286bf8-c566-4451-a252-fc96ac6d8787](../azure/d6286bf8-c566-4451-a252-fc96ac6d8787.md) |
>| email | Délégué | Authentification et connexion des utilisateurs | [d6286bf8-c566-4451-a252-fc96ac6d8787](../azure/d6286bf8-c566-4451-a252-fc96ac6d8787.md) |
>| openid | les deux | Authentification et connexion des utilisateurs | [d6286bf8-c566-4451-a252-fc96ac6d8787](../azure/d6286bf8-c566-4451-a252-fc96ac6d8787.md) |
>| profil | les deux | Authentification et connexion des utilisateurs | [d6286bf8-c566-4451-a252-fc96ac6d8787](../azure/d6286bf8-c566-4451-a252-fc96ac6d8787.md) |
