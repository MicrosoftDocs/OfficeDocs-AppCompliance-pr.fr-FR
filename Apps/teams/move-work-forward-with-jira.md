...
|:----------------|:-------------|
| Nom de l'application | Faire avancer le travail avec Jira |
| ID | WA200002855 |
...
| Fonctionnalités principales de l’application | Move Work Forward permet aux entreprises d’accroître la productivité, la transparence des équipes et de gagner du temps en fournissant un ensemble de produits qui intègrent les outils Atlassian à Microsoft Teams, GitHub, Azure DevOps et d’autres outils de productivité d’équipe. |
| Emplacement du siège social de l’entreprise | Singapour |
| Page d’informations sur l’application | [https://www.moveworkforward.com/product/microsoft-teams-jir...](https://www.moveworkforward.com/product/microsoft-teams-jira-connector) |
...
| Quelles données sont stockées dans vos bases de données ? | Teams et canaux pour envoyer des notifications également. |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Channel.Create | délégué | Créer un canal de discussion pour un problème Jira | [39d845a0-3fa2-4fba-acc2-61afe40cfcea](../azure/39d845a0-3fa2-4fba-acc2-61afe40cfcea.md) |
>| Channel.ReadBasic.All | délégué | Lire les canaux d’une équipe pour envoyer des notifications | [39d845a0-3fa2-4fba-acc2-61afe40cfcea](../azure/39d845a0-3fa2-4fba-acc2-61afe40cfcea.md) |
>| Team.ReadBasic.All | délégué | Pour lire les équipes à afficher sur la page de configuration. Pour les notifications de Jira. | [39d845a0-3fa2-4fba-acc2-61afe40cfcea](../azure/39d845a0-3fa2-4fba-acc2-61afe40cfcea.md) |
>| TeamsAppInstallation.ReadForTeam | délégué | Vérifiez si l’application est installée dans une équipe. | [39d845a0-3fa2-4fba-acc2-61afe40cfcea](../azure/39d845a0-3fa2-4fba-acc2-61afe40cfcea.md) |
>| User.Read | délégué | Pour améliorer l’expérience utilisateur. | [39d845a0-3fa2-4fba-acc2-61afe40cfcea](../azure/39d845a0-3fa2-4fba-acc2-61afe40cfcea.md) |
>| email | délégué | pour matricer des comptes Microsoft et Atlassian | [39d845a0-3fa2-4fba-acc2-61afe40cfcea](../azure/39d845a0-3fa2-4fba-acc2-61afe40cfcea.md) |
