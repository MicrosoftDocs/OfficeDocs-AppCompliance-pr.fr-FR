---
title: Informations sur l’application pour lire le tableau de bord par Read AI, Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/15/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour Read Dashboard, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
ms.locfileid: "64881859"
---
# <a name="read-dashboard"></a>Lire le tableau de bord

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Dernière mise à jour par le développeur : 15 avril 2022</p>

* <a href="https://teams.microsoft.com/l/app/18eb20ae-cd59-48c6-8060-fbe171a917e5" target="_blank">Afficher dans Teams magasin</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003896" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Read AI, Inc. à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | Lire le tableau de bord |
| ID | WA200003896 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | Lire L’IA, Inc. |
| Site web de la société | [https://read.ai](https://read.ai) |
| Conditions d’utilisation de l’application | [https://read.ai/tos](https://read.ai/tos) |
| Fonctionnalités principales de l’application | Le tableau de bord de lecture mesure le sentiment, l’engagement et les performances globales de la réunion. |
| Emplacement du siège social de la société | États-Unis d’Amérique |
| Page d’informations sur l’application | [https://www.read.ai/product](https://www.read.ai/product) |
...
Ces informations ont été fournies par Read AI, Inc. sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont traitées par votre application ? | Données de profil utilisateur, données audio de réunion et données vidéo de réunion  |
| L’application prend-elle en charge TLS 1.1 ou version ultérieure ? | Oui |
| L’application ou l’infrastructure sous-jacente stocke-t-elle des données client Microsoft ? | Oui |
| Quelles données sont stockées dans vos bases de données ? | Données de profil utilisateur, métriques utilisateur agrégées dérivées de données audio et vidéo |
...
| Date de certification SOC2 la plus récente | 2022-04-14 |
...
| URL de la politique de confidentialité | https://read.ai/privacy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.Read | Délégué | Nous permettons aux utilisateurs de lier leurs calendriers à notre service pour activer la distribution automatique de notre bot multimédia Azure | [35e7f5d2-9978-464f-8710-c7a05d5b9fdf](../azure/35e7f5d2-9978-464f-8710-c7a05d5b9fdf.md) |
>| Calls.AccessMedia.All | application | Accéder aux données audio et vidéo de réunion pour le traitement des applications | [35e7f5d2-9978-464f-8710-c7a05d5b9fdf](../azure/35e7f5d2-9978-464f-8710-c7a05d5b9fdf.md) |
>| Calls.JoinGroupCall.All | application | Nous avons besoin d’autorisations de participation pour que notre bot multimédia Azure rejoigne la réunion Teams en cours | [35e7f5d2-9978-464f-8710-c7a05d5b9fdf](../azure/35e7f5d2-9978-464f-8710-c7a05d5b9fdf.md) |
>| User.Read | Délégué | Dans le cadre de notre processus d’authentification unique, nous accédons aux données utilisateur nécessaires en demandant l’autorisation de lecture à leurs profils utilisateur. | [35e7f5d2-9978-464f-8710-c7a05d5b9fdf](../azure/35e7f5d2-9978-464f-8710-c7a05d5b9fdf.md) |
>| email | Délégué | Nous avons besoin d’adresses e-mail dans le cadre du processus de création de compte  | [35e7f5d2-9978-464f-8710-c7a05d5b9fdf](../azure/35e7f5d2-9978-464f-8710-c7a05d5b9fdf.md) |
>| openid | Délégué | Nous permettons aux utilisateurs de se connecter via l’authentification unique | [35e7f5d2-9978-464f-8710-c7a05d5b9fdf](../azure/35e7f5d2-9978-464f-8710-c7a05d5b9fdf.md) |
>| profil | Délégué | Nous avons besoin de données de profil utilisateur pour créer des comptes d’utilisateur (prénom et nom, en particulier) | [35e7f5d2-9978-464f-8710-c7a05d5b9fdf](../azure/35e7f5d2-9978-464f-8710-c7a05d5b9fdf.md) |
