---
title: Informations sur l’application pour SwiftAssess par GamaLearn
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/20/2021
...
description: Toutes les informations de sécurité et de conformité disponibles pour SwiftAssess, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/0cd07157-f297-4c2c-a23b-64577bceea6c" target="_blank">Afficher dans Teams magasin</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001973" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par GamaLearn à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | SwiftAssess |
| ID | WA200001973 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | GamaLearn |
| Site web de la société | [https://gamalearn.com](https://gamalearn.com) |
| Conditions d’utilisation de l’application | [https://swiftassess.com/terms-and-conditions](https://swiftassess.com/terms-and-conditions) |
| Fonctionnalités principales de l’application | Un atelier unique pour tous les besoins d’évaluation, allant des méthodologies et fonctionnalités éprouvées qui guident votre parcours dans la création, la livraison et le suivi de votre stratégie de transformation d’évaluation à tous les niveaux de votre organisation. SwiftAssess offre plusieurs solutions, fonctionnalités et flux de travail clés qui simplifient et automatisent les processus d’évaluation réels dans différentes institutions. Cela couvre les normes du secteur en matière de sécurité, d’accessibilité, d’analytique, de banque d’éléments, etc. |
| Emplacement du siège social de la société | Émirats arabes unis (le) |
| Page d’informations sur l’application | [https://swiftassess.com/about/partners/microsoft#Teams](https://swiftassess.com/about/partners/microsoft#Teams) |
...
Ces informations ont été fournies par GamaLearn sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
