---
title: Informations d’application pour 8x8 par 8x8, Inc
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/16/2021
...
<p>Dernière mise à jour par le développeur : 10 juin 2021</p>

* <a href="https://teams.microsoft.com/l/app/bab6487a-dbe6-426f-b329-b7ef0d0fd5ba" target="_blank">Afficher dans Teams magasin</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002665" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par 8x8, Inc à Microsoft :
...
| Site web de la société | [https://www.8x8.com](https://www.8x8.com) |
| Conditions d’utilisation de l’application | [https://www.8x8.com/terms-and-conditions](https://www.8x8.com/terms-and-conditions) |
| Fonctionnalités principales de l’application | 8x8 Voice est un service de routage direct basé sur le cloud pour effectuer/recevoir des appels RTC. Une expérience native avec les fonctionnalités de téléphonie et de centre de contacts de niveau entreprise. Forfaits d’appels illimités dans 47 pays + service de remplacement RTC dans 43 pays, Analytique, SMS, MMS et Fax. Obtenez des forfaits d’appels économiques localement ou internationalement et étendez les appels RTC aux pays où Microsoft n’offre&#8217;pas encore de plans, pour tirer le meilleur parti de Microsoft 365. |
| Emplacement du siège social de la société | États-Unis d’Amérique |
| Page d’informations sur l’application | [https://www.8x8.com/products/integrations/8x8-voice-for-mic...](https://www.8x8.com/products/integrations/8x8-voice-for-microsoft-teams) |
| Quel est l’environnement d’hébergement ou le modèle de service utilisé pour exécuter votre application ? |  |
| Quels fournisseurs de cloud d’hébergement l’application utilise-t-elle ? | AWS, OracleCloud |
...
Ces informations ont été fournies par 8x8, Inc sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
