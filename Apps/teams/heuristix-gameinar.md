---
title: Informations sur l’application pour gameinar par Heuristix
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/19/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour Gameinar, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
ms.locfileid: "64875401"
---
# <a name="gameinar"></a>Gameinar

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Dernière mise à jour par le développeur : 17 janvier 2022</p>

* <a href="https://teams.microsoft.com/l/app/10a3a812-c72d-47d4-b9b5-6425c6fed158" target="_blank">Afficher dans Teams magasin</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003379" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Heuristix à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | Gameinar |
| ID | WA200003379 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | Heuristix |
| Site web de la société | [https://www.disprz.com](https://www.disprz.com) |
| Conditions d’utilisation de l’application | [https://www.disprz.com/terms-of-service-gameinar/](https://www.disprz.com/terms-of-service-gameinar/) |
| Fonctionnalités principales de l’application | Créer des facilitations virtuelles attrayantes ! |
| Emplacement du siège social de la société | Inde |
| Page d’informations sur l’application | [https://disprz.com/gameinar/](https://disprz.com/gameinar/) |
...
Heuristix a fourni ces informations sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
