...
| Site web de l’entreprise | [https://www.springworks.in](https://www.springworks.in) |
| Conditions d’utilisation de l’application | [https://engagewith.springworks.in/terms-and-conditions](https://engagewith.springworks.in/terms-and-conditions) |
| Fonctionnalités principales de l’application | EngageWith est une plateforme de reconnaissance et de primes d’égal à égal pour les employés qui favorise une culture de reconnaissance, améliore l’engagement des employés et aide l’organisation à se rendre compte de ses réussites ( grandes et petites). Les employés peuvent reconnaître des homologues, des responsables ou des responsables en leur donnant des félicitations ou des conseils pour une tâche bien effectuée. Kudos et Desouts ont chacun un ensemble de points associés qui s’ajoutent au fil du temps à des avantages significatifs.  |
| Emplacement du siège social de l’entreprise | États-Unis d’Amérique |
| Page d’informations sur l’application | [https://www.springworks.in/engagewith/](https://www.springworks.in/engagewith/) |
...
| Quelles données sont stockées dans vos bases de données ? | name, email |
...
| URL de la politique de confidentialité | https://www.springworks.in/gdpr |
