---
title: Informations d’application pour le bot RFPIO par RFPIO
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/03/2021
...
* <a href="https://teams.microsoft.com/l/app/77c23de0-bcf9-4f27-91c9-135a82ee2543" target="_blank">Afficher dans Teams magasin</a>
...
| Site web de la société | [https://www.rfpio.com](https://www.rfpio.com) |
| Conditions d’utilisation de l’application | [https://www.rfpio.com/terms-of-service/](https://www.rfpio.com/terms-of-service/) |
| Fonctionnalités principales de l’application | RFPIO est la première solution de gestion des réponses à la demande d’appel d’offres et le premier logiciel de DFP compatible avec l’IA, approuvé par certaines des entreprises les plus intelligentes au monde pour gérer les réponses aux RFP, aux RFIS, aux questionnaires de sécurité et aux DDQ.  |
| Emplacement du siège social de la société | États-Unis d’Amérique |
| Page d’informations sur l’application | [https://www.rfpio.com/product/](https://www.rfpio.com/product/) |
| Quel est l’environnement d’hébergement ou le modèle de service utilisé pour exécuter votre application ? |  |
| Quels fournisseurs de cloud d’hébergement l’application utilise-t-elle ? | Azure, AWS, GCP |
...
| Date de certification SOC2 la plus récente | 2021-05-17 |
...
| Répertorier les types de stratégies prises en charge | Multifacteur, restriction IP |
