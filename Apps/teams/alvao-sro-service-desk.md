...
description: Toutes les informations disponibles sur la sécurité et la conformité pour Alvao Service Desk, ses politiques de traitement des données, ses informations sur le catalogue d’applications Microsoft Cloud App Security et les informations de sécurité et de conformité dans le registre STAR de l’ASC.
...
<p>Dernière mise à jour par le développeur le: Mars 8, 2021</p>

* <a href="https://teams.microsoft.com/l/app/6b9cc557-e24a-4744-a370-407e717f2195" target="_blank">Vue dans Teams magasin</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002488" target="_blank">Voir dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par ALVAO s.r.o. à Microsoft:
...
| Nom de l’entreprise partenaire | ALVAO s.r.o. |
| URL du site web partenaire | [https://www.alvao.com/en/ ](https://www.alvao.com/en/ ) |
| URL de la page Teams’informations d’application | [https://doc.alvao.com/support/doc/en/alvao_10_4/modules/alv...](https://doc.alvao.com/support/doc/en/alvao_10_4/modules/alvao_teams_addin/default.aspx) |
...
Ces informations ont été fournies par ALVAO s.r.o. sur la façon dont cette application recueille et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
>|:----------------|:--------------------|:---------------------------------------------------|:--------------------------|:--------------------------|
>| User.Read | Délégué | jetons d’authentification | Permet à l’utilisateur de se connecter et de lier Office 365 compte avec son compte Alvao | ef5fa233-c0bb-424e-b9dc-0466d46bade2 |
...
>Les données sont stockées dans le Microsoft Azure Cloud. Les données peuvent être consultées par les ingénieurs à des fins de débogage avec l’approbation de notre haute direction. L’accès aux données est contrôlé par VPN interne.
...
<iframe height='1020' title='Microsoft Cloud App Security information' src='https://appmcasinfoprod.azurewebsites.net/#/dashboard/36558' frameborder='no' style='width: 100%;'></iframe>

<a href="https://appmcasinfoprod.azurewebsites.net/#/dashboard/36558" target="_blank">Afficher dans un nouvel onglet</a>
...
Ces informations ont été fournies par ALVAO s.r.o. sur la façon dont cette application gère l’authentification, l’autorisation, les meilleures pratiques d’enregistrement des applications et d’autres critères d’identité.
