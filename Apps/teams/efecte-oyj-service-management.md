---
title: Informations sur les applications pour la gestion des services efecte par Efecte Oyj
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/16/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour la gestion des services Efecte, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le Registre CSA STAR.
...
ms.locfileid: "63553435"
---
# <a name="efecte-service-management"></a>Gestion des services efecte

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Last updated by the developer on: January 24, 2022</p>

* <a href="https://teams.microsoft.com/l/app/1c20b1ea-7f9f-496a-a577-8b1bb1a28228" target="_blank">Afficher dans Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003830" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Efecte Oyj à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | Gestion des services efecte |
| ID | WA200003830 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | Efecte Oyj |
| Site web de l’entreprise | [https://www.efecte.com](https://www.efecte.com) |
| Conditions d’utilisation de l’application | [https://www.efecte.com/terms-of-service](https://www.efecte.com/terms-of-service) |
| Fonctionnalités principales de l’application | Recevoir des notifications sur les nouveaux tickets dans Efecte Service Management (ESM) |
| Emplacement du siège social de l’entreprise | Finlande |
| Page d’informations sur l’application | [https://www.efecte.com/ms-teams-integration](https://www.efecte.com/ms-teams-integration) |
| Quel est l’environnement d’hébergement ou le modèle de service utilisé pour exécuter votre application ? | Paas |
| Quels fournisseurs de cloud d’hébergement l’application utilise-t-elle ? | Azure, Other |
...
Ces informations ont été fournies par Efecte Oyj sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| URL de la politique de confidentialité | https://www.efecte.com/privacy-policy |
