---
title: Informations sur les applications pour Teams Manager par Solutions2Share GmbH
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/27/2021
...
description: Toutes les informations de sécurité et de conformité disponibles pour Teams Manager, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
<p>Dernière mise à jour par le développeur : 24 septembre 2021</p>

* <a href="https://teams.microsoft.com/l/app/87000000-3db9-bb44-5015-0b4a327a6597" target="_blank">Afficher dans Teams magasin</a>
...
| Site web de la société | [https://teams-manager.com](https://teams-manager.com) |
...
| Fonctionnalités principales de l’application | Créez des Teams basés sur des modèles complexes et personnalisables avec flux de travail d’approbation. Teams Manager permet aux entreprises de garder le contrôle sur leurs Microsoft Teams et de mettre fin à une croissance incontrôlée avec des fonctionnalités de gouvernance, tout en permettant aux utilisateurs de créer de nouvelles Teams. |
...
Ces informations ont été fournies par Solutions2Share GmbH sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Group.ReadWrite.All | les deux | Nous stockons tenantID et TeamId pour mapper les modèles.  | [b9a1aaab-e8aa-4b92-b4ce-f13cae74caa7](../azure/b9a1aaab-e8aa-4b92-b4ce-f13cae74caa7.md) |
>| Notes.ReadWrite.All | application | Aucune | [b9a1aaab-e8aa-4b92-b4ce-f13cae74caa7](../azure/b9a1aaab-e8aa-4b92-b4ce-f13cae74caa7.md) |
>| User.Read | Délégué | Aucune | [b9a1aaab-e8aa-4b92-b4ce-f13cae74caa7](../azure/b9a1aaab-e8aa-4b92-b4ce-f13cae74caa7.md) |
>| User.Read.All | les deux | Nous enregistrons l’ID de l’utilisateur entré dans la section approbateur/administrateur. | [b9a1aaab-e8aa-4b92-b4ce-f13cae74caa7](../azure/b9a1aaab-e8aa-4b92-b4ce-f13cae74caa7.md) |
>| User.ReadBasic.All | Délégué | Aucun | [b9a1aaab-e8aa-4b92-b4ce-f13cae74caa7](../azure/b9a1aaab-e8aa-4b92-b4ce-f13cae74caa7.md) |
