---
title: Informations sur l’application pour Klett par Klett Verlag
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/11/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour Klett, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le Registre CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/e52ef0da-a602-479b-8ac4-f3e0398009e6" target="_blank">Afficher dans Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003716" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies à Microsoft par Le journal de klett Delag à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | Klett |
| ID | WA200003716 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | Ernst Klett Verlag GmbH |
| Site web de l’entreprise | [https://www.klett.de/index/](https://www.klett.de/index/) |
| Conditions d’utilisation de l’application | [https://www.klett.de/inhalt/rechtliches/nutzungsbedingungen...](https://www.klett.de/inhalt/rechtliches/nutzungsbedingungen-fuer-digitale-inhalte-und-online-services/6931) |
| Fonctionnalités principales de l’application | Bequemer Zugriff auf die digitalen Produkte passend zum Digitbuch |
| Emplacement du siège social de l’entreprise | Allemagne |
| Page d’informations sur l’application | [https://www.klett.de/inhalt/217167](https://www.klett.de/inhalt/217167) |
...
Ces informations ont été fournies par L’architecte Klett VerlagD sur la façon dont cette application collecte et stocke les données organisationnelles, ainsi que sur le contrôle que votre organisation aura sur les données collectées par l’application.
...
| URL de la politique de confidentialité | https://www.klett.de/datenschutz |
