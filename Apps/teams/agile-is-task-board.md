...
description: Toutes les informations de sécurité et de conformité disponibles pour agile Task Board, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
<p>Dernière mise à jour par le développeur : 8 avril 2022</p>

* <a href="https://teams.microsoft.com/l/app/6021779f-643c-48c0-9f80-8e41ea801be7" target="_blank">Afficher dans Teams magasin</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002162" target="_blank">Afficher dans AppSource</a>
...
| Site web de la société | [https://www.agile-is.de](https://www.agile-is.de) |
| Conditions d’utilisation de l’application | [https://www.agile-is.de/en/termsofuse](https://www.agile-is.de/en/termsofuse) |
| Fonctionnalités principales de l’application | Le Tableau des tâches agiles vous aide, vous et votre équipe, à obtenir une meilleure vue d’ensemble de votre projet agile. Convertissez votre carte physique en version numérique. Vous pouvez mapper votre processus avec des fonctionnalités telles que des colonnes pour l’affichage de l’état, un nombre quelconque de couloirs, une coloration basée sur les métadonnées des cartes, l’attribution de responsabilités, la modification par glisser-déplacer et de nombreux autres paramètres. Toutes vos données resteront dans votre locataire M365. |
| Emplacement du siège social de la société | Allemagne |
| Page d’informations sur l’application | [https://www.agile-is.de/en/agiletaskboard](https://www.agile-is.de/en/agiletaskboard) |
...
| Quelles données sont stockées dans vos bases de données ? | zur Lizenzverwaltung de l’UPN; Unternehmensdaten zur Rechnungslegung |
...
| URL de la politique de confidentialité | https://www.agile-is.de/en/telemetry |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| AppCatalog.Read.All | Délégué | Permet à l’application d’interroger la version d’application actuellement installée. Utilisé pour fournir les ressources d’application appropriées. | [ed6cb2ac-21e8-4e9c-a917-6a2d5f03e3a5](../azure/ed6cb2ac-21e8-4e9c-a917-6a2d5f03e3a5.md) |
>| GroupMember.Read.All | Délégué | Lire les membres du groupe pour affecter les tâches du planificateur  | [ed6cb2ac-21e8-4e9c-a917-6a2d5f03e3a5](../azure/ed6cb2ac-21e8-4e9c-a917-6a2d5f03e3a5.md) |
>| Tasks.ReadWrite | Délégué | Utiliser les plans et les tâches du planificateur   | [ed6cb2ac-21e8-4e9c-a917-6a2d5f03e3a5](../azure/ed6cb2ac-21e8-4e9c-a917-6a2d5f03e3a5.md) |
>| TeamsActivity.Send | Délégué | Envoyer des messages à l’activité teams | [ed6cb2ac-21e8-4e9c-a917-6a2d5f03e3a5](../azure/ed6cb2ac-21e8-4e9c-a917-6a2d5f03e3a5.md) |
>| TeamsAppInstallation.ReadForTeam | Délégué | Permet à l’application d’interroger la version d’application actuellement installée. Utilisé pour fournir les ressources d’application appropriées. | [ed6cb2ac-21e8-4e9c-a917-6a2d5f03e3a5](../azure/ed6cb2ac-21e8-4e9c-a917-6a2d5f03e3a5.md) |
>| User.Read | Délégué | Permet à l’utilisateur de se connecter et de lire les informations de profil de base | [ed6cb2ac-21e8-4e9c-a917-6a2d5f03e3a5](../azure/ed6cb2ac-21e8-4e9c-a917-6a2d5f03e3a5.md) |
>| User.ReadBasic.All | Délégué | Permet à l’utilisateur de lire les informations de profil de base d’autres utilisateurs | [ed6cb2ac-21e8-4e9c-a917-6a2d5f03e3a5](../azure/ed6cb2ac-21e8-4e9c-a917-6a2d5f03e3a5.md) |
