---
title: Informations d’application pour Pandos par Pandos Intelligence Inc
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/05/2022
...
Informations fournies par Pandos Intelligence Inc à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | Pandos |
| ID | WA200003534 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | Pandos Intelligence Inc |
| Site web de la société | [https://pandos.io](https://pandos.io) |
| Conditions d’utilisation de l’application | [https://app.pandos.io/terms-of-use](https://app.pandos.io/terms-of-use) |
| Fonctionnalités principales de l’application | Pandos est une plateforme d’apprentissage et de développement unique pour les responsables d’équipe et de personnes, les chefs de projet, les formateurs et les formateurs éducatifs. Il prend en charge des fonctionnalités fondamentales telles que la formation d’équipe basée sur des critères (notamment la disponibilité, la personnalité, les compétences ou tout critère personnalisé), la gestion des tâches d’équipe et l’évaluation par les pairs. La plateforme génère automatiquement un profil pour les compétences logicielles des membres, vérifié par les pairs.  |
| Emplacement du siège social de la société | Canada |
| Page d’informations sur l’application | [https://pandos.io](https://pandos.io) |
...
Ces informations ont été fournies par Pandos Intelligence Inc. sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
