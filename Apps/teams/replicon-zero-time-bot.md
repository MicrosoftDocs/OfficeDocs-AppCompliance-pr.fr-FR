---
title: Informations sur l’application pour Zero Time Bot by Replicon
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/06/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour Zero Time Bot, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
ms.locfileid: "65269930"
---
# <a name="zero-time-bot"></a>Zero Time Bot

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Dernière mise à jour par le développeur : 8 décembre 2021</p>

* <a href="https://teams.microsoft.com/l/app/4db812e1-4d29-44e4-b72e-9654c0c91ce4" target="_blank">Afficher dans Teams magasin</a>
...
Informations fournies par Replicon à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | Zero Time Bot |
| ID | WA200003717 |
...
Ces informations ont été fournies par Replicon sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont traitées par votre application ? | Données de profil utilisateur, données de temps |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read.All | application | obtenir l’e-mail de l’utilisateur et le mapper à l’utilisateur dans le système de Replicon pour envoyer des messages de conversation à l’application de Replicon | [4db812e1-4d29-44e4-b72e-9654c0c91ce4](../azure/4db812e1-4d29-44e4-b72e-9654c0c91ce4.md) |
