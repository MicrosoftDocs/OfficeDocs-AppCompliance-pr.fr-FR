---
title: Informations d’application pour Optmyzr par Optmyzr
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 10/26/2021
...
description: Toutes les informations de sécurité et de conformité disponibles pour Optmyzr, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le Registre CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/a8aefb12-8635-4f30-9759-e889fee14d28" target="_blank">Afficher dans Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003395" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Optmyzr à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | Optmyzr |
| ID | WA200003395 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | Optmyzr |
| Site web de l’entreprise | [https://www.optmyzr.com](https://www.optmyzr.com) |
| Conditions d’utilisation de l’application | [https://www.optmyzr.com/information/terms-of-use/](https://www.optmyzr.com/information/terms-of-use/) |
| Fonctionnalités principales de l’application | https://www.optmyzr.com/information/terms-of-use/ |
| Emplacement du siège social de l’entreprise | États-Unis d’Amérique |
| Page d’informations sur l’application | [https://www.optmyzr.com/capabilities/reporting/](https://www.optmyzr.com/capabilities/reporting/) |
...
Ces informations ont été fournies par Optmyzr sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont stockées dans vos bases de données ? | Profil utilisateur : adresse de messagerie utilisée comme identificateur |
...
| URL de la politique de confidentialité | https://www.optmyzr.com/information/privacy-policy/ |
