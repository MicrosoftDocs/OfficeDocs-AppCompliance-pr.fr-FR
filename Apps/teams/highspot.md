---
title: Informations d’application pour Highspot par Highspot
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/14/2021
...
* <a href="https://teams.microsoft.com/l/app/55b7c78e-4768-47e0-97be-e6b953e6a0d0" target="_blank">Afficher dans Teams magasin</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002894" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Highspot à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | Highspot |
| ID | WA200002894 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | Highspot |
| Site web de la société | [https://www.highspot.com](https://www.highspot.com) |
| Conditions d’utilisation de l’application | [https://www.highspot.com/terms/](https://www.highspot.com/terms/) |
| Fonctionnalités principales de l’application | Highspot est la plateforme d’activation des ventes que les représentants aiment. Nous donnons aux entreprises les moyens d’élever les conversations des clients qui favorisent la croissance stratégique. Notre plateforme intuitive combine une gestion intelligente du contenu, une formation, des conseils contextuels, un engagement client et une analytique actionnable. Les équipes de commercialisation utilisent Highspot pour offrir une expérience d’achat unifiée qui augmente le chiffre d’affaires, la satisfaction des clients et la rétention. |
| Emplacement du siège social de la société | États-Unis d’Amérique |
| Page d’informations sur l’application | [https://www.highspot.com/overview/](https://www.highspot.com/overview/) |
...
Ces informations ont été fournies par Highspot sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Date de certification SOC2 la plus récente | 2020-08-20 |
