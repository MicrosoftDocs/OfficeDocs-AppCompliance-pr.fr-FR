...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | délégué | adresse e-mail et ID des utilisateurs.  Il est utilisé pour ma cartographier l’utilisateur sur l’ID utilisateur de WorkBoard | [User.Read](https://docs.microsoft.com/microsoft-365-app-certification/azure/User.Read) |
