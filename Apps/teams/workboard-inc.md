---
title: Informations d’application pour Workboard par Workboard Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/21/2021
...
| Site web de la société | [https://www.workboard.com](https://www.workboard.com) |
...
| Fonctionnalités principales de l’application | Alignez les priorités stratégiques au sein de l’organisation et localisez les objectifs et les résultats clés (OKR) aux équipes et aux individus interfonctionnels. Graphiquez, calculez et partagez la progression des résultats clés et des métriques de réussite.  |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Délégué | adresse e-mail et ID des utilisateurs.  Il est utilisé pour mapper l’utilisateur à l’ID d’utilisateur de WorkBoard | [](../azure/.md) |
