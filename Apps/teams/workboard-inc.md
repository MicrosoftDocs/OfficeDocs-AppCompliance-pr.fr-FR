...
| Site web de l’entreprise | [https://www.workboard.com](https://www.workboard.com) |
| Conditions d’utilisation de l’application | [https://www.workboard.com/license/terms_of_use_v1.php](https://www.workboard.com/license/terms_of_use_v1.php) |
| Fonctionnalités principales de l’application | Aligner les priorités stratégiques au travers de l’organisation et localiser les objectifs et les résultats clés (OKR) aux équipes et aux individus multifonctionnels. Graphiquez, calculez et partagez l’avancement sur les résultats clés et les mesures de réussite.  |
| Emplacement du siège social de l’entreprise | États-Unis d’Amérique |
| Page d’informations sur l’application | [https://www.workboard.com/microsoft/](https://www.workboard.com/microsoft/) |
...
| Date de certification SOC1 la plus récente |  2020-07-31 |
...
| Date de certification SOC2 la plus récente |  2020-10-30 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | délégué | adresse e-mail et ID des utilisateurs.  Il est utilisé pour ma cartographier l’utilisateur sur l’ID utilisateur de WorkBoard | [User.Read](../azure/User.Read.md) |
