---
title: Informations d’application pour Svava pour les réunions par Svava
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 11/17/2021
...
description: Toutes les informations de sécurité et de conformité disponibles pour Svava for Meetings, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le Registre CSA STAR.
...
ms.locfileid: "63545882"
---
# <a name="svava-for-meetings"></a>Svava pour les réunions

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Last updated by the developer on: November 16, 2021</p>

* <a href="https://teams.microsoft.com/l/app/6291175d-3832-4c33-baea-10eb4b9ff1c4" target="_blank">Afficher dans Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001723" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Svava à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | Svava pour les réunions |
| ID | WA200001723 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | Svava |
| Site web de l’entreprise | [https://svava.io](https://svava.io) |
| Conditions d’utilisation de l’application | [https://svava.io/legal/terms-of-service/](https://svava.io/legal/terms-of-service/) |
| Fonctionnalités principales de l’application | Vos réunions sont plus attrayantes et plus efficaces. |
| Emplacement du siège social de l’entreprise | Suède |
| Page d’informations sur l’application | [https://svava.io](https://svava.io) |
...
Ces informations ont été fournies par Svava sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| URL de la politique de confidentialité | https://svava.io/legal/privacy-policy |
