...
description: Toutes les informations de sécurité et de conformité disponibles pour Presentations AI, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
---
# <a name="presentations-ai"></a>Présentations IA

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Dernière mise à jour par le développeur : 17 août 2021</p>

* <a href="https://teams.microsoft.com/l/app/1f510555-b518-4084-84e0-18c7bebc807c" target="_blank">Afficher dans Teams magasin</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001352" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par les technologies Infographfx à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | Présentations IA |
| ID | WA200001352 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | Technologies Infographfx |
| Site web de la société | [https://presentations.ai](https://presentations.ai) |
| Conditions d’utilisation de l’application | [https://presentations.ai/terms_teams.html](https://presentations.ai/terms_teams.html) |
| Fonctionnalités principales de l’application | Presentations.AI est un outil intelligent avec les meilleures pratiques de conception pour créer des présentations étonnantes. |
...
Ces informations ont été fournies par les technologies Infographfx sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
