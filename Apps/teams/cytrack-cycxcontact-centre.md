---
title: Informations sur l’application pour le centre de contacts CyCX par CyTrack
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/01/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour le Centre de contacts CyCX, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
ms.locfileid: "66656167"
---
# <a name="cycx--contact-centre"></a>Centre de contacts CyCX

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Dernière mise à jour par le développeur : 27 mai 2022</p>

* <a href="https://teams.microsoft.com/l/app/4d7b80a9-d64d-4b54-a1db-259cc204b15d" target="_blank">Afficher dans le magasin Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004350" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par CyTrack à Microsoft :

| **Information** | **Réponse** |
|:----------------|:-------------|
| Nom de l'application | Centre de contacts CyCX |
| ID | WA200004350 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | CyTrack |
| Site web de la société | [https://web.cytrack.com](https://web.cytrack.com) |
| Conditions d’utilisation de l’application | [https://web.cytrack.com/subscription-service-software-agree...](https://web.cytrack.com/subscription-service-software-agreement/) |
| Fonctionnalités principales de l’application | CyCX s’adresse aux utilisateurs professionnels qui ont besoin d’améliorer l’expérience client en matière d’appels vocaux et de fonctionnalités de centre de contacts au-delà des réunions, des conversations et de la collaboration.  CyCX est une plateforme de communication et de collaboration pour Microsoft Teams.  Rencontrez vos clients sur le canal de leur choix dans Microsoft Teams, CyTrack CyCX offre à vos agents une interface unifiée unique avec une vue holistique des clients pour permettre des interactions plus approfondies. |
| Emplacement du siège social de la société | Australie |
| Page d’informations sur l’application | [https://web.cytrack.com/microsoft-teams/contact-centre-for-...](https://web.cytrack.com/microsoft-teams/contact-centre-for-microsoft-teams/) |
...
Ces informations ont été fournies par CyTrack sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont traitées par votre application ? | Données d’appel Teams |
| L’application prend-elle en charge TLS 1.1 ou version ultérieure ? | Oui |
| L’application ou l’infrastructure sous-jacente stocke-t-elle des données client Microsoft ? | Oui |
| Quelles données sont stockées dans vos bases de données ? | Données d’appel Teams |
| Si l’infastructure sous-jacente traite ou stocke les données client Microsoft, où ces données sont-elles stockées géographiquement ? | Australie, Nouvelle-Zélande, Royaume-Uni de Grande-Bretagne et Irlande du Nord (le) |
...
| URL de la politique de confidentialité | https://web.cytrack.com/privacy-policy-teams/ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| AppRoleAssignment.ReadWrite.All | Délégué | Nous en avons besoin pour créer servicePrincipal afin d’accorder des autorisations d’API dans l’application Azure AD dans le locataire des clients | [acafd8f7-a6d3-420e-89d7-7729751b7c04](../azure/acafd8f7-a6d3-420e-89d7-7729751b7c04.md) |
>| Application.ReadWrite.All | Délégué | Nous avons besoin de cette autorisation pour créer une application Azure AD dans le locataire des clients que nous utilisons pour nous abonner aux services de notification de modification afin d’obtenir les métadonnées liées aux appels d’équipes. | [acafd8f7-a6d3-420e-89d7-7729751b7c04](../azure/acafd8f7-a6d3-420e-89d7-7729751b7c04.md) |
