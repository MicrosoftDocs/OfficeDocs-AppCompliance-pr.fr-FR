---
title: Informations sur les applications pour AuditBoard par AuditBoard
ms.author: elmalova
author: elenamalova
ms.date: 01/10/2022
ms.topic: article
...
description: Toutes les informations de sécurité et de conformité disponibles pour AuditBoard, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le Registre CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/c37d6bf9-d665-4119-b4e4-c641ee74fe09" target="_blank">Afficher dans Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003600" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par AuditBoard à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | AuditBoard |
| ID | WA200003600 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | AuditBoard |
| Site web de l’entreprise | [https://www.auditboard.com](https://www.auditboard.com) |
| Conditions d’utilisation de l’application | [https://www.auditboard.com/terms-of-use/](https://www.auditboard.com/terms-of-use/) |
| Fonctionnalités principales de l’application | Permet aux abonnés AuditBoard de recevoir des notifications dans Microsoft Teams. |
...
Ces informations ont été fournies par AuditBoard sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Date de certification SOC2 la plus récente |  2021-11-04 |
...
| URL de la politique de confidentialité | https://www.auditboard.com/privacy-policy/ |
