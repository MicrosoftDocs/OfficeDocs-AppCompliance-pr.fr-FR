---
title: Informations sur l’application pour Wanda by Unit4 Business Software
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/15/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour Wanda, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/73642721-0f64-4d3a-ab6c-2c1fe053aa80" target="_blank">Afficher dans Teams magasin</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004038" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Unit4 Business Software à Microsoft :

| **Information** | **Réponse** |
|:----------------|:-------------|
| Nom de l'application | Wanda |
| ID | WA200004038 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | Unit4 Business Software |
| Site web de la société | [https://www.unit4.com](https://www.unit4.com) |
| Conditions d’utilisation de l’application | [https://www.unit4.com/terms-and-conditions](https://www.unit4.com/terms-and-conditions) |
| Fonctionnalités principales de l’application | Wanda vous aide à prendre en charge vos tâches ERP les plus courantes. |
| Emplacement du siège social de la société | Pays-Bas (le) |
| Page d’informations sur l’application | [https://get-wanda-help.u4pp.com](https://get-wanda-help.u4pp.com) |
...
Ces informations ont été fournies par Unit4 Business Software sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont traitées par votre application ? | ID d’utilisateur Microsoft Teams spécifique au bot |
| L’application prend-elle en charge TLS 1.1 ou version ultérieure ? | Oui |
| L’application ou l’infrastructure sous-jacente stocke-t-elle des données client Microsoft ? | Oui |
| Quelles données sont stockées dans vos bases de données ? | ID d’utilisateur Microsoft Teams spécifique au bot |
...
| Date de certification SOC1 la plus récente | 2021-11-05 |
...
| Date de certification SOC2 la plus récente | 2021-11-23 |
...
| URL de la politique de confidentialité | https://info.unit4.com/rs/400-HYB-295/images/Unit4-People-Platform-Service-Description-v.1.1-September-2021-%28EN%29-%281%29.pdf |
