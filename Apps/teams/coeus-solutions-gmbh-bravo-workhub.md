---
title: Informations sur l’application POUR WORKHUB PAR Coeus Solutions
ms.author: elmalova
author: elenamalova
ms.date: 02/07/2022
ms.topic: article
...
description: Toutes les informations de sécurité et de conformité disponibles pour WORKHub, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le Registre CSA STAR.
...
ms.locfileid: "62449882"
---
# <a name="bravo-workhub"></a>BRAVO Workhub

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Last updated by the developer on: December 3, 2021</p>

* <a href="https://teams.microsoft.com/l/app/53ab3c45-3531-47a8-b524-fe8b5fd539ef" target="_blank">Afficher dans Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003694" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Coeus Solutions Eth à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | BRAVO Workhub |
| ID | WA200003694 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | Coeus Solutions GmbH |
| Site web de l’entreprise | [https://getbravo.io](https://getbravo.io) |
| Conditions d’utilisation de l’application | [https://getbravo.io/terms-and-conditions](https://getbravo.io/terms-and-conditions) |
| Fonctionnalités principales de l’application | Donnez facilement des avantages d’égal à égal avec Microsoft Teams’intégration à LASV. |
...
Ces informations ont été fournies par Coeus Solutions StoresH sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont stockées dans vos bases de données ? | Nous stockons Microsoft Teams’ID d’utilisateur et d’équipe dans notre base de données. |
...
| URL de la politique de confidentialité | https://getbravo.io/privacy-policy |
