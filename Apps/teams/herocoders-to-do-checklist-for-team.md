---
title: Liste de vérification des informations d’application pour les tâches à effectuer pour l’équipe par HeroCoders
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/05/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour la liste de vérification des tâches pour l’équipe, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
ms.locfileid: "66655968"
---
# <a name="to-do-checklist-for-team"></a>Liste de vérification des tâches pour l’équipe

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Dernière mise à jour par le développeur : 16 juin 2022</p>

* <a href="https://teams.microsoft.com/l/app/b08b0225-1f4b-4e82-879e-d4ef15b5bbda" target="_blank">Afficher dans le magasin Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004362" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par HeroCoders à Microsoft :

| **Information** | **Réponse** |
|:----------------|:-------------|
| Nom de l'application | Liste de vérification des tâches pour l’équipe |
| ID | WA200004362 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | HeroCoders |
| Site web de la société | [https://herocoders.com](https://herocoders.com) |
| Conditions d’utilisation de l’application | [https://herocoders.com/legal/checklist-for-team#EULA](https://herocoders.com/legal/checklist-for-team#EULA) |
| Fonctionnalités principales de l’application | Liste de vérification avancée pour les équipes de toutes tailles. |
| Emplacement du siège social de la société | Pologne |
| Page d’informations sur l’application | [https://herocoders.com](https://herocoders.com) |
...
Ces informations ont été fournies par HeroCoders sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont traitées par votre application ? | ID Azure AD |
| L’application prend-elle en charge TLS 1.1 ou version ultérieure ? | Oui |
| L’application ou l’infrastructure sous-jacente stocke-t-elle des données client Microsoft ? | Oui |
| Quelles données sont stockées dans vos bases de données ? | ID Azure AD |
...
| URL de la politique de confidentialité | https://herocoders.com/legal/checklist-for-team#Privacy-policy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| email | Délégué | Pour utiliser l’authentification unique Sign-On (SSO) | [777d9a9f-feef-48dd-b62d-562ff21aeda2](../azure/777d9a9f-feef-48dd-b62d-562ff21aeda2.md) |
>| offline_access | Délégué | Pour pouvoir afficher les informations relatives à un élément de liste de vérification à d’autres utilisateurs pendant que l’utilisateur n’est pas connecté. | [777d9a9f-feef-48dd-b62d-562ff21aeda2](../azure/777d9a9f-feef-48dd-b62d-562ff21aeda2.md) |
>| openid | Délégué | Pour connecter des utilisateurs avec leur compte Azure Ad | [777d9a9f-feef-48dd-b62d-562ff21aeda2](../azure/777d9a9f-feef-48dd-b62d-562ff21aeda2.md) |
>| profil | Délégué | Pour afficher le nom de l’utilisateur dans l’historique de la liste de vérification. | [777d9a9f-feef-48dd-b62d-562ff21aeda2](../azure/777d9a9f-feef-48dd-b62d-562ff21aeda2.md) |
