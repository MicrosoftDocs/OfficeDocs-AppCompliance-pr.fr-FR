---
title: Informations sur l’application pour Bigger Brains eLearning par Biggerbrains
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: Toutes les informations de sécurité et de conformité disponibles pour Bigger Brains eLearning, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/12345514-afee-abcd-acde-c5b34109abcd" target="_blank">Afficher dans Teams magasin</a>
...
| Site web de la société | [https://getbiggerbrains.com](https://getbiggerbrains.com) |
| Conditions d’utilisation de l’application | [https://getbiggerbrains.com/privacy-legal/](https://getbiggerbrains.com/privacy-legal/) |
| Fonctionnalités principales de l’application | Notre bibliothèque primée de cours de formation en ligne est maintenant disponible directement dans Microsoft Teams.  Accédez facilement à plus de 180 cours eLearning et à plus de 3 000 leçons vidéo en ajoutant un onglet Cerveaux plus grands dans n’importe quel canal. Les rubriques disponibles sont les suivantes : Microsoft Teams &amp; Office 365Microsoft Excel, Word, Outlook, PowerPoint, Power BI et Rubriques métier. |
| Emplacement du siège social de la société | États-Unis d’Amérique |
| Page d’informations sur l’application | [https://usedapplicensing001.azurewebsites.net/teamsApp/inde...](https://usedapplicensing001.azurewebsites.net/teamsApp/index.html) |
