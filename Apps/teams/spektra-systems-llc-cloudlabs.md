---
title: Informations sur les applications pour CloudLabs par Spektra Systems LLC
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 10/18/2021
...
description: Toutes les informations de sécurité et de conformité disponibles pour CloudLabs, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
ms.locfileid: "64879171"
---
# <a name="cloudlabs"></a>CloudLabs

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Dernière mise à jour par le développeur : 14 octobre 2021</p>

* <a href="https://teams.microsoft.com/l/app/ec483835-4185-4229-a976-32a20138ff9d" target="_blank">Afficher dans Teams magasin</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003273" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Spektra Systems LLC à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | CloudLabs |
| ID | WA200003273 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | Spektra Systems LLC |
| Site web de la société | [https://cloudlabs.ai](https://cloudlabs.ai) |
| Conditions d’utilisation de l’application | [https://cloudlabs.ai/terms-of-use/](https://cloudlabs.ai/terms-of-use/) |
| Fonctionnalités principales de l’application | Préparer les certifications des principes de base du cloud Microsoft en effectuant des tests de pratiques CloudLabs |
| Emplacement du siège social de la société | États-Unis d’Amérique |
| Page d’informations sur l’application | [https://cloudlabs.ai/cloudlabs-teams-app](https://cloudlabs.ai/cloudlabs-teams-app) |
...
Ces informations ont été fournies par Spektra Systems LLC sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Répertorier les types de stratégies prises en charge | Toutes les stratégies d’autorité de certification pour les applications cloud |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Délégué | Nom, e-mail, - Pour être en mesure de fournir une expérience et un support personnalisés | [539ffd4e-15ba-4d18-b136-0d73b67d05f0](../azure/539ffd4e-15ba-4d18-b136-0d73b67d05f0.md) |
