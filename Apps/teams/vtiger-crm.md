---
title: Informations d’application pour Vtiger CRM par Vtiger
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: Toutes les informations de sécurité et de conformité disponibles pour Vtiger CRM, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/08cb9b41-2ceb-4fe1-b85b-6eb6128aa138" target="_blank">Afficher dans Teams magasin</a>
...
Informations fournies par Vtiger à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | Vtiger CRM |
| ID | WA200003089 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | Vtiger |
| Site web de la société | [https://www.vtiger.com](https://www.vtiger.com) |
| Conditions d’utilisation de l’application | [https://www.vtiger.com/policy-legal-center/terms-of-service/](https://www.vtiger.com/policy-legal-center/terms-of-service/) |
| Fonctionnalités principales de l’application | Connecter Vtiger CRM pour afficher et partager les transactions, les cas, les tâches ou les contacts au sein de l’équipe. |
| Emplacement du siège social de la société | Inde |
| Page d’informations sur l’application | [https://help.vtiger.com/article/149601890-MS-Teams-and-Vtig...](https://help.vtiger.com/article/149601890-MS-Teams-and-Vtiger-CRM-Integration) |
...
Vtiger a fourni ces informations sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Répertorier les types de stratégies prises en charge | Restriction basée sur l’adresse IP. Contrôle d’accès aux données à l’aide de rôles et de profils. |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | application | L’adresse e-mail est obtenue pour vérifier par rapport à AuthToken. | [7a483472-4f1b-4c75-bff3-7a48dae227dc](../azure/7a483472-4f1b-4c75-bff3-7a48dae227dc.md) |
