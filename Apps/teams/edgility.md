---
title: Informations d’application pour Edgility par Edgility
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/14/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour Edgility, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/fe2f94eb-7164-4fcd-a2c7-16db90307caa" target="_blank">Afficher dans Teams magasin</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003970" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Edgility à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | Edgility |
| ID | WA200003970 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | Edgility |
| Site web de la société | [https://edgility.com.au](https://edgility.com.au) |
| Conditions d’utilisation de l’application | [https://www.edgility.com.au/legal/](https://www.edgility.com.au/legal/) |
| Fonctionnalités principales de l’application | Edgility est un leader dans le développement d’outils de communication d’entreprise intégrés. Ces solutions SMS permettent aux organisations de simplifier le processus de rappel, de promotion, d’alerte et de notification des personnes qui ont une importance pour leur entreprise, à l’aide des plateformes sur lesquelles elles s’appuient déjà. Il s’agit notamment des produits Microsoft tels que Excel, Outlook et Teams. Les utilisateurs peuvent tirer parti de cet outil conversationnel efficace en recevant des SMS dans Microsoft Outlook et Teams. |
| Emplacement du siège social de la société | Australie |
| Page d’informations sur l’application | [https://www.edgility.com.au/microsoft/teams/](https://www.edgility.com.au/microsoft/teams/) |
...
Ces informations ont été fournies par Edgility sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont traitées par votre application ? | Noms |
