---
title: Informations sur l’application pour Yeastar Workplace by Yeastar Information Technology
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/26/2022
...
Informations fournies par Yeastar Information Technology à Microsoft :

| **Information** | **Réponse** |
|:----------------|:-------------|
| Nom de l'application | Yeastar Workplace |
| ID | WA200004339 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | Yeastar Information Technology |
...
Ces informations ont été fournies par Yeastar Information Technology sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
