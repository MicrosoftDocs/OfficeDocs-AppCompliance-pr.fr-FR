---
title: Informations sur l’application pour Wurqi par Wurqi
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/01/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour Wurqi, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
<p>Dernière mise à jour par le développeur : 11 février 2022</p>

* <a href="https://teams.microsoft.com/l/app/5173558d-bfb0-40dd-b75c-3cfac117ce72" target="_blank">Afficher dans le magasin Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004161" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Wurqi à Microsoft :

| **Information** | **Réponse** |
|:----------------|:-------------|
| Nom de l'application | Wurqi |
| ID | WA200004161 |
| Clients Office 365 pris en charge | Microsoft Teams |
| Nom de la société partenaire | Wurqi |
| Site web de la société | [https://wurqi.com](https://wurqi.com) |
| Conditions d’utilisation de l’application | [https://wurqi.com/terms/](https://wurqi.com/terms/) |
| Fonctionnalités principales de l’application | Wurqi est une plateforme de gestion du travail qui intègre tout votre travail, vos projets et vos communications. L’application Teams fournit aux utilisateurs une page d’affichage uniquement qui affiche toutes les informations sur le projet sur lequel ils travaillent, ce qui permet à tous les utilisateurs de l’équipe de voir comment les choses progressent.  |
...
Wurqi a fourni ces informations sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Authentification multifacteur (MFA) activée pour : | DNSManagement, CodeRepositories |
...
| URL de la politique de confidentialité | https://wurqi.com/privacy-policy/ |
