...
| Site web de l’entreprise | [https://unscrambl.com](https://unscrambl.com) |
| Conditions d’utilisation de l’application | [https://qbo.ai/legal/#service](https://qbo.ai/legal/#service) |
| Fonctionnalités principales de l’application | qbo, optimisé par les informations Unscrambl qbo, effectue une conversation analytique à l’aide de la meilleure NLP de la classe. Les utilisateurs tapent une question et qbo surfaces les informations et visualisations les plus pertinentes en un clin d’œil. Les utilisateurs peuvent collaborer activement avec des collègues, prendre des décisions et capturer des résultats dans des tableaux prêts pour la présentation. qbo permet à tous les membres de l’organisation de prendre des décisions pilotées par les données. qbo se connecte directement à une plage de sources cloud ou locales et est accessible via un Microsoft Teams ou un navigateur. |
