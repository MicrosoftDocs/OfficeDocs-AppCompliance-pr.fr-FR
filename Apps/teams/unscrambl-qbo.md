---
title: Informations sur l’application pour qbo par Unscrambl
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 11/29/2021
...
* <a href="https://teams.microsoft.com/l/app/834c6939-152c-450b-a305-c65b4dd5d1c7" target="_blank">Afficher dans Teams magasin</a>
...
| Site web de la société | [https://unscrambl.com](https://unscrambl.com) |
| Conditions d’utilisation de l’application | [https://unscrambl.com/service-agreement](https://unscrambl.com/service-agreement) |
| Fonctionnalités principales de l’application | qbo, optimisé par Unscrambl qbo Insights, rend l’analytique conversationnelle à l’aide de la meilleure protection contre la perte de données dans la classe. Les utilisateurs tapent une question et qbo expose les insights et visualisations les plus pertinents en un clin d’œil. Les utilisateurs peuvent collaborer activement avec des collègues, prendre des décisions et capturer les résultats dans des tableaux prêts pour la présentation. qbo permet à tous les membres de l’organisation de prendre des décisions pilotées par les données. qbo se connecte directement à une plage de sources cloud ou locales et est accessible via Microsoft Teams ou un navigateur. |
| Emplacement du siège social de la société | États-Unis d’Amérique |
| Page d’informations sur l’application | [https://qbo.ai](https://qbo.ai) |
...
| Quelles données sont traitées par votre application ? | le nom et l’adresse e-mail sont utilisés pour la création de compte |
...
| URL de la politique de confidentialité | https://qbo.ai/legal/ |
