---
title: Informations sur l’application pour l’IA des incendies par Fireflies.ai
ms.author: elmalova
author: elenamalova
ms.date: 11/12/2021
ms.topic: article
...
description: Toutes les informations de sécurité et de conformité disponibles pour Fireflies AI, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le Registre CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/685d9120-feba-4cb0-934c-efcc69b85fc6" target="_blank">Afficher dans Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002618" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Fireflies.ai à Microsoft :

| **Information** | **Réponse** |
|:----------------|:-------------|
| Nom de l'application | Fireflies AI |
| ID | WA200002618 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | Fireflies.ai |
| Site web de l’entreprise | [https://fireflies.ai](https://fireflies.ai) |
| Conditions d’utilisation de l’application | [https://fireflies.ai/terms-of-service.pdf](https://fireflies.ai/terms-of-service.pdf) |
| Fonctionnalités principales de l’application | Fireflies est un assistant de réunion qui enregistre, transcrit et prend des notes de vos réunions.

 | | Emplacement géographique de la société | États-Unis d’Amérique | | Page d’informations sur l| | | Quel est l’environnement d’hébergement ou le modèle de service utilisé pour exécuter votre application ? | Paas | | Quels fournisseurs de cloud d’hébergement l’application utilise-t-elle ? | GCP |
...
Ces informations ont été fournies par Fireflies.ai sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont stockées dans vos bases de données ? | Données de profil utilisateur, métadonnées du calendrier utilisateur |
...
| Date de certification SOC2 la plus récente |  2021-08-18 |
...
| URL de la politique de confidentialité | https://fireflies.ai/privacy_policy.pdf |
