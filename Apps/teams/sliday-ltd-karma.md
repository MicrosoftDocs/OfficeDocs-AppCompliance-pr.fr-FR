...
| Site web de l’entreprise | [https://karmabot.chat/ms](https://karmabot.chat/ms) |
| Conditions d’utilisation de l’application | [https://karmabot.readme.io/docs/karma-end-user-license-agre...](https://karmabot.readme.io/docs/karma-end-user-license-agreement-eula) |
| Fonctionnalités principales de l’application | Liaison véritable pour les équipes distantes. |
| Emplacement du siège social de l’entreprise | Nouvelle-Zélande |
| Page d’informations sur l’application | [https://karmabot.chat/ms](https://karmabot.chat/ms) |
...
| Quelles données sont stockées dans vos bases de données ? | Adresse de messagerie, reconnaissances individuelles |
...
| URL de la politique de confidentialité | https://karmabot.readme.io/docs/privacy-policy-for-microsoft-teams |
