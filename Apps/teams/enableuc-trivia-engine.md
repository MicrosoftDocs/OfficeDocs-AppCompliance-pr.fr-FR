...
description: Toutes les informations de sécurité et de conformité disponibles pour Trivia Engine, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/3bd813fa-a19a-4c06-b130-450b24b8ee08" target="_blank">Afficher dans Teams magasin</a>
...
|:----------------|:-------------|
| Nom de l'application | Trivia Engine |
| ID | WA200003412 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | EnableUC |
| Site web de la société | [https://www.triviaengine.com](https://www.triviaengine.com) |
...
| Fonctionnalités principales de l’application | Améliorez la formation existante et améliorez la rétention des connaissances à l’aide de &#8220;&#8221; de gamification. |
| Emplacement du siège social de la société | Canada |
| Page d’informations sur l’application | [https://www.triviaengine.com](https://www.triviaengine.com) |
...
| Si votre application n’utilise pas l’une des bibliothèques ci-dessus, quelle bibliothèque ou bibliothèque d’authentification utilise-t-elle ? | N/A - La dernière version de MSAL est utilisée. |
