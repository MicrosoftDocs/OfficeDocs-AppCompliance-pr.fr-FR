---
title: Informations sur l’application pour le moteur Trivia par EnableUC
ms.author: elmalova
author: elenamalova
ms.date: 11/09/2021
ms.topic: article
...
description: Toutes les informations de sécurité et de conformité disponibles pour le moteur Trivia, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le Registre CSA STAR.
...
ms.locfileid: "60922957"
---
# <a name="trivia-engine"></a>Moteur Trivia

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Last updated by the developer on: October 1, 2021</p>

* <a href="https://teams.microsoft.com/l/app/3bd813fa-a19a-4c06-b130-450b24b8ee08" target="_blank">Afficher dans Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003412" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par EnableUC à Microsoft :

| **Information** | **Réponse** |
|:----------------|:-------------|
| Nom de l'application | Moteur Trivia |
| ID | WA200003412 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | EnableUC |
| Site web de l’entreprise | [https://www.triviaengine.com](https://www.triviaengine.com) |
| Conditions d’utilisation de l’application | [https://www.triviaengine.com/termsofuse.html](https://www.triviaengine.com/termsofuse.html) |
| Fonctionnalités principales de l’application | Améliorer la formation existante et améliorer la rétention des connaissances à l’aide &#8220;la&#8221;. |
...
Ces informations ont été fournies par EnableUC sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| **Information** | **Réponse** |
|:----------------|:-------------|
| Avez-vous des exigences en matière de confidentialité ou de protection des données ou d’autres obligations en matière de confidentialité ou de protection des données (telles que le CCPA) ? | Non |
