---
title: Informations d’application pour PostBeyond par PostBeyond
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: Toutes les informations de sécurité et de conformité disponibles pour PostBeyond, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
ms.locfileid: "64879281"
---
# <a name="postbeyond"></a>PostBeyond

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Dernière mise à jour par le développeur : 14 juin 2021</p>

* <a href="https://teams.microsoft.com/l/app/6e588f9e-5271-4583-b373-7991497deaec" target="_blank">Afficher dans Teams magasin</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002658" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par PostBeyond à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | PostBeyond |
| ID | WA200002658 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | PostBeyond |
| Site web de la société | [https://www.postbeyond.com](https://www.postbeyond.com) |
| Conditions d’utilisation de l’application | [https://www.postbeyond.com/terms-of-use/](https://www.postbeyond.com/terms-of-use/) |
| Fonctionnalités principales de l’application | Activez vos défenseurs des médias sociaux pour améliorer la visibilité de la marque, l’engagement et les résultats mesurables grâce à la défense des intérêts des employés par PostBeyond. Amplifier votre meilleur contenu sur les réseaux sociaux de vos employés, en accordant à votre marque l’attention qu’elle mérite. Nous rendons la mise à l’échelle de la défense des employés puissante pour les marketeurs et délicieusement facile pour les employés.  |
| Emplacement du siège social de la société | Canada |
| Page d’informations sur l’application | [https://www.postbeyond.com/product/](https://www.postbeyond.com/product/) |
...
Ces informations ont été fournies par PostBeyond sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
