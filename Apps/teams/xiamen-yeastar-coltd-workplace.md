---
title: Informations sur l’application pour Yeastar Workplace par Xiamen Yeastar Co.,Ltd
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/30/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour Yeastar Workplace, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
ms.locfileid: "66655979"
---
# <a name="yeastar-workplace"></a>Espace de travail yeastar

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Dernière mise à jour par le développeur : 21 juin 2022</p>

* <a href="https://teams.microsoft.com/l/app/8a2a6bf3-b7ad-403a-bdf4-68855ed22024" target="_blank">Afficher dans le magasin Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004339" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Xiamen Yeastar Co.,Ltd à Microsoft :

| **Information** | **Réponse** |
|:----------------|:-------------|
| Nom de l'application | Espace de travail yeastar |
| ID | WA200004339 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | Xiamen Yeastar Co.,Ltd |
| Site web de la société | [https://www.yeastar.com](https://www.yeastar.com) |
| Conditions d’utilisation de l’application | [https://www.yeastar.com/yeastar-workplace-terms-of-service/](https://www.yeastar.com/yeastar-workplace-terms-of-service/) |
| Fonctionnalités principales de l’application | Recherchez et réservez facilement des salles de réunion dans Microsoft Teams. |
| Emplacement du siège social de la société | Chine |
| Page d’informations sur l’application | [https://www.yeastar.com/yeastar-workplace/meeting-room-book...](https://www.yeastar.com/yeastar-workplace/meeting-room-booking) |
| Quel est l’environnement d’hébergement ou le modèle de service utilisé pour exécuter votre application ? | Iaas |
| Quels fournisseurs de cloud d’hébergement l’application utilise-t-elle ? | AlibabaCloud, GCP, Aws |
...
Ces informations ont été fournies par Xiamen Yeastar Co.,Ltd sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont traitées par votre application ? | Connexion utilisateur et réservations de réunions |
| L’application prend-elle en charge TLS 1.1 ou version ultérieure ? | Oui |
| L’application ou l’infrastructure sous-jacente stocke-t-elle des données client Microsoft ? | Oui |
| Quelles données sont stockées dans vos bases de données ? | Connexion utilisateur et réservations de réunions |
...
| URL de la politique de confidentialité | https://www.yeastar.com/yeastar-workplace-privacy-policy/ |
