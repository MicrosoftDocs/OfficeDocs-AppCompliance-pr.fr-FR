---
title: Informations d’application pour FormMachines par Enterprise machines numériques
ms.author: elmalova
author: elenamalova
ms.date: 11/03/2020
ms.topic: article
...
description: Toutes les informations disponibles sur la sécurité et la conformité pour FormMachines, ses politiques de traitement des données, ses informations sur le catalogue d’applications Microsoft Cloud App Security et les informations de sécurité et de conformité dans le registre STAR de l’ASC.
...
* <a href="https://teams.microsoft.com/l/app/54d8b826-3e30-4589-a77a-ed99cfbbb4c9" target="_blank">Vue dans Teams magasin</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001217" target="_blank">Voir dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Enterprise machines numériques à Microsoft :
...
| Nom de l’entreprise partenaire | Entreprise d’ordinateurs numériques |
...
Ces informations ont été fournies par Enterprise Digital Machines sur la façon dont cette application recueille et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
