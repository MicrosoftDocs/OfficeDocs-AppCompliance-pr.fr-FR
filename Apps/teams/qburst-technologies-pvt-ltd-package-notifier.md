---
title: Informations d’application pour les déclarants de colis par QBURST TECHNOLOGIES PVT LTD
ms.author: elmalova
author: elenamalova
ms.date: 03/25/2021
ms.topic: article
...
description: Toutes les informations disponibles sur la sécurité et la conformité pour package notifier, ses politiques de traitement des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité et de conformité dans le registre STAR de l’ASC.
...
<p>Dernière mise à jour par le développeur le: Mars 25, 2021</p>

* <a href="https://teams.microsoft.com/l/app/74d74206-0183-401d-932e-315f5021fdb1" target="_blank">Vue dans Teams magasin</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002737" target="_blank">Voir dans AppSource</a>
...
| Nom de l’entreprise partenaire | QBURST TECHNOLOGIES PVT LTD |
| URL du site web partenaire | [https://package-notifier.qburst.in](https://package-notifier.qburst.in) |
...
Ces informations ont été fournies par QBURST TECHNOLOGIES PVT LTD sur la façon dont cette application recueille et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
>|:-------------------|:-------------------|:--------------------------|:--------------------------|:---------------------------------------------------|:--------------------------|
>| Azure DevOps Services API DE REPOS | Non |  |  |  |  |
...
<iframe height='1020' title='Microsoft Cloud App Security information' src='https://appmcasinfoprod.azurewebsites.net/#/dashboard/37866' frameborder='no' style='width: 100%;'></iframe>
...
Ces informations ont été fournies par QBURST TECHNOLOGIES PVT LTD sur la façon dont cette application gère l’authentification, l’autorisation, les meilleures pratiques d’enregistrement des applications et d’autres critères d’identité.
...
| Énumérer les types de politiques prises en charge | 499b84ac-1321-427f-aa17-267ca6975798/user_impersonation offline_access |
