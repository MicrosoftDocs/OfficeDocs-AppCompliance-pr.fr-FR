---
title: Informations sur les applications pour collaboard par solutions IBV
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/24/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour Collaboard, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le Registre CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/28ed14b8-5625-40e6-a17a-b56fa04fc76f" target="_blank">Afficher dans Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002549" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par les solutions IBV à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | Collaboard |
| ID | WA200002549 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | IBV Solutions |
| Site web de l’entreprise | [https://www.collaboard.app](https://www.collaboard.app) |
| Conditions d’utilisation de l’application | [https://www.collaboard.app/terms](https://www.collaboard.app/terms) |
| Fonctionnalités principales de l’application | Collaboard est un très bon tableau blanc collaboratif en ligne pour le travail à distance. |
| Emplacement du siège social de l’entreprise | Suisse |
| Page d’informations sur l’application | [https://www.collaboard.app/product](https://www.collaboard.app/product) |
| Quel est l’environnement d’hébergement ou le modèle de service utilisé pour exécuter votre application ? | Hybride |
| Quels fournisseurs de cloud d’hébergement l’application utilise-t-elle ? | Azure, IBMCloud, Aws, Other |
...
Ces informations ont été fournies par les solutions IBV sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| URL de la politique de confidentialité | https://www.collaboard.app/dpa |
