---
title: Informations sur l’application pour DailyBot par DailyBot
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/20/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour DailyBot, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
ms.locfileid: "66915652"
---
# <a name="dailybot"></a>DailyBot

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Dernière mise à jour par le développeur : 27 avril 2022</p>

* <a href="https://teams.microsoft.com/l/app/82bfb2e1-cad3-4e99-8995-5d140f295ef2" target="_blank">Afficher dans le magasin Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001492" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par DailyBot à Microsoft :

| **Information** | **Réponse** |
|:----------------|:-------------|
| Nom de l'application | DailyBot |
| ID | WA200001492 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | DailyBot |
| Site web de la société | [https://www.dailybot.com](https://www.dailybot.com) |
| Conditions d’utilisation de l’application | [https://www.dailybot.com/legal/terms-and-conditions](https://www.dailybot.com/legal/terms-and-conditions) |
| Fonctionnalités principales de l’application | DailyBot réduit le besoin de réunions en automatisant les standups, les rapports d’état quotidien, les rétrospectives et les archivages périodiques. Il suit la motivation de l’équipe et favorise les commentaires positifs avec des félicitations et de l’appréciation. DailyBot inclut des fonctionnalités supplémentaires pour créer des raccourcis/commandes et automatiser vos flux de travail de conversation. |
| Emplacement du siège social de la société | États-Unis d’Amérique |
| Page d’informations sur l’application | [https://www.dailybot.com/integrations/msteams](https://www.dailybot.com/integrations/msteams) |
...
Ces informations ont été fournies par DailyBot sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont traitées par votre application ? | Email utilisateur, ID de locataire, ID de ressource et nom de l’équipe MS, ID de canal d’équipe |
| L’application prend-elle en charge TLS 1.1 ou version ultérieure ? | Oui |
| L’application ou l’infrastructure sous-jacente stocke-t-elle des données client Microsoft ? | Oui |
| Quelles données sont stockées dans vos bases de données ? | User Email, Tenant ID, MS Team Resource Ids and Names, Team Channel IDs, Content of user responses collected by DailyBot’s features and workflows, such as: Check-Ins, Surveys, Forms or Kudos. |
...
| URL de la politique de confidentialité | https://www.dailybot.com/legal/privacy-policy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Délégué | DailyBot requiert de lire les informations de base des utilisateurs des équipes. Cela permet d’offrir une bonne expérience utilisateur sur l’intégration des processus et de faciliter l’invitation du membre. | [82bfb2e1-cad3-4e99-8995-5d140f295ef2](../azure/82bfb2e1-cad3-4e99-8995-5d140f295ef2.md) |
