---
title: Informations sur l’application pour Skoach par Codify, Lda
ms.author: elmalova
author: elenamalova
ms.date: 11/09/2021
ms.topic: article
...
description: Toutes les informations de sécurité et de conformité disponibles pour Skoach, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le Registre CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/401ece51-d146-4cfb-b426-d7c8b70b056b" target="_blank">Afficher dans Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003455" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Contrôleify, Lda à Microsoft :

| **Information** | **Réponse** |
|:----------------|:-------------|
| Nom de l'application | Skoach |
| ID | WA200003455 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | Tifify, Lda |
| Site web de l’entreprise | [https://skoach.com](https://skoach.com) |
| Conditions d’utilisation de l’application | [https://www.skoach.com/terms-of-service](https://www.skoach.com/terms-of-service) |
| Fonctionnalités principales de l’application | Skoach est un assistant virtuel au travail pour maintenir les équipes ensemble, alignées et productives, ce qui permet aux utilisateurs d’adopter de nouveaux comportements, en fonction des résultats récurrents des enquêtes. Skoach augmente non seulement le flux de communication des équipes, ce qui conduit à l’appartenance et à l’alignement, mais il permet également aux personnes de s’occuper d’elles-mêmes pour relever les nouveaux défis liés au travail hybride, ce qui augmente la productivité de &amp; rétention. |
| Emplacement du siège social de l’entreprise | Portugal |
...
Ces informations ont été fournies par Lasify, Lda sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont stockées dans vos bases de données ? | Les noms des clients et, s’ils sont fournis, les e-mails. |
...
| Votre environnement utilise-t-il une protection anti-programme malveillant classique ou des contrôles d’application ? | TraditionalAntiMalware |
...
| Les pratiques de codage sécurisé prennent-ils en compte les classes de vulnérabilité courantes telles qu’OWASP top 10 ? | Oui |
...
| Avez-vous un logiciel de détection et de prévention des intrusions (IDPS) déployé sur le périmètre de la limite réseau qui permet de soutenir votre application ? | S/O |
...
| Un processus formel de gestion des risques de sécurité des informations est-il établi ? | Non |
...
| URL de la politique de confidentialité | https://www.skoach.com/privacy-policy |
...
| Est-ce que vous devez traiter des catégories spéciales de données sensibles (c’est-à-dire, l’origine ethnique ou ethnique, l’opinion politique, les opinions ethniques ou ethniques, les données génétiques ou biométriques, les données de santé) ou les catégories de données soumises aux lois sur les notifications de violation ? | Non |
