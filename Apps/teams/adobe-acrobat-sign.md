---
title: Informations d’application pour Adobe Acrobat Sign by Adobe
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/23/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour Adobe Acrobat Sign, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
ms.locfileid: "64879841"
---
# <a name="adobe-acrobat-sign"></a>Adobe Acrobat Sign

<p></p><a href="https://aka.ms/appcertification" alt="This Microsoft 365 Certified app has been reviewed by Microsoft against industry standards and controls for security, compliance, and data handling practices. Where applicable, Microsoft has verified the developer's claims of compliance with reasonable and effective practices." target="_blank"><img alt="Click here for more information on the Microsoft Certified app program." src="../media/certified.png" width="650" /></a>
<p>Dernière mise à jour par le développeur : 15 octobre 2021</p>

* <a href="https://teams.microsoft.com/l/app/0f56a9d1-f502-40f9-a9e8-816d7adbb68b" target="_blank">Afficher dans Teams magasin</a>
* <a href="https://appsource.microsoft.com/product/office/WA104381233" target="_blank">Afficher dans AppSource</a>
...
|:----------------|:-------------|
| Nom de l'application | Adobe Acrobat Sign |
| ID | WA104381233 |
...
| Fonctionnalités principales de l’application | Simplifiez les flux de travail de signature de documents et offrez des expériences incroyables aux employés et aux clients lorsque vous tirez parti des fonctionnalités Adobe Sign dans Teams. Vous pouvez signer des documents, les envoyer pour des signatures électroniques et des approbations juridiquement contraignantes, et suivre leur état &#8212; tous avec Adobe Sign for Teams, la solution de signature électronique préférée de Microsoft. |
...
Ces informations ont été fournies par Adobe sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
>| offline_access | Délégué | Pour actualiser le jeton d’accès, lorsque le jeton actuel a expiré. Par exemple, lorsque l’utilisateur se trouve dans une &quot;fenêtre d’envoi de signature&quot; et qu’il la laisse inactive pendant trop longtemps, nous devons actualiser un nouveau jeton pour maintenir l’utilisateur actif. | [a9b0c190-bafb-49ca-a61a-dab99cf2c43b](../azure/a9b0c190-bafb-49ca-a61a-dab99cf2c43b.md) |
