---
title: Informations sur l’application pour Abi par Beroe
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/29/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour Abi, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
ms.locfileid: "66564601"
---
# <a name="abi"></a>Abi

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Dernière mise à jour par le développeur : 17 mars 2022</p>

* <a href="https://teams.microsoft.com/l/app/55560ea0-ae82-48b2-b71e-a45356f56bb1" target="_blank">Afficher dans le magasin Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003862" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Beroe à Microsoft :

| **Information** | **Réponse** |
|:----------------|:-------------|
| Nom de l'application | Abi |
| ID | WA200003862 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | Beroe |
| Site web de la société | [https://www.beroeinc.com](https://www.beroeinc.com) |
| Conditions d’utilisation de l’application | [https://www.beroeinc.com/terms/](https://www.beroeinc.com/terms/) |
| Fonctionnalités principales de l’application | Abi &#8211; votre assistant d’approvisionnement numérique basé sur l’IA |
| Emplacement du siège social de la société | Inde |
| Page d’informations sur l’application | [https://www.beroeinc.com/beroe-live-ai](https://www.beroeinc.com/beroe-live-ai) |
...
Ces informations ont été fournies par Beroe sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont traitées par votre application ? | Prénom, ID de courrier professionnel de nom &amp; |
| L’application prend-elle en charge TLS 1.1 ou version ultérieure ? | Oui |
| L’application ou l’infrastructure sous-jacente stocke-t-elle des données client Microsoft ? | Oui |
| Quelles données sont stockées dans vos bases de données ? | Prénom, Nom, ID de conversation de l’ID &amp; de messagerie professionnelle |
...
| URL de la politique de confidentialité | https://www.beroeinc.com/privacy-policy/ |
