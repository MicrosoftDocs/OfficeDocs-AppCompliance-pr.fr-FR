...
| URL du site web partenaire | [https://www.intumit.com/english/](https://www.intumit.com/english/) |
...
>|:----------------|:------------------------------------------------|:--------------------------------------------------------|:--------------------------------------------------|:--------------------|
>| User.Read | délégué | Utilisation de userPrincipalName pour identifier si le courrier de l’utilisateur est issu d’AAD ou non | Activer la connexion et lire le profil utilisateur | [a938ae1e-a791-4751-9e6a-178c991fa0fa](https://docs.microsoft.com/microsoft-365-app-certification/azure/a938ae1e-a791-4751-9e6a-178c991fa0fa) |
...
>|:---------------------------------------|:-----------------------------------|:------------------------------------|
>| Utilisation pour identifier le courrier de l’utilisateur, qu’il provienne d’AAD ou non | Courrier électronique de l’utilisateur | Liste de courriers de l’utilisateur stocké pour déterminer si l’utilisateur est issu d’AAD ou non |
...
>Seul votre compte AAD peut accéder à l’application.
...
Ces informations ont été fournies par SmartWork d’Intumit sur la façon dont cette application gère l’authentification, l’autorisation, les meilleures pratiques d’inscription d’application et d’autres critères d’identité.
