---
title: Informations d’application pour Skilled Human par SaltFlat Limited
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/24/2021
...
description: Toutes les informations de sécurité et de conformité disponibles pour Skilled Human, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/7c44d518-b820-461c-bbbd-2cbbd83aa3bc" target="_blank">Afficher dans Teams magasin</a>
...
| Site web de la société | [https://skilledhuman.org](https://skilledhuman.org) |
| Conditions d’utilisation de l’application | [https://skilledhuman.org/terms](https://skilledhuman.org/terms) |
| Fonctionnalités principales de l’application | Professional Skills Framework |
| Emplacement du siège social de la société | Royaume-Uni de Grande-Bretagne et d’Irlande du Nord (le) |
| Page d’informations sur l’application | [https://skilledhuman.org/teamsapp](https://skilledhuman.org/teamsapp) |
...
SaltFlat Limited a fourni ces informations sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
