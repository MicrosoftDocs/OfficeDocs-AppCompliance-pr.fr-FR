---
title: Informations sur l’application pour Micromate par Lessyring
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: Toutes les informations de sécurité et de conformité disponibles pour Micromate, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le Registre CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/4112cc9a-d683-4ffd-b0bc-2013af7c7497" target="_blank">Afficher dans Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002981" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies à Microsoft par Contrôleon ContrôleH :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | Micromate |
| ID | WA200002981 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | Paixon GmbH |
| Site web de l’entreprise | [https://paixon.ch](https://paixon.ch) |
| Conditions d’utilisation de l’application | [https://micromate.ai/de/nutzungsbedingungen/](https://micromate.ai/de/nutzungsbedingungen/) |
| Fonctionnalités principales de l’application | Micromate vermittelt durch personalisierte Lerneinheiten direkt im Chat nachhaltig Wissen. Micromate setzt dabei auf Microlearning durch die Ausungung von Quizzes in Form von Adaptive Cards. Die pers&#246;nliche Anspender des Lernenden, ein Tutorial zur Funktionsweise der App und die Integration spannender Gamification Elemente motivieren den Lernenden zur nachhaltigen Nutzung. |
| Emplacement du siège social de l’entreprise | Suisse |
| Page d’informations sur l’application | [https://micromate.ai/de/produkt/](https://micromate.ai/de/produkt/) |
| Quel est l’environnement d’hébergement ou le modèle de service utilisé pour exécuter votre application ? |  |
| Quels fournisseurs de cloud d’hébergement l’application utilise-t-elle ? | Cloudscale |
...
Ces informations ont été fournies par Cette application concernant la façon dont cette application collecte et stocke les données organisationnelles, ainsi que le contrôle que votre organisation aura sur les données collectées par l’application.
