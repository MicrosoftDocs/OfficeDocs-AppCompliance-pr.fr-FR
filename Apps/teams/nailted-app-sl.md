---
title: Informations d’application pour Nailted by NAILTED APP S.L.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 10/21/2021
...
description: Toutes les informations de sécurité et de conformité disponibles pour Nailted, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/1a199d17-c299-4634-a124-075e0c119d71" target="_blank">Afficher dans Teams magasin</a>
...
Informations fournies par NAILTED APP S.L. vers Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | Cloué |
| ID | WA200003375 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | NAILTED APP S.L. |
| Site web de la société | [https://nailted.com](https://nailted.com) |
| Conditions d’utilisation de l’application | [https://nailted.com/legal/terms](https://nailted.com/legal/terms) |
| Fonctionnalités principales de l’application | Plateforme d’engagement des employés pour les équipes RH people &amp; modernes. |
...
Ces informations ont été fournies par NAILTED APP S.L. sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont traitées par votre application ? | tenantId et e-mail |
...
| Si votre application n’utilise pas l’une des bibliothèques ci-dessus, quelle bibliothèque ou bibliothèque d’authentification utilise-t-elle ? | nous utilisons la dernière version de la bibliothèque d’authentification Microsoft |
...
>| TeamsAppInstallation.ReadWriteForUser | application | L’utilisateur peut sélectionner les utilisateurs auxquels il souhaite installer l’application. Nous utilisons donc cette autorisation pour instaliser l’application | [52b2da9b-4cd6-4334-be22-4a3b1b99bac7](../azure/52b2da9b-4cd6-4334-be22-4a3b1b99bac7.md) |
...
>| email | application | Accéder à la messagerie des employés pour les synchroniser | [52b2da9b-4cd6-4334-be22-4a3b1b99bac7](../azure/52b2da9b-4cd6-4334-be22-4a3b1b99bac7.md) |
