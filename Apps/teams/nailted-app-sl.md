...
>| TeamsAppInstallation.ReadWriteForUser | application | L’utilisateur peut choisir les utilisateurs sur lesquels il souhaite installer l’application. Nous utilisons donc cette autorisation pour insérer l’application |
