...
description: Toutes les informations disponibles sur la sécurité et la conformité pour Centrical, ses politiques de traitement des données, ses informations sur le catalogue d’applications Microsoft Cloud App Security et les informations de sécurité et de conformité dans le registre STAR de l’ASC.
...
* <a href="https://teams.microsoft.com/l/app/7a70b8e4-43ca-46a7-b7c3-eb31b33de397" target="_blank">Vue dans Teams magasin</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001531" target="_blank">Voir dans AppSource</a>
...
| Nom de l’entreprise partenaire | Biz-Effective |
| URL du site web partenaire | [https://centrical.com](https://centrical.com) |
| URL de la page Teams’informations d’application | [https://centrical.com/solutions/solutions-by-use-case-2/mic...](https://centrical.com/solutions/solutions-by-use-case-2/microsoft-teams-gamification/) |
...
Ces informations ont été fournies par Biz-Effective sur la façon dont cette application recueille et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
>Nous sommes conformes au SOC2 Type 2, conformes à l’ISO 27001 et au GDPR. Nous avons placé de multiples contrôles pour assurer la confidentialité et la sécurité des données. Nous n’utilisons les données que pour notre application et ne les partageons pas avec des tiers.
...
<iframe height='1020' title='Microsoft Cloud App Security information' src='https://appmcasinfoprod.azurewebsites.net/#/dashboard/36383' frameborder='no' style='width: 100%;'></iframe>
...
Ces informations ont été fournies par des Biz-Effective la façon dont cette application gère l’authentification, l’autorisation, les meilleures pratiques d’enregistrement des applications et d’autres critères d’identité.
