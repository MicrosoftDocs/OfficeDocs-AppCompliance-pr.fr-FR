---
title: Informations sur l’application pour Quitch par Quitch
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/21/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour Quitch, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le Registre CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/f2125454-678c-4f97-90cc-dfe4742f4711" target="_blank">Afficher dans Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003683" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Quitch à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | Quitch |
| ID | WA200003683 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | Quitch |
| Site web de l’entreprise | [https://quitch.com](https://quitch.com) |
| Conditions d’utilisation de l’application | [https://quitch.com/user-terms-of-service/](https://quitch.com/user-terms-of-service/) |
| Fonctionnalités principales de l’application | Questionnaires interactifs pour vos réunions Microsoft Teams réunion |
| Emplacement du siège social de l’entreprise | Australie |
| Page d’informations sur l’application | [https://quitch.com/microsoft-teams/](https://quitch.com/microsoft-teams/) |
...
Ces informations ont été fournies par Quitch sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont stockées dans vos bases de données ? | Seuls les messages électroniques de l’utilisateur sont collectés |
...
| URL de la politique de confidentialité | https://quitch.com/privacy-policy/ |
