---
title: Informations sur l’application pour Motionlab by Motionlab
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/20/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour Motionlab, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/8ad5fc1b-251b-4d14-aceb-2624bcab0e85" target="_blank">Afficher dans le magasin Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004250" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Motionlab à Microsoft :

| **Information** | **Réponse** |
|:----------------|:-------------|
| Nom de l'application | Motionlab |
| ID | WA200004250 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | Motionlab |
| Site web de la société | [https://www.motionlab.io](https://www.motionlab.io) |
| Conditions d’utilisation de l’application | [https://www.motionlab.io/term-of-use](https://www.motionlab.io/term-of-use) |
| Fonctionnalités principales de l’application | Créez facilement des vidéos personnalisées directement dans Microsoft Teams. |
...
Ces informations ont été fournies par Motionlab sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont traitées par votre application ? | Informations nécessaires pour créer une vidéo personnalisée. |
| L’application prend-elle en charge TLS 1.1 ou version ultérieure ? | Oui |
| L’application ou l’infrastructure sous-jacente stocke-t-elle des données client Microsoft ? | Oui |
| Quelles données sont stockées dans vos bases de données ? | Informations nécessaires pour créer une vidéo personnalisée. |
