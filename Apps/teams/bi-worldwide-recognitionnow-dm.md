---
title: Informations sur l’application pour la DM RecognitionNow par BI WORLDWIDE
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/22/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour RecognitionNow DM, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le Registre CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/af14ac7f-7a33-4d98-9c90-1e31285a5aa9" target="_blank">Afficher dans Teams store</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003647" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par BI WORLDWIDE à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | RecognitionNow DM |
| ID | WA200003647 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | BI DANS LE MONDE |
| Site web de l’entreprise | [https://www.biworldwide.com](https://www.biworldwide.com) |
| Conditions d’utilisation de l’application | [https://recognition-now.biw.cloud/terms-and-conditions-dm](https://recognition-now.biw.cloud/terms-and-conditions-dm) |
| Fonctionnalités principales de l’application | Envoyez facilement la reconnaissance directement Teams à d’autres participants dans le même programme de reconnaissance. Ce module complémentaire est le compagnon du programme de reconnaissance d’une organisation. |
...
Ces informations ont été fournies par BI WORLDWIDE sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Date de certification SOC2 la plus récente |  2020-09-10 |
...
| URL de la politique de confidentialité | https://teams.recognitionnow.com/assets/images/privacy-policy.pdf |
...
| Les individus ont-ils la possibilité de s’opposer au traitement ? | Non |
