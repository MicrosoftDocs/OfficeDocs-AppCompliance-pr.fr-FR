---
title: Informations sur l’application pour le coucou par Cuckoo Networks Oy
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/22/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour Cuckoo, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
ms.locfileid: "66547189"
---
# <a name="cuckoo"></a>Cuckoo

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Dernière mise à jour par le développeur : 20 juin 2022</p>

* <a href="https://teams.microsoft.com/l/app/71138876-8738-4935-95b6-ae7c2fbe4e54" target="_blank">Afficher dans le magasin Teams</a>
...
Informations fournies par Cuckoo Networks Oy à Microsoft :

| **Information** | **Réponse** |
|:----------------|:-------------|
| Nom de l'application | Cuckoo |
| ID | WA200002750 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | Cuckoo Networks Oy |
| Site web de la société | [https://cuckoo.fi](https://cuckoo.fi) |
| Conditions d’utilisation de l’application | [https://cuckoo.fi/terms-of-use/](https://cuckoo.fi/terms-of-use/) |
| Fonctionnalités principales de l’application | Des exercices de micro-pause amusants et faciles et gamifiés pour stimuler votre énergie et votre cerveau. |
| Emplacement du siège social de la société | Finlande |
| Page d’informations sur l’application | [https://cuckoo.fi](https://cuckoo.fi) |
...
Ces informations ont été fournies par Cuckoo Networks Oy sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont traitées par votre application ? | Données de profil utilisateur, ID de locataire, nom du locataire |
| L’application prend-elle en charge TLS 1.1 ou version ultérieure ? | Oui |
| L’application ou l’infrastructure sous-jacente stocke-t-elle des données client Microsoft ? | Oui |
| Quelles données sont stockées dans vos bases de données ? | Informations d’identification de l’utilisateur et de l’activité de l’utilisateur |
...
| URL de la politique de confidentialité | https://cuckoo.fi/en/privacy-policy/ |
...
| Si votre application n’utilise pas l’une des bibliothèques ci-dessus, quelle bibliothèque ou bibliothèque d’authentification utilise-t-elle ? | passport-azure-ad, adal |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Délégué | Authentification utilisateur au service via la connexion Microsoft | [71138876-8738-4935-95b6-ae7c2fbe4e54](../azure/71138876-8738-4935-95b6-ae7c2fbe4e54.md) |
>| email | Délégué | Contact des clients avec des informations sur les événements d’application, les concours disponibles et le support technique | [71138876-8738-4935-95b6-ae7c2fbe4e54](../azure/71138876-8738-4935-95b6-ae7c2fbe4e54.md) |
>| offline_access | Délégué | Authentification utilisateur au service via la connexion Microsoft | [71138876-8738-4935-95b6-ae7c2fbe4e54](../azure/71138876-8738-4935-95b6-ae7c2fbe4e54.md) |
>| openid | Délégué | Authentification utilisateur au service via la connexion Microsoft | [71138876-8738-4935-95b6-ae7c2fbe4e54](../azure/71138876-8738-4935-95b6-ae7c2fbe4e54.md) |
>| profil | Délégué | Authentification utilisateur au service via la connexion Microsoft | [71138876-8738-4935-95b6-ae7c2fbe4e54](../azure/71138876-8738-4935-95b6-ae7c2fbe4e54.md) |
