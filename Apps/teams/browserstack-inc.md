---
title: Informations sur l’application pour BrowserStack par BrowserStack Inc
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/15/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour BrowserStack, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/180f19aa-1b79-4b4a-b716-068b81cfb145" target="_blank">Afficher dans le magasin Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004404" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par BrowserStack Inc à Microsoft :

| **Information** | **Réponse** |
|:----------------|:-------------|
| Nom de l'application | BrowserStack |
| ID | WA200004404 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | BrowserStack Inc |
| Site web de la société | [https://www.browserstack.com](https://www.browserstack.com) |
| Conditions d’utilisation de l’application | [https://www.browserstack.com/terms](https://www.browserstack.com/terms) |
| Fonctionnalités principales de l’application | Apportez vos insights BrowserStack directement dans Microsoft Teams ! |
| Emplacement du siège social de la société | Inde |
| Page d’informations sur l’application | [https://www.browserstack.com/docs/automate/selenium/microso...](https://www.browserstack.com/docs/automate/selenium/microsoft-teams) |
...
Ces informations ont été fournies par BrowserStack Inc. sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Date de certification SOC2 la plus récente | 2021-06-14 |
...
| URL de la politique de confidentialité | https://www.browserstack.com/privacy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Délégué | Se connecter et lire le profil utilisateur à des fins d’authentification | [180f19aa-1b79-4b4a-b716-068b81cfb145](../azure/180f19aa-1b79-4b4a-b716-068b81cfb145.md) |
