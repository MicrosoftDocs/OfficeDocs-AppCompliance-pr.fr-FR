---
title: Informations d’application pour Starbucks par Starbucks&#174; Coffee Company
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/17/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour Starbucks, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/aa2600a7-aedf-447c-b15b-8ea2daf68a09" target="_blank">Afficher dans Teams magasin</a>
...
Informations fournies par Starbucks&#174; Coffee Company à Microsoft :
...
| Site web de la société | [https://www.starbucks.com](https://www.starbucks.com) |
...
| Fonctionnalités principales de l’application | Dites merci, félicitations ou félicitations à un membre de l’équipe avec un Starbucks eGift. |
...
Ces informations ont été fournies par Starbucks&#174; Coffee Company sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
