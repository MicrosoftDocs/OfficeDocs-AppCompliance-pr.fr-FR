---
title: Informations d’application pour l’amplatif de culture par culture amp
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/06/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour Culture Amp, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
ms.locfileid: "64698974"
---
# <a name="culture-amp"></a>Culture Amp

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Dernière mise à jour par le développeur : 6 avril 2022</p>

* <a href="https://teams.microsoft.com/l/app/13a11229-3c3e-49d5-843b-71d204a5b5ee" target="_blank">Afficher dans Teams magasin</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001744" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Culture Amp à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | Culture Amp |
| ID | WA200001744 |
| Office 365 clients pris en charge | Microsoft Teams |
| Nom de la société partenaire | Culture Amp |
| Site web de la société | [https://www.cultureamp.com](https://www.cultureamp.com) |
| Conditions d’utilisation de l’application | [https://www.cultureamp.com/terms/](https://www.cultureamp.com/terms/) |
| Fonctionnalités principales de l’application | Aider les employés à partager leurs commentaires et à accéder à Culture Amp insights à partir de Microsoft Teams |
...
Ces informations ont été fournies par Culture Amp sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont stockées dans vos bases de données ? | adresses e-mail de référence de conversation |
| Si l’infastructure sous-jacente traite ou stocke les données client Microsoft, où ces données sont-elles stockées géographiquement ? | Irlande, États-Unis d’Amérique |
...
| URL de la politique de confidentialité | https://www.cultureamp.com/terms/ |
