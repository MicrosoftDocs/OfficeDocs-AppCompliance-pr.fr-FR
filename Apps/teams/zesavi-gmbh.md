---
title: Informations sur l’application pour Zesavi par Zesavi
ms.author: elmalova
author: elenamalova
ms.date: 01/03/2022
ms.topic: article
...
description: Toutes les informations de sécurité et de conformité disponibles pour Zesavi, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le Registre CSA STAR.
...
Informations fournies par Zesavi ContrôleH à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | Zesavi |
| ID | WA200003621 |
...
Ces informations ont été fournies par Zesavi ContrôleH sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont stockées dans vos bases de données ? | ID d’objet pour chaque utilisateur |
