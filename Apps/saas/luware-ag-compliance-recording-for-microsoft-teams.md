---
title: Informations sur l’application pour l’enregistrement de conformité Luware pour Microsoft Teams par Luware AG
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 12/10/2021
...
description: Toutes les informations de sécurité et de conformité disponibles pour l’enregistrement de conformité Luware pour Microsoft Teams, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
ms.locfileid: "64881431"
---
# <a name="luware-compliance-recording-for-microsoft-teams"></a>Enregistrement de conformité Luware pour Microsoft Teams

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Dernière mise à jour par le développeur : 21 octobre 2021</p>

* <a href="https://appsource.microsoft.com/product/web-apps/luwareagzurich.recording_azure_marketplace" target="_blank">Afficher dans AppSource</a>
...
|:----------------|:-------------|
| Nom de l'application | Enregistrement de conformité Luware pour Microsoft Teams |
...
| Fonctionnalités principales de l’application | Solution cloud pour vous aider à capturer, archiver, analyser et récupérer tous les modes de communication. |
| Emplacement du siège social de la société | Suisse |
| Page d’informations sur l’application | [https://luware.com/en/solution/microsoft-teams-recording/](https://luware.com/en/solution/microsoft-teams-recording/) |
...
| Quelles données sont traitées par votre application ? | Informations de l’appelant/de l’appelant (numéros de téléphone, upn, durée, &amp; adresse de messagerie instantanée, etc.), détails de l’appel, métadonnées,  |
| L’application prend-elle en charge TLS 1.1 ou version ultérieure ? | Oui |
| L’application ou l’infrastructure sous-jacente stocke-t-elle des données client Microsoft ? | Oui |
| Quelles données sont stockées dans vos bases de données ? | ID d’objet Azure, UPNs, adresse de messagerie &amp; instantanée, nom complet, prénom, nom, emplacement (facultatif), département (facultatif) |
| Si l’infastructure sous-jacente traite ou stocke les données client Microsoft, où ces données sont-elles stockées géographiquement ? | Suisse |
...
| Authentification multifacteur (MFA) activée pour : | Credential |
...
| URL de la politique de confidentialité | https://luware.com/en/privacy-policy/ |
...
| Si votre application n’utilise pas l’une des bibliothèques ci-dessus, quelle bibliothèque ou bibliothèque d’authentification utilise-t-elle ? | Oauth 2.0 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calls.AccessMedia.All | application | enregistrement Teams | [5e5d72e0-2df7-4ca7-be58-81dc28d3bdad](../azure/5e5d72e0-2df7-4ca7-be58-81dc28d3bdad.md) |
>| Calls.Initiate.All | application | enregistrement Teams | [5e5d72e0-2df7-4ca7-be58-81dc28d3bdad](../azure/5e5d72e0-2df7-4ca7-be58-81dc28d3bdad.md) |
>| Calls.InitiateGroupCall.All | application | enregistrement Teams | [5e5d72e0-2df7-4ca7-be58-81dc28d3bdad](../azure/5e5d72e0-2df7-4ca7-be58-81dc28d3bdad.md) |
>| Calls.JoinGroupCall.All | application | enregistrement Teams | [5e5d72e0-2df7-4ca7-be58-81dc28d3bdad](../azure/5e5d72e0-2df7-4ca7-be58-81dc28d3bdad.md) |
>| Calls.JoinGroupCallasGuest.All | application | enregistrement Teams | [5e5d72e0-2df7-4ca7-be58-81dc28d3bdad](../azure/5e5d72e0-2df7-4ca7-be58-81dc28d3bdad.md) |
>| Group.Read.All | application | enregistrement Teams | [5e5d72e0-2df7-4ca7-be58-81dc28d3bdad](../azure/5e5d72e0-2df7-4ca7-be58-81dc28d3bdad.md) |
>| GroupMember.Read.All | application | enregistrement Teams | [5e5d72e0-2df7-4ca7-be58-81dc28d3bdad](../azure/5e5d72e0-2df7-4ca7-be58-81dc28d3bdad.md) |
>| OnlineMeetings.Read.All | application | enregistrement Teams | [5e5d72e0-2df7-4ca7-be58-81dc28d3bdad](../azure/5e5d72e0-2df7-4ca7-be58-81dc28d3bdad.md) |
>| OnlineMeetings.ReadWrite.All | application | enregistrement Teams | [5e5d72e0-2df7-4ca7-be58-81dc28d3bdad](../azure/5e5d72e0-2df7-4ca7-be58-81dc28d3bdad.md) |
>| User.Read | Délégué | Authentification unique | [5e5d72e0-2df7-4ca7-be58-81dc28d3bdad](../azure/5e5d72e0-2df7-4ca7-be58-81dc28d3bdad.md) |
>| User.Read.All | application | enregistrement Teams | [5e5d72e0-2df7-4ca7-be58-81dc28d3bdad](../azure/5e5d72e0-2df7-4ca7-be58-81dc28d3bdad.md) |
