---
title: Informations sur l’application pour Competella Communication Suite par Competella AB
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/07/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour Competella Communication Suite, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
<p>Dernière mise à jour par le développeur : 1er décembre 2021</p>

* <a href="https://appsource.microsoft.com/product/web-apps/competellaab.sol-52202-iyi" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Competella AB à Microsoft :

| **Information** | **Réponse** |
|:----------------|:-------------|
| Nom de l'application | Competella Communication Suite |
| ID | competellaab.sol-52202-iyi |
| Nom de la société partenaire | Competella AB |
| Site web de la société | [https://www.competella.com](https://www.competella.com) |
| Conditions d’utilisation de l’application | [https://www.competella.com](https://www.competella.com) |
| Fonctionnalités principales de l’application | Une solution de centre de contacts et de console standard pour un excellent service client avec Microsoft Teams. |
| Emplacement du siège social de la société | Suède |
| Page d’informations sur l’application | [https://competella.com/Solutions%20for%20Teams/overview](https://competella.com/Solutions%20for%20Teams/overview) |
...
Ces informations ont été fournies par Competella AB sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont traitées par votre application ? | Profils utilisateur et informations d’appel |
| L’application prend-elle en charge TLS 1.1 ou version ultérieure ? | Oui |
| L’application ou l’infrastructure sous-jacente stocke-t-elle des données client Microsoft ? | Oui |
| Quelles données sont stockées dans vos bases de données ? | Informations sur le profil utilisateur et journaux de conversation |
...
| URL de la politique de confidentialité | www.competella.com |
