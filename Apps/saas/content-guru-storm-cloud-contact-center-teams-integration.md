---
title: Informations d’application pour storm Cloud Contact Center Teams Integration by Content Guru
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/07/2022
...
* <a href="https://appsource.microsoft.com/product/web-apps/contentguru1616168120869.storm_cloud_contact_center_teams_integration" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Content Guru à Microsoft :

| **Information** | **Réponse** |
|:----------------|:-------------|
| Nom de l'application | Storm Cloud Contact Center Teams Integration |
| ID | contentguru1616168120869.storm_cloud_contact_center_teams_integration |
| Nom de la société partenaire | Guru du contenu |
| Site web de la société | [https://www.contentguru.com/microsoft-teams-integration/.](https://www.contentguru.com/microsoft-teams-integration/.) |
| Conditions d’utilisation de l’application | [https://www.contentguru.com/about-us/terms-of-use/](https://www.contentguru.com/about-us/terms-of-use/) |
| Fonctionnalités principales de l’application | Intégrez storm Cloud Contact Center à Microsoft Teams pour une solution CCaaS unifiée. |
...
Ces informations ont été fournies par Content Guru sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont traitées par votre application ? | Us User Reference (EUII), MS Organization Reference (OII), Call details and User Profile Data (EUII) |
...
| URL de la politique de confidentialité | https://www.contentguru.com/about-us/privacy-cookies-policy/ |
