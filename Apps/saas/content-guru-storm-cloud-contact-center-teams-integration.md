---
title: Informations sur l’application pour l’intégration de cloud Teams cloud par Content Cloud
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/11/2022
...
Informations fournies par Content Contents à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | Intégration du centre de contacts cloud Teams tempél |
| ID | contentguru1616168120869.storm_cloud_contact_center_teams_integration |
| Nom de la société partenaire | Content Matière |
| Site web de l’entreprise | [https://www.contentguru.com/microsoft-teams-integration/.](https://www.contentguru.com/microsoft-teams-integration/.) |
...
| Fonctionnalités principales de l’application | Intégrez le centre de contacts cloud d’Microsoft Teams pour une solution CCaaS unifiée. |
...
Ces informations ont été fournies par Content Questions sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
