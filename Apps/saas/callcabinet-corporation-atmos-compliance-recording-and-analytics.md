---
title: Informations d’application pour l’enregistrement et l’analytique de conformité CallCabinet Atmos par CallCabinet Corporation
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/16/2022
...
| **Information** | **Réponse** |
|:----------------|:-------------|
| Nom de l'application | Enregistrement et analytique de conformité CallCabinet Atmos |
| ID | callcabinetcorporation1584393576335.atmos |
| Nom de la société partenaire | CallCabinet Corporation |
| Site web de la société | [https://www.callcabinet.com](https://www.callcabinet.com) |
...
| Fonctionnalités principales de l’application | Atmos by CallCabinet est une solution Azure Native Compliance Call Recording, AI-Analytics et QA SaaS pour Microsoft Teams et d’autres systèmes de collaboration ou de centre de contacts. |
...
| Quelles données sont traitées par votre application ? | Conversations Teams enregistrées, partage de vidéos et d’écran |
| L’application prend-elle en charge TLS 1.1 ou version ultérieure ? | Oui |
| L’application ou l’infrastructure sous-jacente stocke-t-elle des données client Microsoft ? | Oui |
| Quelles données sont stockées dans vos bases de données ? | Conversations Teams enregistrées, partage de vidéos et d’écran |
