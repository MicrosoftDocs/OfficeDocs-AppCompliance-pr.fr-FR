---
title: Informations d’application pour TeamOrgChart par TeamImprover.Com Ltd
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/14/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour TeamOrgChart, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
* <a href="https://appsource.microsoft.com/product/web-apps/teamorgchart.66763c6e-79ef-434a-b4b5-8c64c980ac13" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par TeamImprover.Com Ltd à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | TeamOrgChart |
| ID | teamorgchart.66763c6e-79ef-434a-b4b5-8c64c980ac13 |
| Nom de la société partenaire | TeamImprover.Com Ltd |
| Site web de la société | [https://teamimprover.com](https://teamimprover.com) |
| Conditions d’utilisation de l’application | [https://teamorgchart.com/termsofservice](https://teamorgchart.com/termsofservice) |
| Fonctionnalités principales de l’application | Créer, partager, rechercher et imprimer des organigrammes |
| Emplacement du siège social de la société | Royaume-Uni de Grande-Bretagne et d’Irlande du Nord (le) |
| Page d’informations sur l’application | [https://teamorgchart.com/website/features.cshtml](https://teamorgchart.com/website/features.cshtml) |
...
Ces informations ont été fournies par TeamImprover.Com Ltd sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont traitées par votre application ? | Les informations de hiérarchie d’organisation sont traitées par l’application.   |
| L’application prend-elle en charge TLS 1.1 ou version ultérieure ? | Oui |
| L’application ou l’infrastructure sous-jacente stocke-t-elle des données client Microsoft ? | Oui |
| Quelles données sont stockées dans vos bases de données ? | TeamOrgChart stocke les métadonnées décrivant le graphique, par exemple le nom du graphique, les règles, les signets, le nombre de niveaux d’affichage, etc. |
...
| URL de la politique de confidentialité | https://teamorgchart.com/privacy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.Read.All | Délégué | L’application génère et affiche un organigramme à partir de Azure AD.  Il doit être en mesure de lire les informations de l’utilisateur à partir de Azure AD  | [b12699ab-e60a-46b1-8c9e-231d489947aa](../azure/b12699ab-e60a-46b1-8c9e-231d489947aa.md) |
>| User.Read.All | Délégué | L’application génère et affiche un organigramme à partir de Azure AD.  Il doit être en mesure de lire les informations de l’utilisateur à partir de Azure AD  | [b12699ab-e60a-46b1-8c9e-231d489947aa](../azure/b12699ab-e60a-46b1-8c9e-231d489947aa.md) |
