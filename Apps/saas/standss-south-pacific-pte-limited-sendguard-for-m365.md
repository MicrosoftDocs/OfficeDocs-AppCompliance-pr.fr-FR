---
title: Informations d’application pour SendGuard pour M365 by Standss (Pacifique Sud) PTE Limité
ms.author: elmalova
author: elenamalova
ms.date: 12/10/2021
ms.topic: article
...
description: Toutes les informations de sécurité et de conformité disponibles pour SendGuard pour M365, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le Registre CSA STAR.
...
ms.locfileid: "61420835"
---
# <a name="sendguard-for-m365"></a>SendGuard pour M365
...
Informations fournies par les stands (Pacifique Sud) PTE limité à Microsoft :

| **Information** | **Réponse** |
|:----------------|:-------------|
| Nom de l'application | SendGuard pour M365 |
| ID | standsssouthpacificltd1581455821226.emailnotes |
| Nom de la société partenaire | Stands (Pacifique sud) PTE limité |
| Site web de l’entreprise | [https://www.standss.com](https://www.standss.com) |
...
Ces informations ont été fournies par stands (Pacifique Sud) PTE Limited sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| URL de la politique de confidentialité | http://www.standss.com/sr/sg_m365/privacy_policy.asp |
...
| Liste des types de stratégies pris en charge | Exiger l’authentification multifacteur pour les utilisateurs dotés de rôles d’administration |
...
>|:------------------------|:--------------------|:------------------------------------|
>| Calendars.ReadWrite | délégué | Pour lire le contenu de l’objet , du corps, du contenu des pièces jointes jointes à la demande de réunion  |
>| Mail.ReadWrite | délégué | Pour lire le contenu de l’objet, du corps, du contenu des pièces jointes jointes à l’élément de courrier  |
>| openid | délégué | Conditions requises pour l’autorisation d' sign-on unique (SSO) |
>| profil | délégué | Conditions requises pour l’autorisation d' sign-on unique (SSO) |
>| User.Read | délégué | Il s’agit de lire les données utilisateur pour vérifier les informations de licence de leur domaine/compte d’utilisateur |
