...
| Quelles données sont traitées par votre application ? | AzureADGuid (liaison de comptes).  L’adresse e-mail et le numéro de téléphone peuvent être importés à partir de AAD. |
| L’application prend-elle en charge TLS 1.1 ou version ultérieure ? | Oui |
| L’application ou l’infrastructure sous-jacente stocke-t-elle des données client Microsoft ? | Oui |
| Quelles données sont stockées dans vos bases de données ? | AzureADGuid (liaison de comptes).  L’adresse e-mail et le numéro de téléphone peuvent être importés à partir de AAD. |
