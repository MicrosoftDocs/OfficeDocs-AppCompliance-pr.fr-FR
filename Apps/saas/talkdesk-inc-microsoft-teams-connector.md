---
title: Informations d’application pour Talkdesk Microsoft Teams Connector par Talkdesk, Inc.
ms.author: elmalova
author: elenamalova
ms.date: 02/11/2022
ms.topic: article
...
|:----------------|:-------------|
| Nom de l'application | Talkdesk Microsoft Teams Connector |
| ID | talkdeskinc1579824950513.talkdesk_for_teams |
| Nom de la société partenaire | Talkdesk, Inc. |
| Site web de l’entreprise | [https://www.talkdesk.com](https://www.talkdesk.com) |
...
| Fonctionnalités principales de l’application | Microsoft Teams’intégration à Talkdesk qui permet l’annuaire et le routage direct |
...
Ces informations ont été fournies par Talkdesk, Inc. sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read.All | délégué | Obligatoire pour collecter les données de profil des utilisateurs Teams MS | [10d8604b-e6ea-4c59-8414-aca1bf1ffda8](https://docs.microsoft.com/microsoft-365-app-certification/azure/10d8604b-e6ea-4c59-8414-aca1bf1ffda8) |
>| offline_access | délégué | Permet à l’application de voir les données même lorsque l’utilisateur qui a accordé l’accès n’est pas connecté. | [10d8604b-e6ea-4c59-8414-aca1bf1ffda8](https://docs.microsoft.com/microsoft-365-app-certification/azure/10d8604b-e6ea-4c59-8414-aca1bf1ffda8) |
