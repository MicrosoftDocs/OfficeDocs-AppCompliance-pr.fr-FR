---
title: Informations sur les applications pour la conformité de l’enregistrement de Theta Lake &amp; Teams Video par Theta Lake
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/16/2022
...
|:----------------|:-------------|
| Nom de l'application | Theta Lake Recording &amp; Compliance for Teams Video |
| ID | thetalake.thetalake_recording_and_compliance_for_teams |
| Nom de la société partenaire | Theta Lake |
| Site web de l’entreprise | [https://thetalake.com](https://thetalake.com) |
| Conditions d’utilisation de l’application | [https://thetalake.com/privacy-policy](https://thetalake.com/privacy-policy) |
| Fonctionnalités principales de l’application | Enregistrement, archivage, conformité et atténuation des risques pour Microsoft Teams réunions audio et vidéo |
...
Ces informations ont été fournies par Theta Lake sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont stockées dans vos bases de données ? | Microsoft Video, Microsoft Teams Chat |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calls.JoinGroupCall.All | délégué | Graph API doit être accessible pour recevoir l’enregistrement d’appel | [1cc8eecf-56f3-4137-a0fe-4b0466ca0677](../azure/1cc8eecf-56f3-4137-a0fe-4b0466ca0677.md) |
