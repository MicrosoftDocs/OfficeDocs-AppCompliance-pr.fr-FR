...
Informations fournies par Les services cloud de Casys, Inc à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | Intégration cloud CX Teams Cloud |
| ID | toyslabs.quys-cloud_teams_integration |
| Nom de la société partenaire | Genesys Cloud Services, Inc |
| Site web de l’entreprise | [https://www.genesys.com](https://www.genesys.com) |
...
Ces informations ont été fournies par Les services cloud de Contrôleys, Inc. sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
