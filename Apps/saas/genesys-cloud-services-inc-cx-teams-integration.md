---
title: Application Information for Genesys Cloud CX Teams Integration by Genesys Services cloud, Inc
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/23/2022
...
Informations fournies par Genesys Services cloud, Inc à Microsoft :

| **Information** | **Réponse** |
|:----------------|:-------------|
| Nom de l'application | Intégration de Genesys Cloud CX Teams |
| ID | genesyslabs.genesys-cloud_teams_integration |
| Nom de la société partenaire | Genesys Services cloud, Inc |
| Site web de la société | [https://www.genesys.com](https://www.genesys.com) |
...
| Fonctionnalités principales de l’application | Genesys Cloud CX&#8482; Integration for Microsoft Teams |
...
Ces informations ont été fournies par Genesys Services cloud, Inc. sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| URL de la politique de confidentialité | https://help.mypurecloud.com/wp-content/uploads/2021/11/Genesys-Cloud-Privacy-Policy-Nov-2021.pdf |
