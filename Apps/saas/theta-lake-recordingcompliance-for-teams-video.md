---
title: Informations sur l’application pour la conformité de l’enregistrement &amp; Theta Lake pour Teams Vidéo by Theta Lake
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/16/2022
...
ms.locfileid: "66809045"
---
# <a name="theta-lake-recording-amp-compliance-for-teams-video"></a>Vidéo theta Lake Recording &amp; Compliance for Teams

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Dernière mise à jour par le développeur : 7 mars 2022</p>

* <a href="https://appsource.microsoft.com/product/web-apps/thetalake.thetalake_recording_and_compliance_for_teams" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Theta Lake à Microsoft :

| **Information** | **Réponse** |
|:----------------|:-------------|
| Nom de l'application | Vidéo theta Lake Recording &amp; Compliance for Teams |
| ID | thetalake.thetalake_recording_and_compliance_for_teams |
| Nom de la société partenaire | Theta Lake |
| Site web de la société | [https://thetalake.com](https://thetalake.com) |
| Conditions d’utilisation de l’application | [https://thetalake.com/privacy-policy](https://thetalake.com/privacy-policy) |
| Fonctionnalités principales de l’application | Enregistrement, archivage, conformité et atténuation des risques pour les réunions audio et vidéo Microsoft Teams |
...
Theta Lake a fourni ces informations sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont traitées par votre application ? | Microsoft Video, Conversation Microsoft Teams |
| L’application prend-elle en charge TLS 1.1 ou version ultérieure ? | Oui |
| L’application ou l’infrastructure sous-jacente stocke-t-elle des données client Microsoft ? | Oui |
| Quelles données sont stockées dans vos bases de données ? | Microsoft Video, Conversation Microsoft Teams |
...
| Date de certification SOC2 la plus récente | 2021-08-31 |
...
| URL de la politique de confidentialité | https://thetalake.com/privacy-policy/ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calls.JoinGroupCall.All | Délégué | API Graph doit être l’accès pour recevoir l’enregistrement de l’appel | [1cc8eecf-56f3-4137-a0fe-4b0466ca0677](../azure/1cc8eecf-56f3-4137-a0fe-4b0466ca0677.md) |
