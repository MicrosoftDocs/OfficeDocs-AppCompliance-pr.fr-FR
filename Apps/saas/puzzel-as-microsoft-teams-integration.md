...
Informations fournies par Puzzel AS à Microsoft :
...
| Conditions d’utilisation de l’application | [https://www.puzzel.com/neighbourhood/trust-centre/privacy-p...](https://www.puzzel.com/neighbourhood/trust-centre/privacy-policy) |
| Fonctionnalités principales de l’application | L’intégration de Puzzel à Microsoft Teams rapproche vos agents et facilite la collaboration. Les agents peuvent passer des appels Teams, envoyer des messages, rechercher et transférer des contacts sans avoir à quitter l’application de l’agent Puzzel. Les utilisateurs peuvent voir si d’autres agents sont en ligne, occupés, absents ou dans des appels, ainsi que les états de présence de tous les autres collègues au sein de leur organisation. Les agents peuvent afficher les contacts&#8217; calendriers et planifications dans Teams pour mieux aligner les plans, les réunions et les appels. |
| Emplacement du siège social de la société | Norvège |
| Page d’informations sur l’application | [https://www.puzzel.com/microsoft-teams](https://www.puzzel.com/microsoft-teams) |
...
Ces informations ont été fournies par Puzzel AS sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont traitées par votre application ? | Données de présence, données utilisateur, données de calendrier |
| L’application prend-elle en charge TLS 1.1 ou version ultérieure ? | Oui |
| L’application ou l’infrastructure sous-jacente stocke-t-elle des données client Microsoft ? | Oui |
| Quelles données sont stockées dans vos bases de données ? | Données utilisateur, données de calendrier |
| Si l’infastructure sous-jacente traite ou stocke les données client Microsoft, où ces données sont-elles stockées géographiquement ? | Norvège, Royaume-Uni de Grande-Bretagne et Irlande du Nord (le) |
...
| URL de la politique de confidentialité | https://www.puzzel.com/neighbourhood/trust-centre |
