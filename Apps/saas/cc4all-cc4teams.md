...
* <a href="https://appsource.microsoft.com/product/web-apps/contactcenter4all1634641680587.cc4all_01" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par CC4ALL à Microsoft :

| **Information** | **Réponse** |
|:----------------|:-------------|
| Nom de l'application | CC4Teams |
| ID | contactcenter4all1634641680587.cc4all_01 |
| Nom de la société partenaire | CC4ALL |
| Site web de l’entreprise | [https://contactcenter4all.com](https://contactcenter4all.com) |
...
Ces informations ont été fournies par CC4ALL sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont stockées dans vos bases de données ? | Noms des agents, adresses e-mail, activité des agents dans le centre d’appels |
...
| URL de la politique de confidentialité | https://ss-usa.s3.amazonaws.com/c/308460351/media/12330608ab57a01be064335765158501/CC4ALL%20-%20Data%20Processing%20Agreement%20V1.0.pdf |
...
>|:------------------------|:--------------------|:------------------------------------|
>| CallRecords.Read.All | application | utilisé pour les enregistrements |
>| Calls.AccessMedia.All | application | utilisé pour accéder aux médias |
>| Calls.Initiate.All | application | utilisé pour lancer des appels dans le centre de contacts |
>| Calls.InitiateGroupCall.All | application | utilisé pour lancer des appels dans le centre de contacts |
>| Calls.JoinGroupCall.All | application | utilisé pour lancer des appels dans le centre de contacts |
>| Calls.JoinGroupCallasGuest.All | application | utilisé pour lancer des appels dans le centre de contacts |
>| Presence.Read | délégué | utilisé pour vérifier l’état des agents dans le centre de contacts |
>| Presence.Read.All | délégué | utilisé pour vérifier l’état des agents dans le centre de contacts |
