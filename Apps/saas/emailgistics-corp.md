...
| Site web de la société | [https://emailgistics.com](https://emailgistics.com) |
| Conditions d’utilisation de l’application | [https://emailgistics.com/tos](https://emailgistics.com/tos) |
| Fonctionnalités principales de l’application | Team Inbox Email Management Software for Microsoft 365 |
...
| Quelles données sont traitées par votre application ? | Données de boîte aux lettres partagées |
| L’application prend-elle en charge TLS 1.1 ou version ultérieure ? | Oui |
| L’application ou l’infrastructure sous-jacente stocke-t-elle des données client Microsoft ? | Oui |
| Quelles données sont stockées dans vos bases de données ? | Données d’en-tête de courrier (sujets, adresses, horodatages) |
...
| Si votre application n’utilise pas l’une des bibliothèques ci-dessus, quelle bibliothèque ou bibliothèque d’authentification utilise-t-elle ? | golang.org/x/oauth2 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Mail.ReadWrite | Délégué | Lire la requête d’accès pour obtenir des informations sur les messages dans la boîte aux lettres partagée. Les informations de message sont nécessaires pour exécuter des règles définies par le client (distribuées à l’utilisateur A si le message contient &#8220;&#8221; de facture, par exemple), pour suivre correctement les conversations (pour l’historique des conversations et l’affectation automatique) et pour la création de rapports (par exemple, le rapport Détails des messages ouverts).
Écrivez la nouvelle requête d’accès pour envoyer des messages à partir de règles (par exemple, des réponses automatiques) et pour mettre à jour les sujets de message avec l’ID de conversation Emailgistics. | [2c9fb9b7-5112-4a91-af52-f98682bc7bf3](../azure/2c9fb9b7-5112-4a91-af52-f98682bc7bf3.md) |
>| Mail.Send | Délégué | Permet à Emailgistics d’envoyer des messages électroniques à partir de la boîte aux lettres partagée. Cette autorisation est requise pour envoyer des messages à partir de règles (par exemple, des réponses automatiques). | [2c9fb9b7-5112-4a91-af52-f98682bc7bf3](../azure/2c9fb9b7-5112-4a91-af52-f98682bc7bf3.md) |
>| MailboxSettings.ReadWrite | Délégué | Permet à Emailgistics d’obtenir le nom de la boîte aux lettres partagée et de créer une règle de boîte aux lettres pour acheminer les messages entrants vers son dossier entrant masqué pour le traitement initial, l’exécution des règles et l’attribution automatique. | [2c9fb9b7-5112-4a91-af52-f98682bc7bf3](../azure/2c9fb9b7-5112-4a91-af52-f98682bc7bf3.md) |
>| User.Read | Délégué | Permet à Emailgistics de se connecter en tant que boîte aux lettres partagée et de lire les informations de base à son sujet, telles que son ID de principal de service, son adresse e-mail et son nom d’utilisateur. | [2c9fb9b7-5112-4a91-af52-f98682bc7bf3](../azure/2c9fb9b7-5112-4a91-af52-f98682bc7bf3.md) |
>| User.ReadBasic.All | Délégué | Permet à Emailgistics de lire des informations de base sur les utilisateurs de votre locataire. Requis pour détecter les modifications apportées aux adresses de messagerie et aux noms des membres de la boîte aux lettres et mettre automatiquement à jour ces informations, qui sont utilisées à des fins de suivi et de création de rapports, dans Emailgistics. Il s’agit de la seule autorisation dont l’étendue s’étend au-delà de la boîte aux lettres partagée. | [2c9fb9b7-5112-4a91-af52-f98682bc7bf3](../azure/2c9fb9b7-5112-4a91-af52-f98682bc7bf3.md) |
>| offline_access | Délégué | Permet à Emailgistics de fonctionner en tant qu’application back-end, au lieu d’une application interactive basée sur un navigateur nécessitant qu’un utilisateur se connecte chaque fois qu’elle fonctionne. Cette autorisation permet à Emailgistics d’obtenir un jeton d’actualisation, qu’il peut actualiser en fonction des besoins pour maintenir un accès constant. | [2c9fb9b7-5112-4a91-af52-f98682bc7bf3](../azure/2c9fb9b7-5112-4a91-af52-f98682bc7bf3.md) |
