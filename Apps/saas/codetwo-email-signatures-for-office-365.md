---
title: Informations sur l’application pour les signatures Email CodeTwo pour Office 365 par CodeTwo
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/23/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour CodeTwo Email Signatures pour Office 365, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
ms.locfileid: "66784988"
---
# <a name="codetwo-email-signatures-for-office-365"></a>CodeTwo Email Signatures pour Office 365
...
| **Information** | **Réponse** |
|:----------------|:-------------|
| Nom de l'application | CodeTwo Email Signatures pour Office 365 |
| ID | codetwo.3d2daeb9-a008-4070-a35c-cda39bd30a69 |
| Nom de la société partenaire | Codetwo |
| Site web de la société | [https://www.codetwo.com](https://www.codetwo.com) |
| Conditions d’utilisation de l’application | [https://www.codetwo.com/license-agreement](https://www.codetwo.com/license-agreement) |
| Fonctionnalités principales de l’application | CodeTwo Email Signatures pour Office 365 est un service cloud Basé sur Azure qui ajoute des signatures de messagerie automatiques, des exclusions de responsabilité légales et une personnalisation aux messages envoyés à partir de n’importe quel appareil client &amp; de messagerie. Il permet à une personne (un administrateur ou un utilisateur délégué) ou une équipe de gérer de manière centralisée les signatures électroniques dans une organisation Microsoft 365 (Office 365). Les signatures peuvent être ajoutées dans le cloud (une fois les e-mails envoyés) ou directement dans Outlook à mesure que les utilisateurs tapent. |
| Emplacement du siège social de la société | Pologne |
| Page d’informations sur l’application | [https://www.codetwo.com/email-signatures/](https://www.codetwo.com/email-signatures/) |
...
| Quelles données sont traitées par votre application ? | Données de profil utilisateur, données de messagerie utilisateur |
...
| URL de la politique de confidentialité | https://www.codetwo.com/regulations/dpa/ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Délégué | Permet aux utilisateurs de se connecter à l’application et permet à l’application de lire le profil des utilisateurs connectés. Elle permet également à l’application de lire les informations de base sur la société des utilisateurs connectés. | [2a93620e-4345-4e3b-9bae-0195f08aab69](../azure/2a93620e-4345-4e3b-9bae-0195f08aab69.md) |
>| User.Read | Délégué | Permet aux utilisateurs de se connecter à l’application et permet à l’application de lire le profil des utilisateurs connectés. Elle permet également à l’application de lire les informations de base sur la société des utilisateurs connectés. | [7afd058a-f568-4496-96b1-28d06ab3500f](../azure/7afd058a-f568-4496-96b1-28d06ab3500f.md) |
>| Directory.AccessAsUser.All | Délégué | Permet à l’application de disposer du même accès aux informations dans l’annuaire que l’utilisateur connecté. | [cb657bc2-9910-4b9c-82a0-6f4f3a47006b](../azure/cb657bc2-9910-4b9c-82a0-6f4f3a47006b.md) |
>| Directory.Read.All | les deux | Permet à l’application de lire les données de votre organisation&#8217;répertoire, tels que les utilisateurs, les groupes et les applications. | [cb657bc2-9910-4b9c-82a0-6f4f3a47006b](../azure/cb657bc2-9910-4b9c-82a0-6f4f3a47006b.md) |
>| User.ReadBasic.All | Délégué | Permet à l’application de lire un ensemble de base de propriétés de profil d’autres utilisateurs de votre organisation au nom de l’utilisateur connecté. Cela inclut le nom complet, le prénom et le nom, l’adresse e-mail et la photo. Les informations sont utilisées pour personnaliser automatiquement les signatures par e-mail pour les utilisateurs. | [cb657bc2-9910-4b9c-82a0-6f4f3a47006b](../azure/cb657bc2-9910-4b9c-82a0-6f4f3a47006b.md) |
>| User.Read | Délégué | Permet aux utilisateurs de se connecter à l’application et permet à l’application de lire le profil des utilisateurs connectés. Il permet également à l’application de lire les informations de base de l’entreprise des utilisateurs connectés. Utilisé pour inscrire l’utilisateur auprès du service CodeTwo. | [ce60db2f-439f-4e45-bfdc-d4c827c1820d](../azure/ce60db2f-439f-4e45-bfdc-d4c827c1820d.md) |
>| email | Délégué | Permet à l’application de lire l’adresse de messagerie principale de vos utilisateurs. Utilisé pour inscrire l’utilisateur auprès du service CodeTwo. | [ce60db2f-439f-4e45-bfdc-d4c827c1820d](../azure/ce60db2f-439f-4e45-bfdc-d4c827c1820d.md) |
>| offline_access | Délégué | Permet à l’application de voir et de mettre à jour les données auxquelles vous lui avez donné accès, même lorsque les utilisateurs n’utilisent pas actuellement l’application. Cela ne donne pas d’autorisations supplémentaires à l’application. | [ce60db2f-439f-4e45-bfdc-d4c827c1820d](../azure/ce60db2f-439f-4e45-bfdc-d4c827c1820d.md) |
>| openid | Délégué | Permet aux utilisateurs de se connecter à l’application avec leurs comptes professionnels ou scolaires et permet à l’application d’afficher les informations de profil utilisateur de base. Utilisé pour inscrire l’utilisateur auprès du service CodeTwo. | [ce60db2f-439f-4e45-bfdc-d4c827c1820d](../azure/ce60db2f-439f-4e45-bfdc-d4c827c1820d.md) |
>| profil | Délégué | Permet à l’application d’afficher le profil de base de vos utilisateurs (nom, image, nom d’utilisateur). Utilisé pour inscrire l’utilisateur auprès du service CodeTwo. | [ce60db2f-439f-4e45-bfdc-d4c827c1820d](../azure/ce60db2f-439f-4e45-bfdc-d4c827c1820d.md) |
