---
title: Informations sur l’application pour anywhere365 Contact Center for Teams par WORKSTREAMPEOPLE BV
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/31/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour le Centre de contacts Anywhere365 pour Teams, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
---
# <a name="anywhere365-contact-center-for-teams"></a>Centre de contacts Anywhere365 pour Teams

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Dernière mise à jour par le développeur : 14 mars 2022</p>

* <a href="https://appsource.microsoft.com/product/web-apps/workstreampeople.anywhere365contactcenterforteams" target="_blank">Afficher dans AppSource</a>
...
| **Information** | **Réponse** |
|:----------------|:-------------|
| Nom de l'application | Centre de contacts Anywhere365 pour Teams |
| ID | workstreampeople.anywhere365contactcenterforteams |
| Nom de la société partenaire | WORKSTREAMPEOPLE BV |
| Site web de la société | [https://anywhere365.io](https://anywhere365.io) |
| Conditions d’utilisation de l’application | [https://anywhere365.io/wspstorage/2022/02/Anywhere365-Dialo...](https://anywhere365.io/wspstorage/2022/02/Anywhere365-Dialogue-Cloud-Agreement_202112_V3.6.pdf) |
| Fonctionnalités principales de l’application | Anywhere365&#174; plateforme Dialogue Cloud pour Omnichannel Communications, le premier centre de contacts certifié Microsoft au monde pour Teams, entièrement intégré à l’eocystem Microsoft : d’Azure, Sharepoint et Teams à Dynamics 365, PowerApps et PowerBI. Avec l’adition de notre plateforme d’automatisation de la communication à faible code Dialogue Studio, nous pouvons l’intégrer à n’importe quel framework de bot basé sur les API, les couches de communication et les systèmes d’intelligence. |
| Emplacement du siège social de la société | Pays-Bas (le) |
| Page d’informations sur l’application | [https://anywhere365.io/category/anywhere365-dialogue-cloud/](https://anywhere365.io/category/anywhere365-dialogue-cloud/) |
...
| Quelles données sont traitées par votre application ? | Données de présence des communications &amp; |
| L’application prend-elle en charge TLS 1.1 ou version ultérieure ? | Oui |
| L’application ou l’infrastructure sous-jacente stocke-t-elle des données client Microsoft ? | Oui |
| Quelles données sont stockées dans vos bases de données ? | Données de présence des communications &amp; |
| Si l’infastructure sous-jacente traite ou stocke les données client Microsoft, où ces données sont-elles stockées géographiquement ? | Pays-Bas (le), États-Unis d’Amérique, Singapour |
...
| URL de la politique de confidentialité | https://anywhere365.io/wp-content/uploads/2021/07/Anywhere365-Privacy-Policy-2021.pdf |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.Read.All | Délégué | Collecter les domaines des clients | [d1762bac-3696-429d-ab0b-2a61463d6b7a](../azure/d1762bac-3696-429d-ab0b-2a61463d6b7a.md) |
>| Presence.Read.All | Délégué | Collectez les détails de la présence des clients. | [d1762bac-3696-429d-ab0b-2a61463d6b7a](../azure/d1762bac-3696-429d-ab0b-2a61463d6b7a.md) |
>| User.ReadBasic.All | Délégué | Collecter les noms d’affichage des clients | [d1762bac-3696-429d-ab0b-2a61463d6b7a](../azure/d1762bac-3696-429d-ab0b-2a61463d6b7a.md) |
