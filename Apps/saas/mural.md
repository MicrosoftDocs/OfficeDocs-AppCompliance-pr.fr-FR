---
title: Informations d’application pour MURAL par MURAL
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/13/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour MURAL, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
* <a href="https://appsource.microsoft.com/product/web-apps/tactivosincdbamural1608253315049.sol-43803-aek" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par MURAL à Microsoft :
...
| Site web de la société | [https://www.mural.co](https://www.mural.co) |
| Conditions d’utilisation de l’application | [https://www.mural.co/terms/terms-of-use](https://www.mural.co/terms/terms-of-use) |
| Fonctionnalités principales de l’application | Réfléchir et collaborer visuellement |
| Emplacement du siège social de la société | États-Unis d’Amérique |
| Page d’informations sur l’application | [https://support.mural.co](https://support.mural.co) |
...
Ces informations ont été fournies par MURAL sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont traitées par votre application ? | MURAL requiert uniquement le nom, le nom et l’adresse e-mail à des fins de connexion. Le type de données à traiter/stocker dépend du client. |
| L’application prend-elle en charge TLS 1.1 ou version ultérieure ? | Oui |
| L’application ou l’infrastructure sous-jacente stocke-t-elle des données client Microsoft ? | Oui |
| Quelles données sont stockées dans vos bases de données ? | MURAL stocke uniquement le prénom, le nom et le courrier électronique de l’utilisateur à des fins de connexion. Toutes les autres informations stockées dépendent des informations que les clients stockent dans leurs murales. |
...
| Date de certification SOC2 la plus récente | 2021-04-01 |
| L’application est-elle conforme aux contrôles d’organisation de service (SOC 3) ? | Oui |
| Date de certification SOC3 la plus récente | 2021-04-01 |
...
| URL de la politique de confidentialité | https://www.mural.co/terms/privacy-policy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Files.Read | Délégué | Files.read nécessaire pour charger des documents dans MURAL. | [a1ef3a23-74fc-4c91-909f-691cc47a1c8e](../azure/a1ef3a23-74fc-4c91-909f-691cc47a1c8e.md) |
>| User.Read | Délégué | User.read, car la murale a besoin d’un prénom, d’un nom et d’un e-mail pour la création de compte. | [a1ef3a23-74fc-4c91-909f-691cc47a1c8e](../azure/a1ef3a23-74fc-4c91-909f-691cc47a1c8e.md) |
