---
title: Informations sur l’application pour la découverte d’onna pour MS365 par Onna
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 11/22/2021
...
description: Toutes les informations de sécurité et de conformité disponibles pour la découverte Onna pour MS365, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le Registre CSA STAR.
...
ms.locfileid: "63552223"
---
# <a name="onna-discovery-for-ms365"></a>Découverte d’onna pour MS365

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Last updated by the developer on: November 2, 2021</p>

* <a href="https://appsource.microsoft.com/product/web-apps/onna1600902517721.onna-discovery-1" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Onna à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | Découverte d’onna pour MS365 |
| ID | onna1600902517721.onna-discovery-1 |
| Nom de la société partenaire | Onna |
| Site web de l’entreprise | [https://onna.com](https://onna.com) |
| Conditions d’utilisation de l’application | [https://onna.com/master-subscription-agreement](https://onna.com/master-subscription-agreement) |
| Fonctionnalités principales de l’application | Onna fournit la collecte de données, la recherche et l’évaluation de cas précoces pour les Microsoft 365 |
| Emplacement du siège social de l’entreprise | États-Unis d’Amérique |
| Page d’informations sur l’application | [https://onna.com/features](https://onna.com/features) |
...
Ces informations ont été fournies par Onna sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont stockées dans vos bases de données ? | E-mails, adresses e-mail, ID d’utilisateur, conversations, fichiers. Les stratégies de rétention et de suppression sont configurables par l’utilisateur final.  |
...
| Date de certification SOC2 la plus récente |  2019-06-01 |
...
| URL de la politique de confidentialité | https://onna.com/privacy-policy/ |
