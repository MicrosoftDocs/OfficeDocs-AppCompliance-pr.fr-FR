---
title: Informations d’application pour la sauvegarde cloud Office 365 - Prod (transaction) par AvePoint Inc.
ms.author: elmalova
author: elenamalova
ms.date: 10/27/2021
ms.topic: article
...
| **Information** | **Réponse** |
|:----------------|:-------------|
| Nom de l'application | Sauvegarde cloud pour Office 365 - Prod (transaction) |
