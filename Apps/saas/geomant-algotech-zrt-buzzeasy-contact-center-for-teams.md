---
title: Informations sur l’application pour Buzzeasy Contact Center for Teams par Geomant-Algotech Zrt.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 11/29/2021
...
description: Toutes les informations de sécurité et de conformité disponibles pour buzzeasy Contact Center for Teams, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
---
# <a name="buzzeasy-contact-center-for-teams"></a>Centre de contacts Buzzeasy pour Teams

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Dernière mise à jour par le développeur : 23 novembre 2021</p>
...
Informations fournies par Geomant-Algotech Zrt. vers Microsoft :

| **Information** | **Réponse** |
|:----------------|:-------------|
| Nom de l'application | Centre de contacts Buzzeasy pour Teams |
| ID | geomant.buzzeasy_teams_contact_center |
| Nom de la société partenaire | Geomant-Algotech Zrt. |
| Site web de la société | [https://www.buzzeasy.com](https://www.buzzeasy.com) |
...
| Fonctionnalités principales de l’application | Solution de centre de contacts pour Microsoft Teams |
| Emplacement du siège social de la société | Hongrie |
| Page d’informations sur l’application | [https://www.geomant.com/buzzeasy-contact-centre-for-microso...](https://www.geomant.com/buzzeasy-contact-centre-for-microsoft-teams) |
...
| Quelles données sont traitées par votre application ? | Jeton d’actualisation et d’utilisateur Microsoft JWT, ID d’application Microsoft, secret d’application, contenu Email M365 à partir de API Graph |
| L’application prend-elle en charge TLS 1.1 ou version ultérieure ? | Oui |
| L’application ou l’infrastructure sous-jacente stocke-t-elle des données client Microsoft ? | Oui |
| Quelles données sont stockées dans vos bases de données ? | Jeton d’actualisation et d’utilisateur Microsoft JWT, ID d’application Microsoft, secret d’application, contenu Email M365 à partir de API Graph |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Mail.Send | application | Envoi d’une invitation au nom d’un utilisateur de service. | [1b81b79d-10ff-4614-81cc-5ac3dc64a40c](../azure/1b81b79d-10ff-4614-81cc-5ac3dc64a40c.md) |
>| Presence.Read.All | Délégué | Afficher l’état de l’agent/utilisateur pour d’autres agents, synchroniser avec l’état de l’agent. | [1b81b79d-10ff-4614-81cc-5ac3dc64a40c](../azure/1b81b79d-10ff-4614-81cc-5ac3dc64a40c.md) |
>| User.Read | Délégué | Afficher la liste des utilisateurs pour les administrateurs pour l’inscription. | [1b81b79d-10ff-4614-81cc-5ac3dc64a40c](../azure/1b81b79d-10ff-4614-81cc-5ac3dc64a40c.md) |
>| User.Read.All | Délégué | Afficher les informations AAD utilisateur sur les interfaces administrateur/utilisateur | [1b81b79d-10ff-4614-81cc-5ac3dc64a40c](../azure/1b81b79d-10ff-4614-81cc-5ac3dc64a40c.md) |
>| User.ReadBasic.All | Délégué | Afficher les informations AAD utilisateur sur les interfaces administrateur/utilisateur | [1b81b79d-10ff-4614-81cc-5ac3dc64a40c](../azure/1b81b79d-10ff-4614-81cc-5ac3dc64a40c.md) |
>| Mail.ReadWrite | application | Permet à l’agent de lire/écrire une boîte aux lettres spécifique (partagée) via l’interface utilisateur de l’agent. (Peut être filtré sur une boîte aux lettres spécifique.) | [cbc8bfef-8dd2-4714-ab18-18e15566b63e](../azure/cbc8bfef-8dd2-4714-ab18-18e15566b63e.md) |
>| Mail.Send | application | Envoi d’e-mails pour le compte d’une boîte aux lettres partagée. | [cbc8bfef-8dd2-4714-ab18-18e15566b63e](../azure/cbc8bfef-8dd2-4714-ab18-18e15566b63e.md) |
>| User.Read | Délégué | Activer la connexion et lire le profil utilisateur | [cbc8bfef-8dd2-4714-ab18-18e15566b63e](../azure/cbc8bfef-8dd2-4714-ab18-18e15566b63e.md) |
