...
<p>Dernière mise à jour par le développeur : 29 avril 2022</p>
...
| Page d’informations sur l’application | [https://helpx.adobe.com/sign/using/microsoft-teams-integrat...](https://helpx.adobe.com/sign/using/microsoft-teams-integration-user-guide.html) |
...
| Quelles données sont traitées par votre application ? | Pour actualiser le jeton d’accès, lorsque le jeton actuel a expiré. Par exemple, lorsque l’utilisateur se trouve dans une &quot;fenêtre d’envoi de signature&quot; et qu’il la laisse inactive pendant trop longtemps, nous devons actualiser un nouveau jeton lorsque l’utilisateur est actif. |
| L’application prend-elle en charge TLS 1.1 ou version ultérieure ? | Oui |
| L’application ou l’infrastructure sous-jacente stocke-t-elle des données client Microsoft ? | Oui |
| Quelles données sont stockées dans vos bases de données ? | Pour actualiser le jeton d’accès, lorsque le jeton actuel a expiré. Par exemple, lorsque l’utilisateur se trouve dans une &quot;fenêtre d’envoi de signature&quot; et qu’il la laisse inactive pendant trop longtemps, nous devons actualiser un nouveau jeton lorsque l’utilisateur est actif. |
