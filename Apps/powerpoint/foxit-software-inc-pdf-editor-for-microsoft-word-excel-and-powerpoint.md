---
title: Informations sur l’application pour Foxit PDF Editor Microsoft Word, Excel et PowerPoint par Foxit Software Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/31/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour Foxit PDF Editor pour Microsoft Word, Excel et PowerPoint, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le Registre CSA STAR.
...
ms.locfileid: "64602463"
---
# <a name="foxit-pdf-editor-for-microsoft-word-excel-and-powerpoint"></a>Foxit PDF Editor for Microsoft Word, Excel, and PowerPoint

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Last updated by the developer on: March 17, 2022</p>

* <a href="https://appsource.microsoft.com/product/office/WA200003206" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Foxit Software Inc. à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | Foxit PDF Editor for Microsoft Word, Excel, and PowerPoint |
| ID | WA200003206 |
| Office 365 clients pris en charge | Excel 2016 ou ultérieur sur Mac, Excel 2013 ou une ultérieure sur Windows, Excel sur le Web, Word 2016 ou ultérieur sur Mac, Word sur le web, Word 2013 ou une Windows, PowerPoint 2016 ou ultérieurement sur Mac, PowerPoint sur le web, PowerPoint 2013 ou une Windows |
| Nom de la société partenaire | Foxit Software Inc. |
| Site web de l’entreprise | [https://www.foxit.com](https://www.foxit.com) |
| Conditions d’utilisation de l’application | [https://www.foxit.com/product/terms-of-service.html](https://www.foxit.com/product/terms-of-service.html) |
| Fonctionnalités principales de l’application | Avec Foxit PDF Editor pour Microsoft Teams, vous pouvez en faire plus avec les documents sans quitter Microsoft Teams : 1.Secure collaboration-Share PDF et collaborer avec tout le monde dans votre canal, et les documents stockés dans Microsoft SharePoint ou un lecteur&#65307; 2.Affichage de haute qualité - Avec un affichage PDF de haute qualité en toute sécurité et facilement Microsoft Teams&#65307; 3.Annotate PDF-Provide commentaires aux documents par le biais de marques de texte et d’annoter les outils PDF ; |
...
Ces informations ont été fournies par Foxit Software Inc. sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont stockées dans vos bases de données ? | E-mail, nom d’utilisateur, ID d’utilisateur |
...
| Date de certification SOC2 la plus récente |  2021/06/15 |
...
| URL de la politique de confidentialité | https://www.foxit.com/company/privacy-policy.html |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Files.ReadWrite.All | délégué | Lire des documents utilisateur et enregistrer des documents. | [959a79dd-69d0-4d05-b9a8-b9f02e28c049](../azure/959a79dd-69d0-4d05-b9a8-b9f02e28c049.md) |
