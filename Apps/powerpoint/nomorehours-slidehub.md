...
* <a href="https://appsource.microsoft.com/product/office/WA200001625" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par nomorehours à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | SlideHub |
| ID | WA200001625 |
| Office 365 clients pris en charge | PowerPoint 2016 ou version ultérieure sur Mac, PowerPoint sur le web, PowerPoint 2013 ou version ultérieure sur Windows |
| Nom de la société partenaire | nomorehours |
| Site web de la société | [https://nomorehours.com](https://nomorehours.com) |
| Conditions d’utilisation de l’application | [https://nomorehours.com/eula](https://nomorehours.com/eula) |
| Fonctionnalités principales de l’application | NoMore fournit aux utilisateurs professionnels PowerPoint services de conception et un complément PowerPoint visant à les rendre plus efficaces dans PowerPoint. Dans le cadre du service de conception, NoMore convertit les brouillons bruts en diapositives prêtes pour le client en seulement 8 heures. Le complément permet d’accéder au service plus rapidement, mais permet également aux utilisateurs d’accéder à des conceptions de diapositives prédéfinies et à une bibliothèque de diapositives spécifique à l’entreprise, ainsi qu’à un kit de ressources de conseil &#8220;&#8221; qui contient différents outils de productivité. |
...
Ces informations ont été fournies par nomorehours sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | application | e-mail et nom. L’e-mail est utilisé comme nom d’utilisateur dans l’application. La collecte de l’e-mail peut vous aider à vous inscrire et à vous connecter à l’application plus rapidement. Le nom est utilisé dans le cas d’un événement d’inscription. | [33ccef75-8248-44e8-88d3-24526ca9c2d3](../azure/33ccef75-8248-44e8-88d3-24526ca9c2d3.md) |
