---
title: Informations d’application pour Showmaster (plug-in d’aide) parware
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/19/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour Showmaster (plug-in d’aide), ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le Registre CSA STAR.
...
ms.locfileid: "63545242"
---
# <a name="showmaster-helper-plugin"></a>Showmaster (plug-in d’aide)
...
|:----------------|:-------------|
| Nom de l'application | Showmaster (plug-in d’aide) |
| ID | WA200003676 |
