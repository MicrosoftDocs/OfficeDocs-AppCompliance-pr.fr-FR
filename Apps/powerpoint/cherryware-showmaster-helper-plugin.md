---
title: Informations sur l’application pour Showmaster (plug-in Helper) par cherryware
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/19/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour Showmaster (plug-in Helper), ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
* <a href="https://appsource.microsoft.com/product/office/WA200003676" target="_blank">Afficher dans AppSource</a>
...
|:----------------|:-------------|
| Nom de l'application | Showmaster (plug-in Helper) |
| ID | WA200003676 |
