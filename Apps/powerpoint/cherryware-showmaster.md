---
title: Informations sur l’application pour Showmaster par cherryware
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/23/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour Showmaster, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
* <a href="https://appsource.microsoft.com/product/office/WA200003706" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par cherryware à Microsoft :

| **Information** | **Réponse** |
|:----------------|:-------------|
| Nom de l'application | Showmaster |
| ID | WA200003706 |
...
| Nom de la société partenaire | cherryware |
| Site web de la société | [https://www.cherryware.com](https://www.cherryware.com) |
| Conditions d’utilisation de l’application | [https://showmaster.app/terms/](https://showmaster.app/terms/) |
| Fonctionnalités principales de l’application | Showmaster est un complément PowerPoint qui crée un cadre passionnant autour de votre conversation pendant le temps d’attente et se brise avec les gros titres, le compte à rebours, la musique et bien plus encore. |
| Emplacement du siège social de la société | Allemagne |
| Page d’informations sur l’application | [https://showmaster.app](https://showmaster.app) |
...
Ces informations ont été fournies par cherryware sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
