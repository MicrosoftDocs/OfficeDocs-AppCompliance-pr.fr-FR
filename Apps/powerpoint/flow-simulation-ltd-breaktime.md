---
title: Informations sur l’application pour le temps d’arrêt par Flow Simulation Ltd.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/04/2022
...
description: Toutes les informations de sécurité et de conformité disponibles pour Breaktime, ses stratégies de gestion des données, ses informations de catalogue d’applications Microsoft Cloud App Security et les informations de sécurité/conformité dans le registre CSA STAR.
...
ms.locfileid: "65229386"
---
# <a name="breaktime"></a>Temps d’arrêt

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Dernière mise à jour par le développeur : 4 mai 2022</p>

* <a href="https://appsource.microsoft.com/product/office/WA200001661" target="_blank">Afficher dans AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Informations générales

Informations fournies par Flow Simulation Ltd. à Microsoft :

| **Information** | **Response** |
|:----------------|:-------------|
| Nom de l'application | Temps d’arrêt |
| ID | WA200001661 |
...
| Nom de la société partenaire | Flow Simulation Ltd. |
| Site web de la société | [https://www.flosim.com](https://www.flosim.com) |
| Conditions d’utilisation de l’application | [https://www.flosim.com/breaktime/EULA.html](https://www.flosim.com/breaktime/EULA.html) |
| Fonctionnalités principales de l’application | Un moyen rapide de dire à tout le monde quand vous serez de retour, parce que c’est breaktime! |
| Emplacement du siège social de la société | Royaume-Uni de Grande-Bretagne et d’Irlande du Nord (le) |
| Page d’informations sur l’application | [https://www.flosim.com/breaktime/Breaktime.html](https://www.flosim.com/breaktime/Breaktime.html) |
...
Ces informations ont été fournies par Flow Simulation Ltd. sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
