---
title: Vue d’ensemble d’Excel-à-Word Document Automation
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/28/2022
...
ms.locfileid: "65229208"
---
# <a name="excel-to-word-document-automation-overview"></a>Vue d’ensemble d’Excel-à-Word Document Automation

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Dernière mise à jour par le développeur : 25 février 2022</p>

* <a href="https://appsource.microsoft.com/product/office/WA104380955" target="_blank">Afficher dans AppSource</a>
...
| ID | WA104380955 |
| Office 365 clients pris en charge | Excel 2016 ou version ultérieure sur Mac, Excel 2016 ou ultérieur sur Windows, Word 2016 ou ultérieur sur Mac, Word 2016 ou ultérieur sur Windows, PowerPoint 2016 ou ultérieur sur Mac, PowerPoint 2016 ou une version ultérieure Windows, Excel sur le Web, Word sur le web, PowerPoint sur le web |
| Nom de la société partenaire | AnalysisPlace |
| Site web de la société | [https://analysisplace.com](https://analysisplace.com) |
| Conditions d’utilisation de l’application | [https://analysisplace.com/Terms](https://analysisplace.com/Terms) |
| Fonctionnalités principales de l’application | AnalysisPlace fournit des services pour automatiser la mise à jour des documents Microsoft Office |
| Emplacement du siège social de la société | États-Unis d’Amérique |
| Page d’informations sur l’application | [https://analysisplace.com/Document-Automation](https://analysisplace.com/Document-Automation) |
...
Ces informations ont été fournies par AnalysisPlace sur la façon dont cette application collecte et stocke les données organisationnelles et le contrôle que votre organisation aura sur les données collectées par l’application.
...
| Quelles données sont traitées par votre application ? | Nom d’utilisateur, adresse e-mail de l’utilisateur, ID de locataire de l’organisation |
| L’application prend-elle en charge TLS 1.1 ou version ultérieure ? | Oui |
| L’application ou l’infrastructure sous-jacente stocke-t-elle des données client Microsoft ? | Oui |
| Quelles données sont stockées dans vos bases de données ? | Nom d’utilisateur, adresse e-mail de l’utilisateur, ID de locataire de l’organisation |
...
| URL de la politique de confidentialité | https://analysisplace.com/Privacy |
